...
```
    ...
    [2026-02-26 12:48:40] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.


    [2026-02-26 12:48:40] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.


    [2026-02-26 12:48:40] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-26 12:48:46] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-26 12:48:46] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-26 12:48:46] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-26 12:48:48] INFO server_args.py:1859: Attention backend not specified. Use fa3 backend by default.
    [2026-02-26 12:48:48] INFO server_args.py:2928: Set soft_watchdog_timeout since in CI
    ...
    [2026-02-26 12:49:00] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-26 12:49:00] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-26 12:49:00] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-26 12:49:02] Ignore import error when loading sglang.srt.models.glm_ocr: No module named 'transformers.models.glm_ocr'
    [2026-02-26 12:49:02] Ignore import error when loading sglang.srt.models.glm_ocr_nextn: No module named 'transformers.models.glm_ocr'
    [2026-02-26 12:49:02] Ignore import error when loading sglang.srt.models.glmasr: cannot import name 'GlmAsrConfig' from 'transformers' (/usr/local/lib/python3.10/dist-packages/transformers/__init__.py)
    ...
    [2026-02-26 12:49:03] Ignore import error when loading sglang.srt.multimodal.processors.glmasr: cannot import name 'GlmAsrConfig' from 'transformers' (/usr/local/lib/python3.10/dist-packages/transformers/__init__.py)
    ...
    Capturing batches (bs=4 avail_mem=61.37 GB):  33%|███▎      | 1/3 [00:00<00:01,  1.06it/s]Capturing batches (bs=2 avail_mem=61.34 GB):  33%|███▎      | 1/3 [00:00<00:01,  1.06it/s]Capturing batches (bs=2 avail_mem=61.34 GB):  67%|██████▋   | 2/3 [00:01<00:00,  2.20it/s]Capturing batches (bs=1 avail_mem=61.33 GB):  67%|██████▋   | 2/3 [00:01<00:00,  2.20it/s]Capturing batches (bs=1 avail_mem=61.33 GB): 100%|██████████| 3/3 [00:01<00:00,  2.71it/s]
