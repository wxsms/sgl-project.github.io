...
```
    ...
    [2026-02-24 23:40:05] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.


    [2026-02-24 23:40:05] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.


    [2026-02-24 23:40:05] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-24 23:40:11] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-24 23:40:11] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-24 23:40:11] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-24 23:40:13] INFO server_args.py:1828: Attention backend not specified. Use fa3 backend by default.
    [2026-02-24 23:40:13] INFO server_args.py:2889: Set soft_watchdog_timeout since in CI


    [2026-02-24 23:40:16] Ignore import error when loading sglang.srt.multimodal.processors.glmasr: cannot import name 'GlmAsrConfig' from 'transformers' (/usr/local/lib/python3.10/dist-packages/transformers/__init__.py)


    [2026-02-24 23:40:19] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-24 23:40:19] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-24 23:40:19] INFO utils.py:164: NumExpr defaulting to 16 threads.
    [2026-02-24 23:40:19] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-24 23:40:19] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-24 23:40:19] INFO utils.py:164: NumExpr defaulting to 16 threads.
    ...
    [2026-02-24 23:40:26] Ignore import error when loading sglang.srt.models.glm_ocr: No module named 'transformers.models.glm_ocr'
    [2026-02-24 23:40:26] Ignore import error when loading sglang.srt.models.glm_ocr_nextn: No module named 'transformers.models.glm_ocr'
    [2026-02-24 23:40:26] Ignore import error when loading sglang.srt.models.glmasr: cannot import name 'GlmAsrConfig' from 'transformers' (/usr/local/lib/python3.10/dist-packages/transformers/__init__.py)
    [2026-02-24 23:40:26] Ignore import error when loading sglang.srt.models.grok: cannot import name '_yarn_find_correction_range' from 'sglang.srt.layers.rotary_embedding' (/public_sglang_ci/runner-l2-fbkqc-gpu-0/_work/sglang/sglang/python/sglang/srt/layers/rotary_embedding/__init__.py)
    ...
    Capturing batches (bs=4 avail_mem=59.60 GB):  33%|███▎      | 1/3 [00:00<00:01,  1.33it/s]Capturing batches (bs=2 avail_mem=59.57 GB):  33%|███▎      | 1/3 [00:00<00:01,  1.33it/s]Capturing batches (bs=1 avail_mem=59.57 GB):  33%|███▎      | 1/3 [00:00<00:01,  1.33it/s]Capturing batches (bs=1 avail_mem=59.57 GB): 100%|██████████| 3/3 [00:00<00:00,  3.65it/s]
