...
```
    ...
    2026-04-08 04:25:21.353 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-04-08 04:25:21] Persistent cache disabled, using in-memory JIT cache
    2026-04-08 04:25:21.353 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-04-08 04:25:21] Persistent cache disabled, using in-memory JIT cache
    2026-04-08 04:25:21.353 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-04-08 04:25:21] Persistent cache disabled, using in-memory JIT cache
    ...
    [2026-04-08 04:25:22] Ignore import error when loading sglang.srt.multimodal.processors.gemma4: cannot import name 'Gemma4AudioConfig' from 'transformers' (/usr/local/lib/python3.10/dist-packages/transformers/__init__.py)


    [2026-04-08 04:25:25] Ignore import error when loading sglang.srt.models.gemma4_audio: cannot import name 'Gemma4AudioConfig' from 'transformers' (/usr/local/lib/python3.10/dist-packages/transformers/__init__.py)
    [2026-04-08 04:25:25] Ignore import error when loading sglang.srt.models.gemma4_causal: cannot import name 'Gemma4TextConfig' from 'transformers' (/usr/local/lib/python3.10/dist-packages/transformers/__init__.py)
    [2026-04-08 04:25:25] Ignore import error when loading sglang.srt.models.gemma4_mm: cannot import name 'Gemma4AudioConfig' from 'transformers' (/usr/local/lib/python3.10/dist-packages/transformers/__init__.py)
    [2026-04-08 04:25:25] Ignore import error when loading sglang.srt.models.gemma4_vision: cannot import name 'Gemma4VisionConfig' from 'transformers' (/usr/local/lib/python3.10/dist-packages/transformers/__init__.py)


    2026-04-08 04:25:31.208 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-04-08 04:25:31] Persistent cache disabled, using in-memory JIT cache
    2026-04-08 04:25:31.208 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-04-08 04:25:31] Persistent cache disabled, using in-memory JIT cache
    2026-04-08 04:25:31.208 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-04-08 04:25:31] Persistent cache disabled, using in-memory JIT cache
    2026-04-08 04:25:31.209 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-04-08 04:25:31] Persistent cache disabled, using in-memory JIT cache
    2026-04-08 04:25:31.209 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-04-08 04:25:31] Persistent cache disabled, using in-memory JIT cache


    [2026-04-08 04:25:32] Ignore import error when loading sglang.srt.multimodal.processors.gemma4: cannot import name 'Gemma4AudioConfig' from 'transformers' (/usr/local/lib/python3.10/dist-packages/transformers/__init__.py)
    ...
    2026-04-08 04:25:41,710 - CUTE_DSL - WARNING - [handle_import_error] - Unexpected error during package walk: cutlass.cute.experimental
    [2026-04-08 04:25:41] Unexpected error during package walk: cutlass.cute.experimental
