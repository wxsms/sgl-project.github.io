...
```
    ...
    [2026-02-10 12:44:18] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.


    [2026-02-10 12:44:18] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.


    [2026-02-10 12:44:18] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-10 12:44:23] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-10 12:44:23] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-10 12:44:23] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-10 12:44:26] INFO server_args.py:1806: Attention backend not specified. Use fa3 backend by default.
    [2026-02-10 12:44:26] INFO server_args.py:2813: Set soft_watchdog_timeout since in CI
    ...
    [2026-02-10 12:44:29] Ignore import error when loading sglang.srt.multimodal.processors.glm4v: No module named 'transformers.models.glm_ocr'
    [2026-02-10 12:44:29] Ignore import error when loading sglang.srt.multimodal.processors.glmasr: cannot import name 'GlmAsrConfig' from 'transformers' (/usr/local/lib/python3.10/dist-packages/transformers/__init__.py)
    ...
    [2026-02-10 12:44:41] Ignore import error when loading sglang.srt.models.glm_ocr: No module named 'transformers.models.glm_ocr'
    [2026-02-10 12:44:41] Ignore import error when loading sglang.srt.models.glm_ocr_nextn: No module named 'transformers.models.glm_ocr'
    [2026-02-10 12:44:41] Ignore import error when loading sglang.srt.models.glmasr: cannot import name 'GlmAsrConfig' from 'transformers' (/usr/local/lib/python3.10/dist-packages/transformers/__init__.py)
    ...
    Capturing batches (bs=4 avail_mem=44.51 GB):  33%|███▎      | 1/3 [00:01<00:03,  1.62s/it]Capturing batches (bs=2 avail_mem=43.72 GB):  33%|███▎      | 1/3 [00:01<00:03,  1.62s/it]Capturing batches (bs=1 avail_mem=43.71 GB):  33%|███▎      | 1/3 [00:01<00:03,  1.62s/it]Capturing batches (bs=1 avail_mem=43.71 GB): 100%|██████████| 3/3 [00:01<00:00,  1.78it/s]
