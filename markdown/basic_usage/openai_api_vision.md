...
```
    ...
    [2026-05-04 10:29:30] The `use_fast` parameter is deprecated and will be removed in a future version. Use `backend="torchvision"` instead of `use_fast=True`, or `backend="pil"` instead of `use_fast=False`.


    [transformers] The `use_fast` parameter is deprecated and will be removed in a future version. Use `backend="torchvision"` instead of `use_fast=True`, or `backend="pil"` instead of `use_fast=False`.
    [2026-05-04 10:29:35] The `use_fast` parameter is deprecated and will be removed in a future version. Use `backend="torchvision"` instead of `use_fast=True`, or `backend="pil"` instead of `use_fast=False`.


    Multi-thread loading shards:   0% Completed | 0/5 [00:00<?, ?it/s]

    Multi-thread loading shards:  20% Completed | 1/5 [00:01<00:06,  1.64s/it]

    Multi-thread loading shards:  40% Completed | 2/5 [00:02<00:04,  1.38s/it]

    Multi-thread loading shards:  60% Completed | 3/5 [00:03<00:02,  1.27s/it]

    Multi-thread loading shards:  80% Completed | 4/5 [00:04<00:01,  1.17s/it]

    Multi-thread loading shards: 100% Completed | 5/5 [00:05<00:00,  1.09it/s]Multi-thread loading shards: 100% Completed | 5/5 [00:05<00:00,  1.09s/it]
    ...
    2026-05-04 10:29:50,637 - CUTE_DSL - WARNING - [handle_import_error] - Unexpected error during package walk: cutlass.cute.experimental
    [2026-05-04 10:29:50] Unexpected error during package walk: cutlass.cute.experimental
