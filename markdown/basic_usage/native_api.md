...
<strong style='color: #00008B;'>{'text': ' The capital of France is Paris. How did it come to be the capital? Paris is the "bl concrete" or "metzeline" for the whole capital of France, that\'s why some people say "Paris is the capital of France". Paris came to be a capital of France after the death of King Louis XVI, who later became Emperor. What followed was the Treaty of Versailles and the proclamation of the Third Republic, after which Louis Philippe II (the first Emperor of the First National Republic) abdicated and was succeeded by his son Charles X. ...\n\nSo, the capital of France came to be Paris because there was', 'output_ids': [576, 6722, 315, 9625, 374, 12095, 13, 2585, 1521, 432, 2525, 311, 387, 279, 6722, 30, 12095, 374, 279, 330, 2024, 14175, 1, 476, 330, 4059, 89, 4834, 1, 369, 279, 4361, 6722, 315, 9625, 11, 429, 594, 3170, 1045, 1251, 1977, 330, 59604, 374, 279, 6722, 315, 9625, 3263, 12095, 3697, 311, 387, 264, 6722, 315, 9625, 1283, 279, 4545, 315, 6210, 11876, 93837, 11, 879, 2937, 6116, 34314, 13, 3555, 8110, 572, 279, 51031, 315, 24209, 86355, 323, 279, 95430, 315, 279, 20861, 5429, 11, 1283, 892, 11876, 66854, 7946, 320, 1782, 1156, 34314, 315, 279, 5512, 5055, 5429, 8, 668, 67, 10089, 323, 572, 25331, 553, 806, 4438, 14927, 1599, 13, 5468, 4416, 11, 279, 6722, 315, 9625, 3697, 311, 387, 12095, 1576, 1052, 572], 'meta_info': {'id': 'c944191306d94084afdcd80ae0e1b351', 'finish_reason': {'type': 'length', 'length': 128}, 'prompt_tokens': 7, 'weight_version': 'default', 'num_retractions': 0, 'reasoning_tokens': 0, 'completion_tokens': 128, 'cached_tokens': 0, 'cached_tokens_details': None, 'dp_rank': None, 'e2e_latency': 1.1985340174287558, 'response_sent_to_client_ts': 1781072540.8122778}}</strong>
...
```
    ...
    [2026-06-10 06:22:20] Endpoint '/get_model_info' is deprecated and will be removed in a future version. Please use '/model_info' instead.
...
```
    ...
    [2026-06-10 06:22:23] Failed to get weights iterator: qwen/qwen2.5-0.5b-instruct-wrong (repository not found).
...
```
    ...
    [2026-06-10 06:22:57] Failed to load generation config for BAAI/bge-reranker-v2-m3: BAAI/bge-reranker-v2-m3 does not appear to have a file named generation_config.json. Checkout 'https://huggingface.co/BAAI/bge-reranker-v2-m3/tree/main' for available files.. Proceeding without generation config.


    [2026-06-10 06:23:01] No HuggingFace chat template found


    [2026-06-10 06:23:07] Failed to load generation config for BAAI/bge-reranker-v2-m3: BAAI/bge-reranker-v2-m3 does not appear to have a file named generation_config.json. Checkout 'https://huggingface.co/BAAI/bge-reranker-v2-m3/tree/main' for available files.. Proceeding without generation config.
...
```
    ...
    [2026-06-10 06:24:56] Using default MoE kernel config. Performance might be sub-optimal! Config file not found at /actions-runner/_work/sglang/sglang/python/sglang/srt/layers/moe/moe_runner/triton_utils/configs/triton_3_6_0/E=60,N=1408,device_name=NVIDIA_H100_80GB_HBM3.json, you can create them with https://github.com/sgl-project/sglang/tree/main/benchmark/kernels/fused_moe_triton
    [2026-06-10 06:24:56] Using MoE kernel config with down_moe=False. Performance might be sub-optimal! Config file not found at /actions-runner/_work/sglang/sglang/python/sglang/srt/layers/moe/moe_runner/triton_utils/configs/triton_3_6_0/E=60,N=1408,device_name=NVIDIA_H100_80GB_HBM3_down.json, you can create them with https://github.com/sgl-project/sglang/tree/main/benchmark/kernels/fused_moe_triton
...
<strong style='color: #00008B;'>{'text': ' Paris', 'output_ids': [12095, 151643], 'meta_info': {'id': 'd7b62419ba6e4e58b16d5c0b9b043ce1', 'finish_reason': {'type': 'stop', 'matched': 151643}, 'prompt_tokens': 7, 'weight_version': 'default', 'num_retractions': 0, 'reasoning_tokens': 0, 'completion_tokens': 2, 'cached_tokens': 0, 'cached_tokens_details': None, 'dp_rank': None, 'e2e_latency': 0.7152187619358301, 'response_sent_to_client_ts': 1781072699.9917011}}</strong>
...
```
    ...
    [2026-06-10 06:25:20] Load weight end. elapsed=0.45 s, type=Qwen2ForCausalLM, avail mem=77.53 GB, mem usage=0.98 GB.
    [2026-06-10 06:25:20] Max concurrent requests (per dp worker) from the finalized token capacity: max_num_reqs=128.
    [2026-06-10 06:25:20] KV Cache is allocated. dtype: torch.bfloat16, #tokens: 20480, K size: 0.12 GB, V size: 0.12 GB
    [2026-06-10 06:25:20] Memory pool end. avail mem=77.20 GB


    [2026-06-10 06:25:20] Disable prefill CUDA graph because cuda_graph_config resolved prefill.backend='disabled' (e.g. via --cuda-graph-backend-prefill=disabled or auto-disable rules).


    [2026-06-10 06:25:21] max_total_num_tokens=20480, chunked_prefill_size=8192, max_prefill_tokens=16384, max_running_requests=128, context_len=32768, available_gpu_mem=77.10 GB
    [2026-06-10 06:25:21] Tree cache initialized: source=default impl=RadixCache hybrid_swa=False hybrid_ssm=False hierarchical=False streaming_wrapped=False


    [2026-06-10 06:25:22] INFO:     Started server process [1428648]
    [2026-06-10 06:25:22] INFO:     Waiting for application startup.
    [2026-06-10 06:25:22] Using default chat sampling params from model generation config: {'repetition_penalty': 1.1, 'temperature': 0.7, 'top_k': 20, 'top_p': 0.8}
    [2026-06-10 06:25:22] INFO:     Application startup complete.
    [2026-06-10 06:25:22] INFO:     Uvicorn running on http://127.0.0.1:33685 (Press CTRL+C to quit)


    /usr/local/lib/python3.10/dist-packages/fastapi/routing.py:120: FastAPIDeprecationWarning: ORJSONResponse is deprecated, FastAPI now serializes data directly to JSON bytes via Pydantic when a return type or response model is set, which is faster and doesn't need a custom response class. Read more in the FastAPI docs: https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model and https://fastapi.tiangolo.com/tutorial/response-model/
      response = await f(request)
    [2026-06-10 06:25:22] INFO:     127.0.0.1:59592 - "GET /v1/models HTTP/1.1" 200 OK


    [2026-06-10 06:25:23] INFO:     127.0.0.1:59606 - "GET /model_info HTTP/1.1" 200 OK


    [2026-06-10 06:25:24] Prefill batch, #new-seq: 1, #new-token: 6, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 2.13
    [2026-06-10 06:25:24] INFO:     127.0.0.1:59610 - "POST /generate HTTP/1.1" 200 OK
    [2026-06-10 06:25:24] The server is fired up and ready to roll!
...
<strong style='color: #00008B;'>Original Input Text:<br>'SGLang provides efficient tokenization endpoints.'</strong>
    ...
    [2026-06-10 06:25:27] INFO:     127.0.0.1:59612 - "POST /tokenize HTTP/1.1" 200 OK
...
<strong style='color: #00008B;'>Max Model Length: 131072</strong>
    ...
    [2026-06-10 06:25:27] INFO:     127.0.0.1:59626 - "POST /detokenize HTTP/1.1" 200 OK
