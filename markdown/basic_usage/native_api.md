...
<strong style='color: #00008B;'>{'text': " What is the country's official language? :\nParis\n\nFrance's official language is French. Paris, the capital of France, is also the nation's largest city and one of its most populous metropolitan areas. The French parliament is located in Champs-Élysées in Paris. Paris is the official language of France, though standard French is also used in the official languages of Belgium, Luxembourg, Benelux, Luxembourg and Monaco.\n\nLondon and Paris (when they are located in the same province) are the largest cities in these countries at the time of the passing of the Paris Convention, signed in 1919. Marseille is", 'output_ids': [3555, 374, 279, 3146, 594, 3946, 4128, 30, 6260, 59604, 271, 49000, 594, 3946, 4128, 374, 8585, 13, 12095, 11, 279, 6722, 315, 9625, 11, 374, 1083, 279, 6995, 594, 7772, 3283, 323, 825, 315, 1181, 1429, 94451, 57406, 5671, 13, 576, 8585, 21130, 374, 7407, 304, 910, 14647, 12, 26789, 60392, 13700, 304, 12095, 13, 12095, 374, 279, 3946, 4128, 315, 9625, 11, 3498, 5297, 8585, 374, 1083, 1483, 304, 279, 3946, 15459, 315, 32961, 11, 64871, 11, 7355, 301, 2200, 11, 64871, 323, 61551, 382, 39572, 323, 12095, 320, 9309, 807, 525, 7407, 304, 279, 1852, 16847, 8, 525, 279, 7772, 9720, 304, 1493, 5837, 518, 279, 882, 315, 279, 12299, 315, 279, 12095, 25872, 11, 8499, 304, 220, 16, 24, 16, 24, 13, 87693, 374], 'meta_info': {'id': '7a0cd60125204606924ae2641fe8dde8', 'finish_reason': {'type': 'length', 'length': 128}, 'prompt_tokens': 7, 'weight_version': 'default', 'num_retractions': 0, 'reasoning_tokens': 0, 'completion_tokens': 128, 'cached_tokens': 0, 'cached_tokens_details': None, 'dp_rank': None, 'e2e_latency': 1.0813406817615032, 'response_sent_to_client_ts': 1781071423.3290303}}</strong>
...
```
    ...
    [2026-06-10 06:03:43] Endpoint '/get_model_info' is deprecated and will be removed in a future version. Please use '/model_info' instead.
...
```
    ...
    [2026-06-10 06:03:45] Failed to get weights iterator: qwen/qwen2.5-0.5b-instruct-wrong (repository not found).
...
```
    ...
    [2026-06-10 06:04:18] Failed to load generation config for BAAI/bge-reranker-v2-m3: BAAI/bge-reranker-v2-m3 does not appear to have a file named generation_config.json. Checkout 'https://huggingface.co/BAAI/bge-reranker-v2-m3/tree/main' for available files.. Proceeding without generation config.


    [2026-06-10 06:04:21] No HuggingFace chat template found


    [2026-06-10 06:04:26] Failed to load generation config for BAAI/bge-reranker-v2-m3: BAAI/bge-reranker-v2-m3 does not appear to have a file named generation_config.json. Checkout 'https://huggingface.co/BAAI/bge-reranker-v2-m3/tree/main' for available files.. Proceeding without generation config.
...
```
    ...
    [2026-06-10 06:05:11] Failed to load generation config for Skywork/Skywork-Reward-Llama-3.1-8B-v0.2: Skywork/Skywork-Reward-Llama-3.1-8B-v0.2 does not appear to have a file named generation_config.json. Checkout 'https://huggingface.co/Skywork/Skywork-Reward-Llama-3.1-8B-v0.2/tree/main' for available files.. Proceeding without generation config.


    [2026-06-10 06:05:19] Failed to load generation config for Skywork/Skywork-Reward-Llama-3.1-8B-v0.2: Skywork/Skywork-Reward-Llama-3.1-8B-v0.2 does not appear to have a file named generation_config.json. Checkout 'https://huggingface.co/Skywork/Skywork-Reward-Llama-3.1-8B-v0.2/tree/main' for available files.. Proceeding without generation config.
...
```
    ...
    [2026-06-10 06:06:10] Using default MoE kernel config. Performance might be sub-optimal! Config file not found at /actions-runner/_work/sglang/sglang/python/sglang/srt/layers/moe/moe_runner/triton_utils/configs/triton_3_6_0/E=60,N=1408,device_name=NVIDIA_H100_80GB_HBM3.json, you can create them with https://github.com/sgl-project/sglang/tree/main/benchmark/kernels/fused_moe_triton
    [2026-06-10 06:06:10] Using MoE kernel config with down_moe=False. Performance might be sub-optimal! Config file not found at /actions-runner/_work/sglang/sglang/python/sglang/srt/layers/moe/moe_runner/triton_utils/configs/triton_3_6_0/E=60,N=1408,device_name=NVIDIA_H100_80GB_HBM3_down.json, you can create them with https://github.com/sgl-project/sglang/tree/main/benchmark/kernels/fused_moe_triton
...
<strong style='color: #00008B;'>{'text': " Options: - the uk - dish - canada - desert - paris Let's do it gradually: Paris is the capital of France. Paris also have famous tower and museum.... So the answer is paris. If I want to buy威尔保持凉爽喝什么饮料我应该买什么? Options: - beer - oven - air conditioning - refrigerator -被打垮 空调可用于穿短裤的地方。如果你穿短裤，你应该买一台空调来保持凉爽。 If you wear short pants you should buy what to keep cool?? Let's do it gradually: Short pants means wearing summer clothes. Drinking beer makes some one feel warm", 'output_ids': [14566, 25, 481, 279, 14670, 481, 12000, 481, 31763, 481, 23603, 481, 40858, 6771, 594, 653, 432, 26024, 25, 12095, 374, 279, 6722, 315, 9625, 13, 12095, 1083, 614, 11245, 21271, 323, 23971, 1934, 2055, 279, 4226, 374, 40858, 13, 1416, 358, 1366, 311, 3695, 110840, 100662, 102058, 102308, 100399, 99245, 106099, 35946, 99730, 99565, 99245, 30, 14566, 25, 481, 12883, 481, 23387, 481, 3720, 34021, 481, 44944, 481, 112276, 112275, 10236, 102, 118, 47872, 116984, 99621, 99534, 102693, 103958, 1773, 102056, 99621, 99534, 102693, 3837, 115337, 99565, 106621, 102317, 36407, 100662, 102058, 102308, 1773, 1416, 498, 9850, 2805, 24549, 498, 1265, 3695, 1128, 311, 2506, 7010, 7646, 6771, 594, 653, 432, 26024, 25, 10698, 24549, 3363, 12233, 7324, 15097, 13, 82581, 12883, 3643, 1045, 825, 2666, 8205], 'meta_info': {'id': 'de7a64316c394099bd718e49fa9508e6', 'finish_reason': {'type': 'length', 'length': 128}, 'prompt_tokens': 7, 'weight_version': 'default', 'num_retractions': 0, 'reasoning_tokens': 0, 'completion_tokens': 128, 'cached_tokens': 0, 'cached_tokens_details': None, 'dp_rank': None, 'e2e_latency': 3.600431532599032, 'response_sent_to_client_ts': 1781071577.2703602}}</strong>
...
```
    ...
    [2026-06-10 06:06:36] Load weight end. elapsed=0.50 s, type=Qwen2ForCausalLM, avail mem=61.16 GB, mem usage=0.98 GB.
    [2026-06-10 06:06:36] Max concurrent requests (per dp worker) from the finalized token capacity: max_num_reqs=128.
    [2026-06-10 06:06:36] KV Cache is allocated. dtype: torch.bfloat16, #tokens: 20480, K size: 0.12 GB, V size: 0.12 GB
    [2026-06-10 06:06:36] Memory pool end. avail mem=60.83 GB
    [2026-06-10 06:06:36] Disable prefill CUDA graph because cuda_graph_config resolved prefill.backend='disabled' (e.g. via --cuda-graph-backend-prefill=disabled or auto-disable rules).


    [2026-06-10 06:06:37] max_total_num_tokens=20480, chunked_prefill_size=8192, max_prefill_tokens=16384, max_running_requests=128, context_len=32768, available_gpu_mem=59.37 GB
    [2026-06-10 06:06:37] Tree cache initialized: source=default impl=RadixCache hybrid_swa=False hybrid_ssm=False hierarchical=False streaming_wrapped=False


    [2026-06-10 06:06:37] INFO:     Started server process [1327639]
    [2026-06-10 06:06:37] INFO:     Waiting for application startup.
    [2026-06-10 06:06:37] Using default chat sampling params from model generation config: {'repetition_penalty': 1.1, 'temperature': 0.7, 'top_k': 20, 'top_p': 0.8}
    [2026-06-10 06:06:37] INFO:     Application startup complete.
    [2026-06-10 06:06:37] INFO:     Uvicorn running on http://127.0.0.1:35019 (Press CTRL+C to quit)
    /usr/local/lib/python3.10/dist-packages/fastapi/routing.py:120: FastAPIDeprecationWarning: ORJSONResponse is deprecated, FastAPI now serializes data directly to JSON bytes via Pydantic when a return type or response model is set, which is faster and doesn't need a custom response class. Read more in the FastAPI docs: https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model and https://fastapi.tiangolo.com/tutorial/response-model/
      response = await f(request)
    [2026-06-10 06:06:37] INFO:     127.0.0.1:47462 - "GET /v1/models HTTP/1.1" 200 OK


    [2026-06-10 06:06:38] INFO:     127.0.0.1:47464 - "GET /model_info HTTP/1.1" 200 OK


    [2026-06-10 06:06:39] Prefill batch, #new-seq: 1, #new-token: 6, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 2.20
    [2026-06-10 06:06:39] INFO:     127.0.0.1:47478 - "POST /generate HTTP/1.1" 200 OK
    [2026-06-10 06:06:39] The server is fired up and ready to roll!
...
<strong style='color: #00008B;'>Original Input Text:<br>'SGLang provides efficient tokenization endpoints.'</strong>
    ...
    [2026-06-10 06:06:42] INFO:     127.0.0.1:47486 - "POST /tokenize HTTP/1.1" 200 OK
...
<strong style='color: #00008B;'>Max Model Length: 131072</strong>
    ...
    [2026-06-10 06:06:42] INFO:     127.0.0.1:47496 - "POST /detokenize HTTP/1.1" 200 OK
