...
<strong style='color: #00008B;'>{'text': " Paris\n\nThe capital of France is Paris. \n\nTo elaborate:\n\nParis is France's official capital city. It is situated in the northeastern region of France, bordering the Mediterranean Sea.\n\nSome key points about Paris:\n\n1. Geographical: Paris is located in the Île de France region, centred around Mount's Basilique Notre-Dame-de-Plam三个天空南，享利 - Le Marais arrondissement, and Saint-Germain-des-prés.\n\n2. Population: It's the second-largest city in the European Union (EU), and the 11th-largest city in the world by population (as", 'output_ids': [12095, 271, 785, 6722, 315, 9625, 374, 12095, 13, 4710, 1249, 35967, 1447, 59604, 374, 9625, 594, 3946, 6722, 3283, 13, 1084, 374, 30083, 304, 279, 86144, 5537, 315, 9625, 11, 3886, 287, 279, 37685, 15029, 382, 8373, 1376, 3501, 911, 12095, 1447, 16, 13, 4229, 31177, 25, 12095, 374, 7407, 304, 279, 59108, 273, 409, 9625, 5537, 11, 2889, 1151, 2163, 10423, 594, 65970, 2372, 43464, 9420, 373, 6810, 12, 2120, 309, 101124, 101916, 58463, 3837, 71743, 59532, 481, 1967, 2876, 2782, 2890, 2111, 49653, 11, 323, 14205, 12010, 261, 3817, 24506, 26650, 5397, 382, 17, 13, 39529, 25, 1084, 594, 279, 2086, 66967, 3283, 304, 279, 7513, 9145, 320, 38807, 701, 323, 279, 220, 16, 16, 339, 66967, 3283, 304, 279, 1879, 553, 7042, 320, 300], 'meta_info': {'id': 'b344e228cc284971ac2e671948cc2795', 'finish_reason': {'type': 'length', 'length': 128}, 'prompt_tokens': 7, 'weight_version': 'default', 'num_retractions': 0, 'reasoning_tokens': 0, 'completion_tokens': 128, 'cached_tokens': 0, 'cached_tokens_details': None, 'dp_rank': None, 'e2e_latency': 1.1462430013343692, 'response_sent_to_client_ts': 1781067825.8141267}}</strong>
...
```
    ...
    [2026-06-10 05:03:45] Endpoint '/get_model_info' is deprecated and will be removed in a future version. Please use '/model_info' instead.
...
```
    ...
    [2026-06-10 05:03:48] Failed to get weights iterator: qwen/qwen2.5-0.5b-instruct-wrong (repository not found).
...
```
    ...
    [2026-06-10 05:04:21] Failed to load generation config for BAAI/bge-reranker-v2-m3: BAAI/bge-reranker-v2-m3 does not appear to have a file named generation_config.json. Checkout 'https://huggingface.co/BAAI/bge-reranker-v2-m3/tree/main' for available files.. Proceeding without generation config.


    [2026-06-10 05:04:25] No HuggingFace chat template found


    [2026-06-10 05:04:29] Failed to load generation config for BAAI/bge-reranker-v2-m3: BAAI/bge-reranker-v2-m3 does not appear to have a file named generation_config.json. Checkout 'https://huggingface.co/BAAI/bge-reranker-v2-m3/tree/main' for available files.. Proceeding without generation config.
...
```
    ...
    [2026-06-10 05:05:16] Failed to load generation config for Skywork/Skywork-Reward-Llama-3.1-8B-v0.2: Skywork/Skywork-Reward-Llama-3.1-8B-v0.2 does not appear to have a file named generation_config.json. Checkout 'https://huggingface.co/Skywork/Skywork-Reward-Llama-3.1-8B-v0.2/tree/main' for available files.. Proceeding without generation config.


    [2026-06-10 05:05:23] Failed to load generation config for Skywork/Skywork-Reward-Llama-3.1-8B-v0.2: Skywork/Skywork-Reward-Llama-3.1-8B-v0.2 does not appear to have a file named generation_config.json. Checkout 'https://huggingface.co/Skywork/Skywork-Reward-Llama-3.1-8B-v0.2/tree/main' for available files.. Proceeding without generation config.
...
```
    ...
    [2026-06-10 05:06:13] Using default MoE kernel config. Performance might be sub-optimal! Config file not found at /actions-runner/_work/sglang/sglang/python/sglang/srt/layers/moe/moe_runner/triton_utils/configs/triton_3_6_0/E=60,N=1408,device_name=NVIDIA_H100_80GB_HBM3.json, you can create them with https://github.com/sgl-project/sglang/tree/main/benchmark/kernels/fused_moe_triton
    [2026-06-10 05:06:13] Using MoE kernel config with down_moe=False. Performance might be sub-optimal! Config file not found at /actions-runner/_work/sglang/sglang/python/sglang/srt/layers/moe/moe_runner/triton_utils/configs/triton_3_6_0/E=60,N=1408,device_name=NVIDIA_H100_80GB_HBM3_down.json, you can create them with https://github.com/sgl-project/sglang/tree/main/benchmark/kernels/fused_moe_triton
...
<strong style='color: #00008B;'>{'text': ' The capital of France is Paris.', 'output_ids': [576, 6722, 315, 9625, 374, 12095, 13, 151643], 'meta_info': {'id': 'd27df2a8c0794ff992ba26c4cb5172d7', 'finish_reason': {'type': 'stop', 'matched': 151643}, 'prompt_tokens': 7, 'weight_version': 'default', 'num_retractions': 0, 'reasoning_tokens': 0, 'completion_tokens': 8, 'cached_tokens': 0, 'cached_tokens_details': None, 'dp_rank': None, 'e2e_latency': 0.6628953237086535, 'response_sent_to_client_ts': 1781067977.7266545}}</strong>
...
<strong style='color: #00008B;'>Original Input Text:<br>'SGLang provides efficient tokenization endpoints.'</strong>
    ...
    [2026-06-10 05:06:42] INFO:     127.0.0.1:42944 - "POST /tokenize HTTP/1.1" 200 OK
...
<strong style='color: #00008B;'>Max Model Length: 131072</strong>
    ...
    [2026-06-10 05:06:42] INFO:     127.0.0.1:42950 - "POST /detokenize HTTP/1.1" 200 OK
