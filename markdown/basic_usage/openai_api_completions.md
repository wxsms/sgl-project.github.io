...
```
    ...
    [2026-02-04 16:33:31] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.


    [2026-02-04 16:33:31] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.


    [2026-02-04 16:33:31] INFO utils.py:164: NumExpr defaulting to 16 threads.
    ...
    [2026-02-04 16:33:39] INFO server_args.py:1796: Attention backend not specified. Use fa3 backend by default.
    [2026-02-04 16:33:39] INFO server_args.py:2783: Set soft_watchdog_timeout since in CI
    ...
    [2026-02-04 16:33:46] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-04 16:33:46] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-04 16:33:46] INFO utils.py:164: NumExpr defaulting to 16 threads.
    [2026-02-04 16:33:46] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-04 16:33:46] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-04 16:33:46] INFO utils.py:164: NumExpr defaulting to 16 threads.
    ...
    [2026-02-04 16:33:52] Ignore import error when loading sglang.srt.models.glm_ocr: No module named 'transformers.models.glm_ocr'
    [2026-02-04 16:33:52] Ignore import error when loading sglang.srt.models.glm_ocr_nextn: No module named 'transformers.models.glm_ocr'
    [2026-02-04 16:33:52] Ignore import error when loading sglang.srt.models.glmasr: cannot import name 'GlmAsrConfig' from 'transformers' (/usr/local/lib/python3.10/dist-packages/transformers/__init__.py)
    ...
    Capturing batches (bs=4 avail_mem=74.89 GB):  33%|███▎      | 1/3 [00:00<00:01,  1.95it/s]Capturing batches (bs=2 avail_mem=74.83 GB):  33%|███▎      | 1/3 [00:00<00:01,  1.95it/s]Capturing batches (bs=1 avail_mem=74.82 GB):  33%|███▎      | 1/3 [00:00<00:01,  1.95it/s]Capturing batches (bs=1 avail_mem=74.82 GB): 100%|██████████| 3/3 [00:00<00:00,  5.33it/s]
...
<strong style='color: #00008B;'><br><br>                    NOTE: Typically, the server runs in a separate terminal.<br>                    In this notebook, we run the server and notebook code together, so their outputs are combined.<br>                    To improve clarity, the server logs are displayed in the original black color, while the notebook outputs are highlighted in blue.<br>                    To reduce the log length, we set the log level to warning for the server, the default log level is info.<br>                    We are running those notebooks in a CI environment, so the throughput is not representative of the actual performance.<br>                    </strong>
    ...
    Server started on http://localhost:38544
...
<strong style='color: #00008B;'>Response: ChatCompletion(id='def6274439ce456da92e3c3aef0b15f1', choices=[Choice(finish_reason='stop', index=0, logprobs=None, message=ChatCompletionMessage(content='Sure, here are three countries and their respective capitals:\n\n1. **United States** - Washington, D.C.\n2. **Canada** - Ottawa\n3. **Australia** - Canberra', refusal=None, role='assistant', annotations=None, audio=None, function_call=None, tool_calls=None, reasoning_content=None), matched_stop=151645)], created=1770222840, model='qwen/qwen2.5-0.5b-instruct', object='chat.completion', service_tier=None, system_fingerprint=None, usage=CompletionUsage(completion_tokens=39, prompt_tokens=37, total_tokens=76, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
...
<strong style='color: #00008B;'>Ancient Rome was a major civilization that flourished from the 8th century BCE to the 4th century CE. It was known for its advanced engineering, architecture, and art. Some of the major achievements of ancient Rome include:<br><br>1. The construction of the Colosseum, which was built in the 2nd century CE and is one of the most famous structures in history.<br><br>2. The construction of the Pantheon, a temple that was built in the 2nd century BCE and is still standing today.<br><br>3. The construction of the aqueducts, which were used to transport water from the mountains to Rome</strong>
...
```
    ...
    Yes, I am Qwen, an artificial intelligence created by Alibaba Cloud. I can provide information, answer questions, and assist with various tasks, and I'm not designed to engage in testing or evaluation.
...
<strong style='color: #00008B;'>Response: Completion(id='8299daeae1a44bd98e24ef3dc10e9945', choices=[CompletionChoice(finish_reason='stop', index=0, logprobs=None, text=' Once upon a time, in the vast expanse of space, there was a space explorer named Jack. He had always been fascinated by the universe and dreamed of exploring it with his eyes.', matched_stop='\n\n')], created=1770222841, model='qwen/qwen2.5-0.5b-instruct', object='text_completion', system_fingerprint=None, usage=CompletionUsage(completion_tokens=38, prompt_tokens=9, total_tokens=47, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
