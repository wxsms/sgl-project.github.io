...
```
    ...
    [2026-02-25 07:56:39] INFO utils.py:148: Note: detected 128 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.


    [2026-02-25 07:56:39] INFO utils.py:151: Note: NumExpr detected 128 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.


    [2026-02-25 07:56:39] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-25 07:56:44] INFO utils.py:148: Note: detected 128 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-25 07:56:44] INFO utils.py:151: Note: NumExpr detected 128 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-25 07:56:44] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-25 07:56:46] INFO server_args.py:1860: Attention backend not specified. Use fa3 backend by default.
    [2026-02-25 07:56:46] INFO server_args.py:2927: Set soft_watchdog_timeout since in CI


    [2026-02-25 07:56:50] INFO utils.py:148: Note: detected 128 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-25 07:56:50] INFO utils.py:151: Note: NumExpr detected 128 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-25 07:56:50] INFO utils.py:164: NumExpr defaulting to 16 threads.
    [2026-02-25 07:56:50] INFO utils.py:148: Note: detected 128 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-25 07:56:50] INFO utils.py:151: Note: NumExpr detected 128 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-25 07:56:50] INFO utils.py:164: NumExpr defaulting to 16 threads.
    ...
    [2026-02-25 07:56:55] Ignore import error when loading sglang.srt.models.glm_ocr: No module named 'transformers.models.glm_ocr'
    [2026-02-25 07:56:55] Ignore import error when loading sglang.srt.models.glm_ocr_nextn: No module named 'transformers.models.glm_ocr'
    [2026-02-25 07:56:55] Ignore import error when loading sglang.srt.models.glmasr: cannot import name 'GlmAsrConfig' from 'transformers' (/usr/local/lib/python3.10/dist-packages/transformers/__init__.py)
    ...
    Capturing batches (bs=1 avail_mem=77.04 GB):  33%|███▎      | 1/3 [00:00<00:00,  5.09it/s]Capturing batches (bs=1 avail_mem=77.04 GB): 100%|██████████| 3/3 [00:00<00:00, 12.53it/s]
...
<strong style='color: #00008B;'>Response: ChatCompletion(id='7dc3fe331ba9462cbd7655476266f628', choices=[Choice(finish_reason='stop', index=0, logprobs=None, message=ChatCompletionMessage(content='Sure, here are three countries and their respective capitals:\n\n1. **United States** - Washington, D.C.\n2. **Canada** - Ottawa\n3. **Australia** - Canberra', refusal=None, role='assistant', annotations=None, audio=None, function_call=None, tool_calls=None, reasoning_content=None), matched_stop=151645)], created=1772006224, model='qwen/qwen2.5-0.5b-instruct', object='chat.completion', service_tier=None, system_fingerprint=None, usage=CompletionUsage(completion_tokens=39, prompt_tokens=37, total_tokens=76, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
...
<strong style='color: #00008B;'>Ancient Rome was a major center of civilization in ancient history. Some of their major achievements include:<br><br>1. The construction of the Colosseum, one of the largest amphitheaters in the world, which served as a place for gladiatorial contests and public spectacles.<br><br>2. The construction of the Pantheon, a temple dedicated to Jupiter, which is still standing today and is considered one of the most important religious structures in Rome.<br><br>3. The construction of the aqueducts, which were crucial for water supply and transportation in Rome.<br><br>4. The development of Roman law, which included laws that regulated marriage, property rights</strong>
...
```
    ...
    Yes, I am a test created by Alibaba Cloud. I am here to assist you with any questions or tasks you may have. Please let me know how I can be of assistance.
...
<strong style='color: #00008B;'>Response: Completion(id='7951a8684273439f8e3f95441911ae39', choices=[CompletionChoice(finish_reason='stop', index=0, logprobs=None, text=' Once upon a time, there was a space explorer named Alex. He had always been fascinated by the vastness of space and the mysteries that lay beyond it. One day, he decided to embark on a mission to explore a distant planet.', matched_stop='\n\n')], created=1772006225, model='qwen/qwen2.5-0.5b-instruct', object='text_completion', system_fingerprint=None, usage=CompletionUsage(completion_tokens=48, prompt_tokens=9, total_tokens=57, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
