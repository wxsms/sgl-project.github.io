...
```
    ...
    [2026-02-14 15:26:31] INFO utils.py:148: Note: detected 128 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.


    [2026-02-14 15:26:31] INFO utils.py:151: Note: NumExpr detected 128 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.


    [2026-02-14 15:26:31] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-14 15:26:35] INFO utils.py:148: Note: detected 128 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-14 15:26:35] INFO utils.py:151: Note: NumExpr detected 128 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-14 15:26:35] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-14 15:26:37] INFO server_args.py:1819: Attention backend not specified. Use fa3 backend by default.
    [2026-02-14 15:26:37] INFO server_args.py:2854: Set soft_watchdog_timeout since in CI


    [2026-02-14 15:26:41] INFO utils.py:148: Note: detected 128 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-14 15:26:41] INFO utils.py:151: Note: NumExpr detected 128 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-14 15:26:41] INFO utils.py:164: NumExpr defaulting to 16 threads.
    [2026-02-14 15:26:41] INFO utils.py:148: Note: detected 128 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-14 15:26:41] INFO utils.py:151: Note: NumExpr detected 128 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-14 15:26:41] INFO utils.py:164: NumExpr defaulting to 16 threads.
    ...
    [2026-02-14 15:26:45] Ignore import error when loading sglang.srt.models.glm_ocr: No module named 'transformers.models.glm_ocr'
    [2026-02-14 15:26:45] Ignore import error when loading sglang.srt.models.glm_ocr_nextn: No module named 'transformers.models.glm_ocr'
    [2026-02-14 15:26:45] Ignore import error when loading sglang.srt.models.glmasr: cannot import name 'GlmAsrConfig' from 'transformers' (/usr/local/lib/python3.10/dist-packages/transformers/__init__.py)
    ...
    Capturing batches (bs=4 avail_mem=77.10 GB):  33%|███▎      | 1/3 [00:00<00:00,  4.52it/s]Capturing batches (bs=2 avail_mem=77.04 GB):  33%|███▎      | 1/3 [00:00<00:00,  4.52it/s]Capturing batches (bs=1 avail_mem=77.04 GB):  33%|███▎      | 1/3 [00:00<00:00,  4.52it/s]Capturing batches (bs=1 avail_mem=77.04 GB): 100%|██████████| 3/3 [00:00<00:00, 11.59it/s]
...
<strong style='color: #00008B;'>Response: ChatCompletion(id='c663f6ee4edb4d328baacebfd20c172e', choices=[Choice(finish_reason='stop', index=0, logprobs=None, message=ChatCompletionMessage(content='Sure, here are three countries and their respective capitals:\n\n1. **United States** - Washington, D.C.\n2. **Canada** - Ottawa\n3. **Australia** - Canberra', refusal=None, role='assistant', annotations=None, audio=None, function_call=None, tool_calls=None, reasoning_content=None), matched_stop=151645)], created=1771082813, model='qwen/qwen2.5-0.5b-instruct', object='chat.completion', service_tier=None, system_fingerprint=None, usage=CompletionUsage(completion_tokens=39, prompt_tokens=37, total_tokens=76, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
...
<strong style='color: #00008B;'>Ancient Rome was a major civilization that had a profound impact on world history. Some of their major achievements include:<br><br>1. **Founding of Rome**: The city-state of Rome was founded by Romulus in 753 BC. It was the first city-state in the known world and played a crucial role in the development of Roman law, philosophy, and art.<br><br>2. **Roman Law**: The Roman legal system, which includes the Twelve Tables, was one of the most influential in history. It established a framework for legal rights and responsibilities that would be used for centuries.<br><br>3. **Architecture**: Rome was known for its grand</strong>
...
```
    ...
    Yes, I am Qwen, created by Alibaba Cloud. My primary function is to provide information and assistance in various areas, including AI, language, and technology. I'm here to help answer questions, provide explanations, and offer insights. If you have any specific questions or topics you'd like to discuss, feel free to ask!
...
<strong style='color: #00008B;'>Response: Completion(id='b92e8982f9604114bb692b0bb3800715', choices=[CompletionChoice(finish_reason='stop', index=0, logprobs=None, text=' **Title: The Unseen Mission**', matched_stop='\n\n')], created=1771082814, model='qwen/qwen2.5-0.5b-instruct', object='text_completion', system_fingerprint=None, usage=CompletionUsage(completion_tokens=8, prompt_tokens=9, total_tokens=17, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
