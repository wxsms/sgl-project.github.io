...
```
    ...
    [2026-02-12 17:29:32] INFO utils.py:148: Note: detected 128 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.


    [2026-02-12 17:29:32] INFO utils.py:151: Note: NumExpr detected 128 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.


    [2026-02-12 17:29:32] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-12 17:29:36] INFO utils.py:148: Note: detected 128 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-12 17:29:36] INFO utils.py:151: Note: NumExpr detected 128 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-12 17:29:36] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-12 17:29:38] INFO server_args.py:1813: Attention backend not specified. Use fa3 backend by default.
    [2026-02-12 17:29:38] INFO server_args.py:2821: Set soft_watchdog_timeout since in CI


    [2026-02-12 17:29:42] INFO utils.py:148: Note: detected 128 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-12 17:29:42] INFO utils.py:151: Note: NumExpr detected 128 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-12 17:29:42] INFO utils.py:164: NumExpr defaulting to 16 threads.
    [2026-02-12 17:29:42] INFO utils.py:148: Note: detected 128 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-12 17:29:42] INFO utils.py:151: Note: NumExpr detected 128 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-12 17:29:42] INFO utils.py:164: NumExpr defaulting to 16 threads.
    ...
    [2026-02-12 17:29:47] Ignore import error when loading sglang.srt.models.glm_ocr: No module named 'transformers.models.glm_ocr'
    [2026-02-12 17:29:47] Ignore import error when loading sglang.srt.models.glm_ocr_nextn: No module named 'transformers.models.glm_ocr'
    [2026-02-12 17:29:47] Ignore import error when loading sglang.srt.models.glmasr: cannot import name 'GlmAsrConfig' from 'transformers' (/usr/local/lib/python3.10/dist-packages/transformers/__init__.py)
    ...
    Capturing batches (bs=4 avail_mem=55.70 GB):  33%|███▎      | 1/3 [00:00<00:00,  2.92it/s]Capturing batches (bs=2 avail_mem=55.61 GB):  33%|███▎      | 1/3 [00:00<00:00,  2.92it/s]Capturing batches (bs=1 avail_mem=55.61 GB):  33%|███▎      | 1/3 [00:00<00:00,  2.92it/s]Capturing batches (bs=1 avail_mem=55.61 GB): 100%|██████████| 3/3 [00:00<00:00,  7.85it/s]
...
<strong style='color: #00008B;'>Response: ChatCompletion(id='b84c18c7bd514331948fd9ed0fe2f9cf', choices=[Choice(finish_reason='stop', index=0, logprobs=None, message=ChatCompletionMessage(content='Sure, here are three countries and their respective capitals:\n\n1. **United States** - Washington, D.C.\n2. **Canada** - Ottawa\n3. **Australia** - Canberra', refusal=None, role='assistant', annotations=None, audio=None, function_call=None, tool_calls=None, reasoning_content=None), matched_stop=151645)], created=1770917395, model='qwen/qwen2.5-0.5b-instruct', object='chat.completion', service_tier=None, system_fingerprint=None, usage=CompletionUsage(completion_tokens=39, prompt_tokens=37, total_tokens=76, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
...
<strong style='color: #00008B;'>Ancient Rome was a remarkable civilization that left a profound impact on the world. Some of its major achievements include:<br><br>1. **Growth and Expansion**: Rome expanded rapidly, becoming one of the largest empires in history. It controlled vast territories, including parts of modern-day France, Italy, and Spain.<br><br>2. **Architecture**: Rome was renowned for its architecture, particularly the Colosseum and the Pantheon. The Colosseum is considered one of the greatest buildings in the world, designed by Vitruvius.<br><br>3. **Law**: Roman law, known as "civil law," was highly developed and influenced many</strong>
...
```
    ...
    Yes, I am a test. I was created by Alibaba Cloud to assist with various tasks and can be used to generate text, answer questions, or perform other language-related tasks. If you have any specific questions or need assistance with a particular topic, feel free to ask!
...
<strong style='color: #00008B;'>Response: Completion(id='62f040c7665d47589c7a44679ac40c95', choices=[CompletionChoice(finish_reason='stop', index=0, logprobs=None, text=' Once upon a time, there was a space explorer named Alex. Alex was an adventurous soul who loved to explore new places in the universe. He had always dreamed of traveling to other planets and discovering new worlds.', matched_stop='\n\n')], created=1770917396, model='qwen/qwen2.5-0.5b-instruct', object='text_completion', system_fingerprint=None, usage=CompletionUsage(completion_tokens=42, prompt_tokens=9, total_tokens=51, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
