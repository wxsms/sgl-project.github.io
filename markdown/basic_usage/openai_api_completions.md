...
```
    ...
    [2026-02-27 09:50:12] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.


    [2026-02-27 09:50:12] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.


    [2026-02-27 09:50:12] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-27 09:50:17] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-27 09:50:17] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-27 09:50:17] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-27 09:50:20] INFO server_args.py:1864: Attention backend not specified. Use fa3 backend by default.
    [2026-02-27 09:50:20] INFO server_args.py:2934: Set soft_watchdog_timeout since in CI


    [2026-02-27 09:50:27] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-27 09:50:27] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-27 09:50:27] INFO utils.py:164: NumExpr defaulting to 16 threads.
    [2026-02-27 09:50:27] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-27 09:50:27] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-27 09:50:27] INFO utils.py:164: NumExpr defaulting to 16 threads.
    ...
    [2026-02-27 09:50:45] Ignore import error when loading sglang.srt.models.glm_ocr: No module named 'transformers.models.glm_ocr'
    [2026-02-27 09:50:45] Ignore import error when loading sglang.srt.models.glm_ocr_nextn: No module named 'transformers.models.glm_ocr'
    [2026-02-27 09:50:45] Ignore import error when loading sglang.srt.models.glmasr: cannot import name 'GlmAsrConfig' from 'transformers' (/usr/local/lib/python3.10/dist-packages/transformers/__init__.py)
...
<strong style='color: #00008B;'><br><br>        NOTE: Typically, the server runs in a separate terminal.<br>        In this notebook, we run the server and notebook code together, so their outputs are combined.<br>        To improve clarity, the server logs are displayed in the original black color, while the notebook outputs are highlighted in blue.<br>        To reduce the log length, we set the log level to warning for the server, the default log level is info.<br>        We are running those notebooks in a CI environment, so the throughput is not representative of the actual performance.<br>        </strong>
    ...
    Server started on http://localhost:39244
...
<strong style='color: #00008B;'>Response: ChatCompletion(id='31b087a0401e4d269a9d65895b0e10da', choices=[Choice(finish_reason='stop', index=0, logprobs=None, message=ChatCompletionMessage(content='Sure, here are three countries and their respective capitals:\n\n1. **United States** - Washington, D.C.\n2. **Canada** - Ottawa\n3. **Australia** - Canberra', refusal=None, role='assistant', annotations=None, audio=None, function_call=None, tool_calls=None, reasoning_content=None), matched_stop=151645)], created=1772185854, model='qwen/qwen2.5-0.5b-instruct', object='chat.completion', service_tier=None, system_fingerprint=None, usage=CompletionUsage(completion_tokens=39, prompt_tokens=37, total_tokens=76, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
...
<strong style='color: #00008B;'>Ancient Rome was a major civilization that flourished in the Mediterranean region, particularly in Italy. It was known for its vast urban centers, such as Rome, and its impressive infrastructure. Some of the major achievements of ancient Rome include:<br><br>1. **Roman Empire**: The Roman Empire was one of the largest empires in history, spanning across Europe, Asia Minor, and North Africa. It lasted from the 2nd century BCE to the 4th century CE.<br><br>2. **Architecture**: Rome is renowned for its grand architecture, including the Colosseum, Pantheon, and many others. The city's layout and design were</strong>
...
```
    ...
    Yes, I am Qwen, a large language model created by Alibaba Cloud. I am designed to answer questions and provide information on a wide range of topics. Please let me know if you have any specific questions or need help with something.
...
<strong style='color: #00008B;'>Response: Completion(id='a3574959d6ee4f288c59a87d0542aeda', choices=[CompletionChoice(finish_reason='stop', index=0, logprobs=None, text=' Once upon a time, there was a space explorer named Alex. Alex had always dreamed of exploring the stars and discovering new planets. He had studied astronomy and traveled around the world, looking for new places to visit.', matched_stop='\n\n')], created=1772185855, model='qwen/qwen2.5-0.5b-instruct', object='text_completion', system_fingerprint=None, usage=CompletionUsage(completion_tokens=43, prompt_tokens=9, total_tokens=52, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
