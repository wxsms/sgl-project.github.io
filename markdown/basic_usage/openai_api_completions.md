...
```
    ...
    [2026-02-22 11:12:23] INFO utils.py:148: Note: detected 128 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.


    [2026-02-22 11:12:23] INFO utils.py:151: Note: NumExpr detected 128 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.


    [2026-02-22 11:12:23] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-22 11:12:27] INFO utils.py:148: Note: detected 128 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-22 11:12:27] INFO utils.py:151: Note: NumExpr detected 128 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-22 11:12:27] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-22 11:12:29] INFO server_args.py:1835: Attention backend not specified. Use fa3 backend by default.
    [2026-02-22 11:12:29] INFO server_args.py:2888: Set soft_watchdog_timeout since in CI


    [2026-02-22 11:12:34] INFO utils.py:148: Note: detected 128 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-22 11:12:34] INFO utils.py:151: Note: NumExpr detected 128 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-22 11:12:34] INFO utils.py:164: NumExpr defaulting to 16 threads.
    [2026-02-22 11:12:34] INFO utils.py:148: Note: detected 128 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-22 11:12:34] INFO utils.py:151: Note: NumExpr detected 128 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-22 11:12:34] INFO utils.py:164: NumExpr defaulting to 16 threads.
    ...
    [2026-02-22 11:12:39] Ignore import error when loading sglang.srt.models.glm_ocr: No module named 'transformers.models.glm_ocr'
    [2026-02-22 11:12:39] Ignore import error when loading sglang.srt.models.glm_ocr_nextn: No module named 'transformers.models.glm_ocr'
    [2026-02-22 11:12:39] Ignore import error when loading sglang.srt.models.glmasr: cannot import name 'GlmAsrConfig' from 'transformers' (/usr/local/lib/python3.10/dist-packages/transformers/__init__.py)
...
<strong style='color: #00008B;'><br><br>        NOTE: Typically, the server runs in a separate terminal.<br>        In this notebook, we run the server and notebook code together, so their outputs are combined.<br>        To improve clarity, the server logs are displayed in the original black color, while the notebook outputs are highlighted in blue.<br>        To reduce the log length, we set the log level to warning for the server, the default log level is info.<br>        We are running those notebooks in a CI environment, so the throughput is not representative of the actual performance.<br>        </strong>
    ...
    Server started on http://localhost:31392
...
<strong style='color: #00008B;'>Response: ChatCompletion(id='b094c60190bd48708ce9a866fd7b2ee6', choices=[Choice(finish_reason='stop', index=0, logprobs=None, message=ChatCompletionMessage(content='Sure, here are three countries and their respective capitals:\n\n1. **United States** - Washington, D.C.\n2. **Canada** - Ottawa\n3. **Australia** - Canberra', refusal=None, role='assistant', annotations=None, audio=None, function_call=None, tool_calls=None, reasoning_content=None), matched_stop=151645)], created=1771758768, model='qwen/qwen2.5-0.5b-instruct', object='chat.completion', service_tier=None, system_fingerprint=None, usage=CompletionUsage(completion_tokens=39, prompt_tokens=37, total_tokens=76, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
...
<strong style='color: #00008B;'>The ancient Roman Empire, also known as the Roman Republic or the Roman Empire, was a major civilization that existed from the 8th to the 5th century BCE. It was founded by Romulus, a king of the Rutulii tribe, and ruled for about 100 years. The empire's major achievements include:<br><br>1. **Founding of Rome**: The city of Rome was founded by Romulus in 753 BCE and became the capital of the Roman Republic.<br><br>2. **Growth and Expansion**: The empire grew rapidly, eventually encompassing much of modern-day Italy, Spain, France, and parts</strong>
...
```
    ...
    Yes, it is a test. I'm designed to assist with a wide range of questions and answers, so please feel free to ask me anything.
...
<strong style='color: #00008B;'>Response: Completion(id='794cf0da6fe049cf8aee0828c663dcb6', choices=[CompletionChoice(finish_reason='stop', index=0, logprobs=None, text=' Once upon a time, there was a space explorer named John who had always dreamed of exploring the stars. He had heard stories about the distant galaxies and wondered what it would be like to travel through space.', matched_stop='\n\n')], created=1771758769, model='qwen/qwen2.5-0.5b-instruct', object='text_completion', system_fingerprint=None, usage=CompletionUsage(completion_tokens=41, prompt_tokens=9, total_tokens=50, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
