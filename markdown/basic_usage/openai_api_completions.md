...
```
    ...
    [2026-02-17 23:51:30] INFO utils.py:148: Note: detected 128 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.


    [2026-02-17 23:51:30] INFO utils.py:151: Note: NumExpr detected 128 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.


    [2026-02-17 23:51:30] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-17 23:51:34] INFO utils.py:148: Note: detected 128 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-17 23:51:34] INFO utils.py:151: Note: NumExpr detected 128 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-17 23:51:34] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-17 23:51:36] INFO server_args.py:1830: Attention backend not specified. Use fa3 backend by default.
    [2026-02-17 23:51:36] INFO server_args.py:2865: Set soft_watchdog_timeout since in CI


    [2026-02-17 23:51:40] INFO utils.py:148: Note: detected 128 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-17 23:51:40] INFO utils.py:151: Note: NumExpr detected 128 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-17 23:51:40] INFO utils.py:164: NumExpr defaulting to 16 threads.
    [2026-02-17 23:51:40] INFO utils.py:148: Note: detected 128 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-17 23:51:40] INFO utils.py:151: Note: NumExpr detected 128 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-17 23:51:40] INFO utils.py:164: NumExpr defaulting to 16 threads.
    ...
    [2026-02-17 23:51:44] Ignore import error when loading sglang.srt.models.glm_ocr: No module named 'transformers.models.glm_ocr'
    [2026-02-17 23:51:44] Ignore import error when loading sglang.srt.models.glm_ocr_nextn: No module named 'transformers.models.glm_ocr'
    [2026-02-17 23:51:44] Ignore import error when loading sglang.srt.models.glmasr: cannot import name 'GlmAsrConfig' from 'transformers' (/usr/local/lib/python3.10/dist-packages/transformers/__init__.py)
    ...
    Capturing batches (bs=4 avail_mem=76.43 GB):  33%|███▎      | 1/3 [00:00<00:00,  4.80it/s]Capturing batches (bs=2 avail_mem=60.68 GB):  33%|███▎      | 1/3 [00:00<00:00,  4.80it/s]Capturing batches (bs=1 avail_mem=60.68 GB):  33%|███▎      | 1/3 [00:00<00:00,  4.80it/s]Capturing batches (bs=1 avail_mem=60.68 GB): 100%|██████████| 3/3 [00:00<00:00, 12.20it/s]
...
<strong style='color: #00008B;'>Response: ChatCompletion(id='97fa3cb6cf784bf3ba5c9319282e018b', choices=[Choice(finish_reason='stop', index=0, logprobs=None, message=ChatCompletionMessage(content='Sure, here are three countries and their respective capitals:\n\n1. **United States** - Washington, D.C.\n2. **Canada** - Ottawa\n3. **Australia** - Canberra', refusal=None, role='assistant', annotations=None, audio=None, function_call=None, tool_calls=None, reasoning_content=None), matched_stop=151645)], created=1771372312, model='qwen/qwen2.5-0.5b-instruct', object='chat.completion', service_tier=None, system_fingerprint=None, usage=CompletionUsage(completion_tokens=39, prompt_tokens=37, total_tokens=76, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
...
<strong style='color: #00008B;'>The Roman Empire, which lasted from the 7th to the 4th century AD, was a vast and complex civilization that left a profound impact on history. Some of their major achievements include:<br><br>1. **Roman Law**: This legal system, codified in the "Twelve Tables," was one of the earliest forms of written law in the world. It established principles of justice and equality.<br><br>2. **Architecture**: Rome was renowned for its grand architecture, including the Colosseum, the Pantheon, and the Colosseum. The Pantheon is considered one of the Seven Wonders of the Ancient World.<br><br>3</strong>
...
```
    ...
    Yes, that's a test. I'm designed to assist you with questions, answer complex problems, and provide information on various topics. If you have any questions or need help with anything specific, feel free to ask!
...
<strong style='color: #00008B;'>Response: Completion(id='ecce293495ac4999b10d5ac583ceccad', choices=[CompletionChoice(finish_reason='stop', index=0, logprobs=None, text=" Once upon a time, there was a space explorer named Jack. He had always been fascinated by the stars and the mysteries that lay beyond Earth's borders. One day, while exploring a newly discovered planet, Jack stumbled upon an alien language spoken by the local inhabitants. This language was not the same as any language he had ever heard before.", matched_stop='\n\n')], created=1771372313, model='qwen/qwen2.5-0.5b-instruct', object='text_completion', system_fingerprint=None, usage=CompletionUsage(completion_tokens=68, prompt_tokens=9, total_tokens=77, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
