...
```
    ...
    [2026-02-08 02:56:10] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.


    [2026-02-08 02:56:10] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.


    [2026-02-08 02:56:10] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-08 02:56:15] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-08 02:56:15] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-08 02:56:15] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-08 02:56:18] INFO server_args.py:1796: Attention backend not specified. Use fa3 backend by default.
    [2026-02-08 02:56:18] INFO server_args.py:2783: Set soft_watchdog_timeout since in CI
    ...
    [2026-02-08 02:56:25] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-08 02:56:25] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-08 02:56:25] INFO utils.py:164: NumExpr defaulting to 16 threads.
    [2026-02-08 02:56:25] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-08 02:56:25] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-08 02:56:25] INFO utils.py:164: NumExpr defaulting to 16 threads.
    ...
    [2026-02-08 02:56:31] Ignore import error when loading sglang.srt.models.glm_ocr: No module named 'transformers.models.glm_ocr'
    [2026-02-08 02:56:31] Ignore import error when loading sglang.srt.models.glm_ocr_nextn: No module named 'transformers.models.glm_ocr'
    [2026-02-08 02:56:31] Ignore import error when loading sglang.srt.models.glmasr: cannot import name 'GlmAsrConfig' from 'transformers' (/usr/local/lib/python3.10/dist-packages/transformers/__init__.py)
    [2026-02-08 02:56:31] Ignore import error when loading sglang.srt.models.midashenglm: Detected that PyTorch and TorchAudio were compiled with different CUDA versions. PyTorch has CUDA version 12.8 whereas TorchAudio has CUDA version 12.9. Please install the TorchAudio version that matches your PyTorch version.
...
<strong style='color: #00008B;'>Response: ChatCompletion(id='5edc41469eba49a8b3eff0c020f851f6', choices=[Choice(finish_reason='stop', index=0, logprobs=None, message=ChatCompletionMessage(content='Sure, here are three countries and their respective capitals:\n\n1. **United States** - Washington, D.C.\n2. **Canada** - Ottawa\n3. **Australia** - Canberra', refusal=None, role='assistant', annotations=None, audio=None, function_call=None, tool_calls=None, reasoning_content=None), matched_stop=151645)], created=1770519400, model='qwen/qwen2.5-0.5b-instruct', object='chat.completion', service_tier=None, system_fingerprint=None, usage=CompletionUsage(completion_tokens=39, prompt_tokens=37, total_tokens=76, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
...
<strong style='color: #00008B;'>Ancient Rome was a major civilization that flourished from the 8th to the 4th century BCE. It was known for its political, military, and cultural achievements. Some of the major achievements of ancient Rome include:<br><br>1. The construction of the Colosseum in Rome, which was a massive amphitheater that hosted gladiatorial contests, public spectacles, and other events.<br><br>2. The development of Roman law, which included the Twelve Tables, which established basic principles of Roman law.<br><br>3. The construction of aqueducts and roads, which facilitated trade and transportation.<br><br>4. The invention of the papyrus</strong>
...
```
    ...
    Yes, that is a test. I'm here to assist you with any questions or information you may need. Please let me know how I can help.
...
<strong style='color: #00008B;'>Response: Completion(id='8e6ffd63b2f44553bcea50792124b2b5', choices=[CompletionChoice(finish_reason='stop', index=0, logprobs=None, text=' Once upon a time, there was a young woman named Emily who had always been fascinated by space and astronomy. She spent her days exploring the stars and planets, studying their composition and structure. One day, while on a long trip to explore the solar system, she stumbled upon an ancient temple hidden deep within a mountain range.', matched_stop='\n\n')], created=1770519401, model='qwen/qwen2.5-0.5b-instruct', object='text_completion', system_fingerprint=None, usage=CompletionUsage(completion_tokens=65, prompt_tokens=9, total_tokens=74, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
