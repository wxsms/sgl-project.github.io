...
```
    ...
    [2026-02-21 03:55:57] INFO utils.py:148: Note: detected 128 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.


    [2026-02-21 03:55:57] INFO utils.py:151: Note: NumExpr detected 128 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.


    [2026-02-21 03:55:57] INFO utils.py:164: NumExpr defaulting to 16 threads.
    ...
    [2026-02-21 03:56:03] INFO server_args.py:1835: Attention backend not specified. Use fa3 backend by default.
    [2026-02-21 03:56:03] INFO server_args.py:2888: Set soft_watchdog_timeout since in CI


    [2026-02-21 03:56:07] INFO utils.py:148: Note: detected 128 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-21 03:56:07] INFO utils.py:151: Note: NumExpr detected 128 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-21 03:56:07] INFO utils.py:164: NumExpr defaulting to 16 threads.
    [2026-02-21 03:56:07] INFO utils.py:148: Note: detected 128 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-21 03:56:07] INFO utils.py:151: Note: NumExpr detected 128 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-21 03:56:07] INFO utils.py:164: NumExpr defaulting to 16 threads.
    ...
    [2026-02-21 03:56:11] Ignore import error when loading sglang.srt.models.glm_ocr: No module named 'transformers.models.glm_ocr'
    [2026-02-21 03:56:11] Ignore import error when loading sglang.srt.models.glm_ocr_nextn: No module named 'transformers.models.glm_ocr'
    [2026-02-21 03:56:11] Ignore import error when loading sglang.srt.models.glmasr: cannot import name 'GlmAsrConfig' from 'transformers' (/usr/local/lib/python3.10/dist-packages/transformers/__init__.py)
    ...
      0%|          | 0/3 [00:00<?, ?it/s]Capturing batches (bs=4 avail_mem=72.07 GB):   0%|          | 0/3 [00:00<?, ?it/s]Capturing batches (bs=4 avail_mem=72.07 GB):  33%|███▎      | 1/3 [00:00<00:00,  5.09it/s]Capturing batches (bs=2 avail_mem=72.01 GB):  33%|███▎      | 1/3 [00:00<00:00,  5.09it/s]

    Capturing batches (bs=1 avail_mem=72.01 GB):  33%|███▎      | 1/3 [00:00<00:00,  5.09it/s]Capturing batches (bs=1 avail_mem=72.01 GB): 100%|██████████| 3/3 [00:00<00:00, 12.82it/s]
...
<strong style='color: #00008B;'>Response: ChatCompletion(id='1ab27a0e6e134e82bb34512b9551fd0a', choices=[Choice(finish_reason='stop', index=0, logprobs=None, message=ChatCompletionMessage(content='Sure, here are three countries and their respective capitals:\n\n1. **United States** - Washington, D.C.\n2. **Canada** - Ottawa\n3. **Australia** - Canberra', refusal=None, role='assistant', annotations=None, audio=None, function_call=None, tool_calls=None, reasoning_content=None), matched_stop=151645)], created=1771646179, model='qwen/qwen2.5-0.5b-instruct', object='chat.completion', service_tier=None, system_fingerprint=None, usage=CompletionUsage(completion_tokens=39, prompt_tokens=37, total_tokens=76, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
...
<strong style='color: #00008B;'>Ancient Rome was a major civilization that flourished in Italy from the 8th century BCE to the 4th century CE. Some of their major achievements include:<br><br>1. **Roman Empire**: The Roman Empire was the largest contiguous empire in history, spanning from the Italian Peninsula to the Balkans and extending into North Africa and parts of Europe. It lasted for over 2000 years and became one of the most powerful empires in history.<br><br>2. **Architecture**: Rome was known for its impressive architecture, including the Colosseum, Pantheon, and many others. The Romans also developed a system of public works</strong>
...
```
    ...
    Yes, I am Qwen, an artificial intelligence created by Alibaba Cloud. I am ready to assist you with any questions or tasks you may have. Let me know if you need anything!
...
<strong style='color: #00008B;'>Response: Completion(id='90c4d0a80fdc4457a2d425363357125e', choices=[CompletionChoice(finish_reason='stop', index=0, logprobs=None, text=' Once upon a time, there was a space explorer named Dr. Amelia Hartley. She had always dreamed of exploring the stars and learning about the universe. One day, she received an invitation to attend a conference on space exploration.', matched_stop='\n\n')], created=1771646180, model='qwen/qwen2.5-0.5b-instruct', object='text_completion', system_fingerprint=None, usage=CompletionUsage(completion_tokens=46, prompt_tokens=9, total_tokens=55, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
