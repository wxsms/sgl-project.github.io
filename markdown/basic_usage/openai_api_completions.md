...
```
    ...
    [2026-02-13 00:56:42] INFO utils.py:148: Note: detected 128 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.


    [2026-02-13 00:56:42] INFO utils.py:151: Note: NumExpr detected 128 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.


    [2026-02-13 00:56:42] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-13 00:56:46] INFO utils.py:148: Note: detected 128 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-13 00:56:46] INFO utils.py:151: Note: NumExpr detected 128 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-13 00:56:46] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-13 00:56:49] INFO server_args.py:1813: Attention backend not specified. Use fa3 backend by default.
    [2026-02-13 00:56:49] INFO server_args.py:2821: Set soft_watchdog_timeout since in CI


    [2026-02-13 00:56:53] INFO utils.py:148: Note: detected 128 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-13 00:56:53] INFO utils.py:151: Note: NumExpr detected 128 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-13 00:56:53] INFO utils.py:164: NumExpr defaulting to 16 threads.
    [2026-02-13 00:56:53] INFO utils.py:148: Note: detected 128 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-13 00:56:53] INFO utils.py:151: Note: NumExpr detected 128 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-13 00:56:53] INFO utils.py:164: NumExpr defaulting to 16 threads.
    ...
    [2026-02-13 00:56:58] Ignore import error when loading sglang.srt.models.glm_ocr: No module named 'transformers.models.glm_ocr'
    [2026-02-13 00:56:58] Ignore import error when loading sglang.srt.models.glm_ocr_nextn: No module named 'transformers.models.glm_ocr'
    [2026-02-13 00:56:58] Ignore import error when loading sglang.srt.models.glmasr: cannot import name 'GlmAsrConfig' from 'transformers' (/usr/local/lib/python3.10/dist-packages/transformers/__init__.py)
    ...
    Capturing batches (bs=4 avail_mem=74.26 GB):  33%|███▎      | 1/3 [00:00<00:00,  4.03it/s]Capturing batches (bs=2 avail_mem=74.21 GB):  33%|███▎      | 1/3 [00:00<00:00,  4.03it/s]Capturing batches (bs=1 avail_mem=74.21 GB):  33%|███▎      | 1/3 [00:00<00:00,  4.03it/s]Capturing batches (bs=1 avail_mem=74.21 GB): 100%|██████████| 3/3 [00:00<00:00, 10.47it/s]
...
<strong style='color: #00008B;'><br><br>                    NOTE: Typically, the server runs in a separate terminal.<br>                    In this notebook, we run the server and notebook code together, so their outputs are combined.<br>                    To improve clarity, the server logs are displayed in the original black color, while the notebook outputs are highlighted in blue.<br>                    To reduce the log length, we set the log level to warning for the server, the default log level is info.<br>                    We are running those notebooks in a CI environment, so the throughput is not representative of the actual performance.<br>                    </strong>
    ...
    Server started on http://localhost:33505
...
<strong style='color: #00008B;'>Response: ChatCompletion(id='49bc7099643443f187a6c262e24f425e', choices=[Choice(finish_reason='stop', index=0, logprobs=None, message=ChatCompletionMessage(content='Sure, here are three countries and their respective capitals:\n\n1. **United States** - Washington, D.C.\n2. **Canada** - Ottawa\n3. **Australia** - Canberra', refusal=None, role='assistant', annotations=None, audio=None, function_call=None, tool_calls=None, reasoning_content=None), matched_stop=151645)], created=1770944227, model='qwen/qwen2.5-0.5b-instruct', object='chat.completion', service_tier=None, system_fingerprint=None, usage=CompletionUsage(completion_tokens=39, prompt_tokens=37, total_tokens=76, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
...
<strong style='color: #00008B;'>Ancient Rome was a vast and complex civilization that achieved many significant accomplishments. Some of their major achievements include:<br><br>1. **Roman Empire**: The Roman Empire was the largest and most powerful state in the ancient world, spanning much of Europe, Asia Minor, and North Africa. It was founded by Augustus Caesar in 27 BC.<br><br>2. **Architecture**: Roman architecture is renowned for its grandeur and innovation. Key features include the Colosseum, the Pantheon, and the Roman Forum.<br><br>3. **Law**: The Roman legal system was highly developed and influenced by Greek law. It included laws on property rights, contracts</strong>
...
```
    ...
    Yes, it is a test. I am designed to provide helpful and informative responses to the best of my ability. If you have any questions or need clarification on anything, feel free to ask.
...
<strong style='color: #00008B;'>Response: Completion(id='719af8617f7941cf8857650e01f66a84', choices=[CompletionChoice(finish_reason='stop', index=0, logprobs=None, text=' Once upon a time, there was a space explorer named Dr. Sarah Chen. She had always been fascinated by the stars and the unknown worlds out there. Dr. Chen was known for her ability to navigate through the vastness of space and discover new planets and moons.', matched_stop='\n\n')], created=1770944228, model='qwen/qwen2.5-0.5b-instruct', object='text_completion', system_fingerprint=None, usage=CompletionUsage(completion_tokens=54, prompt_tokens=9, total_tokens=63, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
