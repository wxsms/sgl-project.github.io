...
```
    ...
    [2026-02-07 10:14:55] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.


    [2026-02-07 10:14:55] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.


    [2026-02-07 10:14:55] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-07 10:15:00] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-07 10:15:00] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-07 10:15:00] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-07 10:15:03] INFO server_args.py:1796: Attention backend not specified. Use fa3 backend by default.
    [2026-02-07 10:15:03] INFO server_args.py:2783: Set soft_watchdog_timeout since in CI
    ...
    [2026-02-07 10:15:09] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-07 10:15:09] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-07 10:15:09] INFO utils.py:164: NumExpr defaulting to 16 threads.
    [2026-02-07 10:15:09] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-07 10:15:09] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-07 10:15:09] INFO utils.py:164: NumExpr defaulting to 16 threads.
    ...
    [2026-02-07 10:15:14] Ignore import error when loading sglang.srt.models.glm_ocr: No module named 'transformers.models.glm_ocr'
    [2026-02-07 10:15:14] Ignore import error when loading sglang.srt.models.glm_ocr_nextn: No module named 'transformers.models.glm_ocr'
    [2026-02-07 10:15:14] Ignore import error when loading sglang.srt.models.glmasr: cannot import name 'GlmAsrConfig' from 'transformers' (/usr/local/lib/python3.10/dist-packages/transformers/__init__.py)
    ...
    Capturing batches (bs=4 avail_mem=77.02 GB):  33%|███▎      | 1/3 [00:00<00:01,  1.02it/s]Capturing batches (bs=2 avail_mem=76.96 GB):  33%|███▎      | 1/3 [00:00<00:01,  1.02it/s]Capturing batches (bs=1 avail_mem=76.96 GB):  33%|███▎      | 1/3 [00:01<00:01,  1.02it/s]Capturing batches (bs=1 avail_mem=76.96 GB): 100%|██████████| 3/3 [00:01<00:00,  2.92it/s]
...
<strong style='color: #00008B;'><br><br>                    NOTE: Typically, the server runs in a separate terminal.<br>                    In this notebook, we run the server and notebook code together, so their outputs are combined.<br>                    To improve clarity, the server logs are displayed in the original black color, while the notebook outputs are highlighted in blue.<br>                    To reduce the log length, we set the log level to warning for the server, the default log level is info.<br>                    We are running those notebooks in a CI environment, so the throughput is not representative of the actual performance.<br>                    </strong>
    ...
    Server started on http://localhost:37070
...
<strong style='color: #00008B;'>Response: ChatCompletion(id='97cd286ec2484772a19a456c6c4eaffb', choices=[Choice(finish_reason='stop', index=0, logprobs=None, message=ChatCompletionMessage(content='Sure, here are three countries and their respective capitals:\n\n1. **United States** - Washington, D.C.\n2. **Canada** - Ottawa\n3. **Australia** - Canberra', refusal=None, role='assistant', annotations=None, audio=None, function_call=None, tool_calls=None, reasoning_content=None), matched_stop=151645)], created=1770459324, model='qwen/qwen2.5-0.5b-instruct', object='chat.completion', service_tier=None, system_fingerprint=None, usage=CompletionUsage(completion_tokens=39, prompt_tokens=37, total_tokens=76, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
...
<strong style='color: #00008B;'>Ancient Rome achieved significant accomplishments in various fields, including:<br><br>1. **Architecture**: The Romans were renowned for their architectural achievements, particularly the construction of the Colosseum and the Pantheon. The Colosseum, for example, was built during the reign of Emperor Augustus and is considered one of the greatest structures in history.<br><br>2. **Art**: Roman art was highly influential, particularly in sculpture and painting. The famous Roman mosaics, such as those found in the Vatican Museums, are a testament to the skill and creativity of ancient artists.<br><br>3. **Law**: Roman law was one of the most advanced</strong>
...
```
    ...
    Yes, I am Qwen, a large language model created by Alibaba Cloud. I am designed to understand and respond to questions, and I am ready to assist with any inquiries you may have. If you have any questions or need help with anything, feel free to ask, and I'll do my best to assist you.
...
<strong style='color: #00008B;'>Response: Completion(id='055ee99776e84a098f32edd12f11f6b0', choices=[CompletionChoice(finish_reason='stop', index=0, logprobs=None, text=' Once upon a time, there was a space explorer named Jack who had been in space for over 10 years. He had seen everything from the beauty of the Earth and the wonders of space to the dark and dangerous environments of outer space.', matched_stop='\n\n')], created=1770459325, model='qwen/qwen2.5-0.5b-instruct', object='text_completion', system_fingerprint=None, usage=CompletionUsage(completion_tokens=49, prompt_tokens=9, total_tokens=58, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
