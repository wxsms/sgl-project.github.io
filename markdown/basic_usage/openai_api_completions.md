...
```
    ...
    [2026-02-13 14:37:10] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.


    [2026-02-13 14:37:10] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.


    [2026-02-13 14:37:10] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-13 14:37:16] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-13 14:37:16] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-13 14:37:16] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-13 14:37:18] INFO server_args.py:1813: Attention backend not specified. Use fa3 backend by default.
    [2026-02-13 14:37:18] INFO server_args.py:2822: Set soft_watchdog_timeout since in CI


    [2026-02-13 14:37:25] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-13 14:37:25] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-13 14:37:25] INFO utils.py:164: NumExpr defaulting to 16 threads.
    [2026-02-13 14:37:25] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-13 14:37:25] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-13 14:37:25] INFO utils.py:164: NumExpr defaulting to 16 threads.
    ...
    [2026-02-13 14:37:31] Ignore import error when loading sglang.srt.models.glm_ocr: No module named 'transformers.models.glm_ocr'
    [2026-02-13 14:37:31] Ignore import error when loading sglang.srt.models.glm_ocr_nextn: No module named 'transformers.models.glm_ocr'
    [2026-02-13 14:37:31] Ignore import error when loading sglang.srt.models.glmasr: cannot import name 'GlmAsrConfig' from 'transformers' (/usr/local/lib/python3.10/dist-packages/transformers/__init__.py)
...
<strong style='color: #00008B;'><br><br>                    NOTE: Typically, the server runs in a separate terminal.<br>                    In this notebook, we run the server and notebook code together, so their outputs are combined.<br>                    To improve clarity, the server logs are displayed in the original black color, while the notebook outputs are highlighted in blue.<br>                    To reduce the log length, we set the log level to warning for the server, the default log level is info.<br>                    We are running those notebooks in a CI environment, so the throughput is not representative of the actual performance.<br>                    </strong>
    ...
    Server started on http://localhost:33327
...
<strong style='color: #00008B;'>Response: ChatCompletion(id='e0c43530f1514dafa326df4dbfc7242b', choices=[Choice(finish_reason='stop', index=0, logprobs=None, message=ChatCompletionMessage(content='Sure, here are three countries and their respective capitals:\n\n1. **United States** - Washington, D.C.\n2. **Canada** - Ottawa\n3. **Australia** - Canberra', refusal=None, role='assistant', annotations=None, audio=None, function_call=None, tool_calls=None, reasoning_content=None), matched_stop=151645)], created=1770993460, model='qwen/qwen2.5-0.5b-instruct', object='chat.completion', service_tier=None, system_fingerprint=None, usage=CompletionUsage(completion_tokens=39, prompt_tokens=37, total_tokens=76, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
...
<strong style='color: #00008B;'>The major achievements of ancient Rome include the construction of the Colosseum, which was built to accommodate gladiatorial contests and public spectacles. The Roman Empire was also known for its extensive network of roads, which facilitated trade and communication across the empire. The Roman Empire also had a significant impact on the development of philosophy, science, and art. The Roman Empire's influence extended far beyond its borders, with its influence seen in the development of Christianity and its role in shaping the world's political and economic systems.</strong>
...
```
    ...
    Yes, I can assist with the task. What would you like me to do with this test?
...
<strong style='color: #00008B;'>Response: Completion(id='d6db6428ee9440cc80f5dfcff43bdbc7', choices=[CompletionChoice(finish_reason='length', index=0, logprobs=None, text=" The story should be set in the year 2150 and focus on the character's journey to explore the asteroid belt between Mars and Jupiter. The story should include at least one scientific discovery and a character development arc. The style should be scientific and descriptive, with plenty of detail about the space environment, the explorer's gear, and the nature of the asteroid belt. The story should have a clear beginning, middle, and end, with a satisfying conclusion that ties together all elements of the story.\nDr. Ellie Shire had been studying asteroids for years, but she never expected to make such an impact on her life in her quest to find new worlds beyond Earth. Her spacecraft had reached the asteroid belt between Mars and Jupiter, and she had", matched_stop=None)], created=1770993461, model='qwen/qwen2.5-0.5b-instruct', object='text_completion', system_fingerprint=None, usage=CompletionUsage(completion_tokens=150, prompt_tokens=9, total_tokens=159, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
