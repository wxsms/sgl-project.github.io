...
```
    ...
    [2026-02-26 19:54:43] INFO utils.py:148: Note: detected 128 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.


    [2026-02-26 19:54:43] INFO utils.py:151: Note: NumExpr detected 128 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.


    [2026-02-26 19:54:43] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-26 19:54:46] INFO utils.py:148: Note: detected 128 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-26 19:54:46] INFO utils.py:151: Note: NumExpr detected 128 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-26 19:54:46] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-26 19:54:48] INFO server_args.py:1859: Attention backend not specified. Use fa3 backend by default.
    [2026-02-26 19:54:48] INFO server_args.py:2928: Set soft_watchdog_timeout since in CI


    [2026-02-26 19:54:53] INFO utils.py:148: Note: detected 128 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-26 19:54:53] INFO utils.py:151: Note: NumExpr detected 128 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-26 19:54:53] INFO utils.py:164: NumExpr defaulting to 16 threads.
    [2026-02-26 19:54:53] INFO utils.py:148: Note: detected 128 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-26 19:54:53] INFO utils.py:151: Note: NumExpr detected 128 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-26 19:54:53] INFO utils.py:164: NumExpr defaulting to 16 threads.
    ...
    [2026-02-26 19:54:57] Ignore import error when loading sglang.srt.models.glm_ocr: No module named 'transformers.models.glm_ocr'
    [2026-02-26 19:54:57] Ignore import error when loading sglang.srt.models.glm_ocr_nextn: No module named 'transformers.models.glm_ocr'
    [2026-02-26 19:54:57] Ignore import error when loading sglang.srt.models.glmasr: cannot import name 'GlmAsrConfig' from 'transformers' (/usr/local/lib/python3.10/dist-packages/transformers/__init__.py)
    ...
      0%|          | 0/3 [00:00<?, ?it/s]Capturing batches (bs=4 avail_mem=52.53 GB):   0%|          | 0/3 [00:00<?, ?it/s]Capturing batches (bs=4 avail_mem=52.53 GB):  33%|███▎      | 1/3 [00:00<00:00,  5.13it/s]Capturing batches (bs=2 avail_mem=52.47 GB):  33%|███▎      | 1/3 [00:00<00:00,  5.13it/s]

    Capturing batches (bs=1 avail_mem=52.47 GB):  33%|███▎      | 1/3 [00:00<00:00,  5.13it/s]Capturing batches (bs=1 avail_mem=52.47 GB): 100%|██████████| 3/3 [00:00<00:00, 12.94it/s]
...
<strong style='color: #00008B;'><br><br>        NOTE: Typically, the server runs in a separate terminal.<br>        In this notebook, we run the server and notebook code together, so their outputs are combined.<br>        To improve clarity, the server logs are displayed in the original black color, while the notebook outputs are highlighted in blue.<br>        To reduce the log length, we set the log level to warning for the server, the default log level is info.<br>        We are running those notebooks in a CI environment, so the throughput is not representative of the actual performance.<br>        </strong>
    ...
    Server started on http://localhost:32371
...
<strong style='color: #00008B;'>Response: ChatCompletion(id='164ab822cccd4cfe8342bacb427d8997', choices=[Choice(finish_reason='stop', index=0, logprobs=None, message=ChatCompletionMessage(content='Sure, here are three countries and their respective capitals:\n\n1. **United States** - Washington, D.C.\n2. **Canada** - Ottawa\n3. **Australia** - Canberra', refusal=None, role='assistant', annotations=None, audio=None, function_call=None, tool_calls=None, reasoning_content=None), matched_stop=151645)], created=1772135705, model='qwen/qwen2.5-0.5b-instruct', object='chat.completion', service_tier=None, system_fingerprint=None, usage=CompletionUsage(completion_tokens=39, prompt_tokens=37, total_tokens=76, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
...
<strong style='color: #00008B;'>Ancient Rome was a major civilization that flourished in the Mediterranean region from about 800 BCE to 476 CE. Some of their major achievements include:<br><br>1. The construction of the Colosseum and other monumental structures, which were built during the reign of Emperor Augustus.<br><br>2. The development of Roman law, including the code of Hammurabi, which was later codified into the Code of Hammurabi.<br><br>3. The construction of the Pantheon, one of the most famous temples in Rome, which was built during the reign of Emperor Augustus.<br><br>4. The construction of aqueducts that</strong>
...
```
    ...
    Yes, that's correct! I'm designed to be helpful and answer questions to the best of my abilities. If you have any questions or need assistance with anything, feel free to ask!
...
<strong style='color: #00008B;'>Response: Completion(id='3fa25b79407f4663b296e57d668ed3d5', choices=[CompletionChoice(finish_reason='stop', index=0, logprobs=None, text=' Once upon a time, there was a space explorer named Jack who had been studying space for years. He had always been fascinated by the stars and the planets in the universe. One day, he received an invitation to visit the International Space Station (ISS), which was located in the orbit of Earth.', matched_stop='\n\n')], created=1772135706, model='qwen/qwen2.5-0.5b-instruct', object='text_completion', system_fingerprint=None, usage=CompletionUsage(completion_tokens=60, prompt_tokens=9, total_tokens=69, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
