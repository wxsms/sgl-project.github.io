...
```
    ...
    [2026-02-03 05:51:03] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.


    [2026-02-03 05:51:03] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.


    [2026-02-03 05:51:03] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-03 05:51:10] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-03 05:51:10] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-03 05:51:10] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-03 05:51:13] INFO server_args.py:1796: Attention backend not specified. Use fa3 backend by default.
    [2026-02-03 05:51:13] INFO server_args.py:2783: Set soft_watchdog_timeout since in CI
    ...
    [2026-02-03 05:51:19] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-03 05:51:19] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-03 05:51:19] INFO utils.py:164: NumExpr defaulting to 16 threads.
    [2026-02-03 05:51:19] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-03 05:51:19] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-03 05:51:19] INFO utils.py:164: NumExpr defaulting to 16 threads.
    ...
    Capturing batches (bs=4 avail_mem=73.19 GB):  33%|███▎      | 1/3 [00:00<00:00,  2.12it/s]Capturing batches (bs=2 avail_mem=73.13 GB):  33%|███▎      | 1/3 [00:00<00:00,  2.12it/s]Capturing batches (bs=1 avail_mem=73.13 GB):  33%|███▎      | 1/3 [00:00<00:00,  2.12it/s]Capturing batches (bs=1 avail_mem=73.13 GB): 100%|██████████| 3/3 [00:00<00:00,  5.75it/s]
...
<strong style='color: #00008B;'>Response: ChatCompletion(id='5388d13f7040447092741dda49fd2bde', choices=[Choice(finish_reason='stop', index=0, logprobs=None, message=ChatCompletionMessage(content='Sure, here are three countries and their respective capitals:\n\n1. **United States** - Washington, D.C.\n2. **Canada** - Ottawa\n3. **Australia** - Canberra', refusal=None, role='assistant', annotations=None, audio=None, function_call=None, tool_calls=None, reasoning_content=None), matched_stop=151645)], created=1770097894, model='qwen/qwen2.5-0.5b-instruct', object='chat.completion', service_tier=None, system_fingerprint=None, usage=CompletionUsage(completion_tokens=39, prompt_tokens=37, total_tokens=76, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
...
<strong style='color: #00008B;'>The ancient Roman Empire, which lasted from the 8th to the 4th century AD, is known for its vast and complex society, which included a complex system of government, law, and religion. Some of their major achievements include:<br><br>1. The construction of the Colosseum in Rome, which was the largest amphitheater in the world.<br><br>2. The invention of the papyrus scroll, which revolutionized writing and preservation.<br><br>3. The development of the Roman calendar, which was used for religious and political purposes.<br><br>4. The construction of aqueducts to supply water to cities and towns.<br><br>5. The establishment</strong>
...
<strong style='color: #00008B;'>Response: Completion(id='05d67e18677748dcb3e8b189a27b3190', choices=[CompletionChoice(finish_reason='stop', index=0, logprobs=None, text=' Once upon a time, in a distant galaxy, there was a space explorer named Jack who had always been fascinated by the mysteries of the cosmos. He had always dreamed of exploring outer space and learning about the wonders of the universe.', matched_stop='\n\n')], created=1770097894, model='qwen/qwen2.5-0.5b-instruct', object='text_completion', system_fingerprint=None, usage=CompletionUsage(completion_tokens=46, prompt_tokens=9, total_tokens=55, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
