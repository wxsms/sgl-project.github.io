...
```
    ...
    [2026-02-20 13:22:14] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.


    [2026-02-20 13:22:14] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.


    [2026-02-20 13:22:14] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-20 13:22:20] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-20 13:22:20] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-20 13:22:20] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-20 13:22:22] INFO server_args.py:1834: Attention backend not specified. Use fa3 backend by default.
    [2026-02-20 13:22:22] INFO server_args.py:2885: Set soft_watchdog_timeout since in CI


    [2026-02-20 13:22:29] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-20 13:22:29] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-20 13:22:29] INFO utils.py:164: NumExpr defaulting to 16 threads.
    [2026-02-20 13:22:29] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-20 13:22:29] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-20 13:22:29] INFO utils.py:164: NumExpr defaulting to 16 threads.
    ...
    [2026-02-20 13:22:36] Ignore import error when loading sglang.srt.models.glm_ocr: No module named 'transformers.models.glm_ocr'
    [2026-02-20 13:22:36] Ignore import error when loading sglang.srt.models.glm_ocr_nextn: No module named 'transformers.models.glm_ocr'
    [2026-02-20 13:22:36] Ignore import error when loading sglang.srt.models.glmasr: cannot import name 'GlmAsrConfig' from 'transformers' (/usr/local/lib/python3.10/dist-packages/transformers/__init__.py)
    ...
    Capturing batches (bs=4 avail_mem=72.00 GB):  33%|███▎      | 1/3 [00:00<00:00,  4.50it/s]Capturing batches (bs=2 avail_mem=71.93 GB):  33%|███▎      | 1/3 [00:00<00:00,  4.50it/s]Capturing batches (bs=1 avail_mem=71.93 GB):  33%|███▎      | 1/3 [00:00<00:00,  4.50it/s]Capturing batches (bs=1 avail_mem=71.93 GB): 100%|██████████| 3/3 [00:00<00:00, 10.99it/s]
...
<strong style='color: #00008B;'>Response: ChatCompletion(id='e3e7be2f59474d7ab2743e0fe4c722d6', choices=[Choice(finish_reason='stop', index=0, logprobs=None, message=ChatCompletionMessage(content='Sure, here are three countries and their respective capitals:\n\n1. **United States** - Washington, D.C.\n2. **Canada** - Ottawa\n3. **Australia** - Canberra', refusal=None, role='assistant', annotations=None, audio=None, function_call=None, tool_calls=None, reasoning_content=None), matched_stop=151645)], created=1771593763, model='qwen/qwen2.5-0.5b-instruct', object='chat.completion', service_tier=None, system_fingerprint=None, usage=CompletionUsage(completion_tokens=39, prompt_tokens=37, total_tokens=76, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
...
<strong style='color: #00008B;'>The ancient Roman civilization was renowned for its contributions to art, architecture, philosophy, law, and science. Some of their major achievements include:<br><br>1. **Architecture**: The Romans built magnificent structures such as the Colosseum, the Pantheon, and the Roman Forum. The Colosseum is considered one of the greatest amphitheaters in history and is still used for public events today.<br><br>2. **Art**: Roman art was highly influential and diverse. It included sculpture, painting, and architecture. The famous "Mona Lisa" is a prime example of Renaissance art.<br><br>3. **Philosophy**: The Roman Republic was</strong>
...
```
    ...
    Yes, I am a test. I am Qwen, a large language model created by Alibaba Cloud. I am here to assist you with any questions or tasks you may have, and I will do my best to provide helpful responses.
...
<strong style='color: #00008B;'>Response: Completion(id='410e22036b3d42aa8e03202b4f77c1f5', choices=[CompletionChoice(finish_reason='stop', index=0, logprobs=None, text=' Once upon a time, there was a space explorer named Jack who was on a mission to explore the stars. He had been working for years and had become very good at it, but he still wanted to learn more about the universe.', matched_stop='\n\n')], created=1771593764, model='qwen/qwen2.5-0.5b-instruct', object='text_completion', system_fingerprint=None, usage=CompletionUsage(completion_tokens=47, prompt_tokens=9, total_tokens=56, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
