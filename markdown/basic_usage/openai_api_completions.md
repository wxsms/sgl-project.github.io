...
```
    ...
    [2026-02-16 08:49:00] INFO utils.py:148: Note: detected 128 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.


    [2026-02-16 08:49:00] INFO utils.py:151: Note: NumExpr detected 128 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.


    [2026-02-16 08:49:00] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-16 08:49:05] INFO utils.py:148: Note: detected 128 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-16 08:49:05] INFO utils.py:151: Note: NumExpr detected 128 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-16 08:49:05] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-16 08:49:07] INFO server_args.py:1832: Attention backend not specified. Use fa3 backend by default.
    [2026-02-16 08:49:07] INFO server_args.py:2867: Set soft_watchdog_timeout since in CI


    [2026-02-16 08:49:12] INFO utils.py:148: Note: detected 128 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-16 08:49:12] INFO utils.py:151: Note: NumExpr detected 128 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-16 08:49:12] INFO utils.py:164: NumExpr defaulting to 16 threads.
    [2026-02-16 08:49:12] INFO utils.py:148: Note: detected 128 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-16 08:49:12] INFO utils.py:151: Note: NumExpr detected 128 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-16 08:49:12] INFO utils.py:164: NumExpr defaulting to 16 threads.
    ...
    [2026-02-16 08:49:17] Ignore import error when loading sglang.srt.models.glm_ocr: No module named 'transformers.models.glm_ocr'
    [2026-02-16 08:49:17] Ignore import error when loading sglang.srt.models.glm_ocr_nextn: No module named 'transformers.models.glm_ocr'
    [2026-02-16 08:49:17] Ignore import error when loading sglang.srt.models.glmasr: cannot import name 'GlmAsrConfig' from 'transformers' (/usr/local/lib/python3.10/dist-packages/transformers/__init__.py)
    ...
    Capturing batches (bs=4 avail_mem=59.77 GB):  33%|███▎      | 1/3 [00:00<00:00,  4.51it/s]Capturing batches (bs=2 avail_mem=59.72 GB):  33%|███▎      | 1/3 [00:00<00:00,  4.51it/s]Capturing batches (bs=1 avail_mem=59.72 GB):  33%|███▎      | 1/3 [00:00<00:00,  4.51it/s]Capturing batches (bs=1 avail_mem=59.72 GB): 100%|██████████| 3/3 [00:00<00:00, 10.81it/s]
...
<strong style='color: #00008B;'>Response: ChatCompletion(id='b665fc2bf9be4553ac18c0434f41bf13', choices=[Choice(finish_reason='stop', index=0, logprobs=None, message=ChatCompletionMessage(content='Sure, here are three countries and their respective capitals:\n\n1. **United States** - Washington, D.C.\n2. **Canada** - Ottawa\n3. **Australia** - Canberra', refusal=None, role='assistant', annotations=None, audio=None, function_call=None, tool_calls=None, reasoning_content=None), matched_stop=151645)], created=1771231765, model='qwen/qwen2.5-0.5b-instruct', object='chat.completion', service_tier=None, system_fingerprint=None, usage=CompletionUsage(completion_tokens=39, prompt_tokens=37, total_tokens=76, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
...
<strong style='color: #00008B;'>Ancient Rome was a remarkable civilization that left a lasting legacy in many areas, including architecture, law, philosophy, and literature. Some of their major achievements include:<br><br>1. Architecture: The Romans built magnificent structures such as the Colosseum, the Pantheon, and the Forum of Connaught. They also developed the concept of the amphitheater, which became a popular venue for public spectacles.<br><br>2. Law: The Roman legal system was one of the most advanced in the world, with a complex system of laws that governed everything from marriage to property rights.<br><br>3. Philosophy: The Romans were known for their philosophical contributions</strong>
...
```
    ...
    Yes, it is a test. I'm designed to provide information and assistance in a way that's safe and ethical, without any harmful or inappropriate content. I'm here to help you with your questions or concerns, and I'll do my best to provide helpful and informative responses. If you have any questions or need any help, feel free to ask!
...
<strong style='color: #00008B;'>Response: Completion(id='62acc57ee5fd4088bb9e8d9f59306a17', choices=[CompletionChoice(finish_reason='stop', index=0, logprobs=None, text=' Once upon a time, there was a space explorer named Dr. Maria Rodriguez. She had been working on a space mission for years and had finally reached the final destination in her quest to explore the universe.', matched_stop='\n\n')], created=1771231765, model='qwen/qwen2.5-0.5b-instruct', object='text_completion', system_fingerprint=None, usage=CompletionUsage(completion_tokens=41, prompt_tokens=9, total_tokens=50, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
