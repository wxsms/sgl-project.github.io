...
```
    ...
    [2026-02-09 15:47:49] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.


    [2026-02-09 15:47:49] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.


    [2026-02-09 15:47:49] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-09 15:47:54] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-09 15:47:54] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-09 15:47:54] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-09 15:47:57] INFO server_args.py:1796: Attention backend not specified. Use fa3 backend by default.
    [2026-02-09 15:47:57] INFO server_args.py:2783: Set soft_watchdog_timeout since in CI
    ...
    [2026-02-09 15:48:03] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-09 15:48:03] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-09 15:48:03] INFO utils.py:164: NumExpr defaulting to 16 threads.
    [2026-02-09 15:48:03] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-09 15:48:03] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-09 15:48:03] INFO utils.py:164: NumExpr defaulting to 16 threads.
    ...
    [2026-02-09 15:48:09] Ignore import error when loading sglang.srt.models.glm_ocr: No module named 'transformers.models.glm_ocr'
    [2026-02-09 15:48:09] Ignore import error when loading sglang.srt.models.glm_ocr_nextn: No module named 'transformers.models.glm_ocr'
    [2026-02-09 15:48:09] Ignore import error when loading sglang.srt.models.glmasr: cannot import name 'GlmAsrConfig' from 'transformers' (/usr/local/lib/python3.10/dist-packages/transformers/__init__.py)
...
<strong style='color: #00008B;'><br><br>                    NOTE: Typically, the server runs in a separate terminal.<br>                    In this notebook, we run the server and notebook code together, so their outputs are combined.<br>                    To improve clarity, the server logs are displayed in the original black color, while the notebook outputs are highlighted in blue.<br>                    To reduce the log length, we set the log level to warning for the server, the default log level is info.<br>                    We are running those notebooks in a CI environment, so the throughput is not representative of the actual performance.<br>                    </strong>
    ...
    Server started on http://localhost:37120
...
<strong style='color: #00008B;'>Response: ChatCompletion(id='9a0dac8b29684a889b01a842bdc2c3d1', choices=[Choice(finish_reason='stop', index=0, logprobs=None, message=ChatCompletionMessage(content='Sure, here are three countries and their respective capitals:\n\n1. **United States** - Washington, D.C.\n2. **Canada** - Ottawa\n3. **Australia** - Canberra', refusal=None, role='assistant', annotations=None, audio=None, function_call=None, tool_calls=None, reasoning_content=None), matched_stop=151645)], created=1770652097, model='qwen/qwen2.5-0.5b-instruct', object='chat.completion', service_tier=None, system_fingerprint=None, usage=CompletionUsage(completion_tokens=39, prompt_tokens=37, total_tokens=76, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
...
<strong style='color: #00008B;'>Ancient Rome was a major civilization that flourished in the Mediterranean region from around 800 BCE to 476 CE. It was known for its advanced engineering, agriculture, and art. Some of the major achievements of ancient Rome include:<br><br>1. The construction of the Colosseum, which was the largest amphitheater in the world.<br><br>2. The development of Roman law, which established a system of laws that governed Roman society.<br><br>3. The invention of the wheel, which revolutionized transportation and commerce.<br><br>4. The construction of aqueducts, which provided water to cities and towns.<br><br>5. The development</strong>
...
```
    ...
    Yes, that is a test. I am designed to assist with various tasks and provide answers to questions, so it is important to note that I am not capable of testing or providing answers to specific queries or scenarios. I am here to help answer any questions you may have, and I am programmed to provide accurate and helpful information. If you have any specific questions or topics you would like to discuss, feel free to ask, and I will do my best to provide you with the information you need.
...
<strong style='color: #00008B;'>Response: Completion(id='8fc0bd4666c14141bf2aaf0ec387cbd2', choices=[CompletionChoice(finish_reason='stop', index=0, logprobs=None, text=' **Title: The Voyager 1 Mission**', matched_stop='\n\n')], created=1770652098, model='qwen/qwen2.5-0.5b-instruct', object='text_completion', system_fingerprint=None, usage=CompletionUsage(completion_tokens=9, prompt_tokens=9, total_tokens=18, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
