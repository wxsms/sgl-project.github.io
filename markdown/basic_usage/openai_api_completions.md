...
```
    ...
    [2026-02-22 12:08:40] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-22 12:08:40] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-22 12:08:40] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-22 12:08:43] INFO server_args.py:1835: Attention backend not specified. Use fa3 backend by default.
    [2026-02-22 12:08:43] INFO server_args.py:2888: Set soft_watchdog_timeout since in CI


    [2026-02-22 12:08:50] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-22 12:08:50] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-22 12:08:50] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-22 12:08:50] INFO utils.py:164: NumExpr defaulting to 16 threads.
    [2026-02-22 12:08:50] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-22 12:08:50] INFO utils.py:164: NumExpr defaulting to 16 threads.
    ...
    [2026-02-22 12:08:56] Ignore import error when loading sglang.srt.models.glm_ocr: No module named 'transformers.models.glm_ocr'
    [2026-02-22 12:08:56] Ignore import error when loading sglang.srt.models.glm_ocr_nextn: No module named 'transformers.models.glm_ocr'
    [2026-02-22 12:08:56] Ignore import error when loading sglang.srt.models.glmasr: cannot import name 'GlmAsrConfig' from 'transformers' (/usr/local/lib/python3.10/dist-packages/transformers/__init__.py)
    ...
    Capturing batches (bs=4 avail_mem=72.03 GB):  33%|███▎      | 1/3 [00:00<00:00,  3.91it/s]Capturing batches (bs=2 avail_mem=71.97 GB):  33%|███▎      | 1/3 [00:00<00:00,  3.91it/s]Capturing batches (bs=1 avail_mem=71.97 GB):  33%|███▎      | 1/3 [00:00<00:00,  3.91it/s]Capturing batches (bs=1 avail_mem=71.97 GB): 100%|██████████| 3/3 [00:00<00:00,  8.60it/s]
...
<strong style='color: #00008B;'><br><br>        NOTE: Typically, the server runs in a separate terminal.<br>        In this notebook, we run the server and notebook code together, so their outputs are combined.<br>        To improve clarity, the server logs are displayed in the original black color, while the notebook outputs are highlighted in blue.<br>        To reduce the log length, we set the log level to warning for the server, the default log level is info.<br>        We are running those notebooks in a CI environment, so the throughput is not representative of the actual performance.<br>        </strong>
    ...
    Server started on http://localhost:33059
...
<strong style='color: #00008B;'>Response: ChatCompletion(id='c44d9c59d39b453a9abedf96875dbec8', choices=[Choice(finish_reason='stop', index=0, logprobs=None, message=ChatCompletionMessage(content='Sure, here are three countries and their respective capitals:\n\n1. **United States** - Washington, D.C.\n2. **Canada** - Ottawa\n3. **Australia** - Canberra', refusal=None, role='assistant', annotations=None, audio=None, function_call=None, tool_calls=None, reasoning_content=None), matched_stop=151645)], created=1771762144, model='qwen/qwen2.5-0.5b-instruct', object='chat.completion', service_tier=None, system_fingerprint=None, usage=CompletionUsage(completion_tokens=39, prompt_tokens=37, total_tokens=76, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
...
<strong style='color: #00008B;'>Ancient Rome was a major civilization that spanned from the 8th to the 4th centuries BCE. It was known for its impressive achievements in various fields, including art, architecture, philosophy, and science. Some of the major achievements of ancient Rome include:<br><br>1. **Roman Empire**: The Roman Empire was one of the largest and most powerful empires in history. It stretched from modern-day Italy to Spain and included parts of modern-day France, Germany, and parts of Eastern Europe.<br><br>2. **Architecture**: Roman architecture was renowned for its grandeur and symmetry. Key examples include the Colosseum, the Pantheon</strong>
...
```
    ...
    Yes, I can say that this is a test. I'm here to assist you with any questions or topics you have. Please feel free to ask me anything you'd like to know.
...
<strong style='color: #00008B;'>Response: Completion(id='fef58ae1a5f341c19fa1456f7e8401dc', choices=[CompletionChoice(finish_reason='stop', index=0, logprobs=None, text=" Once upon a time, in the year 2035, a young space explorer named Alex had been exploring the stars for many years. He had seen so much beauty and danger in space that he decided to join NASA's space program to help make it safer and more accessible for people like himself.", matched_stop='\n\n')], created=1771762145, model='qwen/qwen2.5-0.5b-instruct', object='text_completion', system_fingerprint=None, usage=CompletionUsage(completion_tokens=61, prompt_tokens=9, total_tokens=70, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
