...
```
    ...
    [2026-02-13 09:26:51] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.


    [2026-02-13 09:26:51] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.


    [2026-02-13 09:26:51] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-13 09:26:56] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-13 09:26:56] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-13 09:26:56] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-13 09:26:59] INFO server_args.py:1813: Attention backend not specified. Use fa3 backend by default.
    [2026-02-13 09:26:59] INFO server_args.py:2822: Set soft_watchdog_timeout since in CI


    [2026-02-13 09:27:05] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-13 09:27:05] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-13 09:27:05] INFO utils.py:164: NumExpr defaulting to 16 threads.
    [2026-02-13 09:27:05] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-13 09:27:05] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-13 09:27:05] INFO utils.py:164: NumExpr defaulting to 16 threads.
    ...
    [2026-02-13 09:27:11] Ignore import error when loading sglang.srt.models.glm_ocr: No module named 'transformers.models.glm_ocr'
    [2026-02-13 09:27:11] Ignore import error when loading sglang.srt.models.glm_ocr_nextn: No module named 'transformers.models.glm_ocr'
    [2026-02-13 09:27:11] Ignore import error when loading sglang.srt.models.glmasr: cannot import name 'GlmAsrConfig' from 'transformers' (/usr/local/lib/python3.10/dist-packages/transformers/__init__.py)
    ...
    Capturing batches (bs=4 avail_mem=54.66 GB):  33%|███▎      | 1/3 [00:00<00:01,  1.17it/s]Capturing batches (bs=2 avail_mem=54.57 GB):  33%|███▎      | 1/3 [00:00<00:01,  1.17it/s]Capturing batches (bs=1 avail_mem=54.56 GB):  33%|███▎      | 1/3 [00:00<00:01,  1.17it/s]

    Capturing batches (bs=1 avail_mem=54.56 GB): 100%|██████████| 3/3 [00:01<00:00,  3.29it/s]Capturing batches (bs=1 avail_mem=54.56 GB): 100%|██████████| 3/3 [00:01<00:00,  2.78it/s]
...
<strong style='color: #00008B;'><br><br>                    NOTE: Typically, the server runs in a separate terminal.<br>                    In this notebook, we run the server and notebook code together, so their outputs are combined.<br>                    To improve clarity, the server logs are displayed in the original black color, while the notebook outputs are highlighted in blue.<br>                    To reduce the log length, we set the log level to warning for the server, the default log level is info.<br>                    We are running those notebooks in a CI environment, so the throughput is not representative of the actual performance.<br>                    </strong>
    ...
    Server started on http://localhost:38046
...
<strong style='color: #00008B;'>Response: ChatCompletion(id='a0a4b958ca25451dac0dcb0cc6579a4e', choices=[Choice(finish_reason='stop', index=0, logprobs=None, message=ChatCompletionMessage(content='Sure, here are three countries and their respective capitals:\n\n1. **United States** - Washington, D.C.\n2. **Canada** - Ottawa\n3. **Australia** - Canberra', refusal=None, role='assistant', annotations=None, audio=None, function_call=None, tool_calls=None, reasoning_content=None), matched_stop=151645)], created=1770974841, model='qwen/qwen2.5-0.5b-instruct', object='chat.completion', service_tier=None, system_fingerprint=None, usage=CompletionUsage(completion_tokens=39, prompt_tokens=37, total_tokens=76, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
...
<strong style='color: #00008B;'>Ancient Rome was a major civilization that flourished in Italy from the 8th to the 4th century BCE. It was known for its advanced engineering, art, literature, and philosophy. Some of the major achievements of ancient Rome include:<br><br>1. The construction of the Colosseum: A massive amphitheater built in the 2nd century CE, it was one of the largest and most impressive structures in the world.<br><br>2. The Roman Empire: Rome became the dominant power in Europe and Asia Minor during this period, spanning from the 2nd century BCE to the 4th century CE.<br><br>3. The</strong>
...
```
    ...
    Yes, it is a test. I'm here to assist you with any questions or information you might need. Please let me know how I can help you better.
...
<strong style='color: #00008B;'>Response: Completion(id='d619914212a64f778d741c922aa3b0d3', choices=[CompletionChoice(finish_reason='stop', index=0, logprobs=None, text=' **The Enchanted Horizon**', matched_stop='\n\n')], created=1770974841, model='qwen/qwen2.5-0.5b-instruct', object='text_completion', system_fingerprint=None, usage=CompletionUsage(completion_tokens=7, prompt_tokens=9, total_tokens=16, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
