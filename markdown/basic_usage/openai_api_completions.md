...
```
    ...
    [2026-02-27 08:05:26] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.


    [2026-02-27 08:05:26] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.


    [2026-02-27 08:05:26] INFO utils.py:164: NumExpr defaulting to 16 threads.
    ...
    [2026-02-27 08:05:35] INFO server_args.py:1861: Attention backend not specified. Use fa3 backend by default.
    [2026-02-27 08:05:35] INFO server_args.py:2931: Set soft_watchdog_timeout since in CI


    [2026-02-27 08:05:42] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-27 08:05:42] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-27 08:05:42] INFO utils.py:164: NumExpr defaulting to 16 threads.
    [2026-02-27 08:05:42] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-27 08:05:42] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-27 08:05:42] INFO utils.py:164: NumExpr defaulting to 16 threads.
    ...
    [2026-02-27 08:05:48] Ignore import error when loading sglang.srt.models.glm_ocr: No module named 'transformers.models.glm_ocr'
    [2026-02-27 08:05:48] Ignore import error when loading sglang.srt.models.glm_ocr_nextn: No module named 'transformers.models.glm_ocr'
    [2026-02-27 08:05:48] Ignore import error when loading sglang.srt.models.glmasr: cannot import name 'GlmAsrConfig' from 'transformers' (/usr/local/lib/python3.10/dist-packages/transformers/__init__.py)
    ...
    Capturing batches (bs=4 avail_mem=54.60 GB):  33%|███▎      | 1/3 [00:00<00:00,  3.90it/s]Capturing batches (bs=2 avail_mem=54.54 GB):  33%|███▎      | 1/3 [00:00<00:00,  3.90it/s]Capturing batches (bs=1 avail_mem=54.54 GB):  33%|███▎      | 1/3 [00:00<00:00,  3.90it/s]Capturing batches (bs=1 avail_mem=54.54 GB): 100%|██████████| 3/3 [00:00<00:00,  8.84it/s]Capturing batches (bs=1 avail_mem=54.54 GB): 100%|██████████| 3/3 [00:00<00:00,  7.84it/s]
...
<strong style='color: #00008B;'>Response: ChatCompletion(id='a212d2d50041442e86306a0ed3231581', choices=[Choice(finish_reason='stop', index=0, logprobs=None, message=ChatCompletionMessage(content='Sure, here are three countries and their respective capitals:\n\n1. **United States** - Washington, D.C.\n2. **Canada** - Ottawa\n3. **Australia** - Canberra', refusal=None, role='assistant', annotations=None, audio=None, function_call=None, tool_calls=None, reasoning_content=None), matched_stop=151645)], created=1772179557, model='qwen/qwen2.5-0.5b-instruct', object='chat.completion', service_tier=None, system_fingerprint=None, usage=CompletionUsage(completion_tokens=39, prompt_tokens=37, total_tokens=76, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
...
<strong style='color: #00008B;'>The ancient Roman Empire, also known as the Roman Republic or the Roman Empire, was a period of political and cultural dominance in the Western world. It lasted from 509 BC to 476 AD and was marked by a combination of military conquests, economic prosperity, and cultural exchange.<br><br>**Major Achievements:**<br><br>1. **Founding of Rome:** The city of Rome was founded in 753 BC by Romulus, a tribal chief. It became the capital of the Roman Republic in 753 BC.<br><br>2. **Roman Law:** The Romans developed a system of law that included written laws,</strong>
...
```
    ...
    Yes, I am designed to assist with various tasks, including answering questions, providing information, and performing other functions related to AI and technology. If you have any specific questions or need help with something, feel free to ask, and I'll do my best to assist you.
...
<strong style='color: #00008B;'>Response: Completion(id='6ad1de1f90d74c70a51b56b76f137409', choices=[CompletionChoice(finish_reason='length', index=0, logprobs=None, text=' Once upon a time, there was a space explorer named Dr. Sarah Reeves. She was a brilliant scientist and had an amazing imagination. Dr. Sarah had always been fascinated by the mysteries of the universe, and she believed that exploring space was her calling.\nOne day, Dr. Sarah received a message from her superiors asking her to lead a mission to explore a new planet far away in the solar system. She was thrilled at the prospect of making history, but she also knew that it would be an incredibly dangerous mission.\nDr. Sarah knew that she needed to be prepared for any challenges that came her way. She gathered her team and set out on their journey to the newly discovered planet.\nAs they traveled through the asteroid belt, they encountered many', matched_stop=None)], created=1772179558, model='qwen/qwen2.5-0.5b-instruct', object='text_completion', system_fingerprint=None, usage=CompletionUsage(completion_tokens=150, prompt_tokens=9, total_tokens=159, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
