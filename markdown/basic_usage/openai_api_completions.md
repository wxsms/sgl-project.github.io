...
```
    ...
    [2026-02-26 17:41:11] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.


    [2026-02-26 17:41:11] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.


    [2026-02-26 17:41:11] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-26 17:41:16] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-26 17:41:16] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-26 17:41:16] INFO utils.py:164: NumExpr defaulting to 16 threads.
    ...
    Capturing batches (bs=4 avail_mem=72.85 GB):  33%|███▎      | 1/3 [00:00<00:00,  4.71it/s]Capturing batches (bs=2 avail_mem=72.79 GB):  33%|███▎      | 1/3 [00:00<00:00,  4.71it/s]Capturing batches (bs=1 avail_mem=72.78 GB):  33%|███▎      | 1/3 [00:00<00:00,  4.71it/s]Capturing batches (bs=1 avail_mem=72.78 GB): 100%|██████████| 3/3 [00:00<00:00, 11.42it/s]
...
<strong style='color: #00008B;'>Response: ChatCompletion(id='8d62c970ea914d2faee26502c4d49747', choices=[Choice(finish_reason='stop', index=0, logprobs=None, message=ChatCompletionMessage(content='Sure, here are three countries and their respective capitals:\n\n1. **United States** - Washington, D.C.\n2. **Canada** - Ottawa\n3. **Australia** - Canberra', refusal=None, role='assistant', annotations=None, audio=None, function_call=None, tool_calls=None, reasoning_content=None), matched_stop=151645)], created=1772127701, model='qwen/qwen2.5-0.5b-instruct', object='chat.completion', service_tier=None, system_fingerprint=None, usage=CompletionUsage(completion_tokens=39, prompt_tokens=37, total_tokens=76, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
...
<strong style='color: #00008B;'>Ancient Rome was a major civilization that flourished from the 8th to the 4th century BCE. It was a period of great development and innovation, with many significant achievements:<br><br>1. **Roman Empire**: The Roman Empire was the largest and most powerful empire in history, spanning Europe, Asia Minor, and North Africa. It lasted for over 2000 years.<br><br>2. **Architecture**: Roman architecture was renowned for its grandeur and beauty, with iconic structures like the Colosseum, Pantheon, and the Colosseum (which served as a public amphitheater).<br><br>3. **Law**:</strong>
...
```
    ...
    Yes, that's a test. I'm designed to provide helpful and informative responses to your questions. If you have any specific inquiries or need assistance with a particular topic, feel free to ask and I'll do my best to provide the information you're looking for.
...
<strong style='color: #00008B;'>Response: Completion(id='928aa813cc15436a85d8f8beceb376e8', choices=[CompletionChoice(finish_reason='stop', index=0, logprobs=None, text=' Once upon a time, there was a space explorer named Dr. Amelia Hart. She had been exploring the stars for years and had discovered many new planets and galaxies. One day, she decided to take a deep dive into the vast emptiness of space.', matched_stop='\n\n')], created=1772127702, model='qwen/qwen2.5-0.5b-instruct', object='text_completion', system_fingerprint=None, usage=CompletionUsage(completion_tokens=51, prompt_tokens=9, total_tokens=60, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
