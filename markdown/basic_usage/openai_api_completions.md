...
```
    ...
    [2026-02-27 06:30:02] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.


    [2026-02-27 06:30:02] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.


    [2026-02-27 06:30:02] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-27 06:30:08] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-27 06:30:08] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-27 06:30:08] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-27 06:30:12] INFO server_args.py:1859: Attention backend not specified. Use fa3 backend by default.
    [2026-02-27 06:30:12] INFO server_args.py:2929: Set soft_watchdog_timeout since in CI


    [2026-02-27 06:30:19] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-27 06:30:19] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-27 06:30:19] INFO utils.py:164: NumExpr defaulting to 16 threads.
    [2026-02-27 06:30:19] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-27 06:30:19] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-27 06:30:19] INFO utils.py:164: NumExpr defaulting to 16 threads.
    ...
    [2026-02-27 06:30:26] Ignore import error when loading sglang.srt.models.glm_ocr: No module named 'transformers.models.glm_ocr'
    [2026-02-27 06:30:26] Ignore import error when loading sglang.srt.models.glm_ocr_nextn: No module named 'transformers.models.glm_ocr'
    [2026-02-27 06:30:26] Ignore import error when loading sglang.srt.models.glmasr: cannot import name 'GlmAsrConfig' from 'transformers' (/usr/local/lib/python3.10/dist-packages/transformers/__init__.py)
    ...
      0%|          | 0/3 [00:00<?, ?it/s]Capturing batches (bs=4 avail_mem=71.96 GB):   0%|          | 0/3 [00:00<?, ?it/s]

    Capturing batches (bs=4 avail_mem=71.96 GB):  33%|███▎      | 1/3 [00:00<00:00,  4.01it/s]Capturing batches (bs=2 avail_mem=71.27 GB):  33%|███▎      | 1/3 [00:00<00:00,  4.01it/s]Capturing batches (bs=1 avail_mem=71.26 GB):  33%|███▎      | 1/3 [00:00<00:00,  4.01it/s]Capturing batches (bs=1 avail_mem=71.26 GB): 100%|██████████| 3/3 [00:00<00:00,  9.61it/s]
...
<strong style='color: #00008B;'>Response: ChatCompletion(id='0be819966ba440e583ad99193320243d', choices=[Choice(finish_reason='stop', index=0, logprobs=None, message=ChatCompletionMessage(content='Sure, here are three countries and their respective capitals:\n\n1. **United States** - Washington, D.C.\n2. **Canada** - Ottawa\n3. **Australia** - Canberra', refusal=None, role='assistant', annotations=None, audio=None, function_call=None, tool_calls=None, reasoning_content=None), matched_stop=151645)], created=1772173835, model='qwen/qwen2.5-0.5b-instruct', object='chat.completion', service_tier=None, system_fingerprint=None, usage=CompletionUsage(completion_tokens=39, prompt_tokens=37, total_tokens=76, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
...
<strong style='color: #00008B;'>Ancient Rome was a major civilization that flourished from the 8th to the 4th centuries BCE. It was known for its advanced engineering, art, literature, and philosophy. Some of the major achievements include:<br><br>1. **Architecture**: The Romans built magnificent structures such as the Colosseum, the Pantheon, and the Domus Aurea (Golden House). They also developed a sophisticated system of roads and public works.<br><br>2. **Engineering**: They were pioneers in engineering, including aqueducts, bridges, and aqueducts. The Colosseum is one of the most famous examples of Roman engineering.<br><br></strong>
...
```
    ...
    Yes, that is a test. I am Qwen, an AI language model created by Alibaba Cloud. I am here to assist you with any questions or tasks you may have. Let me know if there's anything specific you need help with.
...
<strong style='color: #00008B;'>Response: Completion(id='374d7685922947d0970ff30c4c7bce9c', choices=[CompletionChoice(finish_reason='stop', index=0, logprobs=None, text=' Once upon a time, there was a space explorer named Alex. He had been in space for many years, exploring planets and galaxies far beyond our own. One day, he received a strange message from an unknown source. The message said that there was a dangerous comet hurtling towards Earth.', matched_stop='\n\n')], created=1772173836, model='qwen/qwen2.5-0.5b-instruct', object='text_completion', system_fingerprint=None, usage=CompletionUsage(completion_tokens=58, prompt_tokens=9, total_tokens=67, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
