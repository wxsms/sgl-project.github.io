...
```
    ...
    [2026-02-20 12:03:18] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.


    [2026-02-20 12:03:18] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.


    [2026-02-20 12:03:18] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-20 12:03:23] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-20 12:03:23] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-20 12:03:23] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-20 12:03:26] INFO server_args.py:1834: Attention backend not specified. Use fa3 backend by default.
    [2026-02-20 12:03:26] INFO server_args.py:2885: Set soft_watchdog_timeout since in CI


    [2026-02-20 12:03:33] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-20 12:03:33] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-20 12:03:33] INFO utils.py:164: NumExpr defaulting to 16 threads.
    ...
    [2026-02-20 12:03:39] Ignore import error when loading sglang.srt.models.glm_ocr: No module named 'transformers.models.glm_ocr'
    [2026-02-20 12:03:39] Ignore import error when loading sglang.srt.models.glm_ocr_nextn: No module named 'transformers.models.glm_ocr'
    [2026-02-20 12:03:39] Ignore import error when loading sglang.srt.models.glmasr: cannot import name 'GlmAsrConfig' from 'transformers' (/usr/local/lib/python3.10/dist-packages/transformers/__init__.py)
    ...
    Capturing batches (bs=4 avail_mem=67.82 GB):  33%|███▎      | 1/3 [00:00<00:00,  4.49it/s]Capturing batches (bs=2 avail_mem=67.76 GB):  33%|███▎      | 1/3 [00:00<00:00,  4.49it/s]Capturing batches (bs=1 avail_mem=67.76 GB):  33%|███▎      | 1/3 [00:00<00:00,  4.49it/s]Capturing batches (bs=1 avail_mem=67.76 GB): 100%|██████████| 3/3 [00:00<00:00, 10.96it/s]
...
<strong style='color: #00008B;'><br><br>        NOTE: Typically, the server runs in a separate terminal.<br>        In this notebook, we run the server and notebook code together, so their outputs are combined.<br>        To improve clarity, the server logs are displayed in the original black color, while the notebook outputs are highlighted in blue.<br>        To reduce the log length, we set the log level to warning for the server, the default log level is info.<br>        We are running those notebooks in a CI environment, so the throughput is not representative of the actual performance.<br>        </strong>
    ...
    Server started on http://localhost:30915
...
<strong style='color: #00008B;'>Response: ChatCompletion(id='9cb0ba459a014f0f889451d0d3c785a8', choices=[Choice(finish_reason='stop', index=0, logprobs=None, message=ChatCompletionMessage(content='Sure, here are three countries and their respective capitals:\n\n1. **United States** - Washington, D.C.\n2. **Canada** - Ottawa\n3. **Australia** - Canberra', refusal=None, role='assistant', annotations=None, audio=None, function_call=None, tool_calls=None, reasoning_content=None), matched_stop=151645)], created=1771589027, model='qwen/qwen2.5-0.5b-instruct', object='chat.completion', service_tier=None, system_fingerprint=None, usage=CompletionUsage(completion_tokens=39, prompt_tokens=37, total_tokens=76, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
...
<strong style='color: #00008B;'>The ancient Romans made significant contributions to various fields, including law, philosophy, medicine, and literature. They are known for their extensive use of the Latin language and their extensive use of the Roman numeral system. The Roman Empire was one of the largest empires in history, spanning from the 1st century BCE to the 4th century CE. Key achievements include the construction of monumental architecture like the Colosseum and Pantheon, as well as the development of a complex legal system that influenced later legal systems. The Roman Republic was a period of great political and economic stability, while the Roman Empire reached its peak during the 1</strong>
...
```
    ...
    Yes, I am Qwen, a large language model created by Alibaba Cloud. I am designed to be a helpful assistant to users and can answer questions, provide information, and perform tasks related to various fields. I am not a test, but rather a service that helps users with their inquiries and tasks.
...
<strong style='color: #00008B;'>Response: Completion(id='d794885276074d0db450d1995b7c1f1d', choices=[CompletionChoice(finish_reason='stop', index=0, logprobs=None, text=' Once upon a time, there was a space explorer named Jack. He had always been fascinated by the stars and had dreamed of exploring new worlds far away. One day, he decided to embark on his first space mission.', matched_stop='\n\n')], created=1771589028, model='qwen/qwen2.5-0.5b-instruct', object='text_completion', system_fingerprint=None, usage=CompletionUsage(completion_tokens=44, prompt_tokens=9, total_tokens=53, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
