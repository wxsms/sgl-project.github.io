...
```
    ...
    [2026-02-24 13:27:54] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.


    [2026-02-24 13:27:54] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.


    [2026-02-24 13:27:54] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-24 13:28:00] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-24 13:28:00] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-24 13:28:00] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-24 13:28:02] INFO server_args.py:1828: Attention backend not specified. Use fa3 backend by default.
    [2026-02-24 13:28:02] INFO server_args.py:2889: Set soft_watchdog_timeout since in CI


    [2026-02-24 13:28:09] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-24 13:28:09] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-24 13:28:09] INFO utils.py:164: NumExpr defaulting to 16 threads.
    [2026-02-24 13:28:09] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-24 13:28:09] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-24 13:28:09] INFO utils.py:164: NumExpr defaulting to 16 threads.
    ...
    [2026-02-24 13:28:15] Ignore import error when loading sglang.srt.models.glm_ocr: No module named 'transformers.models.glm_ocr'
    [2026-02-24 13:28:15] Ignore import error when loading sglang.srt.models.glm_ocr_nextn: No module named 'transformers.models.glm_ocr'
    [2026-02-24 13:28:15] Ignore import error when loading sglang.srt.models.glmasr: cannot import name 'GlmAsrConfig' from 'transformers' (/usr/local/lib/python3.10/dist-packages/transformers/__init__.py)
    [2026-02-24 13:28:15] Ignore import error when loading sglang.srt.models.grok: cannot import name '_yarn_find_correction_range' from 'sglang.srt.layers.rotary_embedding' (/public_sglang_ci/runner-l1-7rqrl-gpu-0/_work/sglang/sglang/python/sglang/srt/layers/rotary_embedding/__init__.py)
    ...
    Capturing batches (bs=4 avail_mem=74.85 GB):  33%|███▎      | 1/3 [00:00<00:00,  4.02it/s]Capturing batches (bs=2 avail_mem=74.79 GB):  33%|███▎      | 1/3 [00:00<00:00,  4.02it/s]Capturing batches (bs=1 avail_mem=74.78 GB):  33%|███▎      | 1/3 [00:00<00:00,  4.02it/s]Capturing batches (bs=1 avail_mem=74.78 GB): 100%|██████████| 3/3 [00:00<00:00,  9.70it/s]
...
<strong style='color: #00008B;'><br><br>        NOTE: Typically, the server runs in a separate terminal.<br>        In this notebook, we run the server and notebook code together, so their outputs are combined.<br>        To improve clarity, the server logs are displayed in the original black color, while the notebook outputs are highlighted in blue.<br>        To reduce the log length, we set the log level to warning for the server, the default log level is info.<br>        We are running those notebooks in a CI environment, so the throughput is not representative of the actual performance.<br>        </strong>
    ...
    Server started on http://localhost:32692
...
<strong style='color: #00008B;'>Response: ChatCompletion(id='b58d7194d41c4584bfb460e3c29b928e', choices=[Choice(finish_reason='stop', index=0, logprobs=None, message=ChatCompletionMessage(content='Sure, here are three countries and their respective capitals:\n\n1. **United States** - Washington, D.C.\n2. **Canada** - Ottawa\n3. **Australia** - Canberra', refusal=None, role='assistant', annotations=None, audio=None, function_call=None, tool_calls=None, reasoning_content=None), matched_stop=151645)], created=1771939704, model='qwen/qwen2.5-0.5b-instruct', object='chat.completion', service_tier=None, system_fingerprint=None, usage=CompletionUsage(completion_tokens=39, prompt_tokens=37, total_tokens=76, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
...
<strong style='color: #00008B;'>The Roman Empire, which lasted from the 3rd century BC to the 4th century AD, was a vast and complex civilization that left an indelible mark on history. Some of their major achievements include:<br><br>1. **Roman Law**: This is perhaps the most famous achievement of ancient Rome. It established a legal system that is still in use today, with its principles of justice, equality, and the rule of law.<br><br>2. **Architecture**: The Romans built magnificent structures such as the Colosseum, the Pantheon, and the Colosseum. Their architectural style is characterized by grandeur and symmetry.<br><br>3</strong>
...
```
    ...
    Yes, it is a test. I am Qwen, a large language model created by Alibaba Cloud. I am ready to assist you with any questions or tasks you have. Please let me know how I can help you.
...
<strong style='color: #00008B;'>Response: Completion(id='756f57cfb60048729517c14f6fd6dcad', choices=[CompletionChoice(finish_reason='stop', index=0, logprobs=None, text=' **The Endless Journey**', matched_stop='\n\n')], created=1771939705, model='qwen/qwen2.5-0.5b-instruct', object='text_completion', system_fingerprint=None, usage=CompletionUsage(completion_tokens=6, prompt_tokens=9, total_tokens=15, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
