...
```
    ...
    [2026-02-23 20:47:16] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.


    [2026-02-23 20:47:16] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.


    [2026-02-23 20:47:16] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-23 20:47:22] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-23 20:47:22] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-23 20:47:22] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-23 20:47:25] INFO server_args.py:1823: Attention backend not specified. Use fa3 backend by default.
    [2026-02-23 20:47:25] INFO server_args.py:2874: Set soft_watchdog_timeout since in CI


    [2026-02-23 20:47:31] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-23 20:47:31] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-23 20:47:31] INFO utils.py:164: NumExpr defaulting to 16 threads.
    [2026-02-23 20:47:31] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-23 20:47:31] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-23 20:47:31] INFO utils.py:164: NumExpr defaulting to 16 threads.
    ...
    [2026-02-23 20:47:37] Ignore import error when loading sglang.srt.models.glm_ocr: No module named 'transformers.models.glm_ocr'
    [2026-02-23 20:47:37] Ignore import error when loading sglang.srt.models.glm_ocr_nextn: No module named 'transformers.models.glm_ocr'
    [2026-02-23 20:47:37] Ignore import error when loading sglang.srt.models.glmasr: cannot import name 'GlmAsrConfig' from 'transformers' (/usr/local/lib/python3.10/dist-packages/transformers/__init__.py)
    [2026-02-23 20:47:37] Ignore import error when loading sglang.srt.models.grok: cannot import name '_yarn_find_correction_range' from 'sglang.srt.layers.rotary_embedding' (/public_sglang_ci/runner-l3-qq9x6-gpu-45/_work/sglang/sglang/python/sglang/srt/layers/rotary_embedding/__init__.py)
    ...
    Capturing batches (bs=4 avail_mem=72.00 GB):  33%|███▎      | 1/3 [00:00<00:00,  2.74it/s]Capturing batches (bs=2 avail_mem=76.96 GB):  33%|███▎      | 1/3 [00:00<00:00,  2.74it/s]Capturing batches (bs=1 avail_mem=76.96 GB):  33%|███▎      | 1/3 [00:00<00:00,  2.74it/s]Capturing batches (bs=1 avail_mem=76.96 GB): 100%|██████████| 3/3 [00:00<00:00,  7.22it/s]
...
<strong style='color: #00008B;'>Response: ChatCompletion(id='19da6bcefffe48688fb34ed9cd6b5f7e', choices=[Choice(finish_reason='stop', index=0, logprobs=None, message=ChatCompletionMessage(content='Sure, here are three countries and their respective capitals:\n\n1. **United States** - Washington, D.C.\n2. **Canada** - Ottawa\n3. **Australia** - Canberra', refusal=None, role='assistant', annotations=None, audio=None, function_call=None, tool_calls=None, reasoning_content=None), matched_stop=151645)], created=1771879666, model='qwen/qwen2.5-0.5b-instruct', object='chat.completion', service_tier=None, system_fingerprint=None, usage=CompletionUsage(completion_tokens=39, prompt_tokens=37, total_tokens=76, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
...
<strong style='color: #00008B;'>Ancient Rome was a major civilization that flourished in the Mediterranean region from the 8th to the 4th century BCE. Some of their major achievements include:<br><br>1. **Gothic Architecture**: The Romans were renowned for their Gothic architecture, which is characterized by its pointed arches, ribbed vaults, and flying buttresses. This style is still used in many parts of the world.<br><br>2. **Roman Law**: The Roman legal system, known as "Roman law," is one of the oldest and most influential legal systems in the world. It includes codes such as the "Twelve Tables" and the "Cod</strong>
...
```
    ...
    Yes, I am Qwen, an AI language model created by Alibaba Cloud. I am ready to assist you with any questions or tasks you may have. How can I help you today?
...
<strong style='color: #00008B;'>Response: Completion(id='2a5a1f9d3e1e46319f5c486c5217df3c', choices=[CompletionChoice(finish_reason='stop', index=0, logprobs=None, text=' Once upon a time, there was a space explorer named Tom who had been on many missions to explore the stars. One day, he was assigned to travel to a distant planet and study its unique ecosystem. As he landed on the planet, he was amazed by the vibrant colors of the plants and animals.', matched_stop='\n\n')], created=1771879666, model='qwen/qwen2.5-0.5b-instruct', object='text_completion', system_fingerprint=None, usage=CompletionUsage(completion_tokens=61, prompt_tokens=9, total_tokens=70, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
