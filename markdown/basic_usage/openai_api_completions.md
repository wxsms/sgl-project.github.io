...
```
    ...
    [2026-02-26 16:12:18] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.


    [2026-02-26 16:12:18] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.


    [2026-02-26 16:12:18] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-26 16:12:24] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-26 16:12:24] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-26 16:12:24] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-26 16:12:27] INFO server_args.py:1859: Attention backend not specified. Use fa3 backend by default.
    [2026-02-26 16:12:27] INFO server_args.py:2928: Set soft_watchdog_timeout since in CI


    [2026-02-26 16:12:33] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-26 16:12:33] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-26 16:12:33] INFO utils.py:164: NumExpr defaulting to 16 threads.
    [2026-02-26 16:12:33] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-26 16:12:33] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-26 16:12:33] INFO utils.py:164: NumExpr defaulting to 16 threads.
    ...
    [2026-02-26 16:12:39] Ignore import error when loading sglang.srt.models.glm_ocr: No module named 'transformers.models.glm_ocr'
    [2026-02-26 16:12:39] Ignore import error when loading sglang.srt.models.glm_ocr_nextn: No module named 'transformers.models.glm_ocr'
    [2026-02-26 16:12:39] Ignore import error when loading sglang.srt.models.glmasr: cannot import name 'GlmAsrConfig' from 'transformers' (/usr/local/lib/python3.10/dist-packages/transformers/__init__.py)
    ...
    Capturing batches (bs=4 avail_mem=71.37 GB):  33%|███▎      | 1/3 [00:00<00:00,  4.79it/s]Capturing batches (bs=2 avail_mem=71.30 GB):  33%|███▎      | 1/3 [00:00<00:00,  4.79it/s]Capturing batches (bs=1 avail_mem=71.30 GB):  33%|███▎      | 1/3 [00:00<00:00,  4.79it/s]Capturing batches (bs=1 avail_mem=71.30 GB): 100%|██████████| 3/3 [00:00<00:00, 11.58it/s]
...
<strong style='color: #00008B;'>Response: ChatCompletion(id='f4aed1f867194df5a4fe0834edb83ca1', choices=[Choice(finish_reason='stop', index=0, logprobs=None, message=ChatCompletionMessage(content='Sure, here are three countries and their respective capitals:\n\n1. **United States** - Washington, D.C.\n2. **Canada** - Ottawa\n3. **Australia** - Canberra', refusal=None, role='assistant', annotations=None, audio=None, function_call=None, tool_calls=None, reasoning_content=None), matched_stop=151645)], created=1772122367, model='qwen/qwen2.5-0.5b-instruct', object='chat.completion', service_tier=None, system_fingerprint=None, usage=CompletionUsage(completion_tokens=39, prompt_tokens=37, total_tokens=76, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
...
<strong style='color: #00008B;'>Ancient Rome was a major civilization that flourished from the 8th to the 4th century BCE. Some of their major achievements include:<br><br>1. **Foundation of Rome**: The city-state of Rome was founded by Romulus in 753 BCE. It became the capital of the Roman Republic and later the Roman Empire.<br><br>2. **Founding of the Republic**: Rome established itself as a republic, which was a form of government where power is held by elected officials rather than a single ruler.<br><br>3. **Construction of the Colosseum**: The Colosseum, also known as Flavian Amphitheater</strong>
...
<strong style='color: #00008B;'>Response: Completion(id='36bf1294d1564e5ab6d211d67a3af81c', choices=[CompletionChoice(finish_reason='stop', index=0, logprobs=None, text=' Once upon a time, there was a space explorer named Alex who had been on many missions to the stars. He had seen everything from the bustling cities of Earth to the remote wildernesses of outer space. He had traveled across the galaxy and discovered new planets and star systems.', matched_stop='\n\n')], created=1772122368, model='qwen/qwen2.5-0.5b-instruct', object='text_completion', system_fingerprint=None, usage=CompletionUsage(completion_tokens=55, prompt_tokens=9, total_tokens=64, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
