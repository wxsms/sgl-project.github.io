...
```
    ...
    [2026-02-20 15:30:00] INFO utils.py:148: Note: detected 128 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.


    [2026-02-20 15:30:00] INFO utils.py:151: Note: NumExpr detected 128 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.


    [2026-02-20 15:30:00] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-20 15:30:03] INFO utils.py:148: Note: detected 128 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-20 15:30:03] INFO utils.py:151: Note: NumExpr detected 128 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-20 15:30:03] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-20 15:30:05] INFO server_args.py:1834: Attention backend not specified. Use fa3 backend by default.
    [2026-02-20 15:30:05] INFO server_args.py:2885: Set soft_watchdog_timeout since in CI


    [2026-02-20 15:30:10] INFO utils.py:148: Note: detected 128 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-20 15:30:10] INFO utils.py:151: Note: NumExpr detected 128 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-20 15:30:10] INFO utils.py:164: NumExpr defaulting to 16 threads.
    [2026-02-20 15:30:10] INFO utils.py:148: Note: detected 128 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-20 15:30:10] INFO utils.py:151: Note: NumExpr detected 128 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-20 15:30:10] INFO utils.py:164: NumExpr defaulting to 16 threads.
    ...
    [2026-02-20 15:30:14] Ignore import error when loading sglang.srt.models.glm_ocr: No module named 'transformers.models.glm_ocr'
    [2026-02-20 15:30:14] Ignore import error when loading sglang.srt.models.glm_ocr_nextn: No module named 'transformers.models.glm_ocr'
    [2026-02-20 15:30:14] Ignore import error when loading sglang.srt.models.glmasr: cannot import name 'GlmAsrConfig' from 'transformers' (/usr/local/lib/python3.10/dist-packages/transformers/__init__.py)
...
<strong style='color: #00008B;'><br><br>        NOTE: Typically, the server runs in a separate terminal.<br>        In this notebook, we run the server and notebook code together, so their outputs are combined.<br>        To improve clarity, the server logs are displayed in the original black color, while the notebook outputs are highlighted in blue.<br>        To reduce the log length, we set the log level to warning for the server, the default log level is info.<br>        We are running those notebooks in a CI environment, so the throughput is not representative of the actual performance.<br>        </strong>
    ...
    Server started on http://localhost:33488
...
<strong style='color: #00008B;'>Response: ChatCompletion(id='95d1e746f63e4c1db985d54620808766', choices=[Choice(finish_reason='stop', index=0, logprobs=None, message=ChatCompletionMessage(content='Sure, here are three countries and their respective capitals:\n\n1. **United States** - Washington, D.C.\n2. **Canada** - Ottawa\n3. **Australia** - Canberra', refusal=None, role='assistant', annotations=None, audio=None, function_call=None, tool_calls=None, reasoning_content=None), matched_stop=151645)], created=1771601422, model='qwen/qwen2.5-0.5b-instruct', object='chat.completion', service_tier=None, system_fingerprint=None, usage=CompletionUsage(completion_tokens=39, prompt_tokens=37, total_tokens=76, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
...
<strong style='color: #00008B;'>Ancient Rome was a major civilization that flourished from the 8th century BCE to the 4th century CE. It was known for its political, economic, and cultural achievements. Some of the major achievements of ancient Rome include:<br><br>1. **Roman Republic**: This was the first permanent Roman state, which lasted from 509 BCE to 476 BCE. It was a period of stability and prosperity, with a strong emphasis on law, governance, and the rule of law.<br><br>2. **Roman Empire**: After the fall of the Roman Republic, Rome became the dominant power in Europe and eventually in the Mediterranean world</strong>
...
```
    ...
    Yes, I am designed to assist with various tasks, including answering questions, generating text, and performing tasks related to language and artificial intelligence. I am also capable of interacting with users in a conversational manner, which can be particularly useful for testing purposes.
...
<strong style='color: #00008B;'>Response: Completion(id='9f46e515159f4db2a1fcc593ae95800d', choices=[CompletionChoice(finish_reason='stop', index=0, logprobs=None, text=' Once upon a time, there was a space explorer named Jack who had been exploring the universe for many years. He had seen countless stars and planets, and he had always been fascinated by the mysteries of the cosmos.', matched_stop='\n\n')], created=1771601423, model='qwen/qwen2.5-0.5b-instruct', object='text_completion', system_fingerprint=None, usage=CompletionUsage(completion_tokens=43, prompt_tokens=9, total_tokens=52, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
