...
```
    ...
    [2026-02-25 07:29:19] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.


    [2026-02-25 07:29:19] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.


    [2026-02-25 07:29:19] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-25 07:29:25] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-25 07:29:25] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-25 07:29:25] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-25 07:29:28] INFO server_args.py:1860: Attention backend not specified. Use fa3 backend by default.
    [2026-02-25 07:29:28] INFO server_args.py:2927: Set soft_watchdog_timeout since in CI


    [2026-02-25 07:29:34] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-25 07:29:34] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-25 07:29:34] INFO utils.py:164: NumExpr defaulting to 16 threads.
    [2026-02-25 07:29:35] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-25 07:29:35] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-25 07:29:35] INFO utils.py:164: NumExpr defaulting to 16 threads.
    ...
    [2026-02-25 07:29:41] Ignore import error when loading sglang.srt.models.glm_ocr: No module named 'transformers.models.glm_ocr'
    [2026-02-25 07:29:41] Ignore import error when loading sglang.srt.models.glm_ocr_nextn: No module named 'transformers.models.glm_ocr'
    [2026-02-25 07:29:41] Ignore import error when loading sglang.srt.models.glmasr: cannot import name 'GlmAsrConfig' from 'transformers' (/usr/local/lib/python3.10/dist-packages/transformers/__init__.py)
    ...
    Capturing batches (bs=4 avail_mem=76.36 GB):  33%|███▎      | 1/3 [00:00<00:00,  4.83it/s]Capturing batches (bs=2 avail_mem=76.30 GB):  33%|███▎      | 1/3 [00:00<00:00,  4.83it/s]Capturing batches (bs=1 avail_mem=75.84 GB):  33%|███▎      | 1/3 [00:00<00:00,  4.83it/s]Capturing batches (bs=1 avail_mem=75.84 GB): 100%|██████████| 3/3 [00:00<00:00, 11.65it/s]
...
<strong style='color: #00008B;'><br><br>        NOTE: Typically, the server runs in a separate terminal.<br>        In this notebook, we run the server and notebook code together, so their outputs are combined.<br>        To improve clarity, the server logs are displayed in the original black color, while the notebook outputs are highlighted in blue.<br>        To reduce the log length, we set the log level to warning for the server, the default log level is info.<br>        We are running those notebooks in a CI environment, so the throughput is not representative of the actual performance.<br>        </strong>
    ...
    Server started on http://localhost:30926
...
<strong style='color: #00008B;'>Response: ChatCompletion(id='e0a4e406e3c94731b3a3aba2e091daa0', choices=[Choice(finish_reason='stop', index=0, logprobs=None, message=ChatCompletionMessage(content='Sure, here are three countries and their respective capitals:\n\n1. **United States** - Washington, D.C.\n2. **Canada** - Ottawa\n3. **Australia** - Canberra', refusal=None, role='assistant', annotations=None, audio=None, function_call=None, tool_calls=None, reasoning_content=None), matched_stop=151645)], created=1772004590, model='qwen/qwen2.5-0.5b-instruct', object='chat.completion', service_tier=None, system_fingerprint=None, usage=CompletionUsage(completion_tokens=39, prompt_tokens=37, total_tokens=76, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
...
<strong style='color: #00008B;'>Ancient Rome was a major civilization that flourished in the Mediterranean region from about 800 BCE to 476 CE. Some of their major achievements include:<br><br>1. **Growth and Expansion**: Rome grew rapidly, becoming a powerful empire that stretched from Italy to Greece and beyond.<br><br>2. **Architecture**: The Romans were renowned for their architectural achievements, particularly in the form of the Colosseum, which was built to accommodate gladiatorial contests and public spectacles.<br><br>3. **Law**: They developed a complex legal system based on Roman law, which influenced later legal systems around the world.<br><br>4. **C</strong>
...
```
    ...
    Yes, that is a test. I'm here to assist you with any questions or tasks you have, and I'm happy to help. Please let me know if you need anything.
...
<strong style='color: #00008B;'>Response: Completion(id='52a6146155fc4210a889a6d7015d64a3', choices=[CompletionChoice(finish_reason='stop', index=0, logprobs=None, text=' Once upon a time, there was a space explorer named Jack. Jack was an ambitious and adventurous man who loved exploring the unknown. He had always been fascinated by the stars and the universe, and he had decided to make his dream come true by becoming a space explorer.', matched_stop='\n\n')], created=1772004590, model='qwen/qwen2.5-0.5b-instruct', object='text_completion', system_fingerprint=None, usage=CompletionUsage(completion_tokens=54, prompt_tokens=9, total_tokens=63, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
