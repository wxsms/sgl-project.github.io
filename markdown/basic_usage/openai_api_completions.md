...
```
    ...
    [2026-02-24 10:15:01] INFO utils.py:148: Note: detected 128 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.


    [2026-02-24 10:15:01] INFO utils.py:151: Note: NumExpr detected 128 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.


    [2026-02-24 10:15:01] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-24 10:15:05] INFO utils.py:148: Note: detected 128 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-24 10:15:05] INFO utils.py:151: Note: NumExpr detected 128 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-24 10:15:05] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-24 10:15:07] INFO server_args.py:1828: Attention backend not specified. Use fa3 backend by default.
    [2026-02-24 10:15:07] INFO server_args.py:2889: Set soft_watchdog_timeout since in CI


    [2026-02-24 10:15:11] INFO utils.py:148: Note: detected 128 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-24 10:15:11] INFO utils.py:151: Note: NumExpr detected 128 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-24 10:15:11] INFO utils.py:164: NumExpr defaulting to 16 threads.
    [2026-02-24 10:15:11] INFO utils.py:148: Note: detected 128 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-24 10:15:11] INFO utils.py:151: Note: NumExpr detected 128 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-24 10:15:11] INFO utils.py:164: NumExpr defaulting to 16 threads.
    ...
    [2026-02-24 10:15:16] Ignore import error when loading sglang.srt.models.glm_ocr: No module named 'transformers.models.glm_ocr'
    [2026-02-24 10:15:16] Ignore import error when loading sglang.srt.models.glm_ocr_nextn: No module named 'transformers.models.glm_ocr'
    [2026-02-24 10:15:16] Ignore import error when loading sglang.srt.models.glmasr: cannot import name 'GlmAsrConfig' from 'transformers' (/usr/local/lib/python3.10/dist-packages/transformers/__init__.py)
    [2026-02-24 10:15:16] Ignore import error when loading sglang.srt.models.grok: cannot import name '_yarn_find_correction_range' from 'sglang.srt.layers.rotary_embedding' (/actions-runner/_work/sglang/sglang/python/sglang/srt/layers/rotary_embedding/__init__.py)
...
<strong style='color: #00008B;'>Response: ChatCompletion(id='d86aa1dd466547448d5f5ea6cc7f44de', choices=[Choice(finish_reason='stop', index=0, logprobs=None, message=ChatCompletionMessage(content='Sure, here are three countries and their respective capitals:\n\n1. **United States** - Washington, D.C.\n2. **Canada** - Ottawa\n3. **Australia** - Canberra', refusal=None, role='assistant', annotations=None, audio=None, function_call=None, tool_calls=None, reasoning_content=None), matched_stop=151645)], created=1771928124, model='qwen/qwen2.5-0.5b-instruct', object='chat.completion', service_tier=None, system_fingerprint=None, usage=CompletionUsage(completion_tokens=39, prompt_tokens=37, total_tokens=76, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
...
<strong style='color: #00008B;'>The ancient Romans made significant contributions to various fields, including philosophy, law, medicine, and literature. They were also known for their engineering feats, such as the Colosseum and the Pantheon. Their advancements in agriculture and trade were also notable. The Roman Empire was one of the largest empires in history, spanning from the 3rd century BCE to the 4th century CE.</strong>
...
<strong style='color: #00008B;'>Response: Completion(id='bf30e6ba5f0b41d49102905562b9d8d4', choices=[CompletionChoice(finish_reason='stop', index=0, logprobs=None, text=' Once upon a time, in a far-off galaxy, there was a space explorer named Dr. Amelia Hart. She had always been fascinated by the stars and the universe, and she dreamed of exploring new worlds beyond her own.', matched_stop='\n\n')], created=1771928125, model='qwen/qwen2.5-0.5b-instruct', object='text_completion', system_fingerprint=None, usage=CompletionUsage(completion_tokens=45, prompt_tokens=9, total_tokens=54, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
