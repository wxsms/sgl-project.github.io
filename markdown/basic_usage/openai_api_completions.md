...
```
    ...
    [2026-02-25 09:08:08] INFO utils.py:148: Note: detected 192 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.


    [2026-02-25 09:08:08] INFO utils.py:151: Note: NumExpr detected 192 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.


    [2026-02-25 09:08:08] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-25 09:08:12] INFO utils.py:148: Note: detected 192 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-25 09:08:12] INFO utils.py:151: Note: NumExpr detected 192 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-25 09:08:12] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-25 09:08:14] INFO server_args.py:1860: Attention backend not specified. Use fa3 backend by default.
    [2026-02-25 09:08:14] INFO server_args.py:2927: Set soft_watchdog_timeout since in CI


    [2026-02-25 09:08:19] INFO utils.py:148: Note: detected 192 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-25 09:08:19] INFO utils.py:151: Note: NumExpr detected 192 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-25 09:08:19] INFO utils.py:164: NumExpr defaulting to 16 threads.
    [2026-02-25 09:08:19] INFO utils.py:148: Note: detected 192 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-25 09:08:19] INFO utils.py:151: Note: NumExpr detected 192 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-25 09:08:19] INFO utils.py:164: NumExpr defaulting to 16 threads.
    ...
    [2026-02-25 09:08:25] Ignore import error when loading sglang.srt.models.glm_ocr: No module named 'transformers.models.glm_ocr'
    [2026-02-25 09:08:25] Ignore import error when loading sglang.srt.models.glm_ocr_nextn: No module named 'transformers.models.glm_ocr'
    [2026-02-25 09:08:25] Ignore import error when loading sglang.srt.models.glmasr: cannot import name 'GlmAsrConfig' from 'transformers' (/usr/local/lib/python3.10/dist-packages/transformers/__init__.py)
    ...
      0%|          | 0/3 [00:00<?, ?it/s]Capturing batches (bs=4 avail_mem=132.70 GB):   0%|          | 0/3 [00:00<?, ?it/s]

    Capturing batches (bs=4 avail_mem=132.70 GB):  33%|███▎      | 1/3 [00:00<00:00,  4.68it/s]Capturing batches (bs=2 avail_mem=132.64 GB):  33%|███▎      | 1/3 [00:00<00:00,  4.68it/s]Capturing batches (bs=1 avail_mem=132.64 GB):  33%|███▎      | 1/3 [00:00<00:00,  4.68it/s]Capturing batches (bs=1 avail_mem=132.64 GB): 100%|██████████| 3/3 [00:00<00:00, 11.52it/s]
...
<strong style='color: #00008B;'>Response: ChatCompletion(id='6ba14fa0bc70447daf21ec3e644e9971', choices=[Choice(finish_reason='stop', index=0, logprobs=None, message=ChatCompletionMessage(content='Sure, here are three countries and their respective capitals:\n\n1. **United States** - Washington, D.C.\n2. **Canada** - Ottawa\n3. **Australia** - Canberra', refusal=None, role='assistant', annotations=None, audio=None, function_call=None, tool_calls=None, reasoning_content=None), matched_stop=151645)], created=1772010512, model='qwen/qwen2.5-0.5b-instruct', object='chat.completion', service_tier=None, system_fingerprint=None, usage=CompletionUsage(completion_tokens=39, prompt_tokens=37, total_tokens=76, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
...
<strong style='color: #00008B;'>Ancient Rome was a major civilization that flourished in Italy, spanning from the 8th to the 4th centuries BCE. They were known for their impressive achievements in various fields, including:<br><br>1. Architecture: Rome was renowned for its grandiose architecture, particularly the Colosseum and the Pantheon.<br><br>2. Engineering: They developed advanced engineering techniques, including aqueducts, bridges, and roads.<br><br>3. Literature: The Romans were renowned for their literary works, including the works of Virgil, Ovid, and Horace.<br><br>4. Law: They established a legal system based on Roman law, which influenced</strong>
...
<strong style='color: #00008B;'>Response: Completion(id='dbc4054f1fde4980b1ff2140536d0676', choices=[CompletionChoice(finish_reason='stop', index=0, logprobs=None, text=' **Title: The Cosmic Odyssey**', matched_stop='\n\n')], created=1772010513, model='qwen/qwen2.5-0.5b-instruct', object='text_completion', system_fingerprint=None, usage=CompletionUsage(completion_tokens=7, prompt_tokens=9, total_tokens=16, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
