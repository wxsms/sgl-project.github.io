...
```
    ...
    [2026-02-13 10:42:21] INFO utils.py:148: Note: detected 128 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-13 10:42:21] INFO utils.py:151: Note: NumExpr detected 128 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-13 10:42:21] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-13 10:42:23] INFO server_args.py:1813: Attention backend not specified. Use fa3 backend by default.
    [2026-02-13 10:42:23] INFO server_args.py:2822: Set soft_watchdog_timeout since in CI


    [2026-02-13 10:42:26] INFO utils.py:148: Note: detected 128 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-13 10:42:26] INFO utils.py:151: Note: NumExpr detected 128 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-13 10:42:26] INFO utils.py:164: NumExpr defaulting to 16 threads.
    [2026-02-13 10:42:27] INFO utils.py:148: Note: detected 128 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-13 10:42:27] INFO utils.py:151: Note: NumExpr detected 128 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-13 10:42:27] INFO utils.py:164: NumExpr defaulting to 16 threads.
    ...
    [2026-02-13 10:42:31] Ignore import error when loading sglang.srt.models.glm_ocr: No module named 'transformers.models.glm_ocr'
    [2026-02-13 10:42:31] Ignore import error when loading sglang.srt.models.glm_ocr_nextn: No module named 'transformers.models.glm_ocr'
    [2026-02-13 10:42:31] Ignore import error when loading sglang.srt.models.glmasr: cannot import name 'GlmAsrConfig' from 'transformers' (/usr/local/lib/python3.10/dist-packages/transformers/__init__.py)
    ...
      0%|          | 0/3 [00:00<?, ?it/s]Capturing batches (bs=4 avail_mem=55.67 GB):   0%|          | 0/3 [00:00<?, ?it/s]

    Capturing batches (bs=4 avail_mem=55.67 GB):  33%|███▎      | 1/3 [00:00<00:00,  4.37it/s]Capturing batches (bs=2 avail_mem=55.61 GB):  33%|███▎      | 1/3 [00:00<00:00,  4.37it/s]Capturing batches (bs=1 avail_mem=55.61 GB):  33%|███▎      | 1/3 [00:00<00:00,  4.37it/s]Capturing batches (bs=1 avail_mem=55.61 GB): 100%|██████████| 3/3 [00:00<00:00, 11.26it/s]
...
<strong style='color: #00008B;'><br><br>                    NOTE: Typically, the server runs in a separate terminal.<br>                    In this notebook, we run the server and notebook code together, so their outputs are combined.<br>                    To improve clarity, the server logs are displayed in the original black color, while the notebook outputs are highlighted in blue.<br>                    To reduce the log length, we set the log level to warning for the server, the default log level is info.<br>                    We are running those notebooks in a CI environment, so the throughput is not representative of the actual performance.<br>                    </strong>
    ...
    Server started on http://localhost:36471
...
<strong style='color: #00008B;'>Response: ChatCompletion(id='5eaeb6c9df7a475ab23f3f46246dd95f', choices=[Choice(finish_reason='stop', index=0, logprobs=None, message=ChatCompletionMessage(content='Sure, here are three countries and their respective capitals:\n\n1. **United States** - Washington, D.C.\n2. **Canada** - Ottawa\n3. **Australia** - Canberra', refusal=None, role='assistant', annotations=None, audio=None, function_call=None, tool_calls=None, reasoning_content=None), matched_stop=151645)], created=1770979359, model='qwen/qwen2.5-0.5b-instruct', object='chat.completion', service_tier=None, system_fingerprint=None, usage=CompletionUsage(completion_tokens=39, prompt_tokens=37, total_tokens=76, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
...
<strong style='color: #00008B;'>Ancient Rome was a major center of civilization, known for its advanced engineering, art, literature, and philosophy. Some of their major achievements include:<br><br>1. The construction of the Colosseum, which was the largest amphitheater in the world and was built in the 2nd century AD.<br><br>2. The development of Roman law, which established a system of laws that governed the state and governed relationships between individuals.<br><br>3. The invention of the wheel, which allowed for faster transportation and easier storage of goods.<br><br>4. The construction of the Pantheon, one of the most famous structures in Rome.<br><br>5. The development of</strong>
...
```
    ...
    Yes, I am Qwen, a large language model created by Alibaba Cloud. This means I am available 24/7 to assist you with any questions or tasks you may have. Please let me know how I can be of assistance to you.
...
<strong style='color: #00008B;'>Response: Completion(id='4e4cd546069b4489958dd377d811fe7d', choices=[CompletionChoice(finish_reason='stop', index=0, logprobs=None, text=' Once upon a time, there was a young woman named Emily who had always dreamed of exploring the cosmos. She had been fascinated by the idea of space travel since she was a child, and her parents had encouraged her to pursue it as a career.', matched_stop='\n\n')], created=1770979360, model='qwen/qwen2.5-0.5b-instruct', object='text_completion', system_fingerprint=None, usage=CompletionUsage(completion_tokens=50, prompt_tokens=9, total_tokens=59, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
