...
```
    ...
    [2026-02-26 12:48:00] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.


    [2026-02-26 12:48:00] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.


    [2026-02-26 12:48:00] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-26 12:48:05] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-26 12:48:05] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-26 12:48:05] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-26 12:48:08] INFO server_args.py:1859: Attention backend not specified. Use fa3 backend by default.
    [2026-02-26 12:48:08] INFO server_args.py:2928: Set soft_watchdog_timeout since in CI


    [2026-02-26 12:48:15] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-26 12:48:15] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-26 12:48:15] INFO utils.py:164: NumExpr defaulting to 16 threads.
    [2026-02-26 12:48:15] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-26 12:48:15] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-26 12:48:15] INFO utils.py:164: NumExpr defaulting to 16 threads.
    ...
    [2026-02-26 12:48:21] Ignore import error when loading sglang.srt.models.glm_ocr: No module named 'transformers.models.glm_ocr'
    [2026-02-26 12:48:21] Ignore import error when loading sglang.srt.models.glm_ocr_nextn: No module named 'transformers.models.glm_ocr'
    [2026-02-26 12:48:21] Ignore import error when loading sglang.srt.models.glmasr: cannot import name 'GlmAsrConfig' from 'transformers' (/usr/local/lib/python3.10/dist-packages/transformers/__init__.py)
    ...
    Capturing batches (bs=4 avail_mem=72.00 GB):  33%|███▎      | 1/3 [00:00<00:00,  4.74it/s]Capturing batches (bs=2 avail_mem=71.93 GB):  33%|███▎      | 1/3 [00:00<00:00,  4.74it/s]Capturing batches (bs=1 avail_mem=71.93 GB):  33%|███▎      | 1/3 [00:00<00:00,  4.74it/s]Capturing batches (bs=1 avail_mem=71.93 GB): 100%|██████████| 3/3 [00:00<00:00, 11.49it/s]
...
<strong style='color: #00008B;'>Response: ChatCompletion(id='fa8adffc798347c38aa98ce67cd4d4e2', choices=[Choice(finish_reason='stop', index=0, logprobs=None, message=ChatCompletionMessage(content='Sure, here are three countries and their respective capitals:\n\n1. **United States** - Washington, D.C.\n2. **Canada** - Ottawa\n3. **Australia** - Canberra', refusal=None, role='assistant', annotations=None, audio=None, function_call=None, tool_calls=None, reasoning_content=None), matched_stop=151645)], created=1772110109, model='qwen/qwen2.5-0.5b-instruct', object='chat.completion', service_tier=None, system_fingerprint=None, usage=CompletionUsage(completion_tokens=39, prompt_tokens=37, total_tokens=76, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
...
<strong style='color: #00008B;'>The ancient Romans made significant contributions to various fields, including law, philosophy, science, and literature. They are known for their extensive legal system, which was based on Roman law. The Romans also developed a complex system of government known as the Republic, which lasted for over two centuries.<br><br>In the field of philosophy, the Romans were pioneers in the development of logic and rhetoric. They also made significant contributions to mathematics, particularly in geometry and astronomy. In science, they were instrumental in the development of agriculture and the construction of aqueducts.<br><br>Literature is another area where Roman achievements shine. The Romans are credited with inventing the Latin language</strong>
...
```
    ...
    Yes, I am Qwen, created by Alibaba Cloud. I am designed to assist with a wide range of questions and tasks. If you have any specific questions or need assistance with a particular topic, feel free to ask, and I'll do my best to help you.
...
<strong style='color: #00008B;'>Response: Completion(id='f6eb65ada38941219d5cf6ee01a07ee4', choices=[CompletionChoice(finish_reason='stop', index=0, logprobs=None, text=' Once upon a time, there was a space explorer named Dr. Amelia Hart. She was a brilliant and talented scientist who had spent her entire life studying the stars and planets. Despite her many achievements, she always felt that there was more to discover in the vastness of space.', matched_stop='\n\n')], created=1772110110, model='qwen/qwen2.5-0.5b-instruct', object='text_completion', system_fingerprint=None, usage=CompletionUsage(completion_tokens=56, prompt_tokens=9, total_tokens=65, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
