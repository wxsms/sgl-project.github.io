...
```
    ...
    [2026-02-26 13:15:26] INFO utils.py:148: Note: detected 128 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.


    [2026-02-26 13:15:26] INFO utils.py:151: Note: NumExpr detected 128 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.


    [2026-02-26 13:15:26] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-26 13:15:30] INFO utils.py:148: Note: detected 128 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-26 13:15:30] INFO utils.py:151: Note: NumExpr detected 128 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-26 13:15:30] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-26 13:15:32] INFO server_args.py:1859: Attention backend not specified. Use fa3 backend by default.
    [2026-02-26 13:15:32] INFO server_args.py:2928: Set soft_watchdog_timeout since in CI


    [2026-02-26 13:15:36] INFO utils.py:148: Note: detected 128 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-26 13:15:36] INFO utils.py:151: Note: NumExpr detected 128 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-26 13:15:36] INFO utils.py:164: NumExpr defaulting to 16 threads.
    [2026-02-26 13:15:36] INFO utils.py:148: Note: detected 128 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-26 13:15:36] INFO utils.py:151: Note: NumExpr detected 128 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-26 13:15:36] INFO utils.py:164: NumExpr defaulting to 16 threads.
    ...
    [2026-02-26 13:15:41] Ignore import error when loading sglang.srt.models.glm_ocr: No module named 'transformers.models.glm_ocr'
    [2026-02-26 13:15:41] Ignore import error when loading sglang.srt.models.glm_ocr_nextn: No module named 'transformers.models.glm_ocr'
    [2026-02-26 13:15:41] Ignore import error when loading sglang.srt.models.glmasr: cannot import name 'GlmAsrConfig' from 'transformers' (/usr/local/lib/python3.10/dist-packages/transformers/__init__.py)
    ...
      0%|          | 0/3 [00:00<?, ?it/s]Capturing batches (bs=4 avail_mem=74.93 GB):   0%|          | 0/3 [00:00<?, ?it/s]Capturing batches (bs=4 avail_mem=74.93 GB):  33%|███▎      | 1/3 [00:00<00:00,  5.31it/s]Capturing batches (bs=2 avail_mem=74.88 GB):  33%|███▎      | 1/3 [00:00<00:00,  5.31it/s]

    Capturing batches (bs=1 avail_mem=74.88 GB):  33%|███▎      | 1/3 [00:00<00:00,  5.31it/s]Capturing batches (bs=1 avail_mem=74.88 GB): 100%|██████████| 3/3 [00:00<00:00, 13.28it/s]
...
<strong style='color: #00008B;'><br><br>        NOTE: Typically, the server runs in a separate terminal.<br>        In this notebook, we run the server and notebook code together, so their outputs are combined.<br>        To improve clarity, the server logs are displayed in the original black color, while the notebook outputs are highlighted in blue.<br>        To reduce the log length, we set the log level to warning for the server, the default log level is info.<br>        We are running those notebooks in a CI environment, so the throughput is not representative of the actual performance.<br>        </strong>
    ...
    Server started on http://localhost:37551
...
<strong style='color: #00008B;'>Response: ChatCompletion(id='4c5a6264c59f43b49e0e0f437b6d02a9', choices=[Choice(finish_reason='stop', index=0, logprobs=None, message=ChatCompletionMessage(content='Sure, here are three countries and their respective capitals:\n\n1. **United States** - Washington, D.C.\n2. **Canada** - Ottawa\n3. **Australia** - Canberra', refusal=None, role='assistant', annotations=None, audio=None, function_call=None, tool_calls=None, reasoning_content=None), matched_stop=151645)], created=1772111749, model='qwen/qwen2.5-0.5b-instruct', object='chat.completion', service_tier=None, system_fingerprint=None, usage=CompletionUsage(completion_tokens=39, prompt_tokens=37, total_tokens=76, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
...
<strong style='color: #00008B;'>Ancient Rome was a remarkable civilization that left a lasting impact on history. Some of their major achievements include:<br><br>1. The construction of the Colosseum in Rome, which was the largest amphitheater in the world and served as a place for public spectacles and entertainment.<br><br>2. The development of the Roman Republic, which lasted from 509 to 476 BCE, and the Roman Empire, which lasted from 27 BCE to 476 CE.<br><br>3. The construction of the Pantheon, one of the most famous buildings in Rome, which was built in the 2nd century BCE.<br><br></strong>
...
```
    ...
    Yes, that's correct! I'm here to assist you with any questions or topics you might have. How can I help you today?
...
<strong style='color: #00008B;'>Response: Completion(id='f791c0e1d5534d098cb4103c81d2df46', choices=[CompletionChoice(finish_reason='stop', index=0, logprobs=None, text=' Once upon a time, there was a space explorer named Dr. Elena Martinez. She had always been fascinated by the stars and the unknown worlds out there. She had spent years studying astronomy and had finally decided to make her own space mission.', matched_stop='\n\n')], created=1772111750, model='qwen/qwen2.5-0.5b-instruct', object='text_completion', system_fingerprint=None, usage=CompletionUsage(completion_tokens=48, prompt_tokens=9, total_tokens=57, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
