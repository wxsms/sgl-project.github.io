...
```
    ...
    [2026-02-23 04:10:13] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.


    [2026-02-23 04:10:13] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.


    [2026-02-23 04:10:13] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-23 04:10:19] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-23 04:10:19] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-23 04:10:19] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-23 04:10:21] INFO server_args.py:1835: Attention backend not specified. Use fa3 backend by default.
    [2026-02-23 04:10:21] INFO server_args.py:2886: Set soft_watchdog_timeout since in CI


    [2026-02-23 04:10:28] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-23 04:10:28] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-23 04:10:28] INFO utils.py:164: NumExpr defaulting to 16 threads.
    [2026-02-23 04:10:28] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-23 04:10:28] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-23 04:10:28] INFO utils.py:164: NumExpr defaulting to 16 threads.
    ...
    [2026-02-23 04:10:34] Ignore import error when loading sglang.srt.models.glm_ocr: No module named 'transformers.models.glm_ocr'
    [2026-02-23 04:10:34] Ignore import error when loading sglang.srt.models.glm_ocr_nextn: No module named 'transformers.models.glm_ocr'
    [2026-02-23 04:10:34] Ignore import error when loading sglang.srt.models.glmasr: cannot import name 'GlmAsrConfig' from 'transformers' (/usr/local/lib/python3.10/dist-packages/transformers/__init__.py)
    ...
    Capturing batches (bs=4 avail_mem=71.33 GB):  33%|███▎      | 1/3 [00:00<00:01,  1.68it/s]Capturing batches (bs=2 avail_mem=67.76 GB):  33%|███▎      | 1/3 [00:00<00:01,  1.68it/s]Capturing batches (bs=1 avail_mem=67.75 GB):  33%|███▎      | 1/3 [00:00<00:01,  1.68it/s]Capturing batches (bs=1 avail_mem=67.75 GB): 100%|██████████| 3/3 [00:00<00:00,  4.97it/s]Capturing batches (bs=1 avail_mem=67.75 GB): 100%|██████████| 3/3 [00:00<00:00,  4.16it/s]
...
<strong style='color: #00008B;'>Response: ChatCompletion(id='387a0eb58d874c5491a37a23388245d9', choices=[Choice(finish_reason='stop', index=0, logprobs=None, message=ChatCompletionMessage(content='Sure, here are three countries and their respective capitals:\n\n1. **United States** - Washington, D.C.\n2. **Canada** - Ottawa\n3. **Australia** - Canberra', refusal=None, role='assistant', annotations=None, audio=None, function_call=None, tool_calls=None, reasoning_content=None), matched_stop=151645)], created=1771819843, model='qwen/qwen2.5-0.5b-instruct', object='chat.completion', service_tier=None, system_fingerprint=None, usage=CompletionUsage(completion_tokens=39, prompt_tokens=37, total_tokens=76, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
...
<strong style='color: #00008B;'>Ancient Rome was a major civilization that flourished from the 8th century BCE to the 4th century CE. It is known for its monumental achievements in architecture, engineering, art, and philosophy. Some of the most significant achievements include:<br><br>1. **Architecture**: Rome was renowned for its grand temples, basilicas, and aqueducts. The Colosseum, the Pantheon, and other structures were some of the most impressive examples of Roman architecture.<br><br>2. **Engineering**: The Romans were skilled engineers who built roads, aqueducts, and bridges that connected their vast empire. The Colosseum, for</strong>
...
```
    ...
    Yes, I am designed to assist with various tasks, including testing. If you have any specific questions or tasks you'd like to test, feel free to ask, and I'll do my best to help.
...
<strong style='color: #00008B;'>Response: Completion(id='7898c34da870454b8c3f6fd450057278', choices=[CompletionChoice(finish_reason='stop', index=0, logprobs=None, text=' Once upon a time, there was a space explorer named Dr. Alex Mercer. He had always been fascinated by the mysteries of the universe and dreamed of exploring new worlds beyond our own.', matched_stop='\n\n')], created=1771819844, model='qwen/qwen2.5-0.5b-instruct', object='text_completion', system_fingerprint=None, usage=CompletionUsage(completion_tokens=37, prompt_tokens=9, total_tokens=46, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
