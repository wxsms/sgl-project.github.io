...
```
    ...
    [2026-02-16 14:02:29] INFO utils.py:148: Note: detected 128 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.


    [2026-02-16 14:02:29] INFO utils.py:151: Note: NumExpr detected 128 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.


    [2026-02-16 14:02:29] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-16 14:02:33] INFO utils.py:148: Note: detected 128 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-16 14:02:33] INFO utils.py:151: Note: NumExpr detected 128 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-16 14:02:33] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-16 14:02:35] INFO server_args.py:1832: Attention backend not specified. Use fa3 backend by default.
    [2026-02-16 14:02:35] INFO server_args.py:2867: Set soft_watchdog_timeout since in CI


    [2026-02-16 14:02:39] INFO utils.py:148: Note: detected 128 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-16 14:02:39] INFO utils.py:151: Note: NumExpr detected 128 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-16 14:02:39] INFO utils.py:164: NumExpr defaulting to 16 threads.
    [2026-02-16 14:02:39] INFO utils.py:148: Note: detected 128 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-16 14:02:39] INFO utils.py:151: Note: NumExpr detected 128 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-16 14:02:39] INFO utils.py:164: NumExpr defaulting to 16 threads.
    ...
    [2026-02-16 14:02:44] Ignore import error when loading sglang.srt.models.glm_ocr: No module named 'transformers.models.glm_ocr'
    [2026-02-16 14:02:44] Ignore import error when loading sglang.srt.models.glm_ocr_nextn: No module named 'transformers.models.glm_ocr'
    [2026-02-16 14:02:44] Ignore import error when loading sglang.srt.models.glmasr: cannot import name 'GlmAsrConfig' from 'transformers' (/usr/local/lib/python3.10/dist-packages/transformers/__init__.py)
...
<strong style='color: #00008B;'>Response: ChatCompletion(id='cd28780d8312407985a79cc7c6db48bf', choices=[Choice(finish_reason='stop', index=0, logprobs=None, message=ChatCompletionMessage(content='Sure, here are three countries and their respective capitals:\n\n1. **United States** - Washington, D.C.\n2. **Canada** - Ottawa\n3. **Australia** - Canberra', refusal=None, role='assistant', annotations=None, audio=None, function_call=None, tool_calls=None, reasoning_content=None), matched_stop=151645)], created=1771250571, model='qwen/qwen2.5-0.5b-instruct', object='chat.completion', service_tier=None, system_fingerprint=None, usage=CompletionUsage(completion_tokens=39, prompt_tokens=37, total_tokens=76, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
...
<strong style='color: #00008B;'>Ancient Rome was a major civilization that flourished in the Mediterranean region from the 8th century BCE to the 4th century CE. Some of their major achievements include:<br><br>1. **Roman Republic**: The first permanent Roman state, established in 509 BCE, lasted until 27 BCE. It was a period of stability and prosperity for the Roman Empire.<br><br>2. **Roman Empire**: The largest and most powerful empire in history, spanning from Italy to Spain and including parts of North Africa and parts of Asia Minor. The empire reached its peak under Augustus (27 BCE - 14 CE).<br><br>3.</strong>
...
```
    ...
    Yes, that is a test. I'm here to assist you with any questions or topics you have, so feel free to ask me anything!
...
<strong style='color: #00008B;'>Response: Completion(id='3f5e5d7d5fb64ca3a032830177bb6e2f', choices=[CompletionChoice(finish_reason='stop', index=0, logprobs=None, text=' Once upon a time, there was a space explorer named Alex who had always dreamed of exploring the vastness of space. He had always been fascinated by the stars and the mysteries of the universe, and he knew that there were many unknowns out there that he needed to discover.', matched_stop='\n\n')], created=1771250572, model='qwen/qwen2.5-0.5b-instruct', object='text_completion', system_fingerprint=None, usage=CompletionUsage(completion_tokens=56, prompt_tokens=9, total_tokens=65, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
