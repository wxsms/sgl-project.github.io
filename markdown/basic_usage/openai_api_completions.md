...
```
    ...
    [2026-02-20 16:51:29] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.


    [2026-02-20 16:51:29] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.


    [2026-02-20 16:51:29] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-20 16:51:34] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-20 16:51:34] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-20 16:51:34] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-20 16:51:37] INFO server_args.py:1834: Attention backend not specified. Use fa3 backend by default.
    [2026-02-20 16:51:37] INFO server_args.py:2887: Set soft_watchdog_timeout since in CI


    [2026-02-20 16:51:44] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-20 16:51:44] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-20 16:51:44] INFO utils.py:164: NumExpr defaulting to 16 threads.
    [2026-02-20 16:51:44] INFO utils.py:148: Note: detected 112 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-20 16:51:44] INFO utils.py:151: Note: NumExpr detected 112 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-20 16:51:44] INFO utils.py:164: NumExpr defaulting to 16 threads.
    ...
    [2026-02-20 16:51:50] Ignore import error when loading sglang.srt.models.glm_ocr: No module named 'transformers.models.glm_ocr'
    [2026-02-20 16:51:50] Ignore import error when loading sglang.srt.models.glm_ocr_nextn: No module named 'transformers.models.glm_ocr'
    [2026-02-20 16:51:50] Ignore import error when loading sglang.srt.models.glmasr: cannot import name 'GlmAsrConfig' from 'transformers' (/usr/local/lib/python3.10/dist-packages/transformers/__init__.py)
    ...
      0%|          | 0/3 [00:00<?, ?it/s]Capturing batches (bs=4 avail_mem=12.94 GB):   0%|          | 0/3 [00:00<?, ?it/s]

    Capturing batches (bs=4 avail_mem=12.94 GB):  33%|███▎      | 1/3 [00:02<00:04,  2.21s/it]Capturing batches (bs=2 avail_mem=12.79 GB):  33%|███▎      | 1/3 [00:02<00:04,  2.21s/it]Capturing batches (bs=1 avail_mem=12.78 GB):  33%|███▎      | 1/3 [00:02<00:04,  2.21s/it]Capturing batches (bs=1 avail_mem=12.78 GB): 100%|██████████| 3/3 [00:02<00:00,  1.33it/s]
...
<strong style='color: #00008B;'>Response: ChatCompletion(id='869ccaf2706f4af19207560f86e16be8', choices=[Choice(finish_reason='stop', index=0, logprobs=None, message=ChatCompletionMessage(content='Sure, here are three countries and their respective capitals:\n\n1. **United States** - Washington, D.C.\n2. **Canada** - Ottawa\n3. **Australia** - Canberra', refusal=None, role='assistant', annotations=None, audio=None, function_call=None, tool_calls=None, reasoning_content=None), matched_stop=151645)], created=1771606319, model='qwen/qwen2.5-0.5b-instruct', object='chat.completion', service_tier=None, system_fingerprint=None, usage=CompletionUsage(completion_tokens=39, prompt_tokens=37, total_tokens=76, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
...
<strong style='color: #00008B;'>The ancient Roman civilization was a major center of ancient civilization, and it had a significant impact on the world. Some of their major achievements include:<br><br>1. The Roman Empire: The Roman Empire was the largest and most powerful empire in history, spanning across Europe, Asia Minor, and North Africa. It was founded by Augustus Caesar in 27 BCE and lasted until 476 CE.<br><br>2. Architecture: Roman architecture is renowned for its grandeur and engineering prowess. The Colosseum in Rome, for example, is one of the most famous structures in the world.<br><br>3. Law: Roman law was one of the</strong>
...
<strong style='color: #00008B;'>Response: Completion(id='28de6b274c7947e0b23e112ef5a12135', choices=[CompletionChoice(finish_reason='stop', index=0, logprobs=None, text=' Once upon a time, there was a space explorer named Jack who had been dreaming of exploring the vastness of space for years. He had traveled to many planets and had seen some amazing sights, but he always felt like there was more to explore.', matched_stop='\n\n')], created=1771606320, model='qwen/qwen2.5-0.5b-instruct', object='text_completion', system_fingerprint=None, usage=CompletionUsage(completion_tokens=50, prompt_tokens=9, total_tokens=59, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
