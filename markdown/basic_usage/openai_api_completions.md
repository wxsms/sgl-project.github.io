...
```
    ...
    [2026-02-21 02:25:02] INFO utils.py:148: Note: detected 128 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.


    [2026-02-21 02:25:02] INFO utils.py:151: Note: NumExpr detected 128 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.


    [2026-02-21 02:25:02] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-21 02:25:06] INFO utils.py:148: Note: detected 128 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-21 02:25:06] INFO utils.py:151: Note: NumExpr detected 128 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-21 02:25:06] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-21 02:25:08] INFO server_args.py:1838: Attention backend not specified. Use fa3 backend by default.
    [2026-02-21 02:25:08] INFO server_args.py:2891: Set soft_watchdog_timeout since in CI


    [2026-02-21 02:25:12] INFO utils.py:148: Note: detected 128 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-21 02:25:12] INFO utils.py:151: Note: NumExpr detected 128 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-21 02:25:12] INFO utils.py:164: NumExpr defaulting to 16 threads.
    [2026-02-21 02:25:12] INFO utils.py:148: Note: detected 128 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-21 02:25:12] INFO utils.py:151: Note: NumExpr detected 128 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-21 02:25:12] INFO utils.py:164: NumExpr defaulting to 16 threads.
    ...
    [2026-02-21 02:25:17] Ignore import error when loading sglang.srt.models.glm_ocr: No module named 'transformers.models.glm_ocr'
    [2026-02-21 02:25:17] Ignore import error when loading sglang.srt.models.glm_ocr_nextn: No module named 'transformers.models.glm_ocr'
    [2026-02-21 02:25:17] Ignore import error when loading sglang.srt.models.glmasr: cannot import name 'GlmAsrConfig' from 'transformers' (/usr/local/lib/python3.10/dist-packages/transformers/__init__.py)
    ...
    Capturing batches (bs=1 avail_mem=74.88 GB):  33%|███▎      | 1/3 [00:00<00:00,  5.28it/s]Capturing batches (bs=1 avail_mem=74.88 GB): 100%|██████████| 3/3 [00:00<00:00, 13.02it/s]
...
<strong style='color: #00008B;'>Response: ChatCompletion(id='499519908e5e4b8ab8a1f4b8d0ef35b4', choices=[Choice(finish_reason='stop', index=0, logprobs=None, message=ChatCompletionMessage(content='Sure, here are three countries and their respective capitals:\n\n1. **United States** - Washington, D.C.\n2. **Canada** - Ottawa\n3. **Australia** - Canberra', refusal=None, role='assistant', annotations=None, audio=None, function_call=None, tool_calls=None, reasoning_content=None), matched_stop=151645)], created=1771640725, model='qwen/qwen2.5-0.5b-instruct', object='chat.completion', service_tier=None, system_fingerprint=None, usage=CompletionUsage(completion_tokens=39, prompt_tokens=37, total_tokens=76, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
...
<strong style='color: #00008B;'>The ancient Romans made significant contributions to various fields, including law, philosophy, science, and art. They were known for their advancements in architecture, engineering, and engineering. Their military prowess was also notable, and they developed a complex system of governance that included the concept of the plebeian class. The Roman Republic was a period of political stability and prosperity, with Rome becoming a major power in the Mediterranean world.</strong>
...
```
    ...
    Yes, that is a test. I'm here to assist you with any questions or tasks you might have. Please feel free to ask me anything you need help with.
...
<strong style='color: #00008B;'>Response: Completion(id='29f09e3f9ffe4108992a764e81744e16', choices=[CompletionChoice(finish_reason='stop', index=0, logprobs=None, text=' Once upon a time, there was a young space explorer named Alex who dreamed of exploring the stars. He had always been fascinated by the idea of traveling through space and experiencing new places and cultures.', matched_stop='\n\n')], created=1771640725, model='qwen/qwen2.5-0.5b-instruct', object='text_completion', system_fingerprint=None, usage=CompletionUsage(completion_tokens=39, prompt_tokens=9, total_tokens=48, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
