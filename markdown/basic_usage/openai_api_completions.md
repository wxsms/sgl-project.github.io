...
```
    ...
    [2026-02-26 23:16:19] INFO utils.py:148: Note: detected 192 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.


    [2026-02-26 23:16:19] INFO utils.py:151: Note: NumExpr detected 192 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.


    [2026-02-26 23:16:19] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-26 23:16:25] INFO utils.py:148: Note: detected 192 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-26 23:16:25] INFO utils.py:151: Note: NumExpr detected 192 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-26 23:16:25] INFO utils.py:164: NumExpr defaulting to 16 threads.


    [2026-02-26 23:16:27] INFO server_args.py:1859: Attention backend not specified. Use fa3 backend by default.
    [2026-02-26 23:16:27] INFO server_args.py:2928: Set soft_watchdog_timeout since in CI


    [2026-02-26 23:16:34] INFO utils.py:148: Note: detected 192 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-26 23:16:34] INFO utils.py:151: Note: NumExpr detected 192 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-26 23:16:34] INFO utils.py:164: NumExpr defaulting to 16 threads.
    [2026-02-26 23:16:34] INFO utils.py:148: Note: detected 192 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.
    [2026-02-26 23:16:34] INFO utils.py:151: Note: NumExpr detected 192 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.
    [2026-02-26 23:16:34] INFO utils.py:164: NumExpr defaulting to 16 threads.
    ...
    [2026-02-26 23:16:39] Ignore import error when loading sglang.srt.models.glm_ocr: No module named 'transformers.models.glm_ocr'
    [2026-02-26 23:16:39] Ignore import error when loading sglang.srt.models.glm_ocr_nextn: No module named 'transformers.models.glm_ocr'
    [2026-02-26 23:16:39] Ignore import error when loading sglang.srt.models.glmasr: cannot import name 'GlmAsrConfig' from 'transformers' (/usr/local/lib/python3.10/dist-packages/transformers/__init__.py)
    ...
    Capturing batches (bs=4 avail_mem=119.29 GB):  33%|███▎      | 1/3 [00:11<00:22, 11.01s/it]Capturing batches (bs=2 avail_mem=117.79 GB):  33%|███▎      | 1/3 [00:11<00:22, 11.01s/it]Capturing batches (bs=1 avail_mem=117.78 GB):  33%|███▎      | 1/3 [00:11<00:22, 11.01s/it]Capturing batches (bs=1 avail_mem=117.78 GB): 100%|██████████| 3/3 [00:11<00:00,  3.68s/it]
...
<strong style='color: #00008B;'>Response: ChatCompletion(id='7285220a6800478495d62dab1d0b63b4', choices=[Choice(finish_reason='stop', index=0, logprobs=None, message=ChatCompletionMessage(content='Sure, here are three countries and their respective capitals:\n\n1. **United States** - Washington, D.C.\n2. **Canada** - Ottawa\n3. **Australia** - Canberra', refusal=None, role='assistant', annotations=None, audio=None, function_call=None, tool_calls=None, reasoning_content=None), matched_stop=151645)], created=1772147820, model='qwen/qwen2.5-0.5b-instruct', object='chat.completion', service_tier=None, system_fingerprint=None, usage=CompletionUsage(completion_tokens=39, prompt_tokens=37, total_tokens=76, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
...
<strong style='color: #00008B;'>Ancient Rome was a major civilization that flourished from the 8th century BCE to the 4th century CE. It was known for its advanced engineering, art, literature, and philosophy. Some of their major achievements include:<br><br>1. Architecture: Rome was known for its grand architecture, including the Colosseum, the Pantheon, and the Roman Forum.<br><br>2. Art: The Romans were renowned for their art, particularly in sculpture and pottery. They were also famous for their frescoes and mosaics.<br><br>3. Literature: Roman literature was highly influential, with works like Virgil's Aeneid and Ovid</strong>
...
```
    ...
    Yes, that's correct! I'm designed to provide helpful and informative responses to users. If you have any questions or need assistance with anything, feel free to ask!
...
<strong style='color: #00008B;'>Response: Completion(id='b228586f1315484e831af1a034c15602', choices=[CompletionChoice(finish_reason='stop', index=0, logprobs=None, text=' Once upon a time, in the vast expanse of space, there was a young space explorer named Alex. Alex had always been fascinated by the stars and the universe, and he was determined to become a scientist and discover new wonders.', matched_stop='\n\n')], created=1772147821, model='qwen/qwen2.5-0.5b-instruct', object='text_completion', system_fingerprint=None, usage=CompletionUsage(completion_tokens=47, prompt_tokens=9, total_tokens=56, completion_tokens_details=None, prompt_tokens_details=None, reasoning_tokens=0), metadata={'weight_version': 'default'})</strong>
