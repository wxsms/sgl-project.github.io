...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 188.25it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 124.00it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 187.23it/s]
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 112.80it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 194.55it/s]
...
```
    ...
    [2026-05-30 03:53:49] Load weight end. elapsed=2.57 s, type=LlamaForCausalLM, avail mem=63.48 GB, mem usage=15.02 GB.
    [2026-05-30 03:53:49] Using csgmv as backend of LoRA kernels.
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 44267.06it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 21704.03it/s]
    [2026-05-30 03:53:49] Found local HF snapshot for Nutanix/Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json at /root/.cache/huggingface/hub/models--Nutanix--Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json/snapshots/2c398740f3eba8dc63ee78999316b833a2833b6c; skipping download.
    ...
    [2026-05-30 03:53:50] Found local HF snapshot for algoprog/fact-generation-llama-3.1-8b-instruct-lora at /root/.cache/huggingface/hub/models--algoprog--fact-generation-llama-3.1-8b-instruct-lora/snapshots/dc8cdfb21993a6cb46199d6b1d79f68a42b06439; skipping download.
    ...
    [2026-05-30 03:53:50] Found local HF snapshot for philschmid/code-llama-3-1-8b-text-to-sql-lora at /root/.cache/huggingface/hub/models--philschmid--code-llama-3-1-8b-text-to-sql-lora/snapshots/141fc3a09386a8baf0d7495c247ae2d1a565f69f; skipping download.


    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 118.36it/s]


    [2026-05-30 03:53:51] Max concurrent requests (per dp worker) from the finalized token capacity: max_num_reqs=128.
    [2026-05-30 03:53:51] KV Cache is allocated. dtype: torch.bfloat16, #tokens: 20480, K size: 1.25 GB, V size: 1.25 GB
    [2026-05-30 03:53:51] Memory pool end. avail mem=58.26 GB
    [2026-05-30 03:53:51] Disable piecewise CUDA graph because --disable-piecewise-cuda-graph is set


    [2026-05-30 03:53:56] max_total_num_tokens=20480, chunked_prefill_size=8192, max_prefill_tokens=16384, max_running_requests=128, context_len=131072, available_gpu_mem=49.25 GB
    [2026-05-30 03:53:56] Tree cache initialized: source=default impl=RadixCache hybrid_swa=False hybrid_ssm=False hierarchical=False streaming_wrapped=False


    [2026-05-30 03:53:57] INFO:     Started server process [1696008]
    [2026-05-30 03:53:57] INFO:     Waiting for application startup.
    [2026-05-30 03:53:57] Using default chat sampling params from model generation config: {'temperature': 0.6, 'top_p': 0.9}
    [2026-05-30 03:53:57] INFO:     Application startup complete.
    [2026-05-30 03:53:57] INFO:     Uvicorn running on http://127.0.0.1:38095 (Press CTRL+C to quit)


    /usr/local/lib/python3.10/dist-packages/fastapi/routing.py:120: FastAPIDeprecationWarning: ORJSONResponse is deprecated, FastAPI now serializes data directly to JSON bytes via Pydantic when a return type or response model is set, which is faster and doesn't need a custom response class. Read more in the FastAPI docs: https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model and https://fastapi.tiangolo.com/tutorial/response-model/
      response = await f(request)
    [2026-05-30 03:53:57] INFO:     127.0.0.1:36582 - "GET /v1/models HTTP/1.1" 200 OK


    [2026-05-30 03:53:58] INFO:     127.0.0.1:36592 - "GET /model_info HTTP/1.1" 200 OK


    [2026-05-30 03:53:59] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-05-30 03:53:59] LoRA expand (K=6144, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-05-30 03:53:59] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-05-30 03:53:59] LoRA expand (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}


    [2026-05-30 03:54:00] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-05-30 03:54:00] LoRA expand (K=28672, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-05-30 03:54:00] LoRA shrink (K=14336, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-05-30 03:54:00] Prefill batch, #new-seq: 1, #new-token: 7, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 1.97


    [2026-05-30 03:54:00] INFO:     127.0.0.1:36604 - "POST /generate HTTP/1.1" 200 OK
    [2026-05-30 03:54:00] The server is fired up and ready to roll!
...
```
    ...
    [2026-05-30 03:54:02] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-30 03:54:02] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-05-30 03:54:03] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-05-30 03:54:05] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-30 03:54:05] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-05-30 03:54:05] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-30 03:54:05] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-05-30 03:54:05] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 2, #pending-token: 18, cuda graph: False, input throughput (token/s): 1.69
    [2026-05-30 03:54:05] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-30 03:54:05] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-05-30 03:54:05] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-30 03:54:05] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-05-30 03:54:05] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-30 03:54:05] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-05-30 03:54:06] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-30 03:54:06] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-05-30 03:54:06] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-30 03:54:06] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-05-30 03:54:06] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-30 03:54:06] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 1, #pending-token: 9, cuda graph: False, input throughput (token/s): 6.56


    [2026-05-30 03:54:07] Decode batch, #running-req: 2, #token: 61, token usage: 0.00, cuda graph: False, gen throughput (token/s): 4.70, #queue-req: 1


    [2026-05-30 03:54:07] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-05-30 03:54:07] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 10.29


    [2026-05-30 03:54:07] Decode batch, #running-req: 2, #token: 75, token usage: 0.00, cuda graph: False, gen throughput (token/s): 95.15, #queue-req: 0


    [2026-05-30 03:54:08] Decode batch, #running-req: 2, #token: 155, token usage: 0.01, cuda graph: False, gen throughput (token/s): 110.00, #queue-req: 0


    [2026-05-30 03:54:09] Decode batch, #running-req: 1, #token: 139, token usage: 0.01, cuda graph: False, gen throughput (token/s): 79.39, #queue-req: 0


    [2026-05-30 03:54:10] Decode batch, #running-req: 1, #token: 179, token usage: 0.01, cuda graph: False, gen throughput (token/s): 58.07, #queue-req: 0


    [2026-05-30 03:54:10] Decode batch, #running-req: 1, #token: 219, token usage: 0.01, cuda graph: False, gen throughput (token/s): 56.61, #queue-req: 0


    [2026-05-30 03:54:11] Decode batch, #running-req: 1, #token: 259, token usage: 0.01, cuda graph: False, gen throughput (token/s): 55.06, #queue-req: 0


    [2026-05-30 03:54:12] Decode batch, #running-req: 1, #token: 299, token usage: 0.01, cuda graph: False, gen throughput (token/s): 55.89, #queue-req: 0


    [2026-05-30 03:54:12] Decode batch, #running-req: 1, #token: 339, token usage: 0.02, cuda graph: False, gen throughput (token/s): 55.89, #queue-req: 0


    [2026-05-30 03:54:13] Decode batch, #running-req: 1, #token: 379, token usage: 0.02, cuda graph: False, gen throughput (token/s): 55.60, #queue-req: 0


    [2026-05-30 03:54:14] Decode batch, #running-req: 1, #token: 419, token usage: 0.02, cuda graph: False, gen throughput (token/s): 54.29, #queue-req: 0


    [2026-05-30 03:54:15] Decode batch, #running-req: 1, #token: 459, token usage: 0.02, cuda graph: False, gen throughput (token/s): 56.44, #queue-req: 0


    [2026-05-30 03:54:15] Decode batch, #running-req: 1, #token: 499, token usage: 0.02, cuda graph: False, gen throughput (token/s): 52.97, #queue-req: 0


    [2026-05-30 03:54:16] Decode batch, #running-req: 1, #token: 539, token usage: 0.03, cuda graph: False, gen throughput (token/s): 50.64, #queue-req: 0


    [2026-05-30 03:54:17] Decode batch, #running-req: 1, #token: 579, token usage: 0.03, cuda graph: False, gen throughput (token/s): 51.71, #queue-req: 0


    [2026-05-30 03:54:18] Decode batch, #running-req: 1, #token: 619, token usage: 0.03, cuda graph: False, gen throughput (token/s): 54.91, #queue-req: 0


    [2026-05-30 03:54:18] Decode batch, #running-req: 1, #token: 659, token usage: 0.03, cuda graph: False, gen throughput (token/s): 55.29, #queue-req: 0


    [2026-05-30 03:54:19] Decode batch, #running-req: 1, #token: 699, token usage: 0.03, cuda graph: False, gen throughput (token/s): 54.51, #queue-req: 0


    [2026-05-30 03:54:20] Decode batch, #running-req: 1, #token: 739, token usage: 0.04, cuda graph: False, gen throughput (token/s): 57.13, #queue-req: 0


    [2026-05-30 03:54:21] Decode batch, #running-req: 1, #token: 779, token usage: 0.04, cuda graph: False, gen throughput (token/s): 54.94, #queue-req: 0


    [2026-05-30 03:54:21] Decode batch, #running-req: 1, #token: 819, token usage: 0.04, cuda graph: False, gen throughput (token/s): 55.40, #queue-req: 0


    [2026-05-30 03:54:22] Decode batch, #running-req: 1, #token: 859, token usage: 0.04, cuda graph: False, gen throughput (token/s): 52.41, #queue-req: 0


    [2026-05-30 03:54:23] Decode batch, #running-req: 1, #token: 899, token usage: 0.04, cuda graph: False, gen throughput (token/s): 54.00, #queue-req: 0


    [2026-05-30 03:54:24] Decode batch, #running-req: 1, #token: 939, token usage: 0.05, cuda graph: False, gen throughput (token/s): 52.00, #queue-req: 0


    [2026-05-30 03:54:24] Decode batch, #running-req: 1, #token: 979, token usage: 0.05, cuda graph: False, gen throughput (token/s): 55.72, #queue-req: 0


    [2026-05-30 03:54:25] Decode batch, #running-req: 1, #token: 1019, token usage: 0.05, cuda graph: False, gen throughput (token/s): 55.62, #queue-req: 0


    [2026-05-30 03:54:25] INFO:     127.0.0.1:36610 - "POST /generate HTTP/1.1" 200 OK
    Output from lora0: 
