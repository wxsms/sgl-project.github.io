...
```
    ...
    Multi-thread loading shards:  75% Completed | 3/4 [00:05<00:01,  1.52s/it]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 365.52it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 133.67it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 164.43it/s]
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 116.33it/s]
...
```
    ...
    [2026-05-28 14:23:34] Load weight end. elapsed=3.02 s, type=LlamaForCausalLM, avail mem=62.97 GB, mem usage=15.53 GB.
    [2026-05-28 14:23:34] Using csgmv as backend of LoRA kernels.
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 14576.21it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 84307.62it/s]
    [2026-05-28 14:23:35] Found local HF snapshot for Nutanix/Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json at /root/.cache/huggingface/hub/models--Nutanix--Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json/snapshots/2c398740f3eba8dc63ee78999316b833a2833b6c; skipping download.
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 256.94it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 7466.50it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 13283.62it/s]
    [2026-05-28 14:23:35] Found local HF snapshot for algoprog/fact-generation-llama-3.1-8b-instruct-lora at /root/.cache/huggingface/hub/models--algoprog--fact-generation-llama-3.1-8b-instruct-lora/snapshots/dc8cdfb21993a6cb46199d6b1d79f68a42b06439; skipping download.


    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 131.83it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 12026.68it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 39662.45it/s]
    [2026-05-28 14:23:36] Found local HF snapshot for philschmid/code-llama-3-1-8b-text-to-sql-lora at /root/.cache/huggingface/hub/models--philschmid--code-llama-3-1-8b-text-to-sql-lora/snapshots/141fc3a09386a8baf0d7495c247ae2d1a565f69f; skipping download.


    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 95.94it/s]


    [2026-05-28 14:23:39] Max concurrent requests (per dp worker) from the finalized token capacity: max_num_reqs=128.
    [2026-05-28 14:23:39] KV Cache is allocated. dtype: torch.bfloat16, #tokens: 20480, K size: 1.25 GB, V size: 1.25 GB
    [2026-05-28 14:23:39] Memory pool end. avail mem=49.35 GB
    [2026-05-28 14:23:39] Disable piecewise CUDA graph because --disable-piecewise-cuda-graph is set


    [2026-05-28 14:23:44] max_total_num_tokens=20480, chunked_prefill_size=8192, max_prefill_tokens=16384, max_running_requests=128, context_len=131072, available_gpu_mem=48.54 GB
    [2026-05-28 14:23:44] Tree cache initialized: source=default impl=RadixCache hybrid_swa=False hybrid_ssm=False hierarchical=False streaming_wrapped=False


    [2026-05-28 14:23:45] INFO:     Started server process [345113]
    [2026-05-28 14:23:45] INFO:     Waiting for application startup.
    [2026-05-28 14:23:45] Using default chat sampling params from model generation config: {'temperature': 0.6, 'top_p': 0.9}
    [2026-05-28 14:23:45] INFO:     Application startup complete.
    [2026-05-28 14:23:45] INFO:     Uvicorn running on http://127.0.0.1:32572 (Press CTRL+C to quit)


    /usr/local/lib/python3.10/dist-packages/fastapi/routing.py:120: FastAPIDeprecationWarning: ORJSONResponse is deprecated, FastAPI now serializes data directly to JSON bytes via Pydantic when a return type or response model is set, which is faster and doesn't need a custom response class. Read more in the FastAPI docs: https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model and https://fastapi.tiangolo.com/tutorial/response-model/
      response = await f(request)
    [2026-05-28 14:23:45] INFO:     127.0.0.1:40948 - "GET /v1/models HTTP/1.1" 200 OK


    [2026-05-28 14:23:46] INFO:     127.0.0.1:40950 - "GET /model_info HTTP/1.1" 200 OK


    [2026-05-28 14:23:47] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-05-28 14:23:47] LoRA expand (K=6144, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-05-28 14:23:48] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-05-28 14:23:48] LoRA expand (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}


    [2026-05-28 14:23:48] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-05-28 14:23:48] LoRA expand (K=28672, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-05-28 14:23:48] LoRA shrink (K=14336, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-05-28 14:23:48] Prefill batch, #new-seq: 1, #new-token: 7, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 1.88


    [2026-05-28 14:23:48] INFO:     127.0.0.1:40964 - "POST /generate HTTP/1.1" 200 OK
    [2026-05-28 14:23:48] The server is fired up and ready to roll!
...
```
    ...
    [2026-05-28 14:23:50] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-28 14:23:50] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-05-28 14:23:50] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-05-28 14:23:51] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-28 14:23:51] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-05-28 14:23:51] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-05-28 14:23:52] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-28 14:23:52] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-05-28 14:23:52] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 2, #pending-token: 18, cuda graph: False, input throughput (token/s): 2.23
    [2026-05-28 14:23:52] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-28 14:23:52] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-05-28 14:23:53] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-28 14:23:53] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-05-28 14:23:54] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-28 14:23:54] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-05-28 14:23:54] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-28 14:23:54] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 1, #pending-token: 9, cuda graph: False, input throughput (token/s): 3.81


    [2026-05-28 14:23:55] Decode batch, #running-req: 2, #token: 73, token usage: 0.00, cuda graph: False, gen throughput (token/s): 5.78, #queue-req: 1


    [2026-05-28 14:23:55] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-05-28 14:23:56] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 6.58
    [2026-05-28 14:23:56] Decode batch, #running-req: 2, #token: 87, token usage: 0.00, cuda graph: False, gen throughput (token/s): 74.30, #queue-req: 0


    [2026-05-28 14:23:57] Decode batch, #running-req: 2, #token: 167, token usage: 0.01, cuda graph: False, gen throughput (token/s): 108.90, #queue-req: 0


    [2026-05-28 14:23:57] Decode batch, #running-req: 1, #token: 151, token usage: 0.01, cuda graph: False, gen throughput (token/s): 81.54, #queue-req: 0


    [2026-05-28 14:23:58] Decode batch, #running-req: 1, #token: 191, token usage: 0.01, cuda graph: False, gen throughput (token/s): 55.89, #queue-req: 0


    [2026-05-28 14:23:59] Decode batch, #running-req: 1, #token: 231, token usage: 0.01, cuda graph: False, gen throughput (token/s): 53.75, #queue-req: 0


    [2026-05-28 14:24:00] Decode batch, #running-req: 1, #token: 271, token usage: 0.01, cuda graph: False, gen throughput (token/s): 47.70, #queue-req: 0


    [2026-05-28 14:24:01] Decode batch, #running-req: 1, #token: 311, token usage: 0.02, cuda graph: False, gen throughput (token/s): 43.59, #queue-req: 0


    [2026-05-28 14:24:02] Decode batch, #running-req: 1, #token: 351, token usage: 0.02, cuda graph: False, gen throughput (token/s): 41.41, #queue-req: 0


    [2026-05-28 14:24:02] Decode batch, #running-req: 1, #token: 391, token usage: 0.02, cuda graph: False, gen throughput (token/s): 42.34, #queue-req: 0


    [2026-05-28 14:24:03] Decode batch, #running-req: 1, #token: 431, token usage: 0.02, cuda graph: False, gen throughput (token/s): 41.78, #queue-req: 0


    [2026-05-28 14:24:04] Decode batch, #running-req: 1, #token: 471, token usage: 0.02, cuda graph: False, gen throughput (token/s): 42.14, #queue-req: 0


    [2026-05-28 14:24:05] Decode batch, #running-req: 1, #token: 511, token usage: 0.02, cuda graph: False, gen throughput (token/s): 43.40, #queue-req: 0


    [2026-05-28 14:24:06] Decode batch, #running-req: 1, #token: 551, token usage: 0.03, cuda graph: False, gen throughput (token/s): 43.37, #queue-req: 0


    [2026-05-28 14:24:07] Decode batch, #running-req: 1, #token: 591, token usage: 0.03, cuda graph: False, gen throughput (token/s): 43.64, #queue-req: 0


    [2026-05-28 14:24:08] Decode batch, #running-req: 1, #token: 631, token usage: 0.03, cuda graph: False, gen throughput (token/s): 50.51, #queue-req: 0


    [2026-05-28 14:24:09] Decode batch, #running-req: 1, #token: 671, token usage: 0.03, cuda graph: False, gen throughput (token/s): 53.57, #queue-req: 0


    [2026-05-28 14:24:09] Decode batch, #running-req: 1, #token: 711, token usage: 0.03, cuda graph: False, gen throughput (token/s): 54.46, #queue-req: 0


    [2026-05-28 14:24:10] Decode batch, #running-req: 1, #token: 751, token usage: 0.04, cuda graph: False, gen throughput (token/s): 48.55, #queue-req: 0


    [2026-05-28 14:24:11] Decode batch, #running-req: 1, #token: 791, token usage: 0.04, cuda graph: False, gen throughput (token/s): 49.13, #queue-req: 0


    [2026-05-28 14:24:12] Decode batch, #running-req: 1, #token: 831, token usage: 0.04, cuda graph: False, gen throughput (token/s): 47.22, #queue-req: 0


    [2026-05-28 14:24:13] Decode batch, #running-req: 1, #token: 871, token usage: 0.04, cuda graph: False, gen throughput (token/s): 49.12, #queue-req: 0


    [2026-05-28 14:24:14] Decode batch, #running-req: 1, #token: 911, token usage: 0.04, cuda graph: False, gen throughput (token/s): 46.99, #queue-req: 0


    [2026-05-28 14:24:14] Decode batch, #running-req: 1, #token: 951, token usage: 0.05, cuda graph: False, gen throughput (token/s): 49.75, #queue-req: 0


    [2026-05-28 14:24:15] Decode batch, #running-req: 1, #token: 991, token usage: 0.05, cuda graph: False, gen throughput (token/s): 48.99, #queue-req: 0


    [2026-05-28 14:24:16] Decode batch, #running-req: 1, #token: 1031, token usage: 0.05, cuda graph: False, gen throughput (token/s): 51.32, #queue-req: 0
    [2026-05-28 14:24:16] INFO:     127.0.0.1:40968 - "POST /generate HTTP/1.1" 200 OK
    Output from lora0: 
