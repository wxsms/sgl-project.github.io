...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 152.90it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 100.58it/s]
...
```
    ...
    [2026-05-27 09:39:45] Load weight end. elapsed=3.56 s, type=LlamaForCausalLM, avail mem=26.30 GB, mem usage=15.06 GB.
    [2026-05-27 09:39:45] Using csgmv as backend of LoRA kernels.
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 85163.53it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 16660.59it/s]
    [2026-05-27 09:39:45] Found local HF snapshot for Nutanix/Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json at /root/.cache/huggingface/hub/models--Nutanix--Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json/snapshots/2c398740f3eba8dc63ee78999316b833a2833b6c; skipping download.
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 299.34it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 78766.27it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 80273.76it/s]
    [2026-05-27 09:39:45] Found local HF snapshot for algoprog/fact-generation-llama-3.1-8b-instruct-lora at /root/.cache/huggingface/hub/models--algoprog--fact-generation-llama-3.1-8b-instruct-lora/snapshots/dc8cdfb21993a6cb46199d6b1d79f68a42b06439; skipping download.
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 151.71it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 83886.08it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 23045.63it/s]
    [2026-05-27 09:39:46] Found local HF snapshot for philschmid/code-llama-3-1-8b-text-to-sql-lora at /root/.cache/huggingface/hub/models--philschmid--code-llama-3-1-8b-text-to-sql-lora/snapshots/141fc3a09386a8baf0d7495c247ae2d1a565f69f; skipping download.
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 111.05it/s]


    [2026-05-27 09:39:48] Max concurrent requests (per dp worker) from the finalized token capacity: max_num_reqs=128.
    [2026-05-27 09:39:48] KV Cache is allocated. dtype: torch.bfloat16, #tokens: 20480, K size: 1.25 GB, V size: 1.25 GB
    [2026-05-27 09:39:48] Memory pool end. avail mem=38.66 GB
    [2026-05-27 09:39:48] Disable piecewise CUDA graph because --disable-piecewise-cuda-graph is set


    [2026-05-27 09:39:52] max_total_num_tokens=20480, chunked_prefill_size=8192, max_prefill_tokens=16384, max_running_requests=128, context_len=131072, available_gpu_mem=38.51 GB
    [2026-05-27 09:39:52] Tree cache initialized: source=default impl=RadixCache hybrid_swa=False hybrid_ssm=False hierarchical=False streaming_wrapped=False


    [2026-05-27 09:39:52] INFO:     Started server process [57572]
    [2026-05-27 09:39:52] INFO:     Waiting for application startup.
    [2026-05-27 09:39:52] Using default chat sampling params from model generation config: {'temperature': 0.6, 'top_p': 0.9}
    [2026-05-27 09:39:52] INFO:     Application startup complete.
    [2026-05-27 09:39:52] INFO:     Uvicorn running on http://127.0.0.1:30830 (Press CTRL+C to quit)


    /usr/local/lib/python3.10/dist-packages/fastapi/routing.py:120: FastAPIDeprecationWarning: ORJSONResponse is deprecated, FastAPI now serializes data directly to JSON bytes via Pydantic when a return type or response model is set, which is faster and doesn't need a custom response class. Read more in the FastAPI docs: https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model and https://fastapi.tiangolo.com/tutorial/response-model/
      response = await f(request)
    [2026-05-27 09:39:53] INFO:     127.0.0.1:40084 - "GET /v1/models HTTP/1.1" 200 OK
    [2026-05-27 09:39:53] INFO:     127.0.0.1:40098 - "GET /model_info HTTP/1.1" 200 OK


    [2026-05-27 09:39:55] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-05-27 09:39:55] LoRA expand (K=6144, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-05-27 09:39:55] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-05-27 09:39:55] LoRA expand (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}


    [2026-05-27 09:39:55] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-05-27 09:39:55] LoRA expand (K=28672, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-05-27 09:39:55] LoRA shrink (K=14336, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-05-27 09:39:55] Prefill batch, #new-seq: 1, #new-token: 7, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 2.02


    [2026-05-27 09:39:56] INFO:     127.0.0.1:40112 - "POST /generate HTTP/1.1" 200 OK
    [2026-05-27 09:39:56] The server is fired up and ready to roll!
...
```
    ...
    [2026-05-27 09:39:58] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-27 09:39:58] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-05-27 09:39:58] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-05-27 09:39:59] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-27 09:39:59] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-05-27 09:39:59] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-05-27 09:40:00] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-27 09:40:00] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-05-27 09:40:00] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-05-27 09:40:01] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-05-27 09:40:01] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-27 09:40:01] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-05-27 09:40:02] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-27 09:40:02] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-05-27 09:40:02] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 2, #pending-token: 18, cuda graph: False, input throughput (token/s): 1.41
    [2026-05-27 09:40:02] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-27 09:40:02] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-05-27 09:40:03] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].


    [2026-05-27 09:40:07] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 1, #pending-token: 9, cuda graph: False, input throughput (token/s): 1.79


    [2026-05-27 09:40:07] Decode batch, #running-req: 2, #token: 79, token usage: 0.00, cuda graph: False, gen throughput (token/s): 4.34, #queue-req: 1


    [2026-05-27 09:40:08] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-05-27 09:40:08] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 6.01
    [2026-05-27 09:40:08] Decode batch, #running-req: 2, #token: 93, token usage: 0.00, cuda graph: False, gen throughput (token/s): 74.72, #queue-req: 0


    [2026-05-27 09:40:09] Decode batch, #running-req: 2, #token: 173, token usage: 0.01, cuda graph: False, gen throughput (token/s): 106.83, #queue-req: 0


    [2026-05-27 09:40:10] Decode batch, #running-req: 1, #token: 157, token usage: 0.01, cuda graph: False, gen throughput (token/s): 74.59, #queue-req: 0


    [2026-05-27 09:40:11] Decode batch, #running-req: 1, #token: 197, token usage: 0.01, cuda graph: False, gen throughput (token/s): 47.63, #queue-req: 0


    [2026-05-27 09:40:12] Decode batch, #running-req: 1, #token: 237, token usage: 0.01, cuda graph: False, gen throughput (token/s): 47.30, #queue-req: 0


    [2026-05-27 09:40:13] Decode batch, #running-req: 1, #token: 277, token usage: 0.01, cuda graph: False, gen throughput (token/s): 48.35, #queue-req: 0


    [2026-05-27 09:40:13] Decode batch, #running-req: 1, #token: 317, token usage: 0.02, cuda graph: False, gen throughput (token/s): 48.51, #queue-req: 0


    [2026-05-27 09:40:14] Decode batch, #running-req: 1, #token: 357, token usage: 0.02, cuda graph: False, gen throughput (token/s): 50.35, #queue-req: 0


    [2026-05-27 09:40:15] Decode batch, #running-req: 1, #token: 397, token usage: 0.02, cuda graph: False, gen throughput (token/s): 54.59, #queue-req: 0


    [2026-05-27 09:40:16] Decode batch, #running-req: 1, #token: 437, token usage: 0.02, cuda graph: False, gen throughput (token/s): 54.38, #queue-req: 0


    [2026-05-27 09:40:16] Decode batch, #running-req: 1, #token: 477, token usage: 0.02, cuda graph: False, gen throughput (token/s): 50.09, #queue-req: 0


    [2026-05-27 09:40:17] Decode batch, #running-req: 1, #token: 517, token usage: 0.03, cuda graph: False, gen throughput (token/s): 49.01, #queue-req: 0


    [2026-05-27 09:40:18] Decode batch, #running-req: 1, #token: 557, token usage: 0.03, cuda graph: False, gen throughput (token/s): 49.83, #queue-req: 0


    [2026-05-27 09:40:19] Decode batch, #running-req: 1, #token: 597, token usage: 0.03, cuda graph: False, gen throughput (token/s): 50.57, #queue-req: 0


    [2026-05-27 09:40:20] Decode batch, #running-req: 1, #token: 637, token usage: 0.03, cuda graph: False, gen throughput (token/s): 51.80, #queue-req: 0


    [2026-05-27 09:40:20] Decode batch, #running-req: 1, #token: 677, token usage: 0.03, cuda graph: False, gen throughput (token/s): 53.05, #queue-req: 0


    [2026-05-27 09:40:21] Decode batch, #running-req: 1, #token: 717, token usage: 0.04, cuda graph: False, gen throughput (token/s): 53.15, #queue-req: 0


    [2026-05-27 09:40:22] Decode batch, #running-req: 1, #token: 757, token usage: 0.04, cuda graph: False, gen throughput (token/s): 53.56, #queue-req: 0


    [2026-05-27 09:40:23] Decode batch, #running-req: 1, #token: 797, token usage: 0.04, cuda graph: False, gen throughput (token/s): 53.91, #queue-req: 0


    [2026-05-27 09:40:23] Decode batch, #running-req: 1, #token: 837, token usage: 0.04, cuda graph: False, gen throughput (token/s): 55.95, #queue-req: 0


    [2026-05-27 09:40:24] Decode batch, #running-req: 1, #token: 877, token usage: 0.04, cuda graph: False, gen throughput (token/s): 57.08, #queue-req: 0


    [2026-05-27 09:40:25] Decode batch, #running-req: 1, #token: 917, token usage: 0.04, cuda graph: False, gen throughput (token/s): 55.84, #queue-req: 0


    [2026-05-27 09:40:25] Decode batch, #running-req: 1, #token: 957, token usage: 0.05, cuda graph: False, gen throughput (token/s): 56.72, #queue-req: 0


    [2026-05-27 09:40:26] Decode batch, #running-req: 1, #token: 997, token usage: 0.05, cuda graph: False, gen throughput (token/s): 54.58, #queue-req: 0


    [2026-05-27 09:40:27] INFO:     127.0.0.1:40118 - "POST /generate HTTP/1.1" 200 OK
    Output from lora0: 
