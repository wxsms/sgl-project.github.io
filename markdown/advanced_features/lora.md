LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-05-19 22:15:47] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 4.87
    [2026-05-19 22:15:47] Decode batch, #running-req: 2, #token: 103, token usage: 0.01, cuda graph: False, gen throughput (token/s): 59.85, #queue-req: 0


    [2026-05-19 22:15:48] Decode batch, #running-req: 2, #token: 183, token usage: 0.01, cuda graph: False, gen throughput (token/s): 79.18, #queue-req: 0


    [2026-05-19 22:15:49] Decode batch, #running-req: 1, #token: 169, token usage: 0.01, cuda graph: False, gen throughput (token/s): 65.00, #queue-req: 0


    [2026-05-19 22:15:50] Decode batch, #running-req: 1, #token: 209, token usage: 0.01, cuda graph: False, gen throughput (token/s): 47.45, #queue-req: 0


    [2026-05-19 22:15:51] Decode batch, #running-req: 1, #token: 249, token usage: 0.01, cuda graph: False, gen throughput (token/s): 48.51, #queue-req: 0


    [2026-05-19 22:15:52] Decode batch, #running-req: 1, #token: 289, token usage: 0.01, cuda graph: False, gen throughput (token/s): 48.97, #queue-req: 0


    [2026-05-19 22:15:52] Decode batch, #running-req: 1, #token: 329, token usage: 0.02, cuda graph: False, gen throughput (token/s): 48.98, #queue-req: 0


    [2026-05-19 22:15:53] Decode batch, #running-req: 1, #token: 369, token usage: 0.02, cuda graph: False, gen throughput (token/s): 44.22, #queue-req: 0


    [2026-05-19 22:15:54] Decode batch, #running-req: 1, #token: 409, token usage: 0.02, cuda graph: False, gen throughput (token/s): 45.60, #queue-req: 0


    [2026-05-19 22:15:55] Decode batch, #running-req: 1, #token: 449, token usage: 0.02, cuda graph: False, gen throughput (token/s): 42.64, #queue-req: 0


    [2026-05-19 22:15:56] Decode batch, #running-req: 1, #token: 489, token usage: 0.02, cuda graph: False, gen throughput (token/s): 43.13, #queue-req: 0


    [2026-05-19 22:15:57] Decode batch, #running-req: 1, #token: 529, token usage: 0.03, cuda graph: False, gen throughput (token/s): 52.79, #queue-req: 0


    [2026-05-19 22:15:57] Decode batch, #running-req: 1, #token: 569, token usage: 0.03, cuda graph: False, gen throughput (token/s): 54.67, #queue-req: 0


    [2026-05-19 22:15:58] Decode batch, #running-req: 1, #token: 609, token usage: 0.03, cuda graph: False, gen throughput (token/s): 54.40, #queue-req: 0


    [2026-05-19 22:15:59] Decode batch, #running-req: 1, #token: 649, token usage: 0.03, cuda graph: False, gen throughput (token/s): 53.20, #queue-req: 0


    [2026-05-19 22:16:00] Decode batch, #running-req: 1, #token: 689, token usage: 0.03, cuda graph: False, gen throughput (token/s): 51.22, #queue-req: 0


    [2026-05-19 22:16:01] Decode batch, #running-req: 1, #token: 729, token usage: 0.04, cuda graph: False, gen throughput (token/s): 50.59, #queue-req: 0


    [2026-05-19 22:16:01] Decode batch, #running-req: 1, #token: 769, token usage: 0.04, cuda graph: False, gen throughput (token/s): 50.09, #queue-req: 0


    [2026-05-19 22:16:02] Decode batch, #running-req: 1, #token: 809, token usage: 0.04, cuda graph: False, gen throughput (token/s): 50.79, #queue-req: 0


    [2026-05-19 22:16:03] Decode batch, #running-req: 1, #token: 849, token usage: 0.04, cuda graph: False, gen throughput (token/s): 51.76, #queue-req: 0


    [2026-05-19 22:16:04] Decode batch, #running-req: 1, #token: 889, token usage: 0.04, cuda graph: False, gen throughput (token/s): 51.04, #queue-req: 0


    [2026-05-19 22:16:05] Decode batch, #running-req: 1, #token: 929, token usage: 0.05, cuda graph: False, gen throughput (token/s): 47.92, #queue-req: 0


    [2026-05-19 22:16:05] Decode batch, #running-req: 1, #token: 969, token usage: 0.05, cuda graph: False, gen throughput (token/s): 47.83, #queue-req: 0


    [2026-05-19 22:16:06] Decode batch, #running-req: 1, #token: 1009, token usage: 0.05, cuda graph: False, gen throughput (token/s): 48.48, #queue-req: 0


    [2026-05-19 22:16:07] INFO:     127.0.0.1:34020 - "POST /generate HTTP/1.1" 200 OK
    Output from lora0: 
