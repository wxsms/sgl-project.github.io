...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 181.59it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 371.54it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 186.56it/s]
...
```
    ...
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 6579.30it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 365.71it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 22104.37it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 100462.37it/s]


    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 176.39it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 184.97it/s]
...
```
    ...
    [2026-06-03 18:08:48] Load weight end. elapsed=3.05 s, type=LlamaForCausalLM, avail mem=63.48 GB, mem usage=-3.33 GB.
    [2026-06-03 18:08:48] Using csgmv as backend of LoRA kernels.
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 19972.88it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 83055.52it/s]
    [2026-06-03 18:08:48] Found local HF snapshot for Nutanix/Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json at /root/.cache/huggingface/hub/models--Nutanix--Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json/snapshots/2c398740f3eba8dc63ee78999316b833a2833b6c; skipping download.
    ...
    [2026-06-03 18:08:48] Found local HF snapshot for algoprog/fact-generation-llama-3.1-8b-instruct-lora at /root/.cache/huggingface/hub/models--algoprog--fact-generation-llama-3.1-8b-instruct-lora/snapshots/dc8cdfb21993a6cb46199d6b1d79f68a42b06439; skipping download.
    ...
    [2026-06-03 18:08:49] Found local HF snapshot for philschmid/code-llama-3-1-8b-text-to-sql-lora at /root/.cache/huggingface/hub/models--philschmid--code-llama-3-1-8b-text-to-sql-lora/snapshots/141fc3a09386a8baf0d7495c247ae2d1a565f69f; skipping download.
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 115.59it/s]


    [2026-06-03 18:08:50] Max concurrent requests (per dp worker) from the finalized token capacity: max_num_reqs=128.
    [2026-06-03 18:08:50] KV Cache is allocated. dtype: torch.bfloat16, #tokens: 20480, K size: 1.25 GB, V size: 1.25 GB
    [2026-06-03 18:08:50] Memory pool end. avail mem=58.26 GB
    [2026-06-03 18:08:50] Disable piecewise CUDA graph because --disable-piecewise-cuda-graph is set


    [2026-06-03 18:08:54] max_total_num_tokens=20480, chunked_prefill_size=8192, max_prefill_tokens=16384, max_running_requests=128, context_len=131072, available_gpu_mem=56.42 GB
    [2026-06-03 18:08:54] Tree cache initialized: source=default impl=RadixCache hybrid_swa=False hybrid_ssm=False hierarchical=False streaming_wrapped=False


    [2026-06-03 18:08:54] INFO:     Started server process [667413]
    [2026-06-03 18:08:54] INFO:     Waiting for application startup.
    [2026-06-03 18:08:54] Using default chat sampling params from model generation config: {'temperature': 0.6, 'top_p': 0.9}
    [2026-06-03 18:08:54] INFO:     Application startup complete.
    [2026-06-03 18:08:54] INFO:     Uvicorn running on http://127.0.0.1:30272 (Press CTRL+C to quit)


    /usr/local/lib/python3.10/dist-packages/fastapi/routing.py:120: FastAPIDeprecationWarning: ORJSONResponse is deprecated, FastAPI now serializes data directly to JSON bytes via Pydantic when a return type or response model is set, which is faster and doesn't need a custom response class. Read more in the FastAPI docs: https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model and https://fastapi.tiangolo.com/tutorial/response-model/
      response = await f(request)
    [2026-06-03 18:08:55] INFO:     127.0.0.1:50408 - "GET /v1/models HTTP/1.1" 200 OK
    [2026-06-03 18:08:55] INFO:     127.0.0.1:50424 - "GET /model_info HTTP/1.1" 200 OK


    [2026-06-03 18:08:56] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-03 18:08:56] LoRA expand (K=6144, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-03 18:08:56] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-03 18:08:56] LoRA expand (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}


    [2026-06-03 18:08:57] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-03 18:08:57] LoRA expand (K=28672, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-03 18:08:57] LoRA shrink (K=14336, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}


    [2026-06-03 18:08:57] Prefill batch, #new-seq: 1, #new-token: 7, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 2.41
    [2026-06-03 18:08:57] INFO:     127.0.0.1:50426 - "POST /generate HTTP/1.1" 200 OK
    [2026-06-03 18:08:57] The server is fired up and ready to roll!
...
```
    ...
    [2026-06-03 18:09:00] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-03 18:09:00] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-03 18:09:01] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-03 18:09:03] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-03 18:09:03] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-03 18:09:03] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-03 18:09:03] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-03 18:09:03] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-03 18:09:04] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-03 18:09:04] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 2, #pending-token: 18, cuda graph: False, input throughput (token/s): 1.32
    [2026-06-03 18:09:04] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 1, #pending-token: 9, cuda graph: False, input throughput (token/s): 72.84


    [2026-06-03 18:09:05] Decode batch, #running-req: 2, #token: 83, token usage: 0.00, cuda graph: False, gen throughput (token/s): 6.76, #queue-req: 1


    [2026-06-03 18:09:05] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-03 18:09:06] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 5.53
    [2026-06-03 18:09:06] Decode batch, #running-req: 2, #token: 93, token usage: 0.00, cuda graph: False, gen throughput (token/s): 73.05, #queue-req: 0


    [2026-06-03 18:09:07] Decode batch, #running-req: 2, #token: 173, token usage: 0.01, cuda graph: False, gen throughput (token/s): 81.25, #queue-req: 0


    [2026-06-03 18:09:07] Decode batch, #running-req: 1, #token: 161, token usage: 0.01, cuda graph: False, gen throughput (token/s): 72.91, #queue-req: 0


    [2026-06-03 18:09:08] Decode batch, #running-req: 1, #token: 201, token usage: 0.01, cuda graph: False, gen throughput (token/s): 58.18, #queue-req: 0


    [2026-06-03 18:09:09] Decode batch, #running-req: 1, #token: 241, token usage: 0.01, cuda graph: False, gen throughput (token/s): 57.05, #queue-req: 0


    [2026-06-03 18:09:10] Decode batch, #running-req: 1, #token: 281, token usage: 0.01, cuda graph: False, gen throughput (token/s): 51.97, #queue-req: 0


    [2026-06-03 18:09:10] Decode batch, #running-req: 1, #token: 321, token usage: 0.02, cuda graph: False, gen throughput (token/s): 47.90, #queue-req: 0


    [2026-06-03 18:09:11] Decode batch, #running-req: 1, #token: 361, token usage: 0.02, cuda graph: False, gen throughput (token/s): 49.54, #queue-req: 0


    [2026-06-03 18:09:12] Decode batch, #running-req: 1, #token: 401, token usage: 0.02, cuda graph: False, gen throughput (token/s): 50.95, #queue-req: 0


    [2026-06-03 18:09:13] Decode batch, #running-req: 1, #token: 441, token usage: 0.02, cuda graph: False, gen throughput (token/s): 51.71, #queue-req: 0


    [2026-06-03 18:09:14] Decode batch, #running-req: 1, #token: 481, token usage: 0.02, cuda graph: False, gen throughput (token/s): 54.30, #queue-req: 0


    [2026-06-03 18:09:14] Decode batch, #running-req: 1, #token: 521, token usage: 0.03, cuda graph: False, gen throughput (token/s): 54.59, #queue-req: 0


    [2026-06-03 18:09:15] Decode batch, #running-req: 1, #token: 561, token usage: 0.03, cuda graph: False, gen throughput (token/s): 58.07, #queue-req: 0


    [2026-06-03 18:09:16] Decode batch, #running-req: 1, #token: 601, token usage: 0.03, cuda graph: False, gen throughput (token/s): 59.07, #queue-req: 0


    [2026-06-03 18:09:16] Decode batch, #running-req: 1, #token: 641, token usage: 0.03, cuda graph: False, gen throughput (token/s): 58.95, #queue-req: 0


    [2026-06-03 18:09:17] Decode batch, #running-req: 1, #token: 681, token usage: 0.03, cuda graph: False, gen throughput (token/s): 58.98, #queue-req: 0


    [2026-06-03 18:09:18] Decode batch, #running-req: 1, #token: 721, token usage: 0.04, cuda graph: False, gen throughput (token/s): 58.09, #queue-req: 0


    [2026-06-03 18:09:18] Decode batch, #running-req: 1, #token: 761, token usage: 0.04, cuda graph: False, gen throughput (token/s): 58.27, #queue-req: 0


    [2026-06-03 18:09:19] Decode batch, #running-req: 1, #token: 801, token usage: 0.04, cuda graph: False, gen throughput (token/s): 58.37, #queue-req: 0


    [2026-06-03 18:09:20] Decode batch, #running-req: 1, #token: 841, token usage: 0.04, cuda graph: False, gen throughput (token/s): 58.23, #queue-req: 0


    [2026-06-03 18:09:20] Decode batch, #running-req: 1, #token: 881, token usage: 0.04, cuda graph: False, gen throughput (token/s): 58.26, #queue-req: 0


    [2026-06-03 18:09:21] Decode batch, #running-req: 1, #token: 921, token usage: 0.04, cuda graph: False, gen throughput (token/s): 52.38, #queue-req: 0


    [2026-06-03 18:09:22] Decode batch, #running-req: 1, #token: 961, token usage: 0.05, cuda graph: False, gen throughput (token/s): 58.31, #queue-req: 0


    [2026-06-03 18:09:23] Decode batch, #running-req: 1, #token: 1001, token usage: 0.05, cuda graph: False, gen throughput (token/s): 58.90, #queue-req: 0


    [2026-06-03 18:09:23] INFO:     127.0.0.1:50428 - "POST /generate HTTP/1.1" 200 OK
    Output from lora0: 
