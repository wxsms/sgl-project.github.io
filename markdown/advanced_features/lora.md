...
```
    ...
    Multi-thread loading shards:  25% Completed | 1/4 [00:03<00:09,  3.16s/it]

    Multi-thread loading shards:  50% Completed | 2/4 [00:05<00:05,  2.77s/it]

    Multi-thread loading shards:  75% Completed | 3/4 [00:08<00:02,  2.64s/it]

    Multi-thread loading shards: 100% Completed | 4/4 [00:08<00:00,  1.92s/it]Multi-thread loading shards: 100% Completed | 4/4 [00:08<00:00,  2.24s/it]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 324.49it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 122.52it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 161.75it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 306.78it/s]
    ...
    Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 122.90it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 105.39it/s]
...
```
    ...
    [2026-05-31 07:43:05] Load weight end. elapsed=4.90 s, type=LlamaForCausalLM, avail mem=63.48 GB, mem usage=15.02 GB.
    [2026-05-31 07:43:05] Using csgmv as backend of LoRA kernels.
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 10161.85it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 15128.24it/s]
    [2026-05-31 07:43:05] Found local HF snapshot for Nutanix/Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json at /root/.cache/huggingface/hub/models--Nutanix--Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json/snapshots/2c398740f3eba8dc63ee78999316b833a2833b6c; skipping download.
    ...
    [2026-05-31 07:43:05] Found local HF snapshot for algoprog/fact-generation-llama-3.1-8b-instruct-lora at /root/.cache/huggingface/hub/models--algoprog--fact-generation-llama-3.1-8b-instruct-lora/snapshots/dc8cdfb21993a6cb46199d6b1d79f68a42b06439; skipping download.
    ...
    [2026-05-31 07:43:06] Found local HF snapshot for philschmid/code-llama-3-1-8b-text-to-sql-lora at /root/.cache/huggingface/hub/models--philschmid--code-llama-3-1-8b-text-to-sql-lora/snapshots/141fc3a09386a8baf0d7495c247ae2d1a565f69f; skipping download.


    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 117.06it/s]


    [2026-05-31 07:43:07] Max concurrent requests (per dp worker) from the finalized token capacity: max_num_reqs=128.
    [2026-05-31 07:43:07] KV Cache is allocated. dtype: torch.bfloat16, #tokens: 20480, K size: 1.25 GB, V size: 1.25 GB
    [2026-05-31 07:43:07] Memory pool end. avail mem=58.26 GB
    [2026-05-31 07:43:07] Disable piecewise CUDA graph because --disable-piecewise-cuda-graph is set


    [2026-05-31 07:43:13] max_total_num_tokens=20480, chunked_prefill_size=8192, max_prefill_tokens=16384, max_running_requests=128, context_len=131072, available_gpu_mem=57.49 GB
    [2026-05-31 07:43:13] Tree cache initialized: source=default impl=RadixCache hybrid_swa=False hybrid_ssm=False hierarchical=False streaming_wrapped=False


    [2026-05-31 07:43:13] INFO:     Started server process [2260652]
    [2026-05-31 07:43:13] INFO:     Waiting for application startup.
    [2026-05-31 07:43:13] Using default chat sampling params from model generation config: {'temperature': 0.6, 'top_p': 0.9}
    [2026-05-31 07:43:13] INFO:     Application startup complete.
    [2026-05-31 07:43:13] INFO:     Uvicorn running on http://127.0.0.1:38922 (Press CTRL+C to quit)


    /usr/local/lib/python3.10/dist-packages/fastapi/routing.py:120: FastAPIDeprecationWarning: ORJSONResponse is deprecated, FastAPI now serializes data directly to JSON bytes via Pydantic when a return type or response model is set, which is faster and doesn't need a custom response class. Read more in the FastAPI docs: https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model and https://fastapi.tiangolo.com/tutorial/response-model/
      response = await f(request)
    [2026-05-31 07:43:14] INFO:     127.0.0.1:60626 - "GET /v1/models HTTP/1.1" 200 OK


    [2026-05-31 07:43:14] INFO:     127.0.0.1:60636 - "GET /model_info HTTP/1.1" 200 OK


    [2026-05-31 07:43:15] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-05-31 07:43:15] LoRA expand (K=6144, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-05-31 07:43:15] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-05-31 07:43:15] LoRA expand (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}


    [2026-05-31 07:43:16] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-05-31 07:43:16] LoRA expand (K=28672, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-05-31 07:43:16] LoRA shrink (K=14336, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}


    [2026-05-31 07:43:16] Prefill batch, #new-seq: 1, #new-token: 7, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 2.14
    [2026-05-31 07:43:16] INFO:     127.0.0.1:60648 - "POST /generate HTTP/1.1" 200 OK
    [2026-05-31 07:43:16] The server is fired up and ready to roll!
...
```
    ...
    [2026-05-31 07:43:19] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-31 07:43:19] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-05-31 07:43:19] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-05-31 07:43:21] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-31 07:43:21] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-05-31 07:43:22] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-31 07:43:22] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-05-31 07:43:22] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 2, #pending-token: 18, cuda graph: False, input throughput (token/s): 1.56
    [2026-05-31 07:43:22] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-31 07:43:22] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-05-31 07:43:22] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-31 07:43:22] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-05-31 07:43:22] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-31 07:43:22] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 1, #pending-token: 9, cuda graph: False, input throughput (token/s): 20.45


    [2026-05-31 07:43:23] Decode batch, #running-req: 2, #token: 80, token usage: 0.00, cuda graph: False, gen throughput (token/s): 6.74, #queue-req: 1


    [2026-05-31 07:43:24] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-05-31 07:43:24] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 5.98
    [2026-05-31 07:43:24] Decode batch, #running-req: 2, #token: 94, token usage: 0.00, cuda graph: False, gen throughput (token/s): 76.04, #queue-req: 0


    [2026-05-31 07:43:25] Decode batch, #running-req: 2, #token: 174, token usage: 0.01, cuda graph: False, gen throughput (token/s): 96.55, #queue-req: 0


    [2026-05-31 07:43:26] Decode batch, #running-req: 1, #token: 158, token usage: 0.01, cuda graph: False, gen throughput (token/s): 71.12, #queue-req: 0


    [2026-05-31 07:43:26] Decode batch, #running-req: 1, #token: 198, token usage: 0.01, cuda graph: False, gen throughput (token/s): 51.10, #queue-req: 0


    [2026-05-31 07:43:27] Decode batch, #running-req: 1, #token: 238, token usage: 0.01, cuda graph: False, gen throughput (token/s): 50.40, #queue-req: 0


    [2026-05-31 07:43:28] Decode batch, #running-req: 1, #token: 278, token usage: 0.01, cuda graph: False, gen throughput (token/s): 51.58, #queue-req: 0


    [2026-05-31 07:43:29] Decode batch, #running-req: 1, #token: 318, token usage: 0.02, cuda graph: False, gen throughput (token/s): 51.31, #queue-req: 0


    [2026-05-31 07:43:29] Decode batch, #running-req: 1, #token: 358, token usage: 0.02, cuda graph: False, gen throughput (token/s): 50.54, #queue-req: 0


    [2026-05-31 07:43:30] Decode batch, #running-req: 1, #token: 398, token usage: 0.02, cuda graph: False, gen throughput (token/s): 49.50, #queue-req: 0


    [2026-05-31 07:43:31] Decode batch, #running-req: 1, #token: 438, token usage: 0.02, cuda graph: False, gen throughput (token/s): 49.51, #queue-req: 0


    [2026-05-31 07:43:32] Decode batch, #running-req: 1, #token: 478, token usage: 0.02, cuda graph: False, gen throughput (token/s): 50.44, #queue-req: 0


    [2026-05-31 07:43:33] Decode batch, #running-req: 1, #token: 518, token usage: 0.03, cuda graph: False, gen throughput (token/s): 48.76, #queue-req: 0


    [2026-05-31 07:43:34] Decode batch, #running-req: 1, #token: 558, token usage: 0.03, cuda graph: False, gen throughput (token/s): 48.56, #queue-req: 0


    [2026-05-31 07:43:35] Decode batch, #running-req: 1, #token: 598, token usage: 0.03, cuda graph: False, gen throughput (token/s): 39.12, #queue-req: 0


    [2026-05-31 07:43:35] Decode batch, #running-req: 1, #token: 638, token usage: 0.03, cuda graph: False, gen throughput (token/s): 45.79, #queue-req: 0


    [2026-05-31 07:43:36] Decode batch, #running-req: 1, #token: 678, token usage: 0.03, cuda graph: False, gen throughput (token/s): 45.57, #queue-req: 0


    [2026-05-31 07:43:37] Decode batch, #running-req: 1, #token: 718, token usage: 0.04, cuda graph: False, gen throughput (token/s): 46.23, #queue-req: 0


    [2026-05-31 07:43:38] Decode batch, #running-req: 1, #token: 758, token usage: 0.04, cuda graph: False, gen throughput (token/s): 45.89, #queue-req: 0


    [2026-05-31 07:43:39] Decode batch, #running-req: 1, #token: 798, token usage: 0.04, cuda graph: False, gen throughput (token/s): 46.53, #queue-req: 0


    [2026-05-31 07:43:40] Decode batch, #running-req: 1, #token: 838, token usage: 0.04, cuda graph: False, gen throughput (token/s): 47.56, #queue-req: 0


    [2026-05-31 07:43:41] Decode batch, #running-req: 1, #token: 878, token usage: 0.04, cuda graph: False, gen throughput (token/s): 48.24, #queue-req: 0


    [2026-05-31 07:43:41] Decode batch, #running-req: 1, #token: 918, token usage: 0.04, cuda graph: False, gen throughput (token/s): 43.79, #queue-req: 0


    [2026-05-31 07:43:42] Decode batch, #running-req: 1, #token: 958, token usage: 0.05, cuda graph: False, gen throughput (token/s): 49.37, #queue-req: 0


    [2026-05-31 07:43:43] Decode batch, #running-req: 1, #token: 998, token usage: 0.05, cuda graph: False, gen throughput (token/s): 49.18, #queue-req: 0


    [2026-05-31 07:43:44] INFO:     127.0.0.1:60654 - "POST /generate HTTP/1.1" 200 OK
    Output from lora0: 
