...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 185.30it/s]
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 350.52it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 376.27it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 40041.09it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 22017.34it/s]
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 193.07it/s]
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 110.63it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 182.49it/s]
...
```
    ...
    [2026-06-09 19:45:07] Load weight end. elapsed=3.01 s, type=LlamaForCausalLM, avail mem=43.90 GB, mem usage=15.14 GB.
    [2026-06-09 19:45:07] Using csgmv as backend of LoRA kernels.
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 10040.23it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 21845.33it/s]
    [2026-06-09 19:45:07] Found local HF snapshot for Nutanix/Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json at /root/.cache/huggingface/hub/models--Nutanix--Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json/snapshots/2c398740f3eba8dc63ee78999316b833a2833b6c; skipping download.
    ...
    [2026-06-09 19:45:08] Found local HF snapshot for algoprog/fact-generation-llama-3.1-8b-instruct-lora at /root/.cache/huggingface/hub/models--algoprog--fact-generation-llama-3.1-8b-instruct-lora/snapshots/dc8cdfb21993a6cb46199d6b1d79f68a42b06439; skipping download.


    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 187.91it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 91678.78it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 91678.78it/s]
    [2026-06-09 19:45:08] Found local HF snapshot for philschmid/code-llama-3-1-8b-text-to-sql-lora at /root/.cache/huggingface/hub/models--philschmid--code-llama-3-1-8b-text-to-sql-lora/snapshots/141fc3a09386a8baf0d7495c247ae2d1a565f69f; skipping download.


    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 118.44it/s]


    [2026-06-09 19:45:09] Max concurrent requests (per dp worker) from the finalized token capacity: max_num_reqs=128.
    [2026-06-09 19:45:09] KV Cache is allocated. dtype: torch.bfloat16, #tokens: 20480, K size: 1.25 GB, V size: 1.25 GB
    [2026-06-09 19:45:09] Memory pool end. avail mem=38.62 GB
    [2026-06-09 19:45:09] Disable piecewise CUDA graph because --disable-piecewise-cuda-graph is set


    [2026-06-09 19:45:15] max_total_num_tokens=20480, chunked_prefill_size=8192, max_prefill_tokens=16384, max_running_requests=128, context_len=131072, available_gpu_mem=37.86 GB
    [2026-06-09 19:45:15] Tree cache initialized: source=default impl=RadixCache hybrid_swa=False hybrid_ssm=False hierarchical=False streaming_wrapped=False


    [2026-06-09 19:45:15] INFO:     Started server process [967615]
    [2026-06-09 19:45:15] INFO:     Waiting for application startup.
    [2026-06-09 19:45:15] Using default chat sampling params from model generation config: {'temperature': 0.6, 'top_p': 0.9}
    [2026-06-09 19:45:15] INFO:     Application startup complete.
    [2026-06-09 19:45:15] INFO:     Uvicorn running on http://127.0.0.1:30689 (Press CTRL+C to quit)
    /usr/local/lib/python3.10/dist-packages/fastapi/routing.py:120: FastAPIDeprecationWarning: ORJSONResponse is deprecated, FastAPI now serializes data directly to JSON bytes via Pydantic when a return type or response model is set, which is faster and doesn't need a custom response class. Read more in the FastAPI docs: https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model and https://fastapi.tiangolo.com/tutorial/response-model/
      response = await f(request)
    [2026-06-09 19:45:15] INFO:     127.0.0.1:45476 - "GET /v1/models HTTP/1.1" 200 OK


    [2026-06-09 19:45:16] INFO:     127.0.0.1:45482 - "GET /model_info HTTP/1.1" 200 OK


    [2026-06-09 19:45:17] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-09 19:45:17] LoRA expand (K=6144, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-09 19:45:17] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-09 19:45:17] LoRA expand (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}


    [2026-06-09 19:45:17] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-09 19:45:17] LoRA expand (K=28672, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-09 19:45:17] LoRA shrink (K=14336, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}


    [2026-06-09 19:45:18] Prefill batch, #new-seq: 1, #new-token: 7, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 2.30
    [2026-06-09 19:45:18] INFO:     127.0.0.1:45496 - "POST /generate HTTP/1.1" 200 OK
    [2026-06-09 19:45:18] The server is fired up and ready to roll!
...
```
    ...
    [2026-06-09 19:45:20] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-09 19:45:20] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-09 19:45:21] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-09 19:45:23] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-09 19:45:23] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-09 19:45:23] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-09 19:45:23] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-09 19:45:23] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-09 19:45:23] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 2, #pending-token: 18, cuda graph: False, input throughput (token/s): 1.64
    [2026-06-09 19:45:23] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-09 19:45:23] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-09 19:45:23] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-09 19:45:23] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-09 19:45:23] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-09 19:45:23] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-09 19:45:24] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-09 19:45:24] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-09 19:45:24] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-09 19:45:24] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-09 19:45:24] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-09 19:45:24] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-09 19:45:24] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-09 19:45:24] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 1, #pending-token: 9, cuda graph: False, input throughput (token/s): 7.73


    [2026-06-09 19:45:24] Decode batch, #running-req: 2, #token: 63, token usage: 0.00, cuda graph: False, gen throughput (token/s): 5.15, #queue-req: 1


    [2026-06-09 19:45:25] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-09 19:45:25] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 10.30


    [2026-06-09 19:45:25] Decode batch, #running-req: 2, #token: 78, token usage: 0.00, cuda graph: False, gen throughput (token/s): 99.20, #queue-req: 0


    [2026-06-09 19:45:26] Decode batch, #running-req: 2, #token: 158, token usage: 0.01, cuda graph: False, gen throughput (token/s): 104.24, #queue-req: 0


    [2026-06-09 19:45:27] Decode batch, #running-req: 1, #token: 141, token usage: 0.01, cuda graph: False, gen throughput (token/s): 76.49, #queue-req: 0


    [2026-06-09 19:45:28] Decode batch, #running-req: 1, #token: 181, token usage: 0.01, cuda graph: False, gen throughput (token/s): 53.55, #queue-req: 0


    [2026-06-09 19:45:28] Decode batch, #running-req: 1, #token: 221, token usage: 0.01, cuda graph: False, gen throughput (token/s): 54.64, #queue-req: 0


    [2026-06-09 19:45:29] Decode batch, #running-req: 1, #token: 261, token usage: 0.01, cuda graph: False, gen throughput (token/s): 55.71, #queue-req: 0


    [2026-06-09 19:45:30] Decode batch, #running-req: 1, #token: 301, token usage: 0.01, cuda graph: False, gen throughput (token/s): 54.70, #queue-req: 0


    [2026-06-09 19:45:30] Decode batch, #running-req: 1, #token: 341, token usage: 0.02, cuda graph: False, gen throughput (token/s): 55.40, #queue-req: 0


    [2026-06-09 19:45:31] Decode batch, #running-req: 1, #token: 381, token usage: 0.02, cuda graph: False, gen throughput (token/s): 53.88, #queue-req: 0


    [2026-06-09 19:45:32] Decode batch, #running-req: 1, #token: 421, token usage: 0.02, cuda graph: False, gen throughput (token/s): 53.45, #queue-req: 0


    [2026-06-09 19:45:33] Decode batch, #running-req: 1, #token: 461, token usage: 0.02, cuda graph: False, gen throughput (token/s): 52.54, #queue-req: 0


    [2026-06-09 19:45:33] Decode batch, #running-req: 1, #token: 501, token usage: 0.02, cuda graph: False, gen throughput (token/s): 51.24, #queue-req: 0


    [2026-06-09 19:45:34] Decode batch, #running-req: 1, #token: 541, token usage: 0.03, cuda graph: False, gen throughput (token/s): 53.50, #queue-req: 0


    [2026-06-09 19:45:35] Decode batch, #running-req: 1, #token: 581, token usage: 0.03, cuda graph: False, gen throughput (token/s): 53.90, #queue-req: 0


    [2026-06-09 19:45:36] Decode batch, #running-req: 1, #token: 621, token usage: 0.03, cuda graph: False, gen throughput (token/s): 52.62, #queue-req: 0


    [2026-06-09 19:45:36] Decode batch, #running-req: 1, #token: 661, token usage: 0.03, cuda graph: False, gen throughput (token/s): 54.89, #queue-req: 0


    [2026-06-09 19:45:37] Decode batch, #running-req: 1, #token: 701, token usage: 0.03, cuda graph: False, gen throughput (token/s): 55.60, #queue-req: 0


    [2026-06-09 19:45:38] Decode batch, #running-req: 1, #token: 741, token usage: 0.04, cuda graph: False, gen throughput (token/s): 55.94, #queue-req: 0


    [2026-06-09 19:45:39] Decode batch, #running-req: 1, #token: 781, token usage: 0.04, cuda graph: False, gen throughput (token/s): 56.55, #queue-req: 0


    [2026-06-09 19:45:39] Decode batch, #running-req: 1, #token: 821, token usage: 0.04, cuda graph: False, gen throughput (token/s): 57.12, #queue-req: 0


    [2026-06-09 19:45:40] Decode batch, #running-req: 1, #token: 861, token usage: 0.04, cuda graph: False, gen throughput (token/s): 57.18, #queue-req: 0


    [2026-06-09 19:45:41] Decode batch, #running-req: 1, #token: 901, token usage: 0.04, cuda graph: False, gen throughput (token/s): 57.78, #queue-req: 0


    [2026-06-09 19:45:41] Decode batch, #running-req: 1, #token: 941, token usage: 0.05, cuda graph: False, gen throughput (token/s): 55.63, #queue-req: 0


    [2026-06-09 19:45:42] Decode batch, #running-req: 1, #token: 981, token usage: 0.05, cuda graph: False, gen throughput (token/s): 54.59, #queue-req: 0


    [2026-06-09 19:45:43] Decode batch, #running-req: 1, #token: 1021, token usage: 0.05, cuda graph: False, gen throughput (token/s): 54.34, #queue-req: 0


    [2026-06-09 19:45:43] INFO:     127.0.0.1:45510 - "POST /generate HTTP/1.1" 200 OK
    Output from lora0: 
