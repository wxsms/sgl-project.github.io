...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 361.55it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 122.33it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 111.64it/s]
...
```
    ...
    [2026-06-02 14:31:40] Load weight end. elapsed=3.35 s, type=LlamaForCausalLM, avail mem=45.13 GB, mem usage=15.02 GB.
    [2026-06-02 14:31:40] Using csgmv as backend of LoRA kernels.
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 16878.49it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 102927.71it/s]
    [2026-06-02 14:31:40] Found local HF snapshot for Nutanix/Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json at /root/.cache/huggingface/hub/models--Nutanix--Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json/snapshots/2c398740f3eba8dc63ee78999316b833a2833b6c; skipping download.
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 366.06it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 10485.76it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 103563.06it/s]
    [2026-06-02 14:31:40] Found local HF snapshot for algoprog/fact-generation-llama-3.1-8b-instruct-lora at /root/.cache/huggingface/hub/models--algoprog--fact-generation-llama-3.1-8b-instruct-lora/snapshots/dc8cdfb21993a6cb46199d6b1d79f68a42b06439; skipping download.
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 175.43it/s]
    ...
    [2026-06-02 14:31:41] Found local HF snapshot for philschmid/code-llama-3-1-8b-text-to-sql-lora at /root/.cache/huggingface/hub/models--philschmid--code-llama-3-1-8b-text-to-sql-lora/snapshots/141fc3a09386a8baf0d7495c247ae2d1a565f69f; skipping download.
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 108.82it/s]


    [2026-06-02 14:31:42] Max concurrent requests (per dp worker) from the finalized token capacity: max_num_reqs=128.
    [2026-06-02 14:31:42] KV Cache is allocated. dtype: torch.bfloat16, #tokens: 20480, K size: 1.25 GB, V size: 1.25 GB
    [2026-06-02 14:31:42] Memory pool end. avail mem=58.26 GB
    [2026-06-02 14:31:42] Disable piecewise CUDA graph because --disable-piecewise-cuda-graph is set


    [2026-06-02 14:31:47] max_total_num_tokens=20480, chunked_prefill_size=8192, max_prefill_tokens=16384, max_running_requests=128, context_len=131072, available_gpu_mem=57.49 GB
    [2026-06-02 14:31:47] Tree cache initialized: source=default impl=RadixCache hybrid_swa=False hybrid_ssm=False hierarchical=False streaming_wrapped=False


    [2026-06-02 14:31:47] INFO:     Started server process [3995918]
    [2026-06-02 14:31:47] INFO:     Waiting for application startup.
    [2026-06-02 14:31:47] Using default chat sampling params from model generation config: {'temperature': 0.6, 'top_p': 0.9}
    [2026-06-02 14:31:47] INFO:     Application startup complete.
    [2026-06-02 14:31:47] INFO:     Uvicorn running on http://127.0.0.1:34604 (Press CTRL+C to quit)


    /usr/local/lib/python3.10/dist-packages/fastapi/routing.py:120: FastAPIDeprecationWarning: ORJSONResponse is deprecated, FastAPI now serializes data directly to JSON bytes via Pydantic when a return type or response model is set, which is faster and doesn't need a custom response class. Read more in the FastAPI docs: https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model and https://fastapi.tiangolo.com/tutorial/response-model/
      response = await f(request)
    [2026-06-02 14:31:48] INFO:     127.0.0.1:38592 - "GET /v1/models HTTP/1.1" 200 OK


    [2026-06-02 14:31:48] INFO:     127.0.0.1:38602 - "GET /model_info HTTP/1.1" 200 OK


    [2026-06-02 14:31:49] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-02 14:31:49] LoRA expand (K=6144, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-02 14:31:49] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-02 14:31:49] LoRA expand (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}


    [2026-06-02 14:31:49] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-02 14:31:49] LoRA expand (K=28672, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-02 14:31:49] LoRA shrink (K=14336, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}


    [2026-06-02 14:31:50] Prefill batch, #new-seq: 1, #new-token: 7, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 2.38
    [2026-06-02 14:31:50] INFO:     127.0.0.1:38618 - "POST /generate HTTP/1.1" 200 OK
    [2026-06-02 14:31:50] The server is fired up and ready to roll!
...
```
    ...
    [2026-06-02 14:31:53] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-02 14:31:53] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-02 14:31:53] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-02 14:31:55] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-02 14:31:55] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-02 14:31:55] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-02 14:31:55] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-02 14:31:55] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-02 14:31:55] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 2, #pending-token: 18, cuda graph: False, input throughput (token/s): 1.58
    [2026-06-02 14:31:55] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-02 14:31:55] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-02 14:31:55] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-02 14:31:55] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-02 14:31:55] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-02 14:31:55] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-02 14:31:56] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-02 14:31:56] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-02 14:31:56] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-02 14:31:56] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-02 14:31:56] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-02 14:31:56] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-02 14:31:56] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-02 14:31:56] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-02 14:31:56] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 1, #pending-token: 9, cuda graph: False, input throughput (token/s): 18.05


    [2026-06-02 14:31:56] Decode batch, #running-req: 2, #token: 75, token usage: 0.00, cuda graph: False, gen throughput (token/s): 6.56, #queue-req: 1


    [2026-06-02 14:31:57] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-02 14:31:57] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 7.86
    [2026-06-02 14:31:57] Decode batch, #running-req: 2, #token: 89, token usage: 0.00, cuda graph: False, gen throughput (token/s): 99.70, #queue-req: 0


    [2026-06-02 14:31:58] Decode batch, #running-req: 2, #token: 169, token usage: 0.01, cuda graph: False, gen throughput (token/s): 113.80, #queue-req: 0


    [2026-06-02 14:31:59] Decode batch, #running-req: 1, #token: 153, token usage: 0.01, cuda graph: False, gen throughput (token/s): 80.95, #queue-req: 0


    [2026-06-02 14:31:59] Decode batch, #running-req: 1, #token: 193, token usage: 0.01, cuda graph: False, gen throughput (token/s): 47.69, #queue-req: 0


    [2026-06-02 14:32:00] Decode batch, #running-req: 1, #token: 233, token usage: 0.01, cuda graph: False, gen throughput (token/s): 47.42, #queue-req: 0


    [2026-06-02 14:32:01] Decode batch, #running-req: 1, #token: 273, token usage: 0.01, cuda graph: False, gen throughput (token/s): 48.39, #queue-req: 0


    [2026-06-02 14:32:02] Decode batch, #running-req: 1, #token: 313, token usage: 0.02, cuda graph: False, gen throughput (token/s): 48.88, #queue-req: 0


    [2026-06-02 14:32:03] Decode batch, #running-req: 1, #token: 353, token usage: 0.02, cuda graph: False, gen throughput (token/s): 51.17, #queue-req: 0


    [2026-06-02 14:32:03] Decode batch, #running-req: 1, #token: 393, token usage: 0.02, cuda graph: False, gen throughput (token/s): 58.11, #queue-req: 0


    [2026-06-02 14:32:04] Decode batch, #running-req: 1, #token: 433, token usage: 0.02, cuda graph: False, gen throughput (token/s): 58.70, #queue-req: 0


    [2026-06-02 14:32:05] Decode batch, #running-req: 1, #token: 473, token usage: 0.02, cuda graph: False, gen throughput (token/s): 53.55, #queue-req: 0


    [2026-06-02 14:32:06] Decode batch, #running-req: 1, #token: 513, token usage: 0.03, cuda graph: False, gen throughput (token/s): 49.59, #queue-req: 0


    [2026-06-02 14:32:06] Decode batch, #running-req: 1, #token: 553, token usage: 0.03, cuda graph: False, gen throughput (token/s): 50.69, #queue-req: 0


    [2026-06-02 14:32:07] Decode batch, #running-req: 1, #token: 593, token usage: 0.03, cuda graph: False, gen throughput (token/s): 50.39, #queue-req: 0


    [2026-06-02 14:32:08] Decode batch, #running-req: 1, #token: 633, token usage: 0.03, cuda graph: False, gen throughput (token/s): 51.48, #queue-req: 0


    [2026-06-02 14:32:09] Decode batch, #running-req: 1, #token: 673, token usage: 0.03, cuda graph: False, gen throughput (token/s): 52.33, #queue-req: 0


    [2026-06-02 14:32:09] Decode batch, #running-req: 1, #token: 713, token usage: 0.03, cuda graph: False, gen throughput (token/s): 52.90, #queue-req: 0


    [2026-06-02 14:32:10] Decode batch, #running-req: 1, #token: 753, token usage: 0.04, cuda graph: False, gen throughput (token/s): 56.24, #queue-req: 0


    [2026-06-02 14:32:11] Decode batch, #running-req: 1, #token: 793, token usage: 0.04, cuda graph: False, gen throughput (token/s): 57.81, #queue-req: 0


    [2026-06-02 14:32:12] Decode batch, #running-req: 1, #token: 833, token usage: 0.04, cuda graph: False, gen throughput (token/s): 57.86, #queue-req: 0


    [2026-06-02 14:32:12] Decode batch, #running-req: 1, #token: 873, token usage: 0.04, cuda graph: False, gen throughput (token/s): 57.79, #queue-req: 0


    [2026-06-02 14:32:13] Decode batch, #running-req: 1, #token: 913, token usage: 0.04, cuda graph: False, gen throughput (token/s): 57.63, #queue-req: 0


    [2026-06-02 14:32:14] Decode batch, #running-req: 1, #token: 953, token usage: 0.05, cuda graph: False, gen throughput (token/s): 57.21, #queue-req: 0


    [2026-06-02 14:32:14] Decode batch, #running-req: 1, #token: 993, token usage: 0.05, cuda graph: False, gen throughput (token/s): 54.08, #queue-req: 0


    [2026-06-02 14:32:15] Decode batch, #running-req: 1, #token: 0, token usage: 0.00, cuda graph: False, gen throughput (token/s): 45.89, #queue-req: 0
    [2026-06-02 14:32:15] INFO:     127.0.0.1:38628 - "POST /generate HTTP/1.1" 200 OK
    Output from lora0: 
