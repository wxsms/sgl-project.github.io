...
```
    ...
    Multi-thread loading shards:  50% Completed | 2/4 [00:04<00:04,  2.28s/it]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 185.86it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 127.14it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 120.89it/s]
...
```
    ...
    [2026-06-06 17:27:58] Load weight end. elapsed=3.22 s, type=LlamaForCausalLM, avail mem=63.48 GB, mem usage=15.02 GB.
    [2026-06-06 17:27:58] Using csgmv as backend of LoRA kernels.
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 10248.76it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 18957.31it/s]
    [2026-06-06 17:27:59] Found local HF snapshot for Nutanix/Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json at /root/.cache/huggingface/hub/models--Nutanix--Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json/snapshots/2c398740f3eba8dc63ee78999316b833a2833b6c; skipping download.
    ...
    [2026-06-06 17:27:59] Found local HF snapshot for algoprog/fact-generation-llama-3.1-8b-instruct-lora at /root/.cache/huggingface/hub/models--algoprog--fact-generation-llama-3.1-8b-instruct-lora/snapshots/dc8cdfb21993a6cb46199d6b1d79f68a42b06439; skipping download.


    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 190.16it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 20020.54it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 88768.34it/s]
    [2026-06-06 17:27:59] Found local HF snapshot for philschmid/code-llama-3-1-8b-text-to-sql-lora at /root/.cache/huggingface/hub/models--philschmid--code-llama-3-1-8b-text-to-sql-lora/snapshots/141fc3a09386a8baf0d7495c247ae2d1a565f69f; skipping download.


    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 107.71it/s]


    [2026-06-06 17:28:01] Max concurrent requests (per dp worker) from the finalized token capacity: max_num_reqs=128.
    [2026-06-06 17:28:01] KV Cache is allocated. dtype: torch.bfloat16, #tokens: 20480, K size: 1.25 GB, V size: 1.25 GB
    [2026-06-06 17:28:01] Memory pool end. avail mem=58.26 GB
    [2026-06-06 17:28:01] Disable piecewise CUDA graph because --disable-piecewise-cuda-graph is set


    [2026-06-06 17:28:06] max_total_num_tokens=20480, chunked_prefill_size=8192, max_prefill_tokens=16384, max_running_requests=128, context_len=131072, available_gpu_mem=50.25 GB
    [2026-06-06 17:28:06] Tree cache initialized: source=default impl=RadixCache hybrid_swa=False hybrid_ssm=False hierarchical=False streaming_wrapped=False


    [2026-06-06 17:28:06] INFO:     Started server process [2360266]
    [2026-06-06 17:28:06] INFO:     Waiting for application startup.
    [2026-06-06 17:28:06] Using default chat sampling params from model generation config: {'temperature': 0.6, 'top_p': 0.9}
    [2026-06-06 17:28:06] INFO:     Application startup complete.
    [2026-06-06 17:28:06] INFO:     Uvicorn running on http://127.0.0.1:35586 (Press CTRL+C to quit)


    /usr/local/lib/python3.10/dist-packages/fastapi/routing.py:120: FastAPIDeprecationWarning: ORJSONResponse is deprecated, FastAPI now serializes data directly to JSON bytes via Pydantic when a return type or response model is set, which is faster and doesn't need a custom response class. Read more in the FastAPI docs: https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model and https://fastapi.tiangolo.com/tutorial/response-model/
      response = await f(request)
    [2026-06-06 17:28:07] INFO:     127.0.0.1:45390 - "GET /v1/models HTTP/1.1" 200 OK


    [2026-06-06 17:28:07] INFO:     127.0.0.1:45404 - "GET /model_info HTTP/1.1" 200 OK


    [2026-06-06 17:28:08] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-06 17:28:08] LoRA expand (K=6144, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-06 17:28:08] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-06 17:28:08] LoRA expand (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}


    [2026-06-06 17:28:09] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-06 17:28:09] LoRA expand (K=28672, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-06 17:28:09] LoRA shrink (K=14336, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}


    [2026-06-06 17:28:09] Prefill batch, #new-seq: 1, #new-token: 7, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 2.12
    [2026-06-06 17:28:09] INFO:     127.0.0.1:45416 - "POST /generate HTTP/1.1" 200 OK
    [2026-06-06 17:28:09] The server is fired up and ready to roll!
...
```
    ...
    [2026-06-06 17:28:12] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-06 17:28:12] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-06 17:28:12] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-06 17:28:14] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-06 17:28:14] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-06 17:28:14] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-06 17:28:15] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-06 17:28:15] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-06 17:28:15] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-06 17:28:15] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-06 17:28:15] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 2, #pending-token: 18, cuda graph: False, input throughput (token/s): 1.60
    [2026-06-06 17:28:15] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-06 17:28:15] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-06 17:28:15] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-06 17:28:15] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-06 17:28:15] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-06 17:28:15] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-06 17:28:16] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-06 17:28:16] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-06 17:28:16] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 1, #pending-token: 9, cuda graph: False, input throughput (token/s): 6.11
    [2026-06-06 17:28:16] Decode batch, #running-req: 2, #token: 59, token usage: 0.00, cuda graph: False, gen throughput (token/s): 4.45, #queue-req: 1


    [2026-06-06 17:28:17] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-06 17:28:17] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 8.74


    [2026-06-06 17:28:17] Decode batch, #running-req: 2, #token: 73, token usage: 0.00, cuda graph: False, gen throughput (token/s): 77.62, #queue-req: 0


    [2026-06-06 17:28:18] Decode batch, #running-req: 2, #token: 153, token usage: 0.01, cuda graph: False, gen throughput (token/s): 94.13, #queue-req: 0


    [2026-06-06 17:28:19] Decode batch, #running-req: 1, #token: 137, token usage: 0.01, cuda graph: False, gen throughput (token/s): 70.18, #queue-req: 0


    [2026-06-06 17:28:20] Decode batch, #running-req: 1, #token: 177, token usage: 0.01, cuda graph: False, gen throughput (token/s): 53.38, #queue-req: 0


    [2026-06-06 17:28:21] Decode batch, #running-req: 1, #token: 217, token usage: 0.01, cuda graph: False, gen throughput (token/s): 52.26, #queue-req: 0


    [2026-06-06 17:28:21] Decode batch, #running-req: 1, #token: 257, token usage: 0.01, cuda graph: False, gen throughput (token/s): 51.72, #queue-req: 0


    [2026-06-06 17:28:22] Decode batch, #running-req: 1, #token: 297, token usage: 0.01, cuda graph: False, gen throughput (token/s): 50.94, #queue-req: 0


    [2026-06-06 17:28:23] Decode batch, #running-req: 1, #token: 337, token usage: 0.02, cuda graph: False, gen throughput (token/s): 51.89, #queue-req: 0


    [2026-06-06 17:28:24] Decode batch, #running-req: 1, #token: 377, token usage: 0.02, cuda graph: False, gen throughput (token/s): 50.55, #queue-req: 0


    [2026-06-06 17:28:24] Decode batch, #running-req: 1, #token: 417, token usage: 0.02, cuda graph: False, gen throughput (token/s): 51.66, #queue-req: 0


    [2026-06-06 17:28:25] Decode batch, #running-req: 1, #token: 457, token usage: 0.02, cuda graph: False, gen throughput (token/s): 50.62, #queue-req: 0


    [2026-06-06 17:28:26] Decode batch, #running-req: 1, #token: 497, token usage: 0.02, cuda graph: False, gen throughput (token/s): 51.47, #queue-req: 0


    [2026-06-06 17:28:27] Decode batch, #running-req: 1, #token: 537, token usage: 0.03, cuda graph: False, gen throughput (token/s): 54.95, #queue-req: 0


    [2026-06-06 17:28:28] Decode batch, #running-req: 1, #token: 577, token usage: 0.03, cuda graph: False, gen throughput (token/s): 52.31, #queue-req: 0


    [2026-06-06 17:28:28] Decode batch, #running-req: 1, #token: 617, token usage: 0.03, cuda graph: False, gen throughput (token/s): 51.80, #queue-req: 0


    [2026-06-06 17:28:29] Decode batch, #running-req: 1, #token: 657, token usage: 0.03, cuda graph: False, gen throughput (token/s): 53.05, #queue-req: 0


    [2026-06-06 17:28:30] Decode batch, #running-req: 1, #token: 697, token usage: 0.03, cuda graph: False, gen throughput (token/s): 53.88, #queue-req: 0


    [2026-06-06 17:28:31] Decode batch, #running-req: 1, #token: 737, token usage: 0.04, cuda graph: False, gen throughput (token/s): 48.21, #queue-req: 0


    [2026-06-06 17:28:31] Decode batch, #running-req: 1, #token: 777, token usage: 0.04, cuda graph: False, gen throughput (token/s): 52.25, #queue-req: 0


    [2026-06-06 17:28:32] Decode batch, #running-req: 1, #token: 817, token usage: 0.04, cuda graph: False, gen throughput (token/s): 51.06, #queue-req: 0


    [2026-06-06 17:28:33] Decode batch, #running-req: 1, #token: 857, token usage: 0.04, cuda graph: False, gen throughput (token/s): 51.30, #queue-req: 0


    [2026-06-06 17:28:34] Decode batch, #running-req: 1, #token: 897, token usage: 0.04, cuda graph: False, gen throughput (token/s): 50.61, #queue-req: 0


    [2026-06-06 17:28:35] Decode batch, #running-req: 1, #token: 937, token usage: 0.05, cuda graph: False, gen throughput (token/s): 52.70, #queue-req: 0


    [2026-06-06 17:28:35] Decode batch, #running-req: 1, #token: 977, token usage: 0.05, cuda graph: False, gen throughput (token/s): 52.04, #queue-req: 0


    [2026-06-06 17:28:36] Decode batch, #running-req: 1, #token: 1017, token usage: 0.05, cuda graph: False, gen throughput (token/s): 53.50, #queue-req: 0


    [2026-06-06 17:28:36] INFO:     127.0.0.1:45418 - "POST /generate HTTP/1.1" 200 OK
    Output from lora0: 
