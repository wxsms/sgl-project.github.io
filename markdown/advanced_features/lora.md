...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 174.75it/s]
...
```
    ...
    [2026-05-29 03:48:18] Load weight end. elapsed=2.94 s, type=LlamaForCausalLM, avail mem=45.00 GB, mem usage=17.81 GB.
    [2026-05-29 03:48:18] Using csgmv as backend of LoRA kernels.
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 11374.38it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 81840.08it/s]
    [2026-05-29 03:48:18] Found local HF snapshot for Nutanix/Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json at /root/.cache/huggingface/hub/models--Nutanix--Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json/snapshots/2c398740f3eba8dc63ee78999316b833a2833b6c; skipping download.
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 293.21it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 10324.44it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 9383.23it/s]
    [2026-05-29 03:48:18] Found local HF snapshot for algoprog/fact-generation-llama-3.1-8b-instruct-lora at /root/.cache/huggingface/hub/models--algoprog--fact-generation-llama-3.1-8b-instruct-lora/snapshots/dc8cdfb21993a6cb46199d6b1d79f68a42b06439; skipping download.


    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 160.00it/s]
    ...
    [2026-05-29 03:48:19] Found local HF snapshot for philschmid/code-llama-3-1-8b-text-to-sql-lora at /root/.cache/huggingface/hub/models--philschmid--code-llama-3-1-8b-text-to-sql-lora/snapshots/141fc3a09386a8baf0d7495c247ae2d1a565f69f; skipping download.
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 115.28it/s]


    [2026-05-29 03:48:22] Max concurrent requests (per dp worker) from the finalized token capacity: max_num_reqs=128.
    [2026-05-29 03:48:22] KV Cache is allocated. dtype: torch.bfloat16, #tokens: 20480, K size: 1.25 GB, V size: 1.25 GB
    [2026-05-29 03:48:22] Memory pool end. avail mem=38.84 GB
    [2026-05-29 03:48:22] Disable piecewise CUDA graph because --disable-piecewise-cuda-graph is set


    [2026-05-29 03:48:27] max_total_num_tokens=20480, chunked_prefill_size=8192, max_prefill_tokens=16384, max_running_requests=128, context_len=131072, available_gpu_mem=31.49 GB
    [2026-05-29 03:48:27] Tree cache initialized: source=default impl=RadixCache hybrid_swa=False hybrid_ssm=False hierarchical=False streaming_wrapped=False


    [2026-05-29 03:48:28] INFO:     Started server process [1177739]
    [2026-05-29 03:48:28] INFO:     Waiting for application startup.
    [2026-05-29 03:48:28] Using default chat sampling params from model generation config: {'temperature': 0.6, 'top_p': 0.9}
    [2026-05-29 03:48:28] INFO:     Application startup complete.
    [2026-05-29 03:48:28] INFO:     Uvicorn running on http://127.0.0.1:35524 (Press CTRL+C to quit)


    /usr/local/lib/python3.10/dist-packages/fastapi/routing.py:120: FastAPIDeprecationWarning: ORJSONResponse is deprecated, FastAPI now serializes data directly to JSON bytes via Pydantic when a return type or response model is set, which is faster and doesn't need a custom response class. Read more in the FastAPI docs: https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model and https://fastapi.tiangolo.com/tutorial/response-model/
      response = await f(request)
    [2026-05-29 03:48:29] INFO:     127.0.0.1:53324 - "GET /v1/models HTTP/1.1" 200 OK


    [2026-05-29 03:48:29] INFO:     127.0.0.1:53330 - "GET /model_info HTTP/1.1" 200 OK


    [2026-05-29 03:48:31] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-05-29 03:48:31] LoRA expand (K=6144, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-05-29 03:48:31] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-05-29 03:48:31] LoRA expand (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}


    [2026-05-29 03:48:31] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-05-29 03:48:31] LoRA expand (K=28672, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-05-29 03:48:31] LoRA shrink (K=14336, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-05-29 03:48:32] Prefill batch, #new-seq: 1, #new-token: 7, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 1.62


    [2026-05-29 03:48:32] INFO:     127.0.0.1:53334 - "POST /generate HTTP/1.1" 200 OK
    [2026-05-29 03:48:32] The server is fired up and ready to roll!
...
```
    ...
    [2026-05-29 03:48:34] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-29 03:48:34] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-05-29 03:48:34] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-05-29 03:48:34] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-29 03:48:34] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-05-29 03:48:35] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-05-29 03:48:35] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-29 03:48:35] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-05-29 03:48:35] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-05-29 03:48:36] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-29 03:48:36] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-05-29 03:48:36] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-05-29 03:48:37] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-29 03:48:37] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-05-29 03:48:37] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-05-29 03:48:37] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-29 03:48:37] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-05-29 03:48:38] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-05-29 03:48:38] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-29 03:48:38] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-05-29 03:48:38] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-05-29 03:48:39] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-29 03:48:39] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-05-29 03:48:39] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-05-29 03:48:40] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-29 03:48:40] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-05-29 03:48:40] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-05-29 03:48:41] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-29 03:48:41] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-05-29 03:48:41] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 2, #pending-token: 18, cuda graph: False, input throughput (token/s): 0.96
    [2026-05-29 03:48:41] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-29 03:48:41] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-05-29 03:48:42] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-29 03:48:42] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-05-29 03:48:43] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-29 03:48:43] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-05-29 03:48:44] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-29 03:48:44] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 1, #pending-token: 9, cuda graph: False, input throughput (token/s): 3.12


    [2026-05-29 03:48:44] Decode batch, #running-req: 2, #token: 73, token usage: 0.00, cuda graph: False, gen throughput (token/s): 3.56, #queue-req: 1


    [2026-05-29 03:48:45] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-05-29 03:48:46] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 4.92
    [2026-05-29 03:48:46] Decode batch, #running-req: 2, #token: 87, token usage: 0.00, cuda graph: False, gen throughput (token/s): 55.36, #queue-req: 0


    [2026-05-29 03:48:47] Decode batch, #running-req: 2, #token: 167, token usage: 0.01, cuda graph: False, gen throughput (token/s): 66.50, #queue-req: 0


    [2026-05-29 03:48:49] Decode batch, #running-req: 1, #token: 151, token usage: 0.01, cuda graph: False, gen throughput (token/s): 35.73, #queue-req: 0


    [2026-05-29 03:48:50] Decode batch, #running-req: 1, #token: 191, token usage: 0.01, cuda graph: False, gen throughput (token/s): 40.23, #queue-req: 0


    [2026-05-29 03:48:50] Decode batch, #running-req: 1, #token: 231, token usage: 0.01, cuda graph: False, gen throughput (token/s): 47.74, #queue-req: 0


    [2026-05-29 03:48:51] Decode batch, #running-req: 1, #token: 271, token usage: 0.01, cuda graph: False, gen throughput (token/s): 51.44, #queue-req: 0


    [2026-05-29 03:48:52] Decode batch, #running-req: 1, #token: 311, token usage: 0.02, cuda graph: False, gen throughput (token/s): 49.05, #queue-req: 0


    [2026-05-29 03:48:53] Decode batch, #running-req: 1, #token: 351, token usage: 0.02, cuda graph: False, gen throughput (token/s): 48.31, #queue-req: 0


    [2026-05-29 03:48:54] Decode batch, #running-req: 1, #token: 391, token usage: 0.02, cuda graph: False, gen throughput (token/s): 45.19, #queue-req: 0


    [2026-05-29 03:48:55] Decode batch, #running-req: 1, #token: 431, token usage: 0.02, cuda graph: False, gen throughput (token/s): 31.59, #queue-req: 0


    [2026-05-29 03:48:56] Decode batch, #running-req: 1, #token: 471, token usage: 0.02, cuda graph: False, gen throughput (token/s): 36.27, #queue-req: 0


    [2026-05-29 03:48:57] Decode batch, #running-req: 1, #token: 511, token usage: 0.02, cuda graph: False, gen throughput (token/s): 47.13, #queue-req: 0


    [2026-05-29 03:48:58] Decode batch, #running-req: 1, #token: 551, token usage: 0.03, cuda graph: False, gen throughput (token/s): 35.51, #queue-req: 0


    [2026-05-29 03:48:59] Decode batch, #running-req: 1, #token: 591, token usage: 0.03, cuda graph: False, gen throughput (token/s): 45.07, #queue-req: 0


    [2026-05-29 03:49:00] Decode batch, #running-req: 1, #token: 631, token usage: 0.03, cuda graph: False, gen throughput (token/s): 43.34, #queue-req: 0


    [2026-05-29 03:49:01] Decode batch, #running-req: 1, #token: 671, token usage: 0.03, cuda graph: False, gen throughput (token/s): 35.94, #queue-req: 0


    [2026-05-29 03:49:02] Decode batch, #running-req: 1, #token: 711, token usage: 0.03, cuda graph: False, gen throughput (token/s): 52.51, #queue-req: 0


    [2026-05-29 03:49:03] Decode batch, #running-req: 1, #token: 751, token usage: 0.04, cuda graph: False, gen throughput (token/s): 40.53, #queue-req: 0


    [2026-05-29 03:49:04] Decode batch, #running-req: 1, #token: 791, token usage: 0.04, cuda graph: False, gen throughput (token/s): 34.88, #queue-req: 0


    [2026-05-29 03:49:06] Decode batch, #running-req: 1, #token: 831, token usage: 0.04, cuda graph: False, gen throughput (token/s): 24.20, #queue-req: 0


    [2026-05-29 03:49:06] Decode batch, #running-req: 1, #token: 871, token usage: 0.04, cuda graph: False, gen throughput (token/s): 44.17, #queue-req: 0


    [2026-05-29 03:49:07] Decode batch, #running-req: 1, #token: 911, token usage: 0.04, cuda graph: False, gen throughput (token/s): 50.54, #queue-req: 0


    [2026-05-29 03:49:08] Decode batch, #running-req: 1, #token: 951, token usage: 0.05, cuda graph: False, gen throughput (token/s): 48.41, #queue-req: 0


    [2026-05-29 03:49:09] Decode batch, #running-req: 1, #token: 991, token usage: 0.05, cuda graph: False, gen throughput (token/s): 49.87, #queue-req: 0


    [2026-05-29 03:49:10] Decode batch, #running-req: 1, #token: 1031, token usage: 0.05, cuda graph: False, gen throughput (token/s): 49.89, #queue-req: 0
    [2026-05-29 03:49:10] INFO:     127.0.0.1:60340 - "POST /generate HTTP/1.1" 200 OK
    Output from lora0: 
