Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 5.58
    [2026-05-26 09:57:24] Decode batch, #running-req: 2, #token: 95, token usage: 0.00, cuda graph: False, gen throughput (token/s): 69.23, #queue-req: 0


    [2026-05-26 09:57:25] Decode batch, #running-req: 2, #token: 175, token usage: 0.01, cuda graph: False, gen throughput (token/s): 93.12, #queue-req: 0


    [2026-05-26 09:57:26] Decode batch, #running-req: 1, #token: 159, token usage: 0.01, cuda graph: False, gen throughput (token/s): 69.14, #queue-req: 0


    [2026-05-26 09:57:27] Decode batch, #running-req: 1, #token: 199, token usage: 0.01, cuda graph: False, gen throughput (token/s): 47.41, #queue-req: 0


    [2026-05-26 09:57:28] Decode batch, #running-req: 1, #token: 239, token usage: 0.01, cuda graph: False, gen throughput (token/s): 42.97, #queue-req: 0


    [2026-05-26 09:57:29] Decode batch, #running-req: 1, #token: 279, token usage: 0.01, cuda graph: False, gen throughput (token/s): 43.48, #queue-req: 0


    [2026-05-26 09:57:30] Decode batch, #running-req: 1, #token: 319, token usage: 0.02, cuda graph: False, gen throughput (token/s): 41.85, #queue-req: 0


    [2026-05-26 09:57:31] Decode batch, #running-req: 1, #token: 359, token usage: 0.02, cuda graph: False, gen throughput (token/s): 46.80, #queue-req: 0


    [2026-05-26 09:57:31] Decode batch, #running-req: 1, #token: 399, token usage: 0.02, cuda graph: False, gen throughput (token/s): 47.92, #queue-req: 0


    [2026-05-26 09:57:32] Decode batch, #running-req: 1, #token: 439, token usage: 0.02, cuda graph: False, gen throughput (token/s): 48.87, #queue-req: 0


    [2026-05-26 09:57:33] Decode batch, #running-req: 1, #token: 479, token usage: 0.02, cuda graph: False, gen throughput (token/s): 49.02, #queue-req: 0


    [2026-05-26 09:57:34] Decode batch, #running-req: 1, #token: 519, token usage: 0.03, cuda graph: False, gen throughput (token/s): 48.39, #queue-req: 0


    [2026-05-26 09:57:35] Decode batch, #running-req: 1, #token: 559, token usage: 0.03, cuda graph: False, gen throughput (token/s): 51.99, #queue-req: 0


    [2026-05-26 09:57:35] Decode batch, #running-req: 1, #token: 599, token usage: 0.03, cuda graph: False, gen throughput (token/s): 51.21, #queue-req: 0


    [2026-05-26 09:57:36] Decode batch, #running-req: 1, #token: 639, token usage: 0.03, cuda graph: False, gen throughput (token/s): 50.77, #queue-req: 0


    [2026-05-26 09:57:37] Decode batch, #running-req: 1, #token: 679, token usage: 0.03, cuda graph: False, gen throughput (token/s): 49.52, #queue-req: 0


    [2026-05-26 09:57:38] Decode batch, #running-req: 1, #token: 719, token usage: 0.04, cuda graph: False, gen throughput (token/s): 49.77, #queue-req: 0


    [2026-05-26 09:57:39] Decode batch, #running-req: 1, #token: 759, token usage: 0.04, cuda graph: False, gen throughput (token/s): 51.41, #queue-req: 0


    [2026-05-26 09:57:39] Decode batch, #running-req: 1, #token: 799, token usage: 0.04, cuda graph: False, gen throughput (token/s): 51.29, #queue-req: 0


    [2026-05-26 09:57:40] Decode batch, #running-req: 1, #token: 839, token usage: 0.04, cuda graph: False, gen throughput (token/s): 52.66, #queue-req: 0


    [2026-05-26 09:57:41] Decode batch, #running-req: 1, #token: 879, token usage: 0.04, cuda graph: False, gen throughput (token/s): 51.69, #queue-req: 0


    [2026-05-26 09:57:42] Decode batch, #running-req: 1, #token: 919, token usage: 0.04, cuda graph: False, gen throughput (token/s): 52.13, #queue-req: 0


    [2026-05-26 09:57:42] Decode batch, #running-req: 1, #token: 959, token usage: 0.05, cuda graph: False, gen throughput (token/s): 50.92, #queue-req: 0


    [2026-05-26 09:57:43] Decode batch, #running-req: 1, #token: 999, token usage: 0.05, cuda graph: False, gen throughput (token/s): 52.42, #queue-req: 0


    [2026-05-26 09:57:44] INFO:     127.0.0.1:58106 - "POST /generate HTTP/1.1" 200 OK
    Output from lora0: 
