...
```
    ...
    2026-04-07 12:35:09,632 - CUTE_DSL - WARNING - [handle_import_error] - Unexpected error during package walk: cutlass.cute.experimental
    [2026-04-07 12:35:09] Unexpected error during package walk: cutlass.cute.experimental
...
```
    ...
    [2026-04-07 12:35:36] Ignore import error when loading sglang.srt.models.gemma4_audio: cannot import name 'Gemma4AudioConfig' from 'transformers' (/usr/local/lib/python3.10/dist-packages/transformers/__init__.py)
    [2026-04-07 12:35:36] Ignore import error when loading sglang.srt.models.gemma4_causal: cannot import name 'Gemma4TextConfig' from 'transformers' (/usr/local/lib/python3.10/dist-packages/transformers/__init__.py)
    [2026-04-07 12:35:36] Ignore import error when loading sglang.srt.models.gemma4_mm: cannot import name 'Gemma4AudioConfig' from 'transformers' (/usr/local/lib/python3.10/dist-packages/transformers/__init__.py)
    [2026-04-07 12:35:36] Ignore import error when loading sglang.srt.models.gemma4_vision: cannot import name 'Gemma4VisionConfig' from 'transformers' (/usr/local/lib/python3.10/dist-packages/transformers/__init__.py)
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 163.72it/s]
    ...
    2026-04-07 12:35:46,299 - CUTE_DSL - WARNING - [handle_import_error] - Unexpected error during package walk: cutlass.cute.experimental
    [2026-04-07 12:35:46] Unexpected error during package walk: cutlass.cute.experimental
...
```
    ...
    [2026-04-07 12:36:10] Ignore import error when loading sglang.srt.models.gemma4_audio: cannot import name 'Gemma4AudioConfig' from 'transformers' (/usr/local/lib/python3.10/dist-packages/transformers/__init__.py)
    [2026-04-07 12:36:10] Ignore import error when loading sglang.srt.models.gemma4_causal: cannot import name 'Gemma4TextConfig' from 'transformers' (/usr/local/lib/python3.10/dist-packages/transformers/__init__.py)
    [2026-04-07 12:36:10] Ignore import error when loading sglang.srt.models.gemma4_mm: cannot import name 'Gemma4AudioConfig' from 'transformers' (/usr/local/lib/python3.10/dist-packages/transformers/__init__.py)
    [2026-04-07 12:36:10] Ignore import error when loading sglang.srt.models.gemma4_vision: cannot import name 'Gemma4VisionConfig' from 'transformers' (/usr/local/lib/python3.10/dist-packages/transformers/__init__.py)
    ...
    2026-04-07 12:36:19,050 - CUTE_DSL - WARNING - [handle_import_error] - Unexpected error during package walk: cutlass.cute.experimental
    [2026-04-07 12:36:19] Unexpected error during package walk: cutlass.cute.experimental
...
```
    ...
    [2026-04-07 12:36:47] Ignore import error when loading sglang.srt.models.gemma4_audio: cannot import name 'Gemma4AudioConfig' from 'transformers' (/usr/local/lib/python3.10/dist-packages/transformers/__init__.py)
    [2026-04-07 12:36:47] Ignore import error when loading sglang.srt.models.gemma4_causal: cannot import name 'Gemma4TextConfig' from 'transformers' (/usr/local/lib/python3.10/dist-packages/transformers/__init__.py)
    [2026-04-07 12:36:47] Ignore import error when loading sglang.srt.models.gemma4_mm: cannot import name 'Gemma4AudioConfig' from 'transformers' (/usr/local/lib/python3.10/dist-packages/transformers/__init__.py)
    [2026-04-07 12:36:47] Ignore import error when loading sglang.srt.models.gemma4_vision: cannot import name 'Gemma4VisionConfig' from 'transformers' (/usr/local/lib/python3.10/dist-packages/transformers/__init__.py)
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 330.39it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 10388.37it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]

    Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 10979.85it/s]
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 167.86it/s]
    ...
    2026-04-07 12:36:58,008 - CUTE_DSL - WARNING - [handle_import_error] - Unexpected error during package walk: cutlass.cute.experimental
    [2026-04-07 12:36:58] Unexpected error during package walk: cutlass.cute.experimental
...
```
    ...
    [2026-04-07 12:37:27] Load weight end. elapsed=3.66 s, type=LlamaForCausalLM, avail mem=45.99 GB, mem usage=13.87 GB.
    [2026-04-07 12:37:27] Using csgmv as backend of LoRA kernels.
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 19668.48it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 87381.33it/s]
    [2026-04-07 12:37:27] Found local HF snapshot for Nutanix/Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json at /root/.cache/huggingface/hub/models--Nutanix--Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json/snapshots/2c398740f3eba8dc63ee78999316b833a2833b6c; skipping download.
    [2026-04-07 12:37:27] No model.safetensors.index.json found in remote.
    ...
    [2026-04-07 12:37:27] Found local HF snapshot for algoprog/fact-generation-llama-3.1-8b-instruct-lora at /root/.cache/huggingface/hub/models--algoprog--fact-generation-llama-3.1-8b-instruct-lora/snapshots/dc8cdfb21993a6cb46199d6b1d79f68a42b06439; skipping download.
    [2026-04-07 12:37:27] No model.safetensors.index.json found in remote.
    ...
    [2026-04-07 12:37:28] Found local HF snapshot for philschmid/code-llama-3-1-8b-text-to-sql-lora at /root/.cache/huggingface/hub/models--philschmid--code-llama-3-1-8b-text-to-sql-lora/snapshots/141fc3a09386a8baf0d7495c247ae2d1a565f69f; skipping download.
    [2026-04-07 12:37:28] No model.safetensors.index.json found in remote.
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 122.68it/s]


    [2026-04-07 12:37:31] Using KV cache dtype: torch.bfloat16
    [2026-04-07 12:37:31] KV Cache is allocated. #tokens: 20480, K size: 1.25 GB, V size: 1.25 GB
    [2026-04-07 12:37:31] Memory pool end. avail mem=25.64 GB
    [2026-04-07 12:37:31] Disable piecewise CUDA graph because --disable-piecewise-cuda-graph is set


    [2026-04-07 12:37:34] max_total_num_tokens=20480, chunked_prefill_size=8192, max_prefill_tokens=16384, max_running_requests=128, context_len=131072, available_gpu_mem=24.14 GB


    [2026-04-07 12:37:34] INFO:     Started server process [175863]
    [2026-04-07 12:37:34] INFO:     Waiting for application startup.
    [2026-04-07 12:37:34] Using default chat sampling params from model generation config: {'temperature': 0.6, 'top_p': 0.9}
    [2026-04-07 12:37:34] INFO:     Application startup complete.
    [2026-04-07 12:37:34] INFO:     Uvicorn running on http://127.0.0.1:33837 (Press CTRL+C to quit)
    /usr/local/lib/python3.10/dist-packages/fastapi/routing.py:120: FastAPIDeprecationWarning: ORJSONResponse is deprecated, FastAPI now serializes data directly to JSON bytes via Pydantic when a return type or response model is set, which is faster and doesn't need a custom response class. Read more in the FastAPI docs: https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model and https://fastapi.tiangolo.com/tutorial/response-model/
      response = await f(request)
    [2026-04-07 12:37:34] INFO:     127.0.0.1:58906 - "GET /v1/models HTTP/1.1" 200 OK


    [2026-04-07 12:37:35] INFO:     127.0.0.1:58908 - "GET /model_info HTTP/1.1" 200 OK


    2026-04-07 12:37:36,181 - CUTE_DSL - WARNING - [handle_import_error] - Unexpected error during package walk: cutlass.cute.experimental
    [2026-04-07 12:37:36] Unexpected error during package walk: cutlass.cute.experimental


    [2026-04-07 12:37:36] Prefill batch, #new-seq: 1, #new-token: 7, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 0, cuda graph: False, input throughput (token/s): 0.00
    [2026-04-07 12:37:36] INFO:     127.0.0.1:58918 - "POST /generate HTTP/1.1" 200 OK
    [2026-04-07 12:37:36] The server is fired up and ready to roll!
...
```
    ...
    [2026-04-07 12:37:39] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 1, cuda graph: False, input throughput (token/s): 2.22
    [2026-04-07 12:37:39] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 1, cuda graph: False, input throughput (token/s): 480.74


    [2026-04-07 12:37:40] Decode batch, #running-req: 2, #token: 84, token usage: 0.00, cuda graph: False, gen throughput (token/s): 3.20, #queue-req: 1


    [2026-04-07 12:37:41] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 0, cuda graph: False, input throughput (token/s): 7.03
    [2026-04-07 12:37:41] Decode batch, #running-req: 2, #token: 93, token usage: 0.00, cuda graph: False, gen throughput (token/s): 103.88, #queue-req: 0


    [2026-04-07 12:37:41] Decode batch, #running-req: 2, #token: 173, token usage: 0.01, cuda graph: False, gen throughput (token/s): 122.44, #queue-req: 0


    [2026-04-07 12:37:42] Decode batch, #running-req: 1, #token: 162, token usage: 0.01, cuda graph: False, gen throughput (token/s): 92.55, #queue-req: 0


    [2026-04-07 12:37:43] Decode batch, #running-req: 1, #token: 202, token usage: 0.01, cuda graph: False, gen throughput (token/s): 49.80, #queue-req: 0


    [2026-04-07 12:37:44] Decode batch, #running-req: 1, #token: 242, token usage: 0.01, cuda graph: False, gen throughput (token/s): 49.56, #queue-req: 0


    [2026-04-07 12:37:44] Decode batch, #running-req: 1, #token: 282, token usage: 0.01, cuda graph: False, gen throughput (token/s): 49.99, #queue-req: 0


    [2026-04-07 12:37:45] Decode batch, #running-req: 1, #token: 322, token usage: 0.02, cuda graph: False, gen throughput (token/s): 51.17, #queue-req: 0


    [2026-04-07 12:37:46] Decode batch, #running-req: 1, #token: 362, token usage: 0.02, cuda graph: False, gen throughput (token/s): 56.87, #queue-req: 0


    [2026-04-07 12:37:47] Decode batch, #running-req: 1, #token: 402, token usage: 0.02, cuda graph: False, gen throughput (token/s): 57.70, #queue-req: 0


    [2026-04-07 12:37:47] Decode batch, #running-req: 1, #token: 442, token usage: 0.02, cuda graph: False, gen throughput (token/s): 55.29, #queue-req: 0


    [2026-04-07 12:37:48] Decode batch, #running-req: 1, #token: 482, token usage: 0.02, cuda graph: False, gen throughput (token/s): 60.06, #queue-req: 0


    [2026-04-07 12:37:49] Decode batch, #running-req: 1, #token: 522, token usage: 0.03, cuda graph: False, gen throughput (token/s): 64.08, #queue-req: 0


    [2026-04-07 12:37:49] Decode batch, #running-req: 1, #token: 562, token usage: 0.03, cuda graph: False, gen throughput (token/s): 63.07, #queue-req: 0


    [2026-04-07 12:37:50] Decode batch, #running-req: 1, #token: 602, token usage: 0.03, cuda graph: False, gen throughput (token/s): 45.39, #queue-req: 0


    [2026-04-07 12:37:51] Decode batch, #running-req: 1, #token: 642, token usage: 0.03, cuda graph: False, gen throughput (token/s): 61.26, #queue-req: 0


    [2026-04-07 12:37:51] Decode batch, #running-req: 1, #token: 682, token usage: 0.03, cuda graph: False, gen throughput (token/s): 63.50, #queue-req: 0


    [2026-04-07 12:37:52] Decode batch, #running-req: 1, #token: 722, token usage: 0.04, cuda graph: False, gen throughput (token/s): 63.85, #queue-req: 0


    [2026-04-07 12:37:53] Decode batch, #running-req: 1, #token: 762, token usage: 0.04, cuda graph: False, gen throughput (token/s): 64.46, #queue-req: 0


    [2026-04-07 12:37:53] Decode batch, #running-req: 1, #token: 802, token usage: 0.04, cuda graph: False, gen throughput (token/s): 62.49, #queue-req: 0


    [2026-04-07 12:37:54] Decode batch, #running-req: 1, #token: 842, token usage: 0.04, cuda graph: False, gen throughput (token/s): 61.85, #queue-req: 0


    [2026-04-07 12:37:55] Decode batch, #running-req: 1, #token: 882, token usage: 0.04, cuda graph: False, gen throughput (token/s): 62.94, #queue-req: 0


    [2026-04-07 12:37:55] Decode batch, #running-req: 1, #token: 922, token usage: 0.05, cuda graph: False, gen throughput (token/s): 49.32, #queue-req: 0


    [2026-04-07 12:37:56] Decode batch, #running-req: 1, #token: 962, token usage: 0.05, cuda graph: False, gen throughput (token/s): 52.65, #queue-req: 0


    [2026-04-07 12:37:57] Decode batch, #running-req: 1, #token: 1002, token usage: 0.05, cuda graph: False, gen throughput (token/s): 66.39, #queue-req: 0


    [2026-04-07 12:37:57] INFO:     127.0.0.1:58922 - "POST /generate HTTP/1.1" 200 OK
    Output from lora0: 
