...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 175.60it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 20610.83it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 21873.81it/s]
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 355.69it/s]
...
```
    ...
    [2026-06-02 10:25:09] Load weight end. elapsed=2.69 s, type=LlamaForCausalLM, avail mem=63.48 GB, mem usage=12.41 GB.
    [2026-06-02 10:25:09] Using csgmv as backend of LoRA kernels.
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 22017.34it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 22162.77it/s]
    [2026-06-02 10:25:09] Found local HF snapshot for Nutanix/Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json at /root/.cache/huggingface/hub/models--Nutanix--Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json/snapshots/2c398740f3eba8dc63ee78999316b833a2833b6c; skipping download.
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 342.67it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 11941.08it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 22795.13it/s]
    [2026-06-02 10:25:09] Found local HF snapshot for algoprog/fact-generation-llama-3.1-8b-instruct-lora at /root/.cache/huggingface/hub/models--algoprog--fact-generation-llama-3.1-8b-instruct-lora/snapshots/dc8cdfb21993a6cb46199d6b1d79f68a42b06439; skipping download.
    ...
    [2026-06-02 10:25:09] Found local HF snapshot for philschmid/code-llama-3-1-8b-text-to-sql-lora at /root/.cache/huggingface/hub/models--philschmid--code-llama-3-1-8b-text-to-sql-lora/snapshots/141fc3a09386a8baf0d7495c247ae2d1a565f69f; skipping download.
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 110.88it/s]


    [2026-06-02 10:25:11] Max concurrent requests (per dp worker) from the finalized token capacity: max_num_reqs=128.
    [2026-06-02 10:25:11] KV Cache is allocated. dtype: torch.bfloat16, #tokens: 20480, K size: 1.25 GB, V size: 1.25 GB
    [2026-06-02 10:25:11] Memory pool end. avail mem=58.26 GB
    [2026-06-02 10:25:11] Disable piecewise CUDA graph because --disable-piecewise-cuda-graph is set


    [2026-06-02 10:25:15] max_total_num_tokens=20480, chunked_prefill_size=8192, max_prefill_tokens=16384, max_running_requests=128, context_len=131072, available_gpu_mem=58.17 GB
    [2026-06-02 10:25:15] Tree cache initialized: source=default impl=RadixCache hybrid_swa=False hybrid_ssm=False hierarchical=False streaming_wrapped=False


    [2026-06-02 10:25:15] INFO:     Started server process [3889527]
    [2026-06-02 10:25:15] INFO:     Waiting for application startup.
    [2026-06-02 10:25:15] Using default chat sampling params from model generation config: {'temperature': 0.6, 'top_p': 0.9}
    [2026-06-02 10:25:15] INFO:     Application startup complete.
    [2026-06-02 10:25:15] INFO:     Uvicorn running on http://127.0.0.1:33754 (Press CTRL+C to quit)


    /usr/local/lib/python3.10/dist-packages/fastapi/routing.py:120: FastAPIDeprecationWarning: ORJSONResponse is deprecated, FastAPI now serializes data directly to JSON bytes via Pydantic when a return type or response model is set, which is faster and doesn't need a custom response class. Read more in the FastAPI docs: https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model and https://fastapi.tiangolo.com/tutorial/response-model/
      response = await f(request)
    [2026-06-02 10:25:16] INFO:     127.0.0.1:45976 - "GET /v1/models HTTP/1.1" 200 OK
    [2026-06-02 10:25:16] INFO:     127.0.0.1:45990 - "GET /model_info HTTP/1.1" 200 OK


    [2026-06-02 10:25:17] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-02 10:25:17] LoRA expand (K=6144, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-02 10:25:17] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-02 10:25:17] LoRA expand (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}


    [2026-06-02 10:25:17] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-02 10:25:17] LoRA expand (K=28672, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-02 10:25:17] LoRA shrink (K=14336, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}


    [2026-06-02 10:25:18] Prefill batch, #new-seq: 1, #new-token: 7, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 2.33
    [2026-06-02 10:25:18] INFO:     127.0.0.1:46006 - "POST /generate HTTP/1.1" 200 OK
    [2026-06-02 10:25:18] The server is fired up and ready to roll!
...
```
    ...
    [2026-06-02 10:25:21] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-02 10:25:21] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-02 10:25:22] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-02 10:25:22] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-02 10:25:22] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-02 10:25:23] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-02 10:25:23] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-02 10:25:23] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-02 10:25:23] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-02 10:25:24] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 2, #pending-token: 18, cuda graph: False, input throughput (token/s): 1.53
    [2026-06-02 10:25:24] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-02 10:25:24] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-02 10:25:24] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-02 10:25:24] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-02 10:25:25] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 1, #pending-token: 9, cuda graph: False, input throughput (token/s): 9.05


    [2026-06-02 10:25:25] Decode batch, #running-req: 2, #token: 65, token usage: 0.00, cuda graph: False, gen throughput (token/s): 5.24, #queue-req: 1


    [2026-06-02 10:25:25] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-02 10:25:25] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 10.12
    [2026-06-02 10:25:26] Decode batch, #running-req: 2, #token: 79, token usage: 0.00, cuda graph: False, gen throughput (token/s): 102.12, #queue-req: 0


    [2026-06-02 10:25:26] Decode batch, #running-req: 2, #token: 159, token usage: 0.01, cuda graph: False, gen throughput (token/s): 113.25, #queue-req: 0


    [2026-06-02 10:25:27] Decode batch, #running-req: 1, #token: 143, token usage: 0.01, cuda graph: False, gen throughput (token/s): 85.67, #queue-req: 0


    [2026-06-02 10:25:28] Decode batch, #running-req: 1, #token: 183, token usage: 0.01, cuda graph: False, gen throughput (token/s): 58.93, #queue-req: 0


    [2026-06-02 10:25:28] Decode batch, #running-req: 1, #token: 223, token usage: 0.01, cuda graph: False, gen throughput (token/s): 59.62, #queue-req: 0


    [2026-06-02 10:25:29] Decode batch, #running-req: 1, #token: 263, token usage: 0.01, cuda graph: False, gen throughput (token/s): 58.09, #queue-req: 0


    [2026-06-02 10:25:30] Decode batch, #running-req: 1, #token: 303, token usage: 0.01, cuda graph: False, gen throughput (token/s): 58.70, #queue-req: 0


    [2026-06-02 10:25:30] Decode batch, #running-req: 1, #token: 343, token usage: 0.02, cuda graph: False, gen throughput (token/s): 58.83, #queue-req: 0


    [2026-06-02 10:25:31] Decode batch, #running-req: 1, #token: 383, token usage: 0.02, cuda graph: False, gen throughput (token/s): 58.08, #queue-req: 0


    [2026-06-02 10:25:32] Decode batch, #running-req: 1, #token: 423, token usage: 0.02, cuda graph: False, gen throughput (token/s): 57.54, #queue-req: 0


    [2026-06-02 10:25:32] Decode batch, #running-req: 1, #token: 463, token usage: 0.02, cuda graph: False, gen throughput (token/s): 57.27, #queue-req: 0


    [2026-06-02 10:25:33] Decode batch, #running-req: 1, #token: 503, token usage: 0.02, cuda graph: False, gen throughput (token/s): 59.19, #queue-req: 0


    [2026-06-02 10:25:34] Decode batch, #running-req: 1, #token: 543, token usage: 0.03, cuda graph: False, gen throughput (token/s): 59.47, #queue-req: 0


    [2026-06-02 10:25:34] Decode batch, #running-req: 1, #token: 583, token usage: 0.03, cuda graph: False, gen throughput (token/s): 60.59, #queue-req: 0


    [2026-06-02 10:25:35] Decode batch, #running-req: 1, #token: 623, token usage: 0.03, cuda graph: False, gen throughput (token/s): 59.92, #queue-req: 0


    [2026-06-02 10:25:36] Decode batch, #running-req: 1, #token: 663, token usage: 0.03, cuda graph: False, gen throughput (token/s): 59.92, #queue-req: 0


    [2026-06-02 10:25:36] Decode batch, #running-req: 1, #token: 703, token usage: 0.03, cuda graph: False, gen throughput (token/s): 59.45, #queue-req: 0


    [2026-06-02 10:25:37] Decode batch, #running-req: 1, #token: 743, token usage: 0.04, cuda graph: False, gen throughput (token/s): 60.81, #queue-req: 0


    [2026-06-02 10:25:38] Decode batch, #running-req: 1, #token: 783, token usage: 0.04, cuda graph: False, gen throughput (token/s): 60.27, #queue-req: 0


    [2026-06-02 10:25:38] Decode batch, #running-req: 1, #token: 823, token usage: 0.04, cuda graph: False, gen throughput (token/s): 60.15, #queue-req: 0


    [2026-06-02 10:25:39] Decode batch, #running-req: 1, #token: 863, token usage: 0.04, cuda graph: False, gen throughput (token/s): 59.81, #queue-req: 0


    [2026-06-02 10:25:40] Decode batch, #running-req: 1, #token: 903, token usage: 0.04, cuda graph: False, gen throughput (token/s): 60.41, #queue-req: 0


    [2026-06-02 10:25:40] Decode batch, #running-req: 1, #token: 943, token usage: 0.05, cuda graph: False, gen throughput (token/s): 58.32, #queue-req: 0


    [2026-06-02 10:25:41] Decode batch, #running-req: 1, #token: 983, token usage: 0.05, cuda graph: False, gen throughput (token/s): 60.27, #queue-req: 0


    [2026-06-02 10:25:42] Decode batch, #running-req: 1, #token: 1023, token usage: 0.05, cuda graph: False, gen throughput (token/s): 60.06, #queue-req: 0
    [2026-06-02 10:25:42] INFO:     127.0.0.1:46020 - "POST /generate HTTP/1.1" 200 OK
    Output from lora0: 
