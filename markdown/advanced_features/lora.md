...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 165.26it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 9478.65it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 18335.76it/s]
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 329.02it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 326.84it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 122.16it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 162.13it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 15827.56it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 16644.06it/s]
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 97.31it/s]
...
```
    ...
    [2026-05-29 06:55:03] Load weight end. elapsed=4.27 s, type=LlamaForCausalLM, avail mem=58.92 GB, mem usage=15.05 GB.
    [2026-05-29 06:55:03] Using csgmv as backend of LoRA kernels.
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 85598.04it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 9137.92it/s]
    [2026-05-29 06:55:03] Found local HF snapshot for Nutanix/Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json at /root/.cache/huggingface/hub/models--Nutanix--Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json/snapshots/2c398740f3eba8dc63ee78999316b833a2833b6c; skipping download.
    ...
    [2026-05-29 06:55:03] Found local HF snapshot for algoprog/fact-generation-llama-3.1-8b-instruct-lora at /root/.cache/huggingface/hub/models--algoprog--fact-generation-llama-3.1-8b-instruct-lora/snapshots/dc8cdfb21993a6cb46199d6b1d79f68a42b06439; skipping download.
    ...
    [2026-05-29 06:55:04] Found local HF snapshot for philschmid/code-llama-3-1-8b-text-to-sql-lora at /root/.cache/huggingface/hub/models--philschmid--code-llama-3-1-8b-text-to-sql-lora/snapshots/141fc3a09386a8baf0d7495c247ae2d1a565f69f; skipping download.
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 114.19it/s]


    [2026-05-29 06:55:06] Max concurrent requests (per dp worker) from the finalized token capacity: max_num_reqs=128.
    [2026-05-29 06:55:06] KV Cache is allocated. dtype: torch.bfloat16, #tokens: 20480, K size: 1.25 GB, V size: 1.25 GB
    [2026-05-29 06:55:06] Memory pool end. avail mem=53.69 GB
    [2026-05-29 06:55:06] Disable piecewise CUDA graph because --disable-piecewise-cuda-graph is set


    [2026-05-29 06:55:10] max_total_num_tokens=20480, chunked_prefill_size=8192, max_prefill_tokens=16384, max_running_requests=128, context_len=131072, available_gpu_mem=58.16 GB
    [2026-05-29 06:55:10] Tree cache initialized: source=default impl=RadixCache hybrid_swa=False hybrid_ssm=False hierarchical=False streaming_wrapped=False


    [2026-05-29 06:55:11] INFO:     Started server process [945256]
    [2026-05-29 06:55:11] INFO:     Waiting for application startup.
    [2026-05-29 06:55:11] Using default chat sampling params from model generation config: {'temperature': 0.6, 'top_p': 0.9}
    [2026-05-29 06:55:11] INFO:     Application startup complete.
    [2026-05-29 06:55:11] INFO:     Uvicorn running on http://127.0.0.1:31485 (Press CTRL+C to quit)


    /usr/local/lib/python3.10/dist-packages/fastapi/routing.py:120: FastAPIDeprecationWarning: ORJSONResponse is deprecated, FastAPI now serializes data directly to JSON bytes via Pydantic when a return type or response model is set, which is faster and doesn't need a custom response class. Read more in the FastAPI docs: https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model and https://fastapi.tiangolo.com/tutorial/response-model/
      response = await f(request)
    [2026-05-29 06:55:12] INFO:     127.0.0.1:51020 - "GET /v1/models HTTP/1.1" 200 OK
    [2026-05-29 06:55:12] INFO:     127.0.0.1:51036 - "GET /model_info HTTP/1.1" 200 OK


    [2026-05-29 06:55:13] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-05-29 06:55:13] LoRA expand (K=6144, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-05-29 06:55:13] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-05-29 06:55:13] LoRA expand (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}


    [2026-05-29 06:55:14] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-05-29 06:55:14] LoRA expand (K=28672, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}


    [2026-05-29 06:55:16] LoRA shrink (K=14336, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-05-29 06:55:16] Prefill batch, #new-seq: 1, #new-token: 7, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 1.14


    [2026-05-29 06:55:16] INFO:     127.0.0.1:51050 - "POST /generate HTTP/1.1" 200 OK
    [2026-05-29 06:55:16] The server is fired up and ready to roll!
...
```
    ...
    [2026-05-29 06:55:17] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-29 06:55:17] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-05-29 06:55:17] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-05-29 06:55:17] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-29 06:55:17] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-05-29 06:55:18] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-05-29 06:55:18] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-29 06:55:18] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-05-29 06:55:18] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-05-29 06:55:19] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-29 06:55:19] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-05-29 06:55:19] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-05-29 06:55:20] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-29 06:55:20] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-05-29 06:55:20] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 2, #pending-token: 18, cuda graph: False, input throughput (token/s): 2.44
    [2026-05-29 06:55:20] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-29 06:55:20] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-05-29 06:55:21] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-29 06:55:21] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-05-29 06:55:22] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-29 06:55:22] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-05-29 06:55:23] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-29 06:55:23] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-05-29 06:55:24] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-29 06:55:24] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-05-29 06:55:25] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-29 06:55:25] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-05-29 06:55:26] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-29 06:55:26] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-05-29 06:55:27] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-29 06:55:27] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-05-29 06:55:28] Decode batch, #running-req: 1, #token: 42, token usage: 0.00, cuda graph: False, gen throughput (token/s): 2.29, #queue-req: 2
    [2026-05-29 06:55:28] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-29 06:55:28] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-05-29 06:55:28] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-29 06:55:28] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 1, #pending-token: 9, cuda graph: False, input throughput (token/s): 1.08


    [2026-05-29 06:55:29] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-05-29 06:55:30] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 6.72
    [2026-05-29 06:55:30] Decode batch, #running-req: 2, #token: 63, token usage: 0.00, cuda graph: False, gen throughput (token/s): 34.92, #queue-req: 0


    [2026-05-29 06:55:31] Decode batch, #running-req: 2, #token: 143, token usage: 0.01, cuda graph: False, gen throughput (token/s): 82.64, #queue-req: 0


    [2026-05-29 06:55:32] Decode batch, #running-req: 1, #token: 127, token usage: 0.01, cuda graph: False, gen throughput (token/s): 72.48, #queue-req: 0


    [2026-05-29 06:55:32] Decode batch, #running-req: 1, #token: 167, token usage: 0.01, cuda graph: False, gen throughput (token/s): 57.56, #queue-req: 0


    [2026-05-29 06:55:33] Decode batch, #running-req: 1, #token: 207, token usage: 0.01, cuda graph: False, gen throughput (token/s): 57.67, #queue-req: 0


    [2026-05-29 06:55:34] Decode batch, #running-req: 1, #token: 247, token usage: 0.01, cuda graph: False, gen throughput (token/s): 50.07, #queue-req: 0


    [2026-05-29 06:55:35] Decode batch, #running-req: 1, #token: 287, token usage: 0.01, cuda graph: False, gen throughput (token/s): 47.80, #queue-req: 0


    [2026-05-29 06:55:35] Decode batch, #running-req: 1, #token: 327, token usage: 0.02, cuda graph: False, gen throughput (token/s): 48.90, #queue-req: 0


    [2026-05-29 06:55:36] Decode batch, #running-req: 1, #token: 367, token usage: 0.02, cuda graph: False, gen throughput (token/s): 51.18, #queue-req: 0


    [2026-05-29 06:55:37] Decode batch, #running-req: 1, #token: 407, token usage: 0.02, cuda graph: False, gen throughput (token/s): 53.64, #queue-req: 0


    [2026-05-29 06:55:38] Decode batch, #running-req: 1, #token: 447, token usage: 0.02, cuda graph: False, gen throughput (token/s): 53.19, #queue-req: 0


    [2026-05-29 06:55:38] Decode batch, #running-req: 1, #token: 487, token usage: 0.02, cuda graph: False, gen throughput (token/s): 54.63, #queue-req: 0


    [2026-05-29 06:55:39] Decode batch, #running-req: 1, #token: 527, token usage: 0.03, cuda graph: False, gen throughput (token/s): 56.06, #queue-req: 0


    [2026-05-29 06:55:40] Decode batch, #running-req: 1, #token: 567, token usage: 0.03, cuda graph: False, gen throughput (token/s): 58.65, #queue-req: 0


    [2026-05-29 06:55:40] Decode batch, #running-req: 1, #token: 607, token usage: 0.03, cuda graph: False, gen throughput (token/s): 59.34, #queue-req: 0


    [2026-05-29 06:55:41] Decode batch, #running-req: 1, #token: 647, token usage: 0.03, cuda graph: False, gen throughput (token/s): 50.26, #queue-req: 0


    [2026-05-29 06:55:42] Decode batch, #running-req: 1, #token: 687, token usage: 0.03, cuda graph: False, gen throughput (token/s): 58.21, #queue-req: 0


    [2026-05-29 06:55:43] Decode batch, #running-req: 1, #token: 727, token usage: 0.04, cuda graph: False, gen throughput (token/s): 51.97, #queue-req: 0


    [2026-05-29 06:55:43] Decode batch, #running-req: 1, #token: 767, token usage: 0.04, cuda graph: False, gen throughput (token/s): 52.80, #queue-req: 0


    [2026-05-29 06:55:44] Decode batch, #running-req: 1, #token: 807, token usage: 0.04, cuda graph: False, gen throughput (token/s): 44.45, #queue-req: 0


    [2026-05-29 06:55:45] Decode batch, #running-req: 1, #token: 847, token usage: 0.04, cuda graph: False, gen throughput (token/s): 47.23, #queue-req: 0


    [2026-05-29 06:55:46] Decode batch, #running-req: 1, #token: 887, token usage: 0.04, cuda graph: False, gen throughput (token/s): 47.63, #queue-req: 0


    [2026-05-29 06:55:47] Decode batch, #running-req: 1, #token: 927, token usage: 0.05, cuda graph: False, gen throughput (token/s): 48.76, #queue-req: 0


    [2026-05-29 06:55:48] Decode batch, #running-req: 1, #token: 967, token usage: 0.05, cuda graph: False, gen throughput (token/s): 52.57, #queue-req: 0


    [2026-05-29 06:55:48] Decode batch, #running-req: 1, #token: 1007, token usage: 0.05, cuda graph: False, gen throughput (token/s): 57.91, #queue-req: 0


    [2026-05-29 06:55:49] INFO:     127.0.0.1:51054 - "POST /generate HTTP/1.1" 200 OK
    Output from lora0: 
