...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 301.36it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 251.64it/s]
...
```
    ...
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 7244.05it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 6808.94it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 111.91it/s]
...
```
    ...
    [2026-06-08 12:55:01] Load weight end. elapsed=4.11 s, type=LlamaForCausalLM, avail mem=34.41 GB, mem usage=15.77 GB.
    [2026-06-08 12:55:01] Using csgmv as backend of LoRA kernels.
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 10505.46it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 14169.95it/s]
    [2026-06-08 12:55:01] Found local HF snapshot for Nutanix/Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json at /root/.cache/huggingface/hub/models--Nutanix--Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json/snapshots/2c398740f3eba8dc63ee78999316b833a2833b6c; skipping download.
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 231.83it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 18098.40it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 81049.35it/s]
    [2026-06-08 12:55:01] Found local HF snapshot for algoprog/fact-generation-llama-3.1-8b-instruct-lora at /root/.cache/huggingface/hub/models--algoprog--fact-generation-llama-3.1-8b-instruct-lora/snapshots/dc8cdfb21993a6cb46199d6b1d79f68a42b06439; skipping download.


    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 179.30it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 10713.42it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 12327.12it/s]
    [2026-06-08 12:55:02] Found local HF snapshot for philschmid/code-llama-3-1-8b-text-to-sql-lora at /root/.cache/huggingface/hub/models--philschmid--code-llama-3-1-8b-text-to-sql-lora/snapshots/141fc3a09386a8baf0d7495c247ae2d1a565f69f; skipping download.


    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 111.13it/s]


    [2026-06-08 12:55:03] Max concurrent requests (per dp worker) from the finalized token capacity: max_num_reqs=128.
    [2026-06-08 12:55:03] KV Cache is allocated. dtype: torch.bfloat16, #tokens: 20480, K size: 1.25 GB, V size: 1.25 GB
    [2026-06-08 12:55:03] Memory pool end. avail mem=28.99 GB
    [2026-06-08 12:55:03] Disable piecewise CUDA graph because --disable-piecewise-cuda-graph is set


    [2026-06-08 12:55:09] max_total_num_tokens=20480, chunked_prefill_size=8192, max_prefill_tokens=16384, max_running_requests=128, context_len=131072, available_gpu_mem=28.85 GB
    [2026-06-08 12:55:09] Tree cache initialized: source=default impl=RadixCache hybrid_swa=False hybrid_ssm=False hierarchical=False streaming_wrapped=False


    [2026-06-08 12:55:09] INFO:     Started server process [3884141]
    [2026-06-08 12:55:09] INFO:     Waiting for application startup.
    [2026-06-08 12:55:09] Using default chat sampling params from model generation config: {'temperature': 0.6, 'top_p': 0.9}
    [2026-06-08 12:55:09] INFO:     Application startup complete.
    [2026-06-08 12:55:09] INFO:     Uvicorn running on http://127.0.0.1:39888 (Press CTRL+C to quit)


    /usr/local/lib/python3.10/dist-packages/fastapi/routing.py:120: FastAPIDeprecationWarning: ORJSONResponse is deprecated, FastAPI now serializes data directly to JSON bytes via Pydantic when a return type or response model is set, which is faster and doesn't need a custom response class. Read more in the FastAPI docs: https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model and https://fastapi.tiangolo.com/tutorial/response-model/
      response = await f(request)
    [2026-06-08 12:55:10] INFO:     127.0.0.1:34860 - "GET /v1/models HTTP/1.1" 200 OK


    [2026-06-08 12:55:10] INFO:     127.0.0.1:34872 - "GET /model_info HTTP/1.1" 200 OK


    [2026-06-08 12:55:11] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-08 12:55:11] LoRA expand (K=6144, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-08 12:55:11] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-08 12:55:11] LoRA expand (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}


    [2026-06-08 12:55:12] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-08 12:55:12] LoRA expand (K=28672, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-08 12:55:12] LoRA shrink (K=14336, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}


    [2026-06-08 12:55:12] Prefill batch, #new-seq: 1, #new-token: 7, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 2.13
    [2026-06-08 12:55:12] INFO:     127.0.0.1:34880 - "POST /generate HTTP/1.1" 200 OK
    [2026-06-08 12:55:12] The server is fired up and ready to roll!
...
```
    ...
    [2026-06-08 12:55:15] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-08 12:55:15] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-08 12:55:16] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-08 12:55:16] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-08 12:55:16] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-08 12:55:18] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-08 12:55:18] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-08 12:55:18] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-08 12:55:18] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-08 12:55:18] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-08 12:55:18] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-08 12:55:18] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-08 12:55:18] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 2, #pending-token: 18, cuda graph: False, input throughput (token/s): 1.42
    [2026-06-08 12:55:18] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-08 12:55:18] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-08 12:55:18] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-08 12:55:18] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-08 12:55:19] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-08 12:55:19] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-08 12:55:20] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-08 12:55:20] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-08 12:55:20] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-08 12:55:20] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-08 12:55:20] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-08 12:55:20] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-08 12:55:20] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-08 12:55:20] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-08 12:55:20] Decode batch, #running-req: 1, #token: 42, token usage: 0.00, cuda graph: False, gen throughput (token/s): 3.47, #queue-req: 2
    [2026-06-08 12:55:20] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-08 12:55:20] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-08 12:55:20] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-08 12:55:20] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-08 12:55:20] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-08 12:55:20] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-08 12:55:21] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-08 12:55:21] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-08 12:55:21] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-08 12:55:21] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-08 12:55:21] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-08 12:55:21] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-08 12:55:21] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-08 12:55:21] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-08 12:55:22] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-08 12:55:22] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-08 12:55:22] Prefill batch, #new-seq: 2, #new-token: 18, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 4.54
    [2026-06-08 12:55:23] Decode batch, #running-req: 2, #token: 36, token usage: 0.00, cuda graph: False, gen throughput (token/s): 21.32, #queue-req: 0


    [2026-06-08 12:55:23] Decode batch, #running-req: 2, #token: 116, token usage: 0.01, cuda graph: False, gen throughput (token/s): 88.59, #queue-req: 0


    [2026-06-08 12:55:24] Decode batch, #running-req: 1, #token: 98, token usage: 0.00, cuda graph: False, gen throughput (token/s): 61.06, #queue-req: 0


    [2026-06-08 12:55:25] Decode batch, #running-req: 1, #token: 138, token usage: 0.01, cuda graph: False, gen throughput (token/s): 44.11, #queue-req: 0


    [2026-06-08 12:55:26] Decode batch, #running-req: 1, #token: 178, token usage: 0.01, cuda graph: False, gen throughput (token/s): 42.77, #queue-req: 0


    [2026-06-08 12:55:27] Decode batch, #running-req: 1, #token: 218, token usage: 0.01, cuda graph: False, gen throughput (token/s): 43.23, #queue-req: 0


    [2026-06-08 12:55:28] Decode batch, #running-req: 1, #token: 258, token usage: 0.01, cuda graph: False, gen throughput (token/s): 44.45, #queue-req: 0


    [2026-06-08 12:55:29] Decode batch, #running-req: 1, #token: 298, token usage: 0.01, cuda graph: False, gen throughput (token/s): 46.17, #queue-req: 0


    [2026-06-08 12:55:30] Decode batch, #running-req: 1, #token: 338, token usage: 0.02, cuda graph: False, gen throughput (token/s): 44.28, #queue-req: 0


    [2026-06-08 12:55:31] Decode batch, #running-req: 1, #token: 378, token usage: 0.02, cuda graph: False, gen throughput (token/s): 46.65, #queue-req: 0


    [2026-06-08 12:55:32] Decode batch, #running-req: 1, #token: 418, token usage: 0.02, cuda graph: False, gen throughput (token/s): 45.30, #queue-req: 0


    [2026-06-08 12:55:32] Decode batch, #running-req: 1, #token: 458, token usage: 0.02, cuda graph: False, gen throughput (token/s): 46.87, #queue-req: 0


    [2026-06-08 12:55:33] Decode batch, #running-req: 1, #token: 498, token usage: 0.02, cuda graph: False, gen throughput (token/s): 47.75, #queue-req: 0


    [2026-06-08 12:55:34] Decode batch, #running-req: 1, #token: 538, token usage: 0.03, cuda graph: False, gen throughput (token/s): 47.64, #queue-req: 0


    [2026-06-08 12:55:35] Decode batch, #running-req: 1, #token: 578, token usage: 0.03, cuda graph: False, gen throughput (token/s): 48.36, #queue-req: 0


    [2026-06-08 12:55:36] Decode batch, #running-req: 1, #token: 618, token usage: 0.03, cuda graph: False, gen throughput (token/s): 48.01, #queue-req: 0


    [2026-06-08 12:55:37] Decode batch, #running-req: 1, #token: 658, token usage: 0.03, cuda graph: False, gen throughput (token/s): 44.90, #queue-req: 0


    [2026-06-08 12:55:37] Decode batch, #running-req: 1, #token: 698, token usage: 0.03, cuda graph: False, gen throughput (token/s): 50.11, #queue-req: 0


    [2026-06-08 12:55:38] Decode batch, #running-req: 1, #token: 738, token usage: 0.04, cuda graph: False, gen throughput (token/s): 51.57, #queue-req: 0


    [2026-06-08 12:55:39] Decode batch, #running-req: 1, #token: 778, token usage: 0.04, cuda graph: False, gen throughput (token/s): 50.65, #queue-req: 0


    [2026-06-08 12:55:40] Decode batch, #running-req: 1, #token: 818, token usage: 0.04, cuda graph: False, gen throughput (token/s): 49.94, #queue-req: 0


    [2026-06-08 12:55:41] Decode batch, #running-req: 1, #token: 858, token usage: 0.04, cuda graph: False, gen throughput (token/s): 50.29, #queue-req: 0


    [2026-06-08 12:55:41] Decode batch, #running-req: 1, #token: 898, token usage: 0.04, cuda graph: False, gen throughput (token/s): 52.51, #queue-req: 0


    [2026-06-08 12:55:42] Decode batch, #running-req: 1, #token: 938, token usage: 0.05, cuda graph: False, gen throughput (token/s): 51.67, #queue-req: 0


    [2026-06-08 12:55:43] Decode batch, #running-req: 1, #token: 978, token usage: 0.05, cuda graph: False, gen throughput (token/s): 50.36, #queue-req: 0


    [2026-06-08 12:55:44] Decode batch, #running-req: 1, #token: 1018, token usage: 0.05, cuda graph: False, gen throughput (token/s): 50.61, #queue-req: 0


    [2026-06-08 12:55:44] INFO:     127.0.0.1:60136 - "POST /generate HTTP/1.1" 200 OK
    Output from lora0: 
