...
```
    ...
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 5847.76it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 181.05it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 178.49it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 83886.08it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 83468.74it/s]
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 119.67it/s]
...
```
    ...
    [2026-06-08 08:16:34] Load weight end. elapsed=3.08 s, type=LlamaForCausalLM, avail mem=63.48 GB, mem usage=15.02 GB.
    [2026-06-08 08:16:34] Using csgmv as backend of LoRA kernels.
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 19021.79it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 90687.65it/s]
    [2026-06-08 08:16:34] Found local HF snapshot for Nutanix/Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json at /root/.cache/huggingface/hub/models--Nutanix--Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json/snapshots/2c398740f3eba8dc63ee78999316b833a2833b6c; skipping download.
    ...
    [2026-06-08 08:16:34] Found local HF snapshot for algoprog/fact-generation-llama-3.1-8b-instruct-lora at /root/.cache/huggingface/hub/models--algoprog--fact-generation-llama-3.1-8b-instruct-lora/snapshots/dc8cdfb21993a6cb46199d6b1d79f68a42b06439; skipping download.
    ...
    [2026-06-08 08:16:35] Found local HF snapshot for philschmid/code-llama-3-1-8b-text-to-sql-lora at /root/.cache/huggingface/hub/models--philschmid--code-llama-3-1-8b-text-to-sql-lora/snapshots/141fc3a09386a8baf0d7495c247ae2d1a565f69f; skipping download.
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 115.87it/s]


    [2026-06-08 08:16:36] Max concurrent requests (per dp worker) from the finalized token capacity: max_num_reqs=128.
    [2026-06-08 08:16:36] KV Cache is allocated. dtype: torch.bfloat16, #tokens: 20480, K size: 1.25 GB, V size: 1.25 GB
    [2026-06-08 08:16:36] Memory pool end. avail mem=58.26 GB
    [2026-06-08 08:16:36] Disable piecewise CUDA graph because --disable-piecewise-cuda-graph is set


    [2026-06-08 08:16:40] max_total_num_tokens=20480, chunked_prefill_size=8192, max_prefill_tokens=16384, max_running_requests=128, context_len=131072, available_gpu_mem=43.45 GB
    [2026-06-08 08:16:40] Tree cache initialized: source=default impl=RadixCache hybrid_swa=False hybrid_ssm=False hierarchical=False streaming_wrapped=False


    [2026-06-08 08:16:41] INFO:     Started server process [3654689]
    [2026-06-08 08:16:41] INFO:     Waiting for application startup.
    [2026-06-08 08:16:41] Using default chat sampling params from model generation config: {'temperature': 0.6, 'top_p': 0.9}
    [2026-06-08 08:16:41] INFO:     Application startup complete.
    [2026-06-08 08:16:41] INFO:     Uvicorn running on http://127.0.0.1:32353 (Press CTRL+C to quit)


    /usr/local/lib/python3.10/dist-packages/fastapi/routing.py:120: FastAPIDeprecationWarning: ORJSONResponse is deprecated, FastAPI now serializes data directly to JSON bytes via Pydantic when a return type or response model is set, which is faster and doesn't need a custom response class. Read more in the FastAPI docs: https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model and https://fastapi.tiangolo.com/tutorial/response-model/
      response = await f(request)
    [2026-06-08 08:16:41] INFO:     127.0.0.1:57442 - "GET /v1/models HTTP/1.1" 200 OK


    [2026-06-08 08:16:42] INFO:     127.0.0.1:57450 - "GET /model_info HTTP/1.1" 200 OK


    [2026-06-08 08:16:43] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-08 08:16:43] LoRA expand (K=6144, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-08 08:16:43] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-08 08:16:43] LoRA expand (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}


    [2026-06-08 08:16:43] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-08 08:16:43] LoRA expand (K=28672, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-08 08:16:43] LoRA shrink (K=14336, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}


    [2026-06-08 08:16:43] Prefill batch, #new-seq: 1, #new-token: 7, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 2.22
    [2026-06-08 08:16:43] INFO:     127.0.0.1:57462 - "POST /generate HTTP/1.1" 200 OK
    [2026-06-08 08:16:43] The server is fired up and ready to roll!
...
```
    ...
    [2026-06-08 08:16:46] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-08 08:16:46] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-08 08:16:47] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-08 08:16:47] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-08 08:16:47] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-08 08:16:49] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-08 08:16:49] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-08 08:16:49] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-08 08:16:49] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-08 08:16:49] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 2, #pending-token: 18, cuda graph: False, input throughput (token/s): 1.51
    [2026-06-08 08:16:49] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-08 08:16:49] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-08 08:16:50] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-08 08:16:50] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 1, #pending-token: 9, cuda graph: False, input throughput (token/s): 20.69


    [2026-06-08 08:16:50] Decode batch, #running-req: 2, #token: 76, token usage: 0.00, cuda graph: False, gen throughput (token/s): 6.36, #queue-req: 1


    [2026-06-08 08:16:51] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-08 08:16:51] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 5.79
    [2026-06-08 08:16:51] Decode batch, #running-req: 2, #token: 85, token usage: 0.00, cuda graph: False, gen throughput (token/s): 68.81, #queue-req: 0


    [2026-06-08 08:16:52] Decode batch, #running-req: 2, #token: 165, token usage: 0.01, cuda graph: False, gen throughput (token/s): 77.43, #queue-req: 0


    [2026-06-08 08:16:53] Decode batch, #running-req: 1, #token: 154, token usage: 0.01, cuda graph: False, gen throughput (token/s): 67.49, #queue-req: 0


    [2026-06-08 08:16:54] Decode batch, #running-req: 1, #token: 194, token usage: 0.01, cuda graph: False, gen throughput (token/s): 52.08, #queue-req: 0


    [2026-06-08 08:16:55] Decode batch, #running-req: 1, #token: 234, token usage: 0.01, cuda graph: False, gen throughput (token/s): 57.20, #queue-req: 0


    [2026-06-08 08:16:55] Decode batch, #running-req: 1, #token: 274, token usage: 0.01, cuda graph: False, gen throughput (token/s): 56.09, #queue-req: 0


    [2026-06-08 08:16:56] Decode batch, #running-req: 1, #token: 314, token usage: 0.02, cuda graph: False, gen throughput (token/s): 50.44, #queue-req: 0


    [2026-06-08 08:16:57] Decode batch, #running-req: 1, #token: 354, token usage: 0.02, cuda graph: False, gen throughput (token/s): 51.34, #queue-req: 0


    [2026-06-08 08:16:58] Decode batch, #running-req: 1, #token: 394, token usage: 0.02, cuda graph: False, gen throughput (token/s): 49.71, #queue-req: 0


    [2026-06-08 08:16:59] Decode batch, #running-req: 1, #token: 434, token usage: 0.02, cuda graph: False, gen throughput (token/s): 36.06, #queue-req: 0


    [2026-06-08 08:17:00] Decode batch, #running-req: 1, #token: 474, token usage: 0.02, cuda graph: False, gen throughput (token/s): 36.12, #queue-req: 0


    [2026-06-08 08:17:01] Decode batch, #running-req: 1, #token: 514, token usage: 0.03, cuda graph: False, gen throughput (token/s): 44.42, #queue-req: 0


    [2026-06-08 08:17:02] Decode batch, #running-req: 1, #token: 554, token usage: 0.03, cuda graph: False, gen throughput (token/s): 50.66, #queue-req: 0


    [2026-06-08 08:17:03] Decode batch, #running-req: 1, #token: 594, token usage: 0.03, cuda graph: False, gen throughput (token/s): 45.24, #queue-req: 0


    [2026-06-08 08:17:03] Decode batch, #running-req: 1, #token: 634, token usage: 0.03, cuda graph: False, gen throughput (token/s): 44.73, #queue-req: 0


    [2026-06-08 08:17:04] Decode batch, #running-req: 1, #token: 674, token usage: 0.03, cuda graph: False, gen throughput (token/s): 50.44, #queue-req: 0


    [2026-06-08 08:17:05] Decode batch, #running-req: 1, #token: 714, token usage: 0.03, cuda graph: False, gen throughput (token/s): 56.91, #queue-req: 0


    [2026-06-08 08:17:06] Decode batch, #running-req: 1, #token: 754, token usage: 0.04, cuda graph: False, gen throughput (token/s): 57.94, #queue-req: 0


    [2026-06-08 08:17:07] Decode batch, #running-req: 1, #token: 794, token usage: 0.04, cuda graph: False, gen throughput (token/s): 34.26, #queue-req: 0


    [2026-06-08 08:17:08] Decode batch, #running-req: 1, #token: 834, token usage: 0.04, cuda graph: False, gen throughput (token/s): 40.24, #queue-req: 0


    [2026-06-08 08:17:09] Decode batch, #running-req: 1, #token: 874, token usage: 0.04, cuda graph: False, gen throughput (token/s): 54.71, #queue-req: 0


    [2026-06-08 08:17:09] Decode batch, #running-req: 1, #token: 914, token usage: 0.04, cuda graph: False, gen throughput (token/s): 52.84, #queue-req: 0


    [2026-06-08 08:17:10] Decode batch, #running-req: 1, #token: 954, token usage: 0.05, cuda graph: False, gen throughput (token/s): 53.49, #queue-req: 0


    [2026-06-08 08:17:11] Decode batch, #running-req: 1, #token: 994, token usage: 0.05, cuda graph: False, gen throughput (token/s): 54.29, #queue-req: 0


    [2026-06-08 08:17:12] Decode batch, #running-req: 1, #token: 0, token usage: 0.00, cuda graph: False, gen throughput (token/s): 46.37, #queue-req: 0
    [2026-06-08 08:17:12] INFO:     127.0.0.1:37168 - "POST /generate HTTP/1.1" 200 OK
    Output from lora0: 
