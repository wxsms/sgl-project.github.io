...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 188.51it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 192.86it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 189.55it/s]
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 113.04it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 201.38it/s]
...
```
    ...
    [2026-06-06 05:40:01] Load weight end. elapsed=2.56 s, type=LlamaForCausalLM, avail mem=63.48 GB, mem usage=15.02 GB.
    [2026-06-06 05:40:01] Using csgmv as backend of LoRA kernels.
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 9279.43it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 100462.37it/s]


    [2026-06-06 05:40:02] Found local HF snapshot for Nutanix/Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json at /root/.cache/huggingface/hub/models--Nutanix--Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json/snapshots/2c398740f3eba8dc63ee78999316b833a2833b6c; skipping download.
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 216.75it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 99864.38it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 17367.72it/s]
    [2026-06-06 05:40:02] Found local HF snapshot for algoprog/fact-generation-llama-3.1-8b-instruct-lora at /root/.cache/huggingface/hub/models--algoprog--fact-generation-llama-3.1-8b-instruct-lora/snapshots/dc8cdfb21993a6cb46199d6b1d79f68a42b06439; skipping download.


    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 202.74it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 10713.42it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 21210.13it/s]
    [2026-06-06 05:40:03] Found local HF snapshot for philschmid/code-llama-3-1-8b-text-to-sql-lora at /root/.cache/huggingface/hub/models--philschmid--code-llama-3-1-8b-text-to-sql-lora/snapshots/141fc3a09386a8baf0d7495c247ae2d1a565f69f; skipping download.


    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 116.20it/s]


    [2026-06-06 05:40:04] Max concurrent requests (per dp worker) from the finalized token capacity: max_num_reqs=128.
    [2026-06-06 05:40:04] KV Cache is allocated. dtype: torch.bfloat16, #tokens: 20480, K size: 1.25 GB, V size: 1.25 GB
    [2026-06-06 05:40:04] Memory pool end. avail mem=58.26 GB
    [2026-06-06 05:40:04] Disable piecewise CUDA graph because --disable-piecewise-cuda-graph is set


    [2026-06-06 05:40:08] max_total_num_tokens=20480, chunked_prefill_size=8192, max_prefill_tokens=16384, max_running_requests=128, context_len=131072, available_gpu_mem=49.26 GB
    [2026-06-06 05:40:08] Tree cache initialized: source=default impl=RadixCache hybrid_swa=False hybrid_ssm=False hierarchical=False streaming_wrapped=False


    [2026-06-06 05:40:09] INFO:     Started server process [2624773]
    [2026-06-06 05:40:09] INFO:     Waiting for application startup.
    [2026-06-06 05:40:09] Using default chat sampling params from model generation config: {'temperature': 0.6, 'top_p': 0.9}
    [2026-06-06 05:40:09] INFO:     Application startup complete.
    [2026-06-06 05:40:09] INFO:     Uvicorn running on http://127.0.0.1:36219 (Press CTRL+C to quit)
    /usr/local/lib/python3.10/dist-packages/fastapi/routing.py:120: FastAPIDeprecationWarning: ORJSONResponse is deprecated, FastAPI now serializes data directly to JSON bytes via Pydantic when a return type or response model is set, which is faster and doesn't need a custom response class. Read more in the FastAPI docs: https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model and https://fastapi.tiangolo.com/tutorial/response-model/
      response = await f(request)
    [2026-06-06 05:40:09] INFO:     127.0.0.1:43746 - "GET /v1/models HTTP/1.1" 200 OK


    [2026-06-06 05:40:10] INFO:     127.0.0.1:43750 - "GET /model_info HTTP/1.1" 200 OK


    [2026-06-06 05:40:11] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-06 05:40:11] LoRA expand (K=6144, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-06 05:40:11] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-06 05:40:11] LoRA expand (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}


    [2026-06-06 05:40:11] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-06 05:40:11] LoRA expand (K=28672, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-06 05:40:11] LoRA shrink (K=14336, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}


    [2026-06-06 05:40:12] Prefill batch, #new-seq: 1, #new-token: 7, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 2.30
    [2026-06-06 05:40:12] INFO:     127.0.0.1:43756 - "POST /generate HTTP/1.1" 200 OK
    [2026-06-06 05:40:12] The server is fired up and ready to roll!
...
```
    ...
    [2026-06-06 05:40:14] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-06 05:40:14] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-06 05:40:14] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-06 05:40:14] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-06 05:40:14] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-06 05:40:16] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-06 05:40:16] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-06 05:40:16] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-06 05:40:16] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-06 05:40:17] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 2, #pending-token: 18, cuda graph: False, input throughput (token/s): 1.77
    [2026-06-06 05:40:17] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-06 05:40:17] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-06 05:40:17] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-06 05:40:17] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-06 05:40:17] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-06 05:40:17] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-06 05:40:18] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-06 05:40:18] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-06 05:40:18] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-06 05:40:18] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 1, #pending-token: 9, cuda graph: False, input throughput (token/s): 5.06


    [2026-06-06 05:40:19] Decode batch, #running-req: 2, #token: 70, token usage: 0.00, cuda graph: False, gen throughput (token/s): 5.65, #queue-req: 1


    [2026-06-06 05:40:19] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-06 05:40:20] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 7.35
    [2026-06-06 05:40:20] Decode batch, #running-req: 2, #token: 84, token usage: 0.00, cuda graph: False, gen throughput (token/s): 79.76, #queue-req: 0


    [2026-06-06 05:40:20] Decode batch, #running-req: 2, #token: 164, token usage: 0.01, cuda graph: False, gen throughput (token/s): 108.28, #queue-req: 0


    [2026-06-06 05:40:21] Decode batch, #running-req: 1, #token: 148, token usage: 0.01, cuda graph: False, gen throughput (token/s): 81.46, #queue-req: 0


    [2026-06-06 05:40:22] Decode batch, #running-req: 1, #token: 188, token usage: 0.01, cuda graph: False, gen throughput (token/s): 57.39, #queue-req: 0


    [2026-06-06 05:40:23] Decode batch, #running-req: 1, #token: 228, token usage: 0.01, cuda graph: False, gen throughput (token/s): 57.24, #queue-req: 0


    [2026-06-06 05:40:23] Decode batch, #running-req: 1, #token: 268, token usage: 0.01, cuda graph: False, gen throughput (token/s): 57.20, #queue-req: 0


    [2026-06-06 05:40:24] Decode batch, #running-req: 1, #token: 308, token usage: 0.02, cuda graph: False, gen throughput (token/s): 57.17, #queue-req: 0


    [2026-06-06 05:40:25] Decode batch, #running-req: 1, #token: 348, token usage: 0.02, cuda graph: False, gen throughput (token/s): 57.66, #queue-req: 0


    [2026-06-06 05:40:25] Decode batch, #running-req: 1, #token: 388, token usage: 0.02, cuda graph: False, gen throughput (token/s): 56.31, #queue-req: 0


    [2026-06-06 05:40:26] Decode batch, #running-req: 1, #token: 428, token usage: 0.02, cuda graph: False, gen throughput (token/s): 55.35, #queue-req: 0


    [2026-06-06 05:40:27] Decode batch, #running-req: 1, #token: 468, token usage: 0.02, cuda graph: False, gen throughput (token/s): 57.17, #queue-req: 0


    [2026-06-06 05:40:28] Decode batch, #running-req: 1, #token: 508, token usage: 0.02, cuda graph: False, gen throughput (token/s): 50.35, #queue-req: 0


    [2026-06-06 05:40:28] Decode batch, #running-req: 1, #token: 548, token usage: 0.03, cuda graph: False, gen throughput (token/s): 50.06, #queue-req: 0


    [2026-06-06 05:40:29] Decode batch, #running-req: 1, #token: 588, token usage: 0.03, cuda graph: False, gen throughput (token/s): 51.27, #queue-req: 0


    [2026-06-06 05:40:30] Decode batch, #running-req: 1, #token: 628, token usage: 0.03, cuda graph: False, gen throughput (token/s): 56.00, #queue-req: 0


    [2026-06-06 05:40:31] Decode batch, #running-req: 1, #token: 668, token usage: 0.03, cuda graph: False, gen throughput (token/s): 54.12, #queue-req: 0


    [2026-06-06 05:40:31] Decode batch, #running-req: 1, #token: 708, token usage: 0.03, cuda graph: False, gen throughput (token/s): 55.40, #queue-req: 0


    [2026-06-06 05:40:32] Decode batch, #running-req: 1, #token: 748, token usage: 0.04, cuda graph: False, gen throughput (token/s): 55.00, #queue-req: 0


    [2026-06-06 05:40:33] Decode batch, #running-req: 1, #token: 788, token usage: 0.04, cuda graph: False, gen throughput (token/s): 55.41, #queue-req: 0


    [2026-06-06 05:40:34] Decode batch, #running-req: 1, #token: 828, token usage: 0.04, cuda graph: False, gen throughput (token/s): 54.35, #queue-req: 0


    [2026-06-06 05:40:34] Decode batch, #running-req: 1, #token: 868, token usage: 0.04, cuda graph: False, gen throughput (token/s): 56.59, #queue-req: 0


    [2026-06-06 05:40:35] Decode batch, #running-req: 1, #token: 908, token usage: 0.04, cuda graph: False, gen throughput (token/s): 54.50, #queue-req: 0


    [2026-06-06 05:40:36] Decode batch, #running-req: 1, #token: 948, token usage: 0.05, cuda graph: False, gen throughput (token/s): 54.72, #queue-req: 0


    [2026-06-06 05:40:36] Decode batch, #running-req: 1, #token: 988, token usage: 0.05, cuda graph: False, gen throughput (token/s): 53.70, #queue-req: 0


    [2026-06-06 05:40:37] Decode batch, #running-req: 1, #token: 1028, token usage: 0.05, cuda graph: False, gen throughput (token/s): 54.86, #queue-req: 0
    [2026-06-06 05:40:37] INFO:     127.0.0.1:38800 - "POST /generate HTTP/1.1" 200 OK
    Output from lora0: 
