...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 341.31it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 353.15it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 74.18it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 172.42it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 184.85it/s]
...
```
    ...
    [2026-05-26 03:30:08] Load weight end. elapsed=3.61 s, type=LlamaForCausalLM, avail mem=45.32 GB, mem usage=14.65 GB.
    [2026-05-26 03:30:08] Using csgmv as backend of LoRA kernels.
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 4921.45it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 33091.16it/s]
    [2026-05-26 03:30:08] Found local HF snapshot for Nutanix/Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json at /root/.cache/huggingface/hub/models--Nutanix--Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json/snapshots/2c398740f3eba8dc63ee78999316b833a2833b6c; skipping download.
    ...
    [2026-05-26 03:30:08] Found local HF snapshot for algoprog/fact-generation-llama-3.1-8b-instruct-lora at /root/.cache/huggingface/hub/models--algoprog--fact-generation-llama-3.1-8b-instruct-lora/snapshots/dc8cdfb21993a6cb46199d6b1d79f68a42b06439; skipping download.
    ...
    [2026-05-26 03:30:09] Found local HF snapshot for philschmid/code-llama-3-1-8b-text-to-sql-lora at /root/.cache/huggingface/hub/models--philschmid--code-llama-3-1-8b-text-to-sql-lora/snapshots/141fc3a09386a8baf0d7495c247ae2d1a565f69f; skipping download.
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 90.65it/s]


    [2026-05-26 03:30:12] KV Cache is allocated. dtype: torch.bfloat16, #tokens: 20480, K size: 1.25 GB, V size: 1.25 GB
    [2026-05-26 03:30:12] Memory pool end. avail mem=38.58 GB
    [2026-05-26 03:30:12] Disable piecewise CUDA graph because --disable-piecewise-cuda-graph is set


    [2026-05-26 03:30:15] max_total_num_tokens=20480, chunked_prefill_size=8192, max_prefill_tokens=16384, max_running_requests=128, context_len=131072, available_gpu_mem=38.45 GB
    [2026-05-26 03:30:15] Tree cache initialized: source=default impl=RadixCache hybrid_swa=False hybrid_ssm=False hierarchical=False streaming_wrapped=False


    [2026-05-26 03:30:16] INFO:     Started server process [3368458]
    [2026-05-26 03:30:16] INFO:     Waiting for application startup.
    [2026-05-26 03:30:16] Using default chat sampling params from model generation config: {'temperature': 0.6, 'top_p': 0.9}
    [2026-05-26 03:30:16] INFO:     Application startup complete.
    [2026-05-26 03:30:16] INFO:     Uvicorn running on http://127.0.0.1:31463 (Press CTRL+C to quit)


    /usr/local/lib/python3.10/dist-packages/fastapi/routing.py:120: FastAPIDeprecationWarning: ORJSONResponse is deprecated, FastAPI now serializes data directly to JSON bytes via Pydantic when a return type or response model is set, which is faster and doesn't need a custom response class. Read more in the FastAPI docs: https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model and https://fastapi.tiangolo.com/tutorial/response-model/
      response = await f(request)
    [2026-05-26 03:30:16] INFO:     127.0.0.1:55108 - "GET /v1/models HTTP/1.1" 200 OK


    [2026-05-26 03:30:17] INFO:     127.0.0.1:55110 - "GET /model_info HTTP/1.1" 200 OK


    [2026-05-26 03:30:18] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-05-26 03:30:18] LoRA expand (K=6144, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-05-26 03:30:18] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-05-26 03:30:18] LoRA expand (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}


    [2026-05-26 03:30:19] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-05-26 03:30:19] LoRA expand (K=28672, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}


    [2026-05-26 03:30:20] LoRA shrink (K=14336, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-05-26 03:30:20] Prefill batch, #new-seq: 1, #new-token: 7, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 1.40


    [2026-05-26 03:30:20] INFO:     127.0.0.1:55122 - "POST /generate HTTP/1.1" 200 OK
    [2026-05-26 03:30:20] The server is fired up and ready to roll!
...
```
    ...
    [2026-05-26 03:30:21] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-26 03:30:21] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-05-26 03:30:21] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-05-26 03:30:22] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-26 03:30:22] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-05-26 03:30:22] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 2, #pending-token: 18, cuda graph: False, input throughput (token/s): 4.58
    [2026-05-26 03:30:22] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-26 03:30:22] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-05-26 03:30:23] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-26 03:30:23] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-05-26 03:30:24] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-26 03:30:24] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-05-26 03:30:25] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-26 03:30:25] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-05-26 03:30:26] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-26 03:30:26] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-05-26 03:30:26] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-26 03:30:26] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 1, #pending-token: 9, cuda graph: False, input throughput (token/s): 2.30


    [2026-05-26 03:30:26] Decode batch, #running-req: 2, #token: 67, token usage: 0.00, cuda graph: False, gen throughput (token/s): 4.92, #queue-req: 1


    [2026-05-26 03:30:27] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-05-26 03:30:27] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 7.41
    [2026-05-26 03:30:27] Decode batch, #running-req: 2, #token: 81, token usage: 0.00, cuda graph: False, gen throughput (token/s): 75.27, #queue-req: 0


    [2026-05-26 03:30:28] Decode batch, #running-req: 2, #token: 161, token usage: 0.01, cuda graph: False, gen throughput (token/s): 103.66, #queue-req: 0


    [2026-05-26 03:30:29] Decode batch, #running-req: 1, #token: 145, token usage: 0.01, cuda graph: False, gen throughput (token/s): 72.13, #queue-req: 0


    [2026-05-26 03:30:30] Decode batch, #running-req: 1, #token: 185, token usage: 0.01, cuda graph: False, gen throughput (token/s): 54.83, #queue-req: 0


    [2026-05-26 03:30:30] Decode batch, #running-req: 1, #token: 225, token usage: 0.01, cuda graph: False, gen throughput (token/s): 55.43, #queue-req: 0


    [2026-05-26 03:30:31] Decode batch, #running-req: 1, #token: 265, token usage: 0.01, cuda graph: False, gen throughput (token/s): 52.26, #queue-req: 0


    [2026-05-26 03:30:32] Decode batch, #running-req: 1, #token: 305, token usage: 0.01, cuda graph: False, gen throughput (token/s): 52.89, #queue-req: 0


    [2026-05-26 03:30:33] Decode batch, #running-req: 1, #token: 345, token usage: 0.02, cuda graph: False, gen throughput (token/s): 43.51, #queue-req: 0


    [2026-05-26 03:30:34] Decode batch, #running-req: 1, #token: 385, token usage: 0.02, cuda graph: False, gen throughput (token/s): 56.99, #queue-req: 0


    [2026-05-26 03:30:34] Decode batch, #running-req: 1, #token: 425, token usage: 0.02, cuda graph: False, gen throughput (token/s): 58.37, #queue-req: 0


    [2026-05-26 03:30:35] Decode batch, #running-req: 1, #token: 465, token usage: 0.02, cuda graph: False, gen throughput (token/s): 54.04, #queue-req: 0


    [2026-05-26 03:30:36] Decode batch, #running-req: 1, #token: 505, token usage: 0.02, cuda graph: False, gen throughput (token/s): 55.62, #queue-req: 0


    [2026-05-26 03:30:36] Decode batch, #running-req: 1, #token: 545, token usage: 0.03, cuda graph: False, gen throughput (token/s): 55.57, #queue-req: 0


    [2026-05-26 03:30:37] Decode batch, #running-req: 1, #token: 585, token usage: 0.03, cuda graph: False, gen throughput (token/s): 50.79, #queue-req: 0


    [2026-05-26 03:30:38] Decode batch, #running-req: 1, #token: 625, token usage: 0.03, cuda graph: False, gen throughput (token/s): 56.55, #queue-req: 0


    [2026-05-26 03:30:39] Decode batch, #running-req: 1, #token: 665, token usage: 0.03, cuda graph: False, gen throughput (token/s): 59.42, #queue-req: 0


    [2026-05-26 03:30:39] Decode batch, #running-req: 1, #token: 705, token usage: 0.03, cuda graph: False, gen throughput (token/s): 58.40, #queue-req: 0


    [2026-05-26 03:30:40] Decode batch, #running-req: 1, #token: 745, token usage: 0.04, cuda graph: False, gen throughput (token/s): 56.94, #queue-req: 0


    [2026-05-26 03:30:41] Decode batch, #running-req: 1, #token: 785, token usage: 0.04, cuda graph: False, gen throughput (token/s): 51.22, #queue-req: 0


    [2026-05-26 03:30:42] Decode batch, #running-req: 1, #token: 825, token usage: 0.04, cuda graph: False, gen throughput (token/s): 35.45, #queue-req: 0


    [2026-05-26 03:30:43] Decode batch, #running-req: 1, #token: 865, token usage: 0.04, cuda graph: False, gen throughput (token/s): 45.68, #queue-req: 0


    [2026-05-26 03:30:44] Decode batch, #running-req: 1, #token: 905, token usage: 0.04, cuda graph: False, gen throughput (token/s): 53.07, #queue-req: 0


    [2026-05-26 03:30:44] Decode batch, #running-req: 1, #token: 945, token usage: 0.05, cuda graph: False, gen throughput (token/s): 47.98, #queue-req: 0


    [2026-05-26 03:30:45] Decode batch, #running-req: 1, #token: 985, token usage: 0.05, cuda graph: False, gen throughput (token/s): 47.92, #queue-req: 0


    [2026-05-26 03:30:46] Decode batch, #running-req: 1, #token: 1025, token usage: 0.05, cuda graph: False, gen throughput (token/s): 48.35, #queue-req: 0
    [2026-05-26 03:30:46] INFO:     127.0.0.1:55124 - "POST /generate HTTP/1.1" 200 OK
    Output from lora0: 
