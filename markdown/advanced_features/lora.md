...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 330.99it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 118.74it/s]
...
```
    ...
    [2026-06-01 23:05:50] Load weight end. elapsed=3.15 s, type=LlamaForCausalLM, avail mem=63.48 GB, mem usage=15.02 GB.
    [2026-06-01 23:05:50] Using csgmv as backend of LoRA kernels.
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 9570.57it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 91180.52it/s]
    [2026-06-01 23:05:51] Found local HF snapshot for Nutanix/Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json at /root/.cache/huggingface/hub/models--Nutanix--Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json/snapshots/2c398740f3eba8dc63ee78999316b833a2833b6c; skipping download.
    ...
    [2026-06-01 23:05:51] Found local HF snapshot for algoprog/fact-generation-llama-3.1-8b-instruct-lora at /root/.cache/huggingface/hub/models--algoprog--fact-generation-llama-3.1-8b-instruct-lora/snapshots/dc8cdfb21993a6cb46199d6b1d79f68a42b06439; skipping download.
    ...
    [2026-06-01 23:05:51] Found local HF snapshot for philschmid/code-llama-3-1-8b-text-to-sql-lora at /root/.cache/huggingface/hub/models--philschmid--code-llama-3-1-8b-text-to-sql-lora/snapshots/141fc3a09386a8baf0d7495c247ae2d1a565f69f; skipping download.
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 121.95it/s]


    [2026-06-01 23:05:52] Max concurrent requests (per dp worker) from the finalized token capacity: max_num_reqs=128.
    [2026-06-01 23:05:52] KV Cache is allocated. dtype: torch.bfloat16, #tokens: 20480, K size: 1.25 GB, V size: 1.25 GB
    [2026-06-01 23:05:52] Memory pool end. avail mem=58.26 GB
    [2026-06-01 23:05:52] Disable piecewise CUDA graph because --disable-piecewise-cuda-graph is set


    [2026-06-01 23:05:56] max_total_num_tokens=20480, chunked_prefill_size=8192, max_prefill_tokens=16384, max_running_requests=128, context_len=131072, available_gpu_mem=58.17 GB
    [2026-06-01 23:05:56] Tree cache initialized: source=default impl=RadixCache hybrid_swa=False hybrid_ssm=False hierarchical=False streaming_wrapped=False


    [2026-06-01 23:05:57] INFO:     Started server process [2931230]
    [2026-06-01 23:05:57] INFO:     Waiting for application startup.
    [2026-06-01 23:05:57] Using default chat sampling params from model generation config: {'temperature': 0.6, 'top_p': 0.9}
    [2026-06-01 23:05:57] INFO:     Application startup complete.
    [2026-06-01 23:05:57] INFO:     Uvicorn running on http://127.0.0.1:32457 (Press CTRL+C to quit)
    /usr/local/lib/python3.10/dist-packages/fastapi/routing.py:120: FastAPIDeprecationWarning: ORJSONResponse is deprecated, FastAPI now serializes data directly to JSON bytes via Pydantic when a return type or response model is set, which is faster and doesn't need a custom response class. Read more in the FastAPI docs: https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model and https://fastapi.tiangolo.com/tutorial/response-model/
      response = await f(request)
    [2026-06-01 23:05:57] INFO:     127.0.0.1:49184 - "GET /v1/models HTTP/1.1" 200 OK


    [2026-06-01 23:05:58] INFO:     127.0.0.1:49198 - "GET /model_info HTTP/1.1" 200 OK


    [2026-06-01 23:05:59] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-01 23:05:59] LoRA expand (K=6144, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-01 23:05:59] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-01 23:05:59] LoRA expand (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}


    [2026-06-01 23:05:59] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-01 23:05:59] LoRA expand (K=28672, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-01 23:05:59] LoRA shrink (K=14336, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}


    [2026-06-01 23:05:59] Prefill batch, #new-seq: 1, #new-token: 7, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 2.24
    [2026-06-01 23:06:00] INFO:     127.0.0.1:49212 - "POST /generate HTTP/1.1" 200 OK
    [2026-06-01 23:06:00] The server is fired up and ready to roll!
...
```
    ...
    [2026-06-01 23:06:02] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-01 23:06:02] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-01 23:06:02] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-01 23:06:05] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-01 23:06:05] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-01 23:06:05] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-01 23:06:05] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-01 23:06:05] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-01 23:06:05] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 2, #pending-token: 18, cuda graph: False, input throughput (token/s): 1.51
    [2026-06-01 23:06:05] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-01 23:06:05] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-01 23:06:05] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-01 23:06:05] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-01 23:06:06] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-01 23:06:06] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-01 23:06:06] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-01 23:06:06] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-01 23:06:06] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-01 23:06:06] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-01 23:06:06] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-01 23:06:06] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-01 23:06:07] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-01 23:06:07] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-01 23:06:07] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-01 23:06:07] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-01 23:06:07] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-01 23:06:07] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-01 23:06:07] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-01 23:06:07] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-01 23:06:07] Decode batch, #running-req: 1, #token: 42, token usage: 0.00, cuda graph: False, gen throughput (token/s): 3.68, #queue-req: 2
    [2026-06-01 23:06:07] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-01 23:06:07] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-01 23:06:07] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-01 23:06:07] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-01 23:06:07] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-01 23:06:07] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-01 23:06:08] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-01 23:06:08] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-01 23:06:08] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-01 23:06:08] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-01 23:06:09] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 1, #pending-token: 9, cuda graph: False, input throughput (token/s): 2.83


    [2026-06-01 23:06:09] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-01 23:06:09] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 41.09


    [2026-06-01 23:06:09] Decode batch, #running-req: 2, #token: 41, token usage: 0.00, cuda graph: False, gen throughput (token/s): 31.02, #queue-req: 0


    [2026-06-01 23:06:10] Decode batch, #running-req: 2, #token: 121, token usage: 0.01, cuda graph: False, gen throughput (token/s): 105.26, #queue-req: 0


    [2026-06-01 23:06:10] Decode batch, #running-req: 1, #token: 105, token usage: 0.01, cuda graph: False, gen throughput (token/s): 81.56, #queue-req: 0


    [2026-06-01 23:06:11] Decode batch, #running-req: 1, #token: 145, token usage: 0.01, cuda graph: False, gen throughput (token/s): 58.28, #queue-req: 0


    [2026-06-01 23:06:12] Decode batch, #running-req: 1, #token: 185, token usage: 0.01, cuda graph: False, gen throughput (token/s): 57.28, #queue-req: 0


    [2026-06-01 23:06:13] Decode batch, #running-req: 1, #token: 225, token usage: 0.01, cuda graph: False, gen throughput (token/s): 51.27, #queue-req: 0


    [2026-06-01 23:06:13] Decode batch, #running-req: 1, #token: 265, token usage: 0.01, cuda graph: False, gen throughput (token/s): 57.91, #queue-req: 0


    [2026-06-01 23:06:14] Decode batch, #running-req: 1, #token: 305, token usage: 0.01, cuda graph: False, gen throughput (token/s): 57.12, #queue-req: 0


    [2026-06-01 23:06:15] Decode batch, #running-req: 1, #token: 345, token usage: 0.02, cuda graph: False, gen throughput (token/s): 53.84, #queue-req: 0


    [2026-06-01 23:06:15] Decode batch, #running-req: 1, #token: 385, token usage: 0.02, cuda graph: False, gen throughput (token/s): 57.60, #queue-req: 0


    [2026-06-01 23:06:16] Decode batch, #running-req: 1, #token: 425, token usage: 0.02, cuda graph: False, gen throughput (token/s): 58.51, #queue-req: 0


    [2026-06-01 23:06:17] Decode batch, #running-req: 1, #token: 465, token usage: 0.02, cuda graph: False, gen throughput (token/s): 54.66, #queue-req: 0


    [2026-06-01 23:06:18] Decode batch, #running-req: 1, #token: 505, token usage: 0.02, cuda graph: False, gen throughput (token/s): 52.98, #queue-req: 0


    [2026-06-01 23:06:18] Decode batch, #running-req: 1, #token: 545, token usage: 0.03, cuda graph: False, gen throughput (token/s): 55.59, #queue-req: 0


    [2026-06-01 23:06:19] Decode batch, #running-req: 1, #token: 585, token usage: 0.03, cuda graph: False, gen throughput (token/s): 59.00, #queue-req: 0


    [2026-06-01 23:06:20] Decode batch, #running-req: 1, #token: 625, token usage: 0.03, cuda graph: False, gen throughput (token/s): 56.59, #queue-req: 0


    [2026-06-01 23:06:20] Decode batch, #running-req: 1, #token: 665, token usage: 0.03, cuda graph: False, gen throughput (token/s): 58.06, #queue-req: 0


    [2026-06-01 23:06:21] Decode batch, #running-req: 1, #token: 705, token usage: 0.03, cuda graph: False, gen throughput (token/s): 59.81, #queue-req: 0


    [2026-06-01 23:06:22] Decode batch, #running-req: 1, #token: 745, token usage: 0.04, cuda graph: False, gen throughput (token/s): 59.73, #queue-req: 0


    [2026-06-01 23:06:22] Decode batch, #running-req: 1, #token: 785, token usage: 0.04, cuda graph: False, gen throughput (token/s): 58.66, #queue-req: 0


    [2026-06-01 23:06:23] Decode batch, #running-req: 1, #token: 825, token usage: 0.04, cuda graph: False, gen throughput (token/s): 55.72, #queue-req: 0


    [2026-06-01 23:06:24] Decode batch, #running-req: 1, #token: 865, token usage: 0.04, cuda graph: False, gen throughput (token/s): 55.85, #queue-req: 0


    [2026-06-01 23:06:24] Decode batch, #running-req: 1, #token: 905, token usage: 0.04, cuda graph: False, gen throughput (token/s): 59.05, #queue-req: 0


    [2026-06-01 23:06:25] Decode batch, #running-req: 1, #token: 945, token usage: 0.05, cuda graph: False, gen throughput (token/s): 59.38, #queue-req: 0


    [2026-06-01 23:06:26] Decode batch, #running-req: 1, #token: 985, token usage: 0.05, cuda graph: False, gen throughput (token/s): 58.65, #queue-req: 0


    [2026-06-01 23:06:27] Decode batch, #running-req: 1, #token: 1025, token usage: 0.05, cuda graph: False, gen throughput (token/s): 57.21, #queue-req: 0
    [2026-06-01 23:06:27] INFO:     127.0.0.1:59224 - "POST /generate HTTP/1.1" 200 OK
    Output from lora0: 
