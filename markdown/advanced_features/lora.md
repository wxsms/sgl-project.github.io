...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 165.52it/s]
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 203.58it/s]
...
```
    ...
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 7581.21it/s]


    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 61.49it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 321.80it/s]
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 111.65it/s]
...
```
    ...
    [2026-06-02 06:01:04] Load weight end. elapsed=2.90 s, type=LlamaForCausalLM, avail mem=40.39 GB, mem usage=18.47 GB.
    [2026-06-02 06:01:04] Using csgmv as backend of LoRA kernels.
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 9927.35it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 6309.60it/s]
    [2026-06-02 06:01:04] Found local HF snapshot for Nutanix/Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json at /root/.cache/huggingface/hub/models--Nutanix--Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json/snapshots/2c398740f3eba8dc63ee78999316b833a2833b6c; skipping download.
    ...
    [2026-06-02 06:01:05] Found local HF snapshot for algoprog/fact-generation-llama-3.1-8b-instruct-lora at /root/.cache/huggingface/hub/models--algoprog--fact-generation-llama-3.1-8b-instruct-lora/snapshots/dc8cdfb21993a6cb46199d6b1d79f68a42b06439; skipping download.
    ...
    [2026-06-02 06:01:05] Found local HF snapshot for philschmid/code-llama-3-1-8b-text-to-sql-lora at /root/.cache/huggingface/hub/models--philschmid--code-llama-3-1-8b-text-to-sql-lora/snapshots/141fc3a09386a8baf0d7495c247ae2d1a565f69f; skipping download.


    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 111.81it/s]


    [2026-06-02 06:01:06] Max concurrent requests (per dp worker) from the finalized token capacity: max_num_reqs=128.
    [2026-06-02 06:01:06] KV Cache is allocated. dtype: torch.bfloat16, #tokens: 20480, K size: 1.25 GB, V size: 1.25 GB
    [2026-06-02 06:01:06] Memory pool end. avail mem=49.35 GB
    [2026-06-02 06:01:06] Disable piecewise CUDA graph because --disable-piecewise-cuda-graph is set


    [2026-06-02 06:01:12] max_total_num_tokens=20480, chunked_prefill_size=8192, max_prefill_tokens=16384, max_running_requests=128, context_len=131072, available_gpu_mem=48.55 GB
    [2026-06-02 06:01:12] Tree cache initialized: source=default impl=RadixCache hybrid_swa=False hybrid_ssm=False hierarchical=False streaming_wrapped=False


    [2026-06-02 06:01:12] INFO:     Started server process [2881470]
    [2026-06-02 06:01:12] INFO:     Waiting for application startup.
    [2026-06-02 06:01:12] Using default chat sampling params from model generation config: {'temperature': 0.6, 'top_p': 0.9}
    [2026-06-02 06:01:12] INFO:     Application startup complete.
    [2026-06-02 06:01:12] INFO:     Uvicorn running on http://127.0.0.1:38703 (Press CTRL+C to quit)


    /usr/local/lib/python3.10/dist-packages/fastapi/routing.py:120: FastAPIDeprecationWarning: ORJSONResponse is deprecated, FastAPI now serializes data directly to JSON bytes via Pydantic when a return type or response model is set, which is faster and doesn't need a custom response class. Read more in the FastAPI docs: https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model and https://fastapi.tiangolo.com/tutorial/response-model/
      response = await f(request)
    [2026-06-02 06:01:13] INFO:     127.0.0.1:35644 - "GET /v1/models HTTP/1.1" 200 OK
    [2026-06-02 06:01:13] INFO:     127.0.0.1:35654 - "GET /model_info HTTP/1.1" 200 OK


    [2026-06-02 06:01:14] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-02 06:01:14] LoRA expand (K=6144, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-02 06:01:14] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-02 06:01:14] LoRA expand (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}


    [2026-06-02 06:01:15] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-02 06:01:15] LoRA expand (K=28672, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-02 06:01:15] LoRA shrink (K=14336, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}


    [2026-06-02 06:01:15] Prefill batch, #new-seq: 1, #new-token: 7, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 2.15
    [2026-06-02 06:01:15] INFO:     127.0.0.1:35662 - "POST /generate HTTP/1.1" 200 OK
    [2026-06-02 06:01:15] The server is fired up and ready to roll!
...
```
    ...
    [2026-06-02 06:01:18] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-02 06:01:18] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-02 06:01:19] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-02 06:01:21] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-02 06:01:21] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-02 06:01:21] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-02 06:01:22] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-02 06:01:22] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-02 06:01:22] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-02 06:01:22] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-02 06:01:22] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 2, #pending-token: 18, cuda graph: False, input throughput (token/s): 1.37
    [2026-06-02 06:01:22] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-02 06:01:22] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-02 06:01:22] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-02 06:01:22] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-02 06:01:23] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 1, #pending-token: 9, cuda graph: False, input throughput (token/s): 10.34


    [2026-06-02 06:01:23] Decode batch, #running-req: 2, #token: 70, token usage: 0.00, cuda graph: False, gen throughput (token/s): 5.22, #queue-req: 1


    [2026-06-02 06:01:24] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-02 06:01:24] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 7.68


    [2026-06-02 06:01:24] Decode batch, #running-req: 2, #token: 84, token usage: 0.00, cuda graph: False, gen throughput (token/s): 87.77, #queue-req: 0


    [2026-06-02 06:01:25] Decode batch, #running-req: 2, #token: 164, token usage: 0.01, cuda graph: False, gen throughput (token/s): 99.10, #queue-req: 0


    [2026-06-02 06:01:26] Decode batch, #running-req: 1, #token: 148, token usage: 0.01, cuda graph: False, gen throughput (token/s): 68.13, #queue-req: 0


    [2026-06-02 06:01:26] Decode batch, #running-req: 1, #token: 188, token usage: 0.01, cuda graph: False, gen throughput (token/s): 44.83, #queue-req: 0


    [2026-06-02 06:01:27] Decode batch, #running-req: 1, #token: 228, token usage: 0.01, cuda graph: False, gen throughput (token/s): 49.44, #queue-req: 0


    [2026-06-02 06:01:28] Decode batch, #running-req: 1, #token: 268, token usage: 0.01, cuda graph: False, gen throughput (token/s): 47.28, #queue-req: 0


    [2026-06-02 06:01:29] Decode batch, #running-req: 1, #token: 308, token usage: 0.02, cuda graph: False, gen throughput (token/s): 46.84, #queue-req: 0


    [2026-06-02 06:01:30] Decode batch, #running-req: 1, #token: 348, token usage: 0.02, cuda graph: False, gen throughput (token/s): 47.29, #queue-req: 0


    [2026-06-02 06:01:31] Decode batch, #running-req: 1, #token: 388, token usage: 0.02, cuda graph: False, gen throughput (token/s): 49.61, #queue-req: 0


    [2026-06-02 06:01:31] Decode batch, #running-req: 1, #token: 428, token usage: 0.02, cuda graph: False, gen throughput (token/s): 49.28, #queue-req: 0


    [2026-06-02 06:01:32] Decode batch, #running-req: 1, #token: 468, token usage: 0.02, cuda graph: False, gen throughput (token/s): 50.58, #queue-req: 0


    [2026-06-02 06:01:33] Decode batch, #running-req: 1, #token: 508, token usage: 0.02, cuda graph: False, gen throughput (token/s): 49.42, #queue-req: 0


    [2026-06-02 06:01:34] Decode batch, #running-req: 1, #token: 548, token usage: 0.03, cuda graph: False, gen throughput (token/s): 49.70, #queue-req: 0


    [2026-06-02 06:01:35] Decode batch, #running-req: 1, #token: 588, token usage: 0.03, cuda graph: False, gen throughput (token/s): 50.63, #queue-req: 0


    [2026-06-02 06:01:35] Decode batch, #running-req: 1, #token: 628, token usage: 0.03, cuda graph: False, gen throughput (token/s): 50.41, #queue-req: 0


    [2026-06-02 06:01:36] Decode batch, #running-req: 1, #token: 668, token usage: 0.03, cuda graph: False, gen throughput (token/s): 47.43, #queue-req: 0


    [2026-06-02 06:01:37] Decode batch, #running-req: 1, #token: 708, token usage: 0.03, cuda graph: False, gen throughput (token/s): 48.82, #queue-req: 0


    [2026-06-02 06:01:38] Decode batch, #running-req: 1, #token: 748, token usage: 0.04, cuda graph: False, gen throughput (token/s): 46.96, #queue-req: 0


    [2026-06-02 06:01:39] Decode batch, #running-req: 1, #token: 788, token usage: 0.04, cuda graph: False, gen throughput (token/s): 48.84, #queue-req: 0


    [2026-06-02 06:01:40] Decode batch, #running-req: 1, #token: 828, token usage: 0.04, cuda graph: False, gen throughput (token/s): 49.49, #queue-req: 0


    [2026-06-02 06:01:40] Decode batch, #running-req: 1, #token: 868, token usage: 0.04, cuda graph: False, gen throughput (token/s): 48.38, #queue-req: 0


    [2026-06-02 06:01:41] Decode batch, #running-req: 1, #token: 908, token usage: 0.04, cuda graph: False, gen throughput (token/s): 49.09, #queue-req: 0


    [2026-06-02 06:01:42] Decode batch, #running-req: 1, #token: 948, token usage: 0.05, cuda graph: False, gen throughput (token/s): 53.10, #queue-req: 0


    [2026-06-02 06:01:43] Decode batch, #running-req: 1, #token: 988, token usage: 0.05, cuda graph: False, gen throughput (token/s): 53.14, #queue-req: 0


    [2026-06-02 06:01:43] Decode batch, #running-req: 1, #token: 1028, token usage: 0.05, cuda graph: False, gen throughput (token/s): 50.98, #queue-req: 0
    [2026-06-02 06:01:44] INFO:     127.0.0.1:35664 - "POST /generate HTTP/1.1" 200 OK
    Output from lora0: 
