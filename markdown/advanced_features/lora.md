...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 309.41it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 355.06it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 107.08it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 354.58it/s]
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 112.41it/s]
...
```
    ...
    [2026-06-04 20:51:38] Load weight end. elapsed=3.31 s, type=LlamaForCausalLM, avail mem=27.41 GB, mem usage=17.25 GB.
    [2026-06-04 20:51:38] Using csgmv as backend of LoRA kernels.
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 77672.30it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 18893.26it/s]
    [2026-06-04 20:51:38] Found local HF snapshot for Nutanix/Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json at /root/.cache/huggingface/hub/models--Nutanix--Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json/snapshots/2c398740f3eba8dc63ee78999316b833a2833b6c; skipping download.
    ...
    [2026-06-04 20:51:39] Found local HF snapshot for algoprog/fact-generation-llama-3.1-8b-instruct-lora at /root/.cache/huggingface/hub/models--algoprog--fact-generation-llama-3.1-8b-instruct-lora/snapshots/dc8cdfb21993a6cb46199d6b1d79f68a42b06439; skipping download.
    ...
    [2026-06-04 20:51:39] Found local HF snapshot for philschmid/code-llama-3-1-8b-text-to-sql-lora at /root/.cache/huggingface/hub/models--philschmid--code-llama-3-1-8b-text-to-sql-lora/snapshots/141fc3a09386a8baf0d7495c247ae2d1a565f69f; skipping download.
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 74.24it/s]


    [2026-06-04 20:51:40] Max concurrent requests (per dp worker) from the finalized token capacity: max_num_reqs=128.
    [2026-06-04 20:51:40] KV Cache is allocated. dtype: torch.bfloat16, #tokens: 20480, K size: 1.25 GB, V size: 1.25 GB
    [2026-06-04 20:51:40] Memory pool end. avail mem=22.18 GB
    [2026-06-04 20:51:40] Disable piecewise CUDA graph because --disable-piecewise-cuda-graph is set


    [2026-06-04 20:51:45] max_total_num_tokens=20480, chunked_prefill_size=8192, max_prefill_tokens=16384, max_running_requests=128, context_len=131072, available_gpu_mem=21.09 GB
    [2026-06-04 20:51:45] Tree cache initialized: source=default impl=RadixCache hybrid_swa=False hybrid_ssm=False hierarchical=False streaming_wrapped=False


    [2026-06-04 20:51:45] INFO:     Started server process [1154871]
    [2026-06-04 20:51:45] INFO:     Waiting for application startup.
    [2026-06-04 20:51:45] Using default chat sampling params from model generation config: {'temperature': 0.6, 'top_p': 0.9}
    [2026-06-04 20:51:45] INFO:     Application startup complete.
    [2026-06-04 20:51:45] INFO:     Uvicorn running on http://127.0.0.1:34520 (Press CTRL+C to quit)


    /usr/local/lib/python3.10/dist-packages/fastapi/routing.py:120: FastAPIDeprecationWarning: ORJSONResponse is deprecated, FastAPI now serializes data directly to JSON bytes via Pydantic when a return type or response model is set, which is faster and doesn't need a custom response class. Read more in the FastAPI docs: https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model and https://fastapi.tiangolo.com/tutorial/response-model/
      response = await f(request)
    [2026-06-04 20:51:46] INFO:     127.0.0.1:47424 - "GET /v1/models HTTP/1.1" 200 OK


    [2026-06-04 20:51:46] INFO:     127.0.0.1:47438 - "GET /model_info HTTP/1.1" 200 OK


    [2026-06-04 20:51:47] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-04 20:51:47] LoRA expand (K=6144, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-04 20:51:47] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-04 20:51:47] LoRA expand (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}


    [2026-06-04 20:51:48] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-04 20:51:48] LoRA expand (K=28672, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-04 20:51:48] LoRA shrink (K=14336, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}


    [2026-06-04 20:51:48] Prefill batch, #new-seq: 1, #new-token: 7, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 1.96
    [2026-06-04 20:51:48] INFO:     127.0.0.1:47452 - "POST /generate HTTP/1.1" 200 OK
    [2026-06-04 20:51:48] The server is fired up and ready to roll!
...
```
    ...
    [2026-06-04 20:51:51] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-04 20:51:51] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-04 20:51:51] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-04 20:51:54] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-04 20:51:54] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-04 20:51:54] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-04 20:51:54] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-04 20:51:54] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-04 20:51:55] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-04 20:51:55] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-04 20:51:55] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 2, #pending-token: 18, cuda graph: False, input throughput (token/s): 1.40
    [2026-06-04 20:51:55] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-04 20:51:55] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-04 20:51:55] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-04 20:51:55] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-04 20:51:55] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-04 20:51:55] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-04 20:51:56] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-04 20:51:56] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-04 20:51:56] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-04 20:51:56] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-04 20:51:56] Decode batch, #running-req: 1, #token: 42, token usage: 0.00, cuda graph: False, gen throughput (token/s): 3.36, #queue-req: 2
    [2026-06-04 20:51:56] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-04 20:51:56] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-04 20:51:57] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-04 20:51:57] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-04 20:51:57] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-04 20:51:57] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-04 20:51:57] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-04 20:51:57] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-04 20:51:58] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 1, #pending-token: 9, cuda graph: False, input throughput (token/s): 2.98


    [2026-06-04 20:51:58] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-04 20:51:58] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 20.45


    [2026-06-04 20:51:58] Decode batch, #running-req: 2, #token: 48, token usage: 0.00, cuda graph: False, gen throughput (token/s): 35.56, #queue-req: 0


    [2026-06-04 20:51:59] Decode batch, #running-req: 2, #token: 128, token usage: 0.01, cuda graph: False, gen throughput (token/s): 98.36, #queue-req: 0


    [2026-06-04 20:52:00] Decode batch, #running-req: 1, #token: 112, token usage: 0.01, cuda graph: False, gen throughput (token/s): 67.47, #queue-req: 0


    [2026-06-04 20:52:01] Decode batch, #running-req: 1, #token: 152, token usage: 0.01, cuda graph: False, gen throughput (token/s): 49.50, #queue-req: 0


    [2026-06-04 20:52:01] Decode batch, #running-req: 1, #token: 192, token usage: 0.01, cuda graph: False, gen throughput (token/s): 50.70, #queue-req: 0


    [2026-06-04 20:52:02] Decode batch, #running-req: 1, #token: 232, token usage: 0.01, cuda graph: False, gen throughput (token/s): 41.04, #queue-req: 0


    [2026-06-04 20:52:04] Decode batch, #running-req: 1, #token: 272, token usage: 0.01, cuda graph: False, gen throughput (token/s): 35.64, #queue-req: 0


    [2026-06-04 20:52:04] Decode batch, #running-req: 1, #token: 312, token usage: 0.02, cuda graph: False, gen throughput (token/s): 43.15, #queue-req: 0


    [2026-06-04 20:52:05] Decode batch, #running-req: 1, #token: 352, token usage: 0.02, cuda graph: False, gen throughput (token/s): 49.46, #queue-req: 0


    [2026-06-04 20:52:06] Decode batch, #running-req: 1, #token: 392, token usage: 0.02, cuda graph: False, gen throughput (token/s): 51.49, #queue-req: 0


    [2026-06-04 20:52:07] Decode batch, #running-req: 1, #token: 432, token usage: 0.02, cuda graph: False, gen throughput (token/s): 49.26, #queue-req: 0


    [2026-06-04 20:52:08] Decode batch, #running-req: 1, #token: 472, token usage: 0.02, cuda graph: False, gen throughput (token/s): 48.50, #queue-req: 0


    [2026-06-04 20:52:08] Decode batch, #running-req: 1, #token: 512, token usage: 0.03, cuda graph: False, gen throughput (token/s): 50.65, #queue-req: 0


    [2026-06-04 20:52:09] Decode batch, #running-req: 1, #token: 552, token usage: 0.03, cuda graph: False, gen throughput (token/s): 51.65, #queue-req: 0


    [2026-06-04 20:52:10] Decode batch, #running-req: 1, #token: 592, token usage: 0.03, cuda graph: False, gen throughput (token/s): 49.94, #queue-req: 0


    [2026-06-04 20:52:11] Decode batch, #running-req: 1, #token: 632, token usage: 0.03, cuda graph: False, gen throughput (token/s): 51.74, #queue-req: 0


    [2026-06-04 20:52:12] Decode batch, #running-req: 1, #token: 672, token usage: 0.03, cuda graph: False, gen throughput (token/s): 53.13, #queue-req: 0


    [2026-06-04 20:52:12] Decode batch, #running-req: 1, #token: 712, token usage: 0.03, cuda graph: False, gen throughput (token/s): 53.60, #queue-req: 0


    [2026-06-04 20:52:13] Decode batch, #running-req: 1, #token: 752, token usage: 0.04, cuda graph: False, gen throughput (token/s): 54.74, #queue-req: 0


    [2026-06-04 20:52:14] Decode batch, #running-req: 1, #token: 792, token usage: 0.04, cuda graph: False, gen throughput (token/s): 54.11, #queue-req: 0


    [2026-06-04 20:52:15] Decode batch, #running-req: 1, #token: 832, token usage: 0.04, cuda graph: False, gen throughput (token/s): 54.19, #queue-req: 0


    [2026-06-04 20:52:15] Decode batch, #running-req: 1, #token: 872, token usage: 0.04, cuda graph: False, gen throughput (token/s): 57.13, #queue-req: 0


    [2026-06-04 20:52:16] Decode batch, #running-req: 1, #token: 912, token usage: 0.04, cuda graph: False, gen throughput (token/s): 53.91, #queue-req: 0


    [2026-06-04 20:52:17] Decode batch, #running-req: 1, #token: 952, token usage: 0.05, cuda graph: False, gen throughput (token/s): 57.31, #queue-req: 0


    [2026-06-04 20:52:17] Decode batch, #running-req: 1, #token: 992, token usage: 0.05, cuda graph: False, gen throughput (token/s): 57.29, #queue-req: 0


    [2026-06-04 20:52:18] Decode batch, #running-req: 1, #token: 1032, token usage: 0.05, cuda graph: False, gen throughput (token/s): 50.11, #queue-req: 0
    [2026-06-04 20:52:18] INFO:     127.0.0.1:42386 - "POST /generate HTTP/1.1" 200 OK
    Output from lora0: 
