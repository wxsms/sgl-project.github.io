...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 172.31it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 89717.73it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 104206.31it/s]
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 339.07it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 111.53it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 331.64it/s]
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 120.57it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 195.58it/s]
...
```
    ...
    [2026-05-26 20:38:23] Load weight end. elapsed=3.30 s, type=LlamaForCausalLM, avail mem=59.61 GB, mem usage=-5.28 GB.
    [2026-05-26 20:38:23] Using csgmv as backend of LoRA kernels.


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 9362.29it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 85163.53it/s]
    [2026-05-26 20:38:23] Found local HF snapshot for Nutanix/Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json at /root/.cache/huggingface/hub/models--Nutanix--Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json/snapshots/2c398740f3eba8dc63ee78999316b833a2833b6c; skipping download.
    ...
    [2026-05-26 20:38:23] Found local HF snapshot for algoprog/fact-generation-llama-3.1-8b-instruct-lora at /root/.cache/huggingface/hub/models--algoprog--fact-generation-llama-3.1-8b-instruct-lora/snapshots/dc8cdfb21993a6cb46199d6b1d79f68a42b06439; skipping download.
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 132.24it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 19949.13it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 18829.65it/s]
    [2026-05-26 20:38:24] Found local HF snapshot for philschmid/code-llama-3-1-8b-text-to-sql-lora at /root/.cache/huggingface/hub/models--philschmid--code-llama-3-1-8b-text-to-sql-lora/snapshots/141fc3a09386a8baf0d7495c247ae2d1a565f69f; skipping download.
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 121.80it/s]


    [2026-05-26 20:38:27] KV Cache is allocated. dtype: torch.bfloat16, #tokens: 20480, K size: 1.25 GB, V size: 1.25 GB
    [2026-05-26 20:38:27] Memory pool end. avail mem=53.82 GB
    [2026-05-26 20:38:27] Disable piecewise CUDA graph because --disable-piecewise-cuda-graph is set


    [2026-05-26 20:38:31] max_total_num_tokens=20480, chunked_prefill_size=8192, max_prefill_tokens=16384, max_running_requests=128, context_len=131072, available_gpu_mem=53.63 GB
    [2026-05-26 20:38:31] Tree cache initialized: source=default impl=RadixCache hybrid_swa=False hybrid_ssm=False hierarchical=False streaming_wrapped=False


    [2026-05-26 20:38:31] INFO:     Started server process [3736268]
    [2026-05-26 20:38:31] INFO:     Waiting for application startup.
    [2026-05-26 20:38:31] Using default chat sampling params from model generation config: {'temperature': 0.6, 'top_p': 0.9}
    [2026-05-26 20:38:31] INFO:     Application startup complete.
    [2026-05-26 20:38:31] INFO:     Uvicorn running on http://127.0.0.1:35437 (Press CTRL+C to quit)


    /usr/local/lib/python3.10/dist-packages/fastapi/routing.py:120: FastAPIDeprecationWarning: ORJSONResponse is deprecated, FastAPI now serializes data directly to JSON bytes via Pydantic when a return type or response model is set, which is faster and doesn't need a custom response class. Read more in the FastAPI docs: https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model and https://fastapi.tiangolo.com/tutorial/response-model/
      response = await f(request)
    [2026-05-26 20:38:32] INFO:     127.0.0.1:41464 - "GET /v1/models HTTP/1.1" 200 OK


    [2026-05-26 20:38:32] INFO:     127.0.0.1:41476 - "GET /model_info HTTP/1.1" 200 OK


    [2026-05-26 20:38:34] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-05-26 20:38:34] LoRA expand (K=6144, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-05-26 20:38:34] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-05-26 20:38:34] LoRA expand (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}


    [2026-05-26 20:38:34] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-05-26 20:38:34] LoRA expand (K=28672, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-05-26 20:38:34] LoRA shrink (K=14336, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-05-26 20:38:34] Prefill batch, #new-seq: 1, #new-token: 7, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 1.93


    [2026-05-26 20:38:34] INFO:     127.0.0.1:41492 - "POST /generate HTTP/1.1" 200 OK
    [2026-05-26 20:38:34] The server is fired up and ready to roll!
...
```
    ...
    [2026-05-26 20:38:37] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-26 20:38:37] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-05-26 20:38:37] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-26 20:38:37] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-05-26 20:38:37] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-05-26 20:38:38] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-26 20:38:38] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-05-26 20:38:38] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-26 20:38:38] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-05-26 20:38:38] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 2, #pending-token: 18, cuda graph: False, input throughput (token/s): 2.52
    [2026-05-26 20:38:38] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-26 20:38:38] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-05-26 20:38:38] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-26 20:38:38] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-05-26 20:38:39] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-26 20:38:39] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-05-26 20:38:39] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-26 20:38:39] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-05-26 20:38:40] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-26 20:38:40] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-05-26 20:38:40] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-26 20:38:40] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-05-26 20:38:40] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-26 20:38:40] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-05-26 20:38:40] Decode batch, #running-req: 1, #token: 42, token usage: 0.00, cuda graph: False, gen throughput (token/s): 4.16, #queue-req: 2
    [2026-05-26 20:38:40] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-26 20:38:40] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-05-26 20:38:40] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-26 20:38:40] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-05-26 20:38:40] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-26 20:38:40] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-05-26 20:38:41] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-26 20:38:41] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-05-26 20:38:41] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-26 20:38:41] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-05-26 20:38:42] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-26 20:38:42] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-05-26 20:38:42] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-26 20:38:42] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-05-26 20:38:42] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 1, #pending-token: 9, cuda graph: False, input throughput (token/s): 1.95
    [2026-05-26 20:38:42] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-05-26 20:38:43] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 32.85
    [2026-05-26 20:38:43] Decode batch, #running-req: 2, #token: 36, token usage: 0.00, cuda graph: False, gen throughput (token/s): 18.51, #queue-req: 0


    [2026-05-26 20:38:44] Decode batch, #running-req: 2, #token: 116, token usage: 0.01, cuda graph: False, gen throughput (token/s): 112.50, #queue-req: 0


    [2026-05-26 20:38:44] Decode batch, #running-req: 1, #token: 100, token usage: 0.00, cuda graph: False, gen throughput (token/s): 84.99, #queue-req: 0


    [2026-05-26 20:38:45] Decode batch, #running-req: 1, #token: 140, token usage: 0.01, cuda graph: False, gen throughput (token/s): 57.28, #queue-req: 0


    [2026-05-26 20:38:46] Decode batch, #running-req: 1, #token: 180, token usage: 0.01, cuda graph: False, gen throughput (token/s): 50.80, #queue-req: 0


    [2026-05-26 20:38:47] Decode batch, #running-req: 1, #token: 220, token usage: 0.01, cuda graph: False, gen throughput (token/s): 47.23, #queue-req: 0


    [2026-05-26 20:38:47] Decode batch, #running-req: 1, #token: 260, token usage: 0.01, cuda graph: False, gen throughput (token/s): 47.04, #queue-req: 0


    [2026-05-26 20:38:48] Decode batch, #running-req: 1, #token: 300, token usage: 0.01, cuda graph: False, gen throughput (token/s): 47.51, #queue-req: 0


    [2026-05-26 20:38:49] Decode batch, #running-req: 1, #token: 340, token usage: 0.02, cuda graph: False, gen throughput (token/s): 47.94, #queue-req: 0


    [2026-05-26 20:38:50] Decode batch, #running-req: 1, #token: 380, token usage: 0.02, cuda graph: False, gen throughput (token/s): 50.39, #queue-req: 0


    [2026-05-26 20:38:51] Decode batch, #running-req: 1, #token: 420, token usage: 0.02, cuda graph: False, gen throughput (token/s): 57.57, #queue-req: 0


    [2026-05-26 20:38:51] Decode batch, #running-req: 1, #token: 460, token usage: 0.02, cuda graph: False, gen throughput (token/s): 58.64, #queue-req: 0


    [2026-05-26 20:38:52] Decode batch, #running-req: 1, #token: 500, token usage: 0.02, cuda graph: False, gen throughput (token/s): 54.63, #queue-req: 0


    [2026-05-26 20:38:53] Decode batch, #running-req: 1, #token: 540, token usage: 0.03, cuda graph: False, gen throughput (token/s): 49.45, #queue-req: 0


    [2026-05-26 20:38:54] Decode batch, #running-req: 1, #token: 580, token usage: 0.03, cuda graph: False, gen throughput (token/s): 50.75, #queue-req: 0


    [2026-05-26 20:38:54] Decode batch, #running-req: 1, #token: 620, token usage: 0.03, cuda graph: False, gen throughput (token/s): 48.97, #queue-req: 0


    [2026-05-26 20:38:55] Decode batch, #running-req: 1, #token: 660, token usage: 0.03, cuda graph: False, gen throughput (token/s): 50.29, #queue-req: 0


    [2026-05-26 20:38:56] Decode batch, #running-req: 1, #token: 700, token usage: 0.03, cuda graph: False, gen throughput (token/s): 51.71, #queue-req: 0


    [2026-05-26 20:38:57] Decode batch, #running-req: 1, #token: 740, token usage: 0.04, cuda graph: False, gen throughput (token/s): 53.49, #queue-req: 0


    [2026-05-26 20:38:57] Decode batch, #running-req: 1, #token: 780, token usage: 0.04, cuda graph: False, gen throughput (token/s): 52.49, #queue-req: 0


    [2026-05-26 20:38:58] Decode batch, #running-req: 1, #token: 820, token usage: 0.04, cuda graph: False, gen throughput (token/s): 56.78, #queue-req: 0


    [2026-05-26 20:38:59] Decode batch, #running-req: 1, #token: 860, token usage: 0.04, cuda graph: False, gen throughput (token/s): 56.19, #queue-req: 0


    [2026-05-26 20:39:00] Decode batch, #running-req: 1, #token: 900, token usage: 0.04, cuda graph: False, gen throughput (token/s): 47.48, #queue-req: 0


    [2026-05-26 20:39:00] Decode batch, #running-req: 1, #token: 940, token usage: 0.05, cuda graph: False, gen throughput (token/s): 55.35, #queue-req: 0


    [2026-05-26 20:39:01] Decode batch, #running-req: 1, #token: 980, token usage: 0.05, cuda graph: False, gen throughput (token/s): 58.88, #queue-req: 0


    [2026-05-26 20:39:02] Decode batch, #running-req: 1, #token: 1020, token usage: 0.05, cuda graph: False, gen throughput (token/s): 55.82, #queue-req: 0


    [2026-05-26 20:39:02] INFO:     127.0.0.1:53502 - "POST /generate HTTP/1.1" 200 OK
    Output from lora0: 
