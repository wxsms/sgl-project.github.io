...
```
    ...
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 7364.89it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 8136.38it/s]
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 158.94it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 132.66it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 141.82it/s]
...
```
    ...
    [2026-06-06 00:14:18] Load weight end. elapsed=3.32 s, type=LlamaForCausalLM, avail mem=63.48 GB, mem usage=-2.63 GB.
    [2026-06-06 00:14:18] Using csgmv as backend of LoRA kernels.
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 21509.25it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 19395.63it/s]
    [2026-06-06 00:14:18] Found local HF snapshot for Nutanix/Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json at /root/.cache/huggingface/hub/models--Nutanix--Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json/snapshots/2c398740f3eba8dc63ee78999316b833a2833b6c; skipping download.
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 354.25it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 89717.73it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 11975.17it/s]
    [2026-06-06 00:14:18] Found local HF snapshot for algoprog/fact-generation-llama-3.1-8b-instruct-lora at /root/.cache/huggingface/hub/models--algoprog--fact-generation-llama-3.1-8b-instruct-lora/snapshots/dc8cdfb21993a6cb46199d6b1d79f68a42b06439; skipping download.


    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 256.36it/s]
    ...
    [2026-06-06 00:14:19] Found local HF snapshot for philschmid/code-llama-3-1-8b-text-to-sql-lora at /root/.cache/huggingface/hub/models--philschmid--code-llama-3-1-8b-text-to-sql-lora/snapshots/141fc3a09386a8baf0d7495c247ae2d1a565f69f; skipping download.
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 119.59it/s]


    [2026-06-06 00:14:20] Max concurrent requests (per dp worker) from the finalized token capacity: max_num_reqs=128.
    [2026-06-06 00:14:20] KV Cache is allocated. dtype: torch.bfloat16, #tokens: 20480, K size: 1.25 GB, V size: 1.25 GB
    [2026-06-06 00:14:20] Memory pool end. avail mem=58.15 GB
    [2026-06-06 00:14:20] Disable piecewise CUDA graph because --disable-piecewise-cuda-graph is set


    [2026-06-06 00:14:24] max_total_num_tokens=20480, chunked_prefill_size=8192, max_prefill_tokens=16384, max_running_requests=128, context_len=131072, available_gpu_mem=56.09 GB
    [2026-06-06 00:14:24] Tree cache initialized: source=default impl=RadixCache hybrid_swa=False hybrid_ssm=False hierarchical=False streaming_wrapped=False


    [2026-06-06 00:14:24] INFO:     Started server process [2973567]
    [2026-06-06 00:14:24] INFO:     Waiting for application startup.
    [2026-06-06 00:14:24] Using default chat sampling params from model generation config: {'temperature': 0.6, 'top_p': 0.9}
    [2026-06-06 00:14:24] INFO:     Application startup complete.
    [2026-06-06 00:14:24] INFO:     Uvicorn running on http://127.0.0.1:30565 (Press CTRL+C to quit)


    /usr/local/lib/python3.10/dist-packages/fastapi/routing.py:120: FastAPIDeprecationWarning: ORJSONResponse is deprecated, FastAPI now serializes data directly to JSON bytes via Pydantic when a return type or response model is set, which is faster and doesn't need a custom response class. Read more in the FastAPI docs: https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model and https://fastapi.tiangolo.com/tutorial/response-model/
      response = await f(request)
    [2026-06-06 00:14:25] INFO:     127.0.0.1:54076 - "GET /v1/models HTTP/1.1" 200 OK


    [2026-06-06 00:14:25] INFO:     127.0.0.1:54084 - "GET /model_info HTTP/1.1" 200 OK


    [2026-06-06 00:14:26] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-06 00:14:26] LoRA expand (K=6144, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-06 00:14:26] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-06 00:14:26] LoRA expand (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}


    [2026-06-06 00:14:27] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-06 00:14:27] LoRA expand (K=28672, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-06 00:14:27] LoRA shrink (K=14336, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}


    [2026-06-06 00:14:27] Prefill batch, #new-seq: 1, #new-token: 7, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 2.22
    [2026-06-06 00:14:27] INFO:     127.0.0.1:54094 - "POST /generate HTTP/1.1" 200 OK
    [2026-06-06 00:14:27] The server is fired up and ready to roll!
...
```
    ...
    [2026-06-06 00:14:30] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-06 00:14:30] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-06 00:14:31] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-06 00:14:33] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-06 00:14:33] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-06 00:14:33] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-06 00:14:33] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-06 00:14:33] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-06 00:14:33] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-06 00:14:33] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-06 00:14:33] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 2, #pending-token: 18, cuda graph: False, input throughput (token/s): 1.47
    [2026-06-06 00:14:33] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-06 00:14:33] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-06 00:14:33] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-06 00:14:33] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-06 00:14:33] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-06 00:14:33] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-06 00:14:34] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-06 00:14:34] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-06 00:14:34] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-06 00:14:34] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 1, #pending-token: 9, cuda graph: False, input throughput (token/s): 8.83


    [2026-06-06 00:14:35] Decode batch, #running-req: 2, #token: 67, token usage: 0.00, cuda graph: False, gen throughput (token/s): 5.17, #queue-req: 1


    [2026-06-06 00:14:35] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-06 00:14:35] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 8.07


    [2026-06-06 00:14:35] Decode batch, #running-req: 2, #token: 81, token usage: 0.00, cuda graph: False, gen throughput (token/s): 85.14, #queue-req: 0


    [2026-06-06 00:14:36] Decode batch, #running-req: 2, #token: 161, token usage: 0.01, cuda graph: False, gen throughput (token/s): 94.55, #queue-req: 0


    [2026-06-06 00:14:37] Decode batch, #running-req: 1, #token: 145, token usage: 0.01, cuda graph: False, gen throughput (token/s): 72.82, #queue-req: 0


    [2026-06-06 00:14:38] Decode batch, #running-req: 1, #token: 185, token usage: 0.01, cuda graph: False, gen throughput (token/s): 51.97, #queue-req: 0


    [2026-06-06 00:14:39] Decode batch, #running-req: 1, #token: 225, token usage: 0.01, cuda graph: False, gen throughput (token/s): 57.08, #queue-req: 0


    [2026-06-06 00:14:39] Decode batch, #running-req: 1, #token: 265, token usage: 0.01, cuda graph: False, gen throughput (token/s): 56.43, #queue-req: 0


    [2026-06-06 00:14:40] Decode batch, #running-req: 1, #token: 305, token usage: 0.01, cuda graph: False, gen throughput (token/s): 52.17, #queue-req: 0


    [2026-06-06 00:14:41] Decode batch, #running-req: 1, #token: 345, token usage: 0.02, cuda graph: False, gen throughput (token/s): 50.82, #queue-req: 0


    [2026-06-06 00:14:42] Decode batch, #running-req: 1, #token: 385, token usage: 0.02, cuda graph: False, gen throughput (token/s): 57.15, #queue-req: 0


    [2026-06-06 00:14:42] Decode batch, #running-req: 1, #token: 425, token usage: 0.02, cuda graph: False, gen throughput (token/s): 52.91, #queue-req: 0


    [2026-06-06 00:14:43] Decode batch, #running-req: 1, #token: 465, token usage: 0.02, cuda graph: False, gen throughput (token/s): 47.63, #queue-req: 0


    [2026-06-06 00:14:44] Decode batch, #running-req: 1, #token: 505, token usage: 0.02, cuda graph: False, gen throughput (token/s): 47.13, #queue-req: 0


    [2026-06-06 00:14:45] Decode batch, #running-req: 1, #token: 545, token usage: 0.03, cuda graph: False, gen throughput (token/s): 48.03, #queue-req: 0


    [2026-06-06 00:14:46] Decode batch, #running-req: 1, #token: 585, token usage: 0.03, cuda graph: False, gen throughput (token/s): 49.27, #queue-req: 0


    [2026-06-06 00:14:46] Decode batch, #running-req: 1, #token: 625, token usage: 0.03, cuda graph: False, gen throughput (token/s): 51.33, #queue-req: 0


    [2026-06-06 00:14:47] Decode batch, #running-req: 1, #token: 665, token usage: 0.03, cuda graph: False, gen throughput (token/s): 58.33, #queue-req: 0


    [2026-06-06 00:14:48] Decode batch, #running-req: 1, #token: 705, token usage: 0.03, cuda graph: False, gen throughput (token/s): 58.59, #queue-req: 0


    [2026-06-06 00:14:48] Decode batch, #running-req: 1, #token: 745, token usage: 0.04, cuda graph: False, gen throughput (token/s): 59.05, #queue-req: 0


    [2026-06-06 00:14:49] Decode batch, #running-req: 1, #token: 785, token usage: 0.04, cuda graph: False, gen throughput (token/s): 59.44, #queue-req: 0


    [2026-06-06 00:14:50] Decode batch, #running-req: 1, #token: 825, token usage: 0.04, cuda graph: False, gen throughput (token/s): 58.59, #queue-req: 0


    [2026-06-06 00:14:50] Decode batch, #running-req: 1, #token: 865, token usage: 0.04, cuda graph: False, gen throughput (token/s): 59.02, #queue-req: 0


    [2026-06-06 00:14:51] Decode batch, #running-req: 1, #token: 905, token usage: 0.04, cuda graph: False, gen throughput (token/s): 47.14, #queue-req: 0


    [2026-06-06 00:14:52] Decode batch, #running-req: 1, #token: 945, token usage: 0.05, cuda graph: False, gen throughput (token/s): 49.18, #queue-req: 0


    [2026-06-06 00:14:53] Decode batch, #running-req: 1, #token: 985, token usage: 0.05, cuda graph: False, gen throughput (token/s): 49.60, #queue-req: 0


    [2026-06-06 00:14:54] Decode batch, #running-req: 1, #token: 1025, token usage: 0.05, cuda graph: False, gen throughput (token/s): 51.97, #queue-req: 0
    [2026-06-06 00:14:54] INFO:     127.0.0.1:54110 - "POST /generate HTTP/1.1" 200 OK
    Output from lora0: 
