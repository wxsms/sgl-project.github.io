...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 338.17it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 113.79it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 108.33it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 144.70it/s]
...
```
    ...
    [2026-06-06 14:09:41] Load weight end. elapsed=3.64 s, type=LlamaForCausalLM, avail mem=61.12 GB, mem usage=15.02 GB.
    [2026-06-06 14:09:41] Using csgmv as backend of LoRA kernels.


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 20189.19it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 19622.47it/s]
    [2026-06-06 14:09:41] Found local HF snapshot for Nutanix/Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json at /root/.cache/huggingface/hub/models--Nutanix--Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json/snapshots/2c398740f3eba8dc63ee78999316b833a2833b6c; skipping download.
    ...
    [2026-06-06 14:09:41] Found local HF snapshot for algoprog/fact-generation-llama-3.1-8b-instruct-lora at /root/.cache/huggingface/hub/models--algoprog--fact-generation-llama-3.1-8b-instruct-lora/snapshots/dc8cdfb21993a6cb46199d6b1d79f68a42b06439; skipping download.
    ...
    [2026-06-06 14:09:42] Found local HF snapshot for philschmid/code-llama-3-1-8b-text-to-sql-lora at /root/.cache/huggingface/hub/models--philschmid--code-llama-3-1-8b-text-to-sql-lora/snapshots/141fc3a09386a8baf0d7495c247ae2d1a565f69f; skipping download.
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 107.43it/s]


    [2026-06-06 14:09:43] Max concurrent requests (per dp worker) from the finalized token capacity: max_num_reqs=128.
    [2026-06-06 14:09:43] KV Cache is allocated. dtype: torch.bfloat16, #tokens: 20480, K size: 1.25 GB, V size: 1.25 GB
    [2026-06-06 14:09:43] Memory pool end. avail mem=55.69 GB
    [2026-06-06 14:09:43] Disable piecewise CUDA graph because --disable-piecewise-cuda-graph is set


    [2026-06-06 14:09:48] max_total_num_tokens=20480, chunked_prefill_size=8192, max_prefill_tokens=16384, max_running_requests=128, context_len=131072, available_gpu_mem=55.56 GB
    [2026-06-06 14:09:48] Tree cache initialized: source=default impl=RadixCache hybrid_swa=False hybrid_ssm=False hierarchical=False streaming_wrapped=False


    [2026-06-06 14:09:48] INFO:     Started server process [2849916]
    [2026-06-06 14:09:48] INFO:     Waiting for application startup.
    [2026-06-06 14:09:48] Using default chat sampling params from model generation config: {'temperature': 0.6, 'top_p': 0.9}
    [2026-06-06 14:09:48] INFO:     Application startup complete.
    [2026-06-06 14:09:48] INFO:     Uvicorn running on http://127.0.0.1:39938 (Press CTRL+C to quit)


    /usr/local/lib/python3.10/dist-packages/fastapi/routing.py:120: FastAPIDeprecationWarning: ORJSONResponse is deprecated, FastAPI now serializes data directly to JSON bytes via Pydantic when a return type or response model is set, which is faster and doesn't need a custom response class. Read more in the FastAPI docs: https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model and https://fastapi.tiangolo.com/tutorial/response-model/
      response = await f(request)
    [2026-06-06 14:09:49] INFO:     127.0.0.1:40248 - "GET /v1/models HTTP/1.1" 200 OK


    [2026-06-06 14:09:49] INFO:     127.0.0.1:40250 - "GET /model_info HTTP/1.1" 200 OK


    [2026-06-06 14:09:50] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-06 14:09:50] LoRA expand (K=6144, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-06 14:09:50] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-06 14:09:50] LoRA expand (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}


    [2026-06-06 14:09:51] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-06 14:09:51] LoRA expand (K=28672, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-06 14:09:51] LoRA shrink (K=14336, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}


    [2026-06-06 14:09:51] Prefill batch, #new-seq: 1, #new-token: 7, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 2.22
    [2026-06-06 14:09:51] INFO:     127.0.0.1:40264 - "POST /generate HTTP/1.1" 200 OK
    [2026-06-06 14:09:51] The server is fired up and ready to roll!
...
```
    ...
    [2026-06-06 14:09:54] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-06 14:09:54] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-06 14:09:54] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-06 14:09:57] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-06 14:09:57] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-06 14:09:57] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-06 14:09:57] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-06 14:09:57] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 2, #pending-token: 18, cuda graph: False, input throughput (token/s): 1.46
    [2026-06-06 14:09:57] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-06 14:09:57] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-06 14:09:57] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-06 14:09:58] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-06 14:09:58] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-06 14:09:58] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-06 14:09:58] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-06 14:09:58] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-06 14:09:58] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-06 14:09:58] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-06 14:09:58] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-06 14:09:59] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].


    [2026-06-06 14:09:59] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 1, #pending-token: 9, cuda graph: False, input throughput (token/s): 5.26
    [2026-06-06 14:09:59] Decode batch, #running-req: 2, #token: 57, token usage: 0.00, cuda graph: False, gen throughput (token/s): 4.01, #queue-req: 1


    [2026-06-06 14:10:00] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-06 14:10:00] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 9.48


    [2026-06-06 14:10:00] Decode batch, #running-req: 2, #token: 71, token usage: 0.00, cuda graph: False, gen throughput (token/s): 89.24, #queue-req: 0


    [2026-06-06 14:10:01] Decode batch, #running-req: 2, #token: 151, token usage: 0.01, cuda graph: False, gen throughput (token/s): 102.17, #queue-req: 0


    [2026-06-06 14:10:01] Decode batch, #running-req: 1, #token: 135, token usage: 0.01, cuda graph: False, gen throughput (token/s): 77.39, #queue-req: 0


    [2026-06-06 14:10:02] Decode batch, #running-req: 1, #token: 175, token usage: 0.01, cuda graph: False, gen throughput (token/s): 51.18, #queue-req: 0


    [2026-06-06 14:10:03] Decode batch, #running-req: 1, #token: 215, token usage: 0.01, cuda graph: False, gen throughput (token/s): 55.31, #queue-req: 0


    [2026-06-06 14:10:04] Decode batch, #running-req: 1, #token: 255, token usage: 0.01, cuda graph: False, gen throughput (token/s): 52.67, #queue-req: 0


    [2026-06-06 14:10:04] Decode batch, #running-req: 1, #token: 295, token usage: 0.01, cuda graph: False, gen throughput (token/s): 46.75, #queue-req: 0


    [2026-06-06 14:10:05] Decode batch, #running-req: 1, #token: 335, token usage: 0.02, cuda graph: False, gen throughput (token/s): 44.35, #queue-req: 0


    [2026-06-06 14:10:06] Decode batch, #running-req: 1, #token: 375, token usage: 0.02, cuda graph: False, gen throughput (token/s): 47.42, #queue-req: 0


    [2026-06-06 14:10:07] Decode batch, #running-req: 1, #token: 415, token usage: 0.02, cuda graph: False, gen throughput (token/s): 49.26, #queue-req: 0


    [2026-06-06 14:10:08] Decode batch, #running-req: 1, #token: 455, token usage: 0.02, cuda graph: False, gen throughput (token/s): 47.54, #queue-req: 0


    [2026-06-06 14:10:09] Decode batch, #running-req: 1, #token: 495, token usage: 0.02, cuda graph: False, gen throughput (token/s): 56.25, #queue-req: 0


    [2026-06-06 14:10:09] Decode batch, #running-req: 1, #token: 535, token usage: 0.03, cuda graph: False, gen throughput (token/s): 53.03, #queue-req: 0


    [2026-06-06 14:10:10] Decode batch, #running-req: 1, #token: 575, token usage: 0.03, cuda graph: False, gen throughput (token/s): 52.67, #queue-req: 0


    [2026-06-06 14:10:11] Decode batch, #running-req: 1, #token: 615, token usage: 0.03, cuda graph: False, gen throughput (token/s): 46.47, #queue-req: 0


    [2026-06-06 14:10:12] Decode batch, #running-req: 1, #token: 655, token usage: 0.03, cuda graph: False, gen throughput (token/s): 51.28, #queue-req: 0


    [2026-06-06 14:10:12] Decode batch, #running-req: 1, #token: 695, token usage: 0.03, cuda graph: False, gen throughput (token/s): 54.86, #queue-req: 0


    [2026-06-06 14:10:13] Decode batch, #running-req: 1, #token: 735, token usage: 0.04, cuda graph: False, gen throughput (token/s): 54.61, #queue-req: 0


    [2026-06-06 14:10:14] Decode batch, #running-req: 1, #token: 775, token usage: 0.04, cuda graph: False, gen throughput (token/s): 50.82, #queue-req: 0


    [2026-06-06 14:10:15] Decode batch, #running-req: 1, #token: 815, token usage: 0.04, cuda graph: False, gen throughput (token/s): 52.32, #queue-req: 0


    [2026-06-06 14:10:15] Decode batch, #running-req: 1, #token: 855, token usage: 0.04, cuda graph: False, gen throughput (token/s): 51.55, #queue-req: 0


    [2026-06-06 14:10:16] Decode batch, #running-req: 1, #token: 895, token usage: 0.04, cuda graph: False, gen throughput (token/s): 45.23, #queue-req: 0


    [2026-06-06 14:10:17] Decode batch, #running-req: 1, #token: 935, token usage: 0.05, cuda graph: False, gen throughput (token/s): 50.34, #queue-req: 0


    [2026-06-06 14:10:18] Decode batch, #running-req: 1, #token: 975, token usage: 0.05, cuda graph: False, gen throughput (token/s): 53.99, #queue-req: 0


    [2026-06-06 14:10:19] Decode batch, #running-req: 1, #token: 1015, token usage: 0.05, cuda graph: False, gen throughput (token/s): 53.69, #queue-req: 0


    [2026-06-06 14:10:19] INFO:     127.0.0.1:40276 - "POST /generate HTTP/1.1" 200 OK
    Output from lora0: 
