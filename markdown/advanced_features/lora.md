...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 370.59it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 340.14it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 112.68it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 152.40it/s]
...
```
    ...
    [2026-06-09 22:11:35] Load weight end. elapsed=3.14 s, type=LlamaForCausalLM, avail mem=44.07 GB, mem usage=15.02 GB.
    [2026-06-09 22:11:35] Using csgmv as backend of LoRA kernels.
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 21399.51it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 15293.72it/s]
    [2026-06-09 22:11:36] Found local HF snapshot for Nutanix/Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json at /root/.cache/huggingface/hub/models--Nutanix--Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json/snapshots/2c398740f3eba8dc63ee78999316b833a2833b6c; skipping download.
    ...
    [2026-06-09 22:11:36] Found local HF snapshot for algoprog/fact-generation-llama-3.1-8b-instruct-lora at /root/.cache/huggingface/hub/models--algoprog--fact-generation-llama-3.1-8b-instruct-lora/snapshots/dc8cdfb21993a6cb46199d6b1d79f68a42b06439; skipping download.
    ...
    [2026-06-09 22:11:36] Found local HF snapshot for philschmid/code-llama-3-1-8b-text-to-sql-lora at /root/.cache/huggingface/hub/models--philschmid--code-llama-3-1-8b-text-to-sql-lora/snapshots/141fc3a09386a8baf0d7495c247ae2d1a565f69f; skipping download.


    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 113.97it/s]


    [2026-06-09 22:11:38] Max concurrent requests (per dp worker) from the finalized token capacity: max_num_reqs=128.
    [2026-06-09 22:11:38] KV Cache is allocated. dtype: torch.bfloat16, #tokens: 20480, K size: 1.25 GB, V size: 1.25 GB
    [2026-06-09 22:11:38] Memory pool end. avail mem=38.21 GB
    [2026-06-09 22:11:38] Disable piecewise CUDA graph because --disable-piecewise-cuda-graph is set


    [2026-06-09 22:11:43] max_total_num_tokens=20480, chunked_prefill_size=8192, max_prefill_tokens=16384, max_running_requests=128, context_len=131072, available_gpu_mem=38.54 GB
    [2026-06-09 22:11:43] Tree cache initialized: source=default impl=RadixCache hybrid_swa=False hybrid_ssm=False hierarchical=False streaming_wrapped=False


    [2026-06-09 22:11:43] INFO:     Started server process [313692]
    [2026-06-09 22:11:43] INFO:     Waiting for application startup.
    [2026-06-09 22:11:43] Using default chat sampling params from model generation config: {'temperature': 0.6, 'top_p': 0.9}
    [2026-06-09 22:11:43] INFO:     Application startup complete.
    [2026-06-09 22:11:43] INFO:     Uvicorn running on http://127.0.0.1:32220 (Press CTRL+C to quit)


    /usr/local/lib/python3.10/dist-packages/fastapi/routing.py:120: FastAPIDeprecationWarning: ORJSONResponse is deprecated, FastAPI now serializes data directly to JSON bytes via Pydantic when a return type or response model is set, which is faster and doesn't need a custom response class. Read more in the FastAPI docs: https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model and https://fastapi.tiangolo.com/tutorial/response-model/
      response = await f(request)
    [2026-06-09 22:11:44] INFO:     127.0.0.1:58430 - "GET /v1/models HTTP/1.1" 200 OK
    [2026-06-09 22:11:44] INFO:     127.0.0.1:58438 - "GET /model_info HTTP/1.1" 200 OK


    [2026-06-09 22:11:45] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-09 22:11:45] LoRA expand (K=6144, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-09 22:11:45] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-09 22:11:45] LoRA expand (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}


    [2026-06-09 22:11:46] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-09 22:11:46] LoRA expand (K=28672, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-09 22:11:46] LoRA shrink (K=14336, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}


    [2026-06-09 22:11:46] Prefill batch, #new-seq: 1, #new-token: 7, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 2.22
    [2026-06-09 22:11:46] INFO:     127.0.0.1:58446 - "POST /generate HTTP/1.1" 200 OK
    [2026-06-09 22:11:46] The server is fired up and ready to roll!
...
```
    ...
    [2026-06-09 22:11:49] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-09 22:11:49] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-09 22:11:50] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-09 22:11:52] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-09 22:11:52] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-09 22:11:53] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-09 22:11:53] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-09 22:11:53] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 2, #pending-token: 18, cuda graph: False, input throughput (token/s): 1.36
    [2026-06-09 22:11:53] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-09 22:11:53] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-09 22:11:53] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-09 22:11:53] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-09 22:11:53] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 1, #pending-token: 9, cuda graph: False, input throughput (token/s): 17.51


    [2026-06-09 22:11:54] Decode batch, #running-req: 2, #token: 79, token usage: 0.00, cuda graph: False, gen throughput (token/s): 6.17, #queue-req: 1


    [2026-06-09 22:11:54] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-09 22:11:55] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 6.49


    [2026-06-09 22:11:55] Decode batch, #running-req: 2, #token: 94, token usage: 0.00, cuda graph: False, gen throughput (token/s): 80.99, #queue-req: 0


    [2026-06-09 22:11:56] Decode batch, #running-req: 2, #token: 174, token usage: 0.01, cuda graph: False, gen throughput (token/s): 98.03, #queue-req: 0


    [2026-06-09 22:11:56] Decode batch, #running-req: 1, #token: 157, token usage: 0.01, cuda graph: False, gen throughput (token/s): 72.37, #queue-req: 0


    [2026-06-09 22:11:57] Decode batch, #running-req: 1, #token: 197, token usage: 0.01, cuda graph: False, gen throughput (token/s): 52.59, #queue-req: 0


    [2026-06-09 22:11:58] Decode batch, #running-req: 1, #token: 237, token usage: 0.01, cuda graph: False, gen throughput (token/s): 50.83, #queue-req: 0


    [2026-06-09 22:11:59] Decode batch, #running-req: 1, #token: 277, token usage: 0.01, cuda graph: False, gen throughput (token/s): 52.75, #queue-req: 0


    [2026-06-09 22:11:59] Decode batch, #running-req: 1, #token: 317, token usage: 0.02, cuda graph: False, gen throughput (token/s): 52.59, #queue-req: 0


    [2026-06-09 22:12:00] Decode batch, #running-req: 1, #token: 357, token usage: 0.02, cuda graph: False, gen throughput (token/s): 53.46, #queue-req: 0


    [2026-06-09 22:12:01] Decode batch, #running-req: 1, #token: 397, token usage: 0.02, cuda graph: False, gen throughput (token/s): 50.40, #queue-req: 0


    [2026-06-09 22:12:02] Decode batch, #running-req: 1, #token: 437, token usage: 0.02, cuda graph: False, gen throughput (token/s): 47.27, #queue-req: 0


    [2026-06-09 22:12:03] Decode batch, #running-req: 1, #token: 477, token usage: 0.02, cuda graph: False, gen throughput (token/s): 47.20, #queue-req: 0


    [2026-06-09 22:12:04] Decode batch, #running-req: 1, #token: 517, token usage: 0.03, cuda graph: False, gen throughput (token/s): 47.02, #queue-req: 0


    [2026-06-09 22:12:04] Decode batch, #running-req: 1, #token: 557, token usage: 0.03, cuda graph: False, gen throughput (token/s): 46.65, #queue-req: 0


    [2026-06-09 22:12:05] Decode batch, #running-req: 1, #token: 597, token usage: 0.03, cuda graph: False, gen throughput (token/s): 46.84, #queue-req: 0


    [2026-06-09 22:12:06] Decode batch, #running-req: 1, #token: 637, token usage: 0.03, cuda graph: False, gen throughput (token/s): 45.28, #queue-req: 0


    [2026-06-09 22:12:07] Decode batch, #running-req: 1, #token: 677, token usage: 0.03, cuda graph: False, gen throughput (token/s): 44.50, #queue-req: 0


    [2026-06-09 22:12:08] Decode batch, #running-req: 1, #token: 717, token usage: 0.04, cuda graph: False, gen throughput (token/s): 45.31, #queue-req: 0


    [2026-06-09 22:12:09] Decode batch, #running-req: 1, #token: 757, token usage: 0.04, cuda graph: False, gen throughput (token/s): 39.69, #queue-req: 0


    [2026-06-09 22:12:10] Decode batch, #running-req: 1, #token: 797, token usage: 0.04, cuda graph: False, gen throughput (token/s): 31.57, #queue-req: 0


    [2026-06-09 22:12:11] Decode batch, #running-req: 1, #token: 837, token usage: 0.04, cuda graph: False, gen throughput (token/s): 44.64, #queue-req: 0


    [2026-06-09 22:12:12] Decode batch, #running-req: 1, #token: 877, token usage: 0.04, cuda graph: False, gen throughput (token/s): 44.82, #queue-req: 0


    [2026-06-09 22:12:13] Decode batch, #running-req: 1, #token: 917, token usage: 0.04, cuda graph: False, gen throughput (token/s): 35.32, #queue-req: 0


    [2026-06-09 22:12:15] Decode batch, #running-req: 1, #token: 957, token usage: 0.05, cuda graph: False, gen throughput (token/s): 28.11, #queue-req: 0


    [2026-06-09 22:12:15] Decode batch, #running-req: 1, #token: 997, token usage: 0.05, cuda graph: False, gen throughput (token/s): 45.35, #queue-req: 0


    [2026-06-09 22:12:16] INFO:     127.0.0.1:58460 - "POST /generate HTTP/1.1" 200 OK
    Output from lora0: 
