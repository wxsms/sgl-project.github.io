...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 121.19it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 163.74it/s]
...
```
    ...
    [2026-06-10 06:21:29] Load weight end. elapsed=3.32 s, type=LlamaForCausalLM, avail mem=60.71 GB, mem usage=15.22 GB.
    [2026-06-10 06:21:29] Using csgmv as backend of LoRA kernels.
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 20763.88it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 90200.09it/s]
    [2026-06-10 06:21:29] Found local HF snapshot for Nutanix/Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json at /root/.cache/huggingface/hub/models--Nutanix--Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json/snapshots/2c398740f3eba8dc63ee78999316b833a2833b6c; skipping download.
    ...
    [2026-06-10 06:21:29] Found local HF snapshot for algoprog/fact-generation-llama-3.1-8b-instruct-lora at /root/.cache/huggingface/hub/models--algoprog--fact-generation-llama-3.1-8b-instruct-lora/snapshots/dc8cdfb21993a6cb46199d6b1d79f68a42b06439; skipping download.
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 172.56it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 20997.77it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 19807.81it/s]
    [2026-06-10 06:21:30] Found local HF snapshot for philschmid/code-llama-3-1-8b-text-to-sql-lora at /root/.cache/huggingface/hub/models--philschmid--code-llama-3-1-8b-text-to-sql-lora/snapshots/141fc3a09386a8baf0d7495c247ae2d1a565f69f; skipping download.
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 114.56it/s]


    [2026-06-10 06:21:31] Max concurrent requests (per dp worker) from the finalized token capacity: max_num_reqs=128.
    [2026-06-10 06:21:31] KV Cache is allocated. dtype: torch.bfloat16, #tokens: 20480, K size: 1.25 GB, V size: 1.25 GB
    [2026-06-10 06:21:31] Memory pool end. avail mem=54.92 GB
    [2026-06-10 06:21:31] Disable prefill CUDA graph because cuda_graph_config resolved prefill.backend='disabled' (e.g. via --cuda-graph-backend-prefill=disabled or auto-disable rules).


    [2026-06-10 06:21:35] max_total_num_tokens=20480, chunked_prefill_size=8192, max_prefill_tokens=16384, max_running_requests=128, context_len=131072, available_gpu_mem=53.99 GB
    [2026-06-10 06:21:35] Tree cache initialized: source=default impl=RadixCache hybrid_swa=False hybrid_ssm=False hierarchical=False streaming_wrapped=False


    [2026-06-10 06:21:36] INFO:     Started server process [1417448]
    [2026-06-10 06:21:36] INFO:     Waiting for application startup.
    [2026-06-10 06:21:36] Using default chat sampling params from model generation config: {'temperature': 0.6, 'top_p': 0.9}
    [2026-06-10 06:21:36] INFO:     Application startup complete.
    [2026-06-10 06:21:36] INFO:     Uvicorn running on http://127.0.0.1:37015 (Press CTRL+C to quit)


    /usr/local/lib/python3.10/dist-packages/fastapi/routing.py:120: FastAPIDeprecationWarning: ORJSONResponse is deprecated, FastAPI now serializes data directly to JSON bytes via Pydantic when a return type or response model is set, which is faster and doesn't need a custom response class. Read more in the FastAPI docs: https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model and https://fastapi.tiangolo.com/tutorial/response-model/
      response = await f(request)
    [2026-06-10 06:21:37] INFO:     127.0.0.1:50224 - "GET /v1/models HTTP/1.1" 200 OK
    [2026-06-10 06:21:37] INFO:     127.0.0.1:50240 - "GET /model_info HTTP/1.1" 200 OK


    [2026-06-10 06:21:38] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-10 06:21:38] LoRA expand (K=6144, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-10 06:21:38] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-10 06:21:38] LoRA expand (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}


    [2026-06-10 06:21:38] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-10 06:21:38] LoRA expand (K=28672, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-10 06:21:38] LoRA shrink (K=14336, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}


    [2026-06-10 06:21:38] Prefill batch, #new-seq: 1, #new-token: 7, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 2.31
    [2026-06-10 06:21:38] INFO:     127.0.0.1:50242 - "POST /generate HTTP/1.1" 200 OK
    [2026-06-10 06:21:38] The server is fired up and ready to roll!
...
```
    ...
    [2026-06-10 06:21:42] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-10 06:21:42] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-10 06:21:42] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-10 06:21:42] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-10 06:21:42] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-10 06:21:44] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-10 06:21:44] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-10 06:21:44] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-10 06:21:44] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-10 06:21:44] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-10 06:21:44] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 2, #pending-token: 18, cuda graph: False, input throughput (token/s): 1.47
    [2026-06-10 06:21:44] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-10 06:21:44] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-10 06:21:44] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    ...
    [2026-06-10 06:21:44] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-10 06:21:44] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-10 06:21:45] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-10 06:21:45] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-10 06:21:45] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-10 06:21:45] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-10 06:21:46] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-10 06:21:46] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-10 06:21:46] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-10 06:21:46] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-10 06:21:46] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-10 06:21:46] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-10 06:21:46] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-10 06:21:46] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-10 06:21:46] Decode batch, #running-req: 1, #token: 42, token usage: 0.00, cuda graph: False, gen throughput (token/s): 3.66, #queue-req: 2
    [2026-06-10 06:21:46] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-10 06:21:46] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-10 06:21:46] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-10 06:21:46] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-10 06:21:47] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-10 06:21:47] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-10 06:21:47] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-10 06:21:47] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-10 06:21:47] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-10 06:21:47] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-10 06:21:48] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-10 06:21:48] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-10 06:21:48] Prefill batch, #new-seq: 2, #new-token: 18, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 4.83
    [2026-06-10 06:21:48] Decode batch, #running-req: 2, #token: 36, token usage: 0.00, cuda graph: False, gen throughput (token/s): 22.75, #queue-req: 0


    [2026-06-10 06:21:49] Decode batch, #running-req: 2, #token: 116, token usage: 0.01, cuda graph: False, gen throughput (token/s): 94.39, #queue-req: 0


    [2026-06-10 06:21:50] Decode batch, #running-req: 1, #token: 98, token usage: 0.00, cuda graph: False, gen throughput (token/s): 71.18, #queue-req: 0


    [2026-06-10 06:21:51] Decode batch, #running-req: 1, #token: 138, token usage: 0.01, cuda graph: False, gen throughput (token/s): 49.33, #queue-req: 0


    [2026-06-10 06:21:51] Decode batch, #running-req: 1, #token: 178, token usage: 0.01, cuda graph: False, gen throughput (token/s): 50.95, #queue-req: 0


    [2026-06-10 06:21:52] Decode batch, #running-req: 1, #token: 218, token usage: 0.01, cuda graph: False, gen throughput (token/s): 52.00, #queue-req: 0


    [2026-06-10 06:21:53] Decode batch, #running-req: 1, #token: 258, token usage: 0.01, cuda graph: False, gen throughput (token/s): 52.54, #queue-req: 0


    [2026-06-10 06:21:54] Decode batch, #running-req: 1, #token: 298, token usage: 0.01, cuda graph: False, gen throughput (token/s): 51.31, #queue-req: 0


    [2026-06-10 06:21:55] Decode batch, #running-req: 1, #token: 338, token usage: 0.02, cuda graph: False, gen throughput (token/s): 50.43, #queue-req: 0


    [2026-06-10 06:21:55] Decode batch, #running-req: 1, #token: 378, token usage: 0.02, cuda graph: False, gen throughput (token/s): 47.94, #queue-req: 0


    [2026-06-10 06:21:56] Decode batch, #running-req: 1, #token: 418, token usage: 0.02, cuda graph: False, gen throughput (token/s): 48.37, #queue-req: 0


    [2026-06-10 06:21:57] Decode batch, #running-req: 1, #token: 458, token usage: 0.02, cuda graph: False, gen throughput (token/s): 49.19, #queue-req: 0


    [2026-06-10 06:21:58] Decode batch, #running-req: 1, #token: 498, token usage: 0.02, cuda graph: False, gen throughput (token/s): 47.14, #queue-req: 0


    [2026-06-10 06:21:59] Decode batch, #running-req: 1, #token: 538, token usage: 0.03, cuda graph: False, gen throughput (token/s): 49.74, #queue-req: 0


    [2026-06-10 06:22:00] Decode batch, #running-req: 1, #token: 578, token usage: 0.03, cuda graph: False, gen throughput (token/s): 48.61, #queue-req: 0


    [2026-06-10 06:22:00] Decode batch, #running-req: 1, #token: 618, token usage: 0.03, cuda graph: False, gen throughput (token/s): 50.01, #queue-req: 0


    [2026-06-10 06:22:01] Decode batch, #running-req: 1, #token: 658, token usage: 0.03, cuda graph: False, gen throughput (token/s): 48.30, #queue-req: 0


    [2026-06-10 06:22:02] Decode batch, #running-req: 1, #token: 698, token usage: 0.03, cuda graph: False, gen throughput (token/s): 43.22, #queue-req: 0


    [2026-06-10 06:22:03] Decode batch, #running-req: 1, #token: 738, token usage: 0.04, cuda graph: False, gen throughput (token/s): 48.05, #queue-req: 0


    [2026-06-10 06:22:04] Decode batch, #running-req: 1, #token: 778, token usage: 0.04, cuda graph: False, gen throughput (token/s): 48.96, #queue-req: 0


    [2026-06-10 06:22:05] Decode batch, #running-req: 1, #token: 818, token usage: 0.04, cuda graph: False, gen throughput (token/s): 48.62, #queue-req: 0


    [2026-06-10 06:22:05] Decode batch, #running-req: 1, #token: 858, token usage: 0.04, cuda graph: False, gen throughput (token/s): 52.28, #queue-req: 0


    [2026-06-10 06:22:06] Decode batch, #running-req: 1, #token: 898, token usage: 0.04, cuda graph: False, gen throughput (token/s): 51.94, #queue-req: 0


    [2026-06-10 06:22:07] Decode batch, #running-req: 1, #token: 938, token usage: 0.05, cuda graph: False, gen throughput (token/s): 49.04, #queue-req: 0


    [2026-06-10 06:22:08] Decode batch, #running-req: 1, #token: 978, token usage: 0.05, cuda graph: False, gen throughput (token/s): 47.50, #queue-req: 0


    [2026-06-10 06:22:09] Decode batch, #running-req: 1, #token: 1018, token usage: 0.05, cuda graph: False, gen throughput (token/s): 49.45, #queue-req: 0


    [2026-06-10 06:22:09] INFO:     127.0.0.1:53688 - "POST /generate HTTP/1.1" 200 OK
    Output from lora0: 
