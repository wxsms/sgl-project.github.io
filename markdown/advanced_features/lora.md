...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 323.34it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 119.28it/s]
...
```
    ...
    [2026-05-25 10:19:08] Load weight end. elapsed=3.57 s, type=LlamaForCausalLM, avail mem=27.40 GB, mem usage=15.02 GB.
    [2026-05-25 10:19:08] Using csgmv as backend of LoRA kernels.
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 14364.05it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 94254.02it/s]
    [2026-05-25 10:19:08] Found local HF snapshot for Nutanix/Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json at /root/.cache/huggingface/hub/models--Nutanix--Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json/snapshots/2c398740f3eba8dc63ee78999316b833a2833b6c; skipping download.
    ...
    [2026-05-25 10:19:08] Found local HF snapshot for algoprog/fact-generation-llama-3.1-8b-instruct-lora at /root/.cache/huggingface/hub/models--algoprog--fact-generation-llama-3.1-8b-instruct-lora/snapshots/dc8cdfb21993a6cb46199d6b1d79f68a42b06439; skipping download.
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 167.23it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 80273.76it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 93727.46it/s]
    [2026-05-25 10:19:09] Found local HF snapshot for philschmid/code-llama-3-1-8b-text-to-sql-lora at /root/.cache/huggingface/hub/models--philschmid--code-llama-3-1-8b-text-to-sql-lora/snapshots/141fc3a09386a8baf0d7495c247ae2d1a565f69f; skipping download.
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 117.27it/s]


    [2026-05-25 10:19:11] KV Cache is allocated. dtype: torch.bfloat16, #tokens: 20480, K size: 1.25 GB, V size: 1.25 GB
    [2026-05-25 10:19:11] Memory pool end. avail mem=58.26 GB
    [2026-05-25 10:19:11] Disable piecewise CUDA graph because --disable-piecewise-cuda-graph is set


    [2026-05-25 10:19:15] max_total_num_tokens=20480, chunked_prefill_size=8192, max_prefill_tokens=16384, max_running_requests=128, context_len=131072, available_gpu_mem=58.16 GB
    [2026-05-25 10:19:15] Tree cache initialized: source=default impl=RadixCache hybrid_swa=False hybrid_ssm=False hierarchical=False streaming_wrapped=False


    [2026-05-25 10:19:15] INFO:     Started server process [3043517]
    [2026-05-25 10:19:15] INFO:     Waiting for application startup.
    [2026-05-25 10:19:15] Using default chat sampling params from model generation config: {'temperature': 0.6, 'top_p': 0.9}
    [2026-05-25 10:19:16] INFO:     Application startup complete.
    [2026-05-25 10:19:16] INFO:     Uvicorn running on http://127.0.0.1:38140 (Press CTRL+C to quit)


    /usr/local/lib/python3.10/dist-packages/fastapi/routing.py:120: FastAPIDeprecationWarning: ORJSONResponse is deprecated, FastAPI now serializes data directly to JSON bytes via Pydantic when a return type or response model is set, which is faster and doesn't need a custom response class. Read more in the FastAPI docs: https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model and https://fastapi.tiangolo.com/tutorial/response-model/
      response = await f(request)
    [2026-05-25 10:19:16] INFO:     127.0.0.1:57058 - "GET /v1/models HTTP/1.1" 200 OK


    [2026-05-25 10:19:17] INFO:     127.0.0.1:57064 - "GET /model_info HTTP/1.1" 200 OK


    [2026-05-25 10:19:18] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-05-25 10:19:18] LoRA expand (K=6144, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-05-25 10:19:18] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-05-25 10:19:18] LoRA expand (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}


    [2026-05-25 10:19:18] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-05-25 10:19:18] LoRA expand (K=28672, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-05-25 10:19:18] LoRA shrink (K=14336, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-05-25 10:19:19] Prefill batch, #new-seq: 1, #new-token: 7, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 1.97


    [2026-05-25 10:19:19] INFO:     127.0.0.1:57076 - "POST /generate HTTP/1.1" 200 OK
    [2026-05-25 10:19:19] The server is fired up and ready to roll!
...
```
    ...
    [2026-05-25 10:19:21] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-25 10:19:21] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-05-25 10:19:21] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-05-25 10:19:22] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-25 10:19:22] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-05-25 10:19:22] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-05-25 10:19:22] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-25 10:19:22] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-05-25 10:19:22] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 2, #pending-token: 18, cuda graph: False, input throughput (token/s): 2.54
    [2026-05-25 10:19:22] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-25 10:19:22] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-05-25 10:19:22] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-25 10:19:22] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-05-25 10:19:23] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-25 10:19:23] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-05-25 10:19:23] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-25 10:19:23] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 1, #pending-token: 9, cuda graph: False, input throughput (token/s): 13.57


    [2026-05-25 10:19:23] Decode batch, #running-req: 2, #token: 75, token usage: 0.00, cuda graph: False, gen throughput (token/s): 7.67, #queue-req: 1


    [2026-05-25 10:19:24] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-05-25 10:19:24] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 7.76


    [2026-05-25 10:19:24] Decode batch, #running-req: 2, #token: 89, token usage: 0.00, cuda graph: False, gen throughput (token/s): 95.98, #queue-req: 0


    [2026-05-25 10:19:25] Decode batch, #running-req: 2, #token: 169, token usage: 0.01, cuda graph: False, gen throughput (token/s): 109.18, #queue-req: 0


    [2026-05-25 10:19:25] Decode batch, #running-req: 1, #token: 153, token usage: 0.01, cuda graph: False, gen throughput (token/s): 81.58, #queue-req: 0


    [2026-05-25 10:19:26] Decode batch, #running-req: 1, #token: 193, token usage: 0.01, cuda graph: False, gen throughput (token/s): 56.74, #queue-req: 0


    [2026-05-25 10:19:27] Decode batch, #running-req: 1, #token: 233, token usage: 0.01, cuda graph: False, gen throughput (token/s): 41.83, #queue-req: 0


    [2026-05-25 10:19:28] Decode batch, #running-req: 1, #token: 273, token usage: 0.01, cuda graph: False, gen throughput (token/s): 56.27, #queue-req: 0


    [2026-05-25 10:19:29] Decode batch, #running-req: 1, #token: 313, token usage: 0.02, cuda graph: False, gen throughput (token/s): 57.13, #queue-req: 0


    [2026-05-25 10:19:30] Decode batch, #running-req: 1, #token: 353, token usage: 0.02, cuda graph: False, gen throughput (token/s): 37.23, #queue-req: 0


    [2026-05-25 10:19:31] Decode batch, #running-req: 1, #token: 393, token usage: 0.02, cuda graph: False, gen throughput (token/s): 31.27, #queue-req: 0


    [2026-05-25 10:19:32] Decode batch, #running-req: 1, #token: 433, token usage: 0.02, cuda graph: False, gen throughput (token/s): 31.75, #queue-req: 0


    [2026-05-25 10:19:33] Decode batch, #running-req: 1, #token: 473, token usage: 0.02, cuda graph: False, gen throughput (token/s): 31.51, #queue-req: 0


    [2026-05-25 10:19:35] Decode batch, #running-req: 1, #token: 513, token usage: 0.03, cuda graph: False, gen throughput (token/s): 32.42, #queue-req: 0


    [2026-05-25 10:19:36] Decode batch, #running-req: 1, #token: 553, token usage: 0.03, cuda graph: False, gen throughput (token/s): 38.11, #queue-req: 0


    [2026-05-25 10:19:37] Decode batch, #running-req: 1, #token: 593, token usage: 0.03, cuda graph: False, gen throughput (token/s): 48.61, #queue-req: 0


    [2026-05-25 10:19:37] Decode batch, #running-req: 1, #token: 633, token usage: 0.03, cuda graph: False, gen throughput (token/s): 55.95, #queue-req: 0


    [2026-05-25 10:19:38] Decode batch, #running-req: 1, #token: 673, token usage: 0.03, cuda graph: False, gen throughput (token/s): 39.96, #queue-req: 0


    [2026-05-25 10:19:39] Decode batch, #running-req: 1, #token: 713, token usage: 0.03, cuda graph: False, gen throughput (token/s): 34.68, #queue-req: 0


    [2026-05-25 10:19:41] Decode batch, #running-req: 1, #token: 753, token usage: 0.04, cuda graph: False, gen throughput (token/s): 31.83, #queue-req: 0


    [2026-05-25 10:19:42] Decode batch, #running-req: 1, #token: 793, token usage: 0.04, cuda graph: False, gen throughput (token/s): 33.72, #queue-req: 0


    [2026-05-25 10:19:43] Decode batch, #running-req: 1, #token: 833, token usage: 0.04, cuda graph: False, gen throughput (token/s): 36.36, #queue-req: 0


    [2026-05-25 10:19:44] Decode batch, #running-req: 1, #token: 873, token usage: 0.04, cuda graph: False, gen throughput (token/s): 38.31, #queue-req: 0


    [2026-05-25 10:19:45] Decode batch, #running-req: 1, #token: 913, token usage: 0.04, cuda graph: False, gen throughput (token/s): 41.68, #queue-req: 0


    [2026-05-25 10:19:46] Decode batch, #running-req: 1, #token: 953, token usage: 0.05, cuda graph: False, gen throughput (token/s): 44.96, #queue-req: 0


    [2026-05-25 10:19:47] Decode batch, #running-req: 1, #token: 993, token usage: 0.05, cuda graph: False, gen throughput (token/s): 47.28, #queue-req: 0


    [2026-05-25 10:19:47] Decode batch, #running-req: 1, #token: 0, token usage: 0.00, cuda graph: False, gen throughput (token/s): 53.36, #queue-req: 0
    [2026-05-25 10:19:47] INFO:     127.0.0.1:60266 - "POST /generate HTTP/1.1" 200 OK
    Output from lora0: 
