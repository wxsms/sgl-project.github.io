...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 107.46it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 337.92it/s]
...
```
    ...
    [2026-06-10 03:15:03] Load weight end. elapsed=3.12 s, type=LlamaForCausalLM, avail mem=43.84 GB, mem usage=15.02 GB.
    [2026-06-10 03:15:03] Using csgmv as backend of LoRA kernels.
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 51622.20it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 18137.53it/s]
    [2026-06-10 03:15:03] Found local HF snapshot for Nutanix/Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json at /root/.cache/huggingface/hub/models--Nutanix--Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json/snapshots/2c398740f3eba8dc63ee78999316b833a2833b6c; skipping download.
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 328.27it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 8943.08it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 10505.46it/s]
    [2026-06-10 03:15:03] Found local HF snapshot for algoprog/fact-generation-llama-3.1-8b-instruct-lora at /root/.cache/huggingface/hub/models--algoprog--fact-generation-llama-3.1-8b-instruct-lora/snapshots/dc8cdfb21993a6cb46199d6b1d79f68a42b06439; skipping download.


    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 172.16it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 15563.28it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 85163.53it/s]
    [2026-06-10 03:15:04] Found local HF snapshot for philschmid/code-llama-3-1-8b-text-to-sql-lora at /root/.cache/huggingface/hub/models--philschmid--code-llama-3-1-8b-text-to-sql-lora/snapshots/141fc3a09386a8baf0d7495c247ae2d1a565f69f; skipping download.


    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 114.16it/s]


    [2026-06-10 03:15:05] Max concurrent requests (per dp worker) from the finalized token capacity: max_num_reqs=128.
    [2026-06-10 03:15:05] KV Cache is allocated. dtype: torch.bfloat16, #tokens: 20480, K size: 1.25 GB, V size: 1.25 GB
    [2026-06-10 03:15:05] Memory pool end. avail mem=37.96 GB
    [2026-06-10 03:15:05] Disable piecewise CUDA graph because --disable-piecewise-cuda-graph is set


    [2026-06-10 03:15:12] max_total_num_tokens=20480, chunked_prefill_size=8192, max_prefill_tokens=16384, max_running_requests=128, context_len=131072, available_gpu_mem=58.17 GB
    [2026-06-10 03:15:12] Tree cache initialized: source=default impl=RadixCache hybrid_swa=False hybrid_ssm=False hierarchical=False streaming_wrapped=False


    [2026-06-10 03:15:12] INFO:     Started server process [1031081]
    [2026-06-10 03:15:12] INFO:     Waiting for application startup.
    [2026-06-10 03:15:12] Using default chat sampling params from model generation config: {'temperature': 0.6, 'top_p': 0.9}
    [2026-06-10 03:15:12] INFO:     Application startup complete.
    [2026-06-10 03:15:12] INFO:     Uvicorn running on http://127.0.0.1:38959 (Press CTRL+C to quit)


    /usr/local/lib/python3.10/dist-packages/fastapi/routing.py:120: FastAPIDeprecationWarning: ORJSONResponse is deprecated, FastAPI now serializes data directly to JSON bytes via Pydantic when a return type or response model is set, which is faster and doesn't need a custom response class. Read more in the FastAPI docs: https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model and https://fastapi.tiangolo.com/tutorial/response-model/
      response = await f(request)
    [2026-06-10 03:15:13] INFO:     127.0.0.1:48858 - "GET /v1/models HTTP/1.1" 200 OK


    [2026-06-10 03:15:13] INFO:     127.0.0.1:48862 - "GET /model_info HTTP/1.1" 200 OK


    [2026-06-10 03:15:14] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-10 03:15:14] LoRA expand (K=6144, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-10 03:15:14] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-10 03:15:14] LoRA expand (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}


    [2026-06-10 03:15:15] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-10 03:15:15] LoRA expand (K=28672, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-10 03:15:15] LoRA shrink (K=14336, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}


    [2026-06-10 03:15:15] Prefill batch, #new-seq: 1, #new-token: 7, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 2.13
    [2026-06-10 03:15:15] INFO:     127.0.0.1:48864 - "POST /generate HTTP/1.1" 200 OK
    [2026-06-10 03:15:15] The server is fired up and ready to roll!
...
```
    ...
    [2026-06-10 03:15:18] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-10 03:15:18] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-10 03:15:19] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-10 03:15:21] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-10 03:15:21] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-10 03:15:21] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-10 03:15:22] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-10 03:15:22] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-10 03:15:22] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-10 03:15:22] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 2, #pending-token: 18, cuda graph: False, input throughput (token/s): 1.34


    [2026-06-10 03:15:22] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 1, #pending-token: 9, cuda graph: False, input throughput (token/s): 70.48


    [2026-06-10 03:15:23] Decode batch, #running-req: 2, #token: 83, token usage: 0.00, cuda graph: False, gen throughput (token/s): 6.59, #queue-req: 1


    [2026-06-10 03:15:23] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-10 03:15:24] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 5.87


    [2026-06-10 03:15:24] Decode batch, #running-req: 2, #token: 98, token usage: 0.00, cuda graph: False, gen throughput (token/s): 75.86, #queue-req: 0


    [2026-06-10 03:15:25] Decode batch, #running-req: 2, #token: 178, token usage: 0.01, cuda graph: False, gen throughput (token/s): 89.18, #queue-req: 0


    [2026-06-10 03:15:25] Decode batch, #running-req: 1, #token: 161, token usage: 0.01, cuda graph: False, gen throughput (token/s): 66.85, #queue-req: 0


    [2026-06-10 03:15:26] Decode batch, #running-req: 1, #token: 201, token usage: 0.01, cuda graph: False, gen throughput (token/s): 49.31, #queue-req: 0


    [2026-06-10 03:15:27] Decode batch, #running-req: 1, #token: 241, token usage: 0.01, cuda graph: False, gen throughput (token/s): 47.82, #queue-req: 0


    [2026-06-10 03:15:28] Decode batch, #running-req: 1, #token: 281, token usage: 0.01, cuda graph: False, gen throughput (token/s): 46.21, #queue-req: 0


    [2026-06-10 03:15:29] Decode batch, #running-req: 1, #token: 321, token usage: 0.02, cuda graph: False, gen throughput (token/s): 45.60, #queue-req: 0


    [2026-06-10 03:15:30] Decode batch, #running-req: 1, #token: 361, token usage: 0.02, cuda graph: False, gen throughput (token/s): 47.06, #queue-req: 0


    [2026-06-10 03:15:31] Decode batch, #running-req: 1, #token: 401, token usage: 0.02, cuda graph: False, gen throughput (token/s): 45.24, #queue-req: 0


    [2026-06-10 03:15:31] Decode batch, #running-req: 1, #token: 441, token usage: 0.02, cuda graph: False, gen throughput (token/s): 46.59, #queue-req: 0


    [2026-06-10 03:15:32] Decode batch, #running-req: 1, #token: 481, token usage: 0.02, cuda graph: False, gen throughput (token/s): 46.22, #queue-req: 0


    [2026-06-10 03:15:33] Decode batch, #running-req: 1, #token: 521, token usage: 0.03, cuda graph: False, gen throughput (token/s): 45.48, #queue-req: 0


    [2026-06-10 03:15:34] Decode batch, #running-req: 1, #token: 561, token usage: 0.03, cuda graph: False, gen throughput (token/s): 45.14, #queue-req: 0


    [2026-06-10 03:15:35] Decode batch, #running-req: 1, #token: 601, token usage: 0.03, cuda graph: False, gen throughput (token/s): 46.93, #queue-req: 0


    [2026-06-10 03:15:36] Decode batch, #running-req: 1, #token: 641, token usage: 0.03, cuda graph: False, gen throughput (token/s): 45.58, #queue-req: 0


    [2026-06-10 03:15:37] Decode batch, #running-req: 1, #token: 681, token usage: 0.03, cuda graph: False, gen throughput (token/s): 44.26, #queue-req: 0


    [2026-06-10 03:15:37] Decode batch, #running-req: 1, #token: 721, token usage: 0.04, cuda graph: False, gen throughput (token/s): 49.27, #queue-req: 0


    [2026-06-10 03:15:38] Decode batch, #running-req: 1, #token: 761, token usage: 0.04, cuda graph: False, gen throughput (token/s): 48.46, #queue-req: 0


    [2026-06-10 03:15:39] Decode batch, #running-req: 1, #token: 801, token usage: 0.04, cuda graph: False, gen throughput (token/s): 48.71, #queue-req: 0


    [2026-06-10 03:15:40] Decode batch, #running-req: 1, #token: 841, token usage: 0.04, cuda graph: False, gen throughput (token/s): 48.00, #queue-req: 0


    [2026-06-10 03:15:41] Decode batch, #running-req: 1, #token: 881, token usage: 0.04, cuda graph: False, gen throughput (token/s): 42.25, #queue-req: 0


    [2026-06-10 03:15:42] Decode batch, #running-req: 1, #token: 921, token usage: 0.04, cuda graph: False, gen throughput (token/s): 44.36, #queue-req: 0


    [2026-06-10 03:15:43] Decode batch, #running-req: 1, #token: 961, token usage: 0.05, cuda graph: False, gen throughput (token/s): 43.53, #queue-req: 0


    [2026-06-10 03:15:44] Decode batch, #running-req: 1, #token: 1001, token usage: 0.05, cuda graph: False, gen throughput (token/s): 43.36, #queue-req: 0


    [2026-06-10 03:15:44] INFO:     127.0.0.1:48876 - "POST /generate HTTP/1.1" 200 OK
    Output from lora0: 
