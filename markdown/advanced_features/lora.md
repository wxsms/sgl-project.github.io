...
```
    ...
    Multi-thread loading shards:  25% Completed | 1/4 [00:02<00:08,  2.99s/it]

    Multi-thread loading shards:  50% Completed | 2/4 [00:05<00:05,  2.66s/it]

    Multi-thread loading shards:  75% Completed | 3/4 [00:07<00:02,  2.58s/it]

    Multi-thread loading shards: 100% Completed | 4/4 [00:08<00:00,  1.93s/it]Multi-thread loading shards: 100% Completed | 4/4 [00:08<00:00,  2.21s/it]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 275.80it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 162.70it/s]
...
```
    ...
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 7240.92it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 9172.89it/s]


    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 188.20it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 14181.92it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 32326.04it/s]
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 132.58it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 154.48it/s]
...
```
    ...
    [2026-06-03 21:29:45] Load weight end. elapsed=4.72 s, type=LlamaForCausalLM, avail mem=43.84 GB, mem usage=15.02 GB.
    [2026-06-03 21:29:45] Using csgmv as backend of LoRA kernels.
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 10168.01it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 77672.30it/s]
    [2026-06-03 21:29:45] Found local HF snapshot for Nutanix/Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json at /root/.cache/huggingface/hub/models--Nutanix--Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json/snapshots/2c398740f3eba8dc63ee78999316b833a2833b6c; skipping download.
    ...
    [2026-06-03 21:29:45] Found local HF snapshot for algoprog/fact-generation-llama-3.1-8b-instruct-lora at /root/.cache/huggingface/hub/models--algoprog--fact-generation-llama-3.1-8b-instruct-lora/snapshots/dc8cdfb21993a6cb46199d6b1d79f68a42b06439; skipping download.


    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 150.73it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 42690.12it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 53430.62it/s]
    [2026-06-03 21:29:46] Found local HF snapshot for philschmid/code-llama-3-1-8b-text-to-sql-lora at /root/.cache/huggingface/hub/models--philschmid--code-llama-3-1-8b-text-to-sql-lora/snapshots/141fc3a09386a8baf0d7495c247ae2d1a565f69f; skipping download.


    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 104.14it/s]


    [2026-06-03 21:29:47] Max concurrent requests (per dp worker) from the finalized token capacity: max_num_reqs=128.
    [2026-06-03 21:29:47] KV Cache is allocated. dtype: torch.bfloat16, #tokens: 20480, K size: 1.25 GB, V size: 1.25 GB
    [2026-06-03 21:29:47] Memory pool end. avail mem=37.45 GB
    [2026-06-03 21:29:47] Disable piecewise CUDA graph because --disable-piecewise-cuda-graph is set


    [2026-06-03 21:29:53] max_total_num_tokens=20480, chunked_prefill_size=8192, max_prefill_tokens=16384, max_running_requests=128, context_len=131072, available_gpu_mem=49.25 GB
    [2026-06-03 21:29:53] Tree cache initialized: source=default impl=RadixCache hybrid_swa=False hybrid_ssm=False hierarchical=False streaming_wrapped=False


    [2026-06-03 21:29:54] INFO:     Started server process [505111]
    [2026-06-03 21:29:54] INFO:     Waiting for application startup.
    [2026-06-03 21:29:54] Using default chat sampling params from model generation config: {'temperature': 0.6, 'top_p': 0.9}
    [2026-06-03 21:29:54] INFO:     Application startup complete.
    [2026-06-03 21:29:54] INFO:     Uvicorn running on http://127.0.0.1:39991 (Press CTRL+C to quit)


    /usr/local/lib/python3.10/dist-packages/fastapi/routing.py:120: FastAPIDeprecationWarning: ORJSONResponse is deprecated, FastAPI now serializes data directly to JSON bytes via Pydantic when a return type or response model is set, which is faster and doesn't need a custom response class. Read more in the FastAPI docs: https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model and https://fastapi.tiangolo.com/tutorial/response-model/
      response = await f(request)
    [2026-06-03 21:29:54] INFO:     127.0.0.1:41146 - "GET /v1/models HTTP/1.1" 200 OK


    [2026-06-03 21:29:55] INFO:     127.0.0.1:41160 - "GET /model_info HTTP/1.1" 200 OK


    [2026-06-03 21:29:56] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-03 21:29:56] LoRA expand (K=6144, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-03 21:29:56] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-03 21:29:56] LoRA expand (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}


    [2026-06-03 21:29:56] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-03 21:29:56] LoRA expand (K=28672, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-03 21:29:56] LoRA shrink (K=14336, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}


    [2026-06-03 21:29:57] Prefill batch, #new-seq: 1, #new-token: 7, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 2.07
    [2026-06-03 21:29:57] INFO:     127.0.0.1:41162 - "POST /generate HTTP/1.1" 200 OK
    [2026-06-03 21:29:57] The server is fired up and ready to roll!
...
```
    ...
    [2026-06-03 21:29:59] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-03 21:29:59] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-03 21:30:00] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-03 21:30:00] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-03 21:30:00] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-03 21:30:02] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-03 21:30:02] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-03 21:30:02] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-03 21:30:02] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-03 21:30:02] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 2, #pending-token: 18, cuda graph: False, input throughput (token/s): 1.53
    [2026-06-03 21:30:02] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-03 21:30:02] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-03 21:30:03] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-03 21:30:03] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-03 21:30:03] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-03 21:30:03] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-03 21:30:03] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-03 21:30:03] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 1, #pending-token: 9, cuda graph: False, input throughput (token/s): 10.38


    [2026-06-03 21:30:04] Decode batch, #running-req: 2, #token: 77, token usage: 0.00, cuda graph: False, gen throughput (token/s): 6.12, #queue-req: 1


    [2026-06-03 21:30:04] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-03 21:30:05] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 6.05
    [2026-06-03 21:30:05] Decode batch, #running-req: 2, #token: 91, token usage: 0.00, cuda graph: False, gen throughput (token/s): 67.30, #queue-req: 0


    [2026-06-03 21:30:06] Decode batch, #running-req: 2, #token: 171, token usage: 0.01, cuda graph: False, gen throughput (token/s): 83.00, #queue-req: 0


    [2026-06-03 21:30:07] Decode batch, #running-req: 1, #token: 155, token usage: 0.01, cuda graph: False, gen throughput (token/s): 61.14, #queue-req: 0


    [2026-06-03 21:30:08] Decode batch, #running-req: 1, #token: 195, token usage: 0.01, cuda graph: False, gen throughput (token/s): 50.23, #queue-req: 0


    [2026-06-03 21:30:08] Decode batch, #running-req: 1, #token: 235, token usage: 0.01, cuda graph: False, gen throughput (token/s): 51.23, #queue-req: 0


    [2026-06-03 21:30:09] Decode batch, #running-req: 1, #token: 275, token usage: 0.01, cuda graph: False, gen throughput (token/s): 53.30, #queue-req: 0


    [2026-06-03 21:30:10] Decode batch, #running-req: 1, #token: 315, token usage: 0.02, cuda graph: False, gen throughput (token/s): 49.08, #queue-req: 0


    [2026-06-03 21:30:11] Decode batch, #running-req: 1, #token: 355, token usage: 0.02, cuda graph: False, gen throughput (token/s): 50.92, #queue-req: 0


    [2026-06-03 21:30:12] Decode batch, #running-req: 1, #token: 395, token usage: 0.02, cuda graph: False, gen throughput (token/s): 52.72, #queue-req: 0


    [2026-06-03 21:30:12] Decode batch, #running-req: 1, #token: 435, token usage: 0.02, cuda graph: False, gen throughput (token/s): 51.39, #queue-req: 0


    [2026-06-03 21:30:13] Decode batch, #running-req: 1, #token: 475, token usage: 0.02, cuda graph: False, gen throughput (token/s): 42.58, #queue-req: 0


    [2026-06-03 21:30:14] Decode batch, #running-req: 1, #token: 515, token usage: 0.03, cuda graph: False, gen throughput (token/s): 47.37, #queue-req: 0


    [2026-06-03 21:30:15] Decode batch, #running-req: 1, #token: 555, token usage: 0.03, cuda graph: False, gen throughput (token/s): 48.33, #queue-req: 0


    [2026-06-03 21:30:16] Decode batch, #running-req: 1, #token: 595, token usage: 0.03, cuda graph: False, gen throughput (token/s): 49.34, #queue-req: 0


    [2026-06-03 21:30:17] Decode batch, #running-req: 1, #token: 635, token usage: 0.03, cuda graph: False, gen throughput (token/s): 50.45, #queue-req: 0


    [2026-06-03 21:30:17] Decode batch, #running-req: 1, #token: 675, token usage: 0.03, cuda graph: False, gen throughput (token/s): 49.29, #queue-req: 0


    [2026-06-03 21:30:18] Decode batch, #running-req: 1, #token: 715, token usage: 0.03, cuda graph: False, gen throughput (token/s): 55.76, #queue-req: 0


    [2026-06-03 21:30:19] Decode batch, #running-req: 1, #token: 755, token usage: 0.04, cuda graph: False, gen throughput (token/s): 52.72, #queue-req: 0


    [2026-06-03 21:30:20] Decode batch, #running-req: 1, #token: 795, token usage: 0.04, cuda graph: False, gen throughput (token/s): 53.68, #queue-req: 0


    [2026-06-03 21:30:20] Decode batch, #running-req: 1, #token: 835, token usage: 0.04, cuda graph: False, gen throughput (token/s): 48.98, #queue-req: 0


    [2026-06-03 21:30:21] Decode batch, #running-req: 1, #token: 875, token usage: 0.04, cuda graph: False, gen throughput (token/s): 48.71, #queue-req: 0


    [2026-06-03 21:30:22] Decode batch, #running-req: 1, #token: 915, token usage: 0.04, cuda graph: False, gen throughput (token/s): 51.37, #queue-req: 0


    [2026-06-03 21:30:23] Decode batch, #running-req: 1, #token: 955, token usage: 0.05, cuda graph: False, gen throughput (token/s): 47.07, #queue-req: 0


    [2026-06-03 21:30:24] Decode batch, #running-req: 1, #token: 995, token usage: 0.05, cuda graph: False, gen throughput (token/s): 53.81, #queue-req: 0


    [2026-06-03 21:30:24] INFO:     127.0.0.1:41174 - "POST /generate HTTP/1.1" 200 OK
    Output from lora0: 
