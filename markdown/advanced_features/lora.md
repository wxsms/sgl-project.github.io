...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 176.52it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 118.93it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 170.61it/s]
...
```
    ...
    [2026-06-01 04:06:12] Load weight end. elapsed=3.96 s, type=LlamaForCausalLM, avail mem=63.48 GB, mem usage=-4.62 GB.
    [2026-06-01 04:06:12] Using csgmv as backend of LoRA kernels.
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 17512.75it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 59493.67it/s]
    [2026-06-01 04:06:12] Found local HF snapshot for Nutanix/Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json at /root/.cache/huggingface/hub/models--Nutanix--Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json/snapshots/2c398740f3eba8dc63ee78999316b833a2833b6c; skipping download.
    ...
    [2026-06-01 04:06:13] Found local HF snapshot for algoprog/fact-generation-llama-3.1-8b-instruct-lora at /root/.cache/huggingface/hub/models--algoprog--fact-generation-llama-3.1-8b-instruct-lora/snapshots/dc8cdfb21993a6cb46199d6b1d79f68a42b06439; skipping download.


    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 169.28it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 82241.25it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 22310.13it/s]
    [2026-06-01 04:06:13] Found local HF snapshot for philschmid/code-llama-3-1-8b-text-to-sql-lora at /root/.cache/huggingface/hub/models--philschmid--code-llama-3-1-8b-text-to-sql-lora/snapshots/141fc3a09386a8baf0d7495c247ae2d1a565f69f; skipping download.


    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 106.04it/s]


    [2026-06-01 04:06:15] Max concurrent requests (per dp worker) from the finalized token capacity: max_num_reqs=128.
    [2026-06-01 04:06:15] KV Cache is allocated. dtype: torch.bfloat16, #tokens: 20480, K size: 1.25 GB, V size: 1.25 GB
    [2026-06-01 04:06:15] Memory pool end. avail mem=58.26 GB
    [2026-06-01 04:06:15] Disable piecewise CUDA graph because --disable-piecewise-cuda-graph is set


    [2026-06-01 04:06:20] max_total_num_tokens=20480, chunked_prefill_size=8192, max_prefill_tokens=16384, max_running_requests=128, context_len=131072, available_gpu_mem=49.26 GB
    [2026-06-01 04:06:20] Tree cache initialized: source=default impl=RadixCache hybrid_swa=False hybrid_ssm=False hierarchical=False streaming_wrapped=False


    [2026-06-01 04:06:21] INFO:     Started server process [2573290]
    [2026-06-01 04:06:21] INFO:     Waiting for application startup.
    [2026-06-01 04:06:21] Using default chat sampling params from model generation config: {'temperature': 0.6, 'top_p': 0.9}
    [2026-06-01 04:06:21] INFO:     Application startup complete.
    [2026-06-01 04:06:21] INFO:     Uvicorn running on http://127.0.0.1:32320 (Press CTRL+C to quit)


    /usr/local/lib/python3.10/dist-packages/fastapi/routing.py:120: FastAPIDeprecationWarning: ORJSONResponse is deprecated, FastAPI now serializes data directly to JSON bytes via Pydantic when a return type or response model is set, which is faster and doesn't need a custom response class. Read more in the FastAPI docs: https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model and https://fastapi.tiangolo.com/tutorial/response-model/
      response = await f(request)
    [2026-06-01 04:06:21] INFO:     127.0.0.1:55506 - "GET /v1/models HTTP/1.1" 200 OK


    [2026-06-01 04:06:22] INFO:     127.0.0.1:55520 - "GET /model_info HTTP/1.1" 200 OK


    [2026-06-01 04:06:23] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-01 04:06:23] LoRA expand (K=6144, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-01 04:06:23] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-01 04:06:23] LoRA expand (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}


    [2026-06-01 04:06:23] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-01 04:06:23] LoRA expand (K=28672, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-01 04:06:23] LoRA shrink (K=14336, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}


    [2026-06-01 04:06:24] Prefill batch, #new-seq: 1, #new-token: 7, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 2.13
    [2026-06-01 04:06:24] INFO:     127.0.0.1:55534 - "POST /generate HTTP/1.1" 200 OK
    [2026-06-01 04:06:24] The server is fired up and ready to roll!
...
```
    ...
    [2026-06-01 04:06:26] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-01 04:06:26] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-01 04:06:27] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-01 04:06:29] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-01 04:06:29] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-01 04:06:29] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-01 04:06:29] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-01 04:06:30] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 2, #pending-token: 18, cuda graph: False, input throughput (token/s): 1.47
    [2026-06-01 04:06:30] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-01 04:06:30] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-01 04:06:31] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-01 04:06:31] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-01 04:06:31] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-01 04:06:31] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-01 04:06:31] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-01 04:06:31] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-01 04:06:32] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].


    [2026-06-01 04:06:32] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 1, #pending-token: 9, cuda graph: False, input throughput (token/s): 4.32


    [2026-06-01 04:06:32] Decode batch, #running-req: 2, #token: 68, token usage: 0.00, cuda graph: False, gen throughput (token/s): 4.73, #queue-req: 1


    [2026-06-01 04:06:33] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-01 04:06:33] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 6.42
    [2026-06-01 04:06:33] Decode batch, #running-req: 2, #token: 82, token usage: 0.00, cuda graph: False, gen throughput (token/s): 65.99, #queue-req: 0


    [2026-06-01 04:06:34] Decode batch, #running-req: 2, #token: 162, token usage: 0.01, cuda graph: False, gen throughput (token/s): 105.11, #queue-req: 0


    [2026-06-01 04:06:35] Decode batch, #running-req: 1, #token: 146, token usage: 0.01, cuda graph: False, gen throughput (token/s): 77.97, #queue-req: 0


    [2026-06-01 04:06:36] Decode batch, #running-req: 1, #token: 186, token usage: 0.01, cuda graph: False, gen throughput (token/s): 49.94, #queue-req: 0


    [2026-06-01 04:06:36] Decode batch, #running-req: 1, #token: 226, token usage: 0.01, cuda graph: False, gen throughput (token/s): 52.87, #queue-req: 0


    [2026-06-01 04:06:37] Decode batch, #running-req: 1, #token: 266, token usage: 0.01, cuda graph: False, gen throughput (token/s): 50.50, #queue-req: 0


    [2026-06-01 04:06:38] Decode batch, #running-req: 1, #token: 306, token usage: 0.01, cuda graph: False, gen throughput (token/s): 45.51, #queue-req: 0


    [2026-06-01 04:06:39] Decode batch, #running-req: 1, #token: 346, token usage: 0.02, cuda graph: False, gen throughput (token/s): 52.32, #queue-req: 0


    [2026-06-01 04:06:40] Decode batch, #running-req: 1, #token: 386, token usage: 0.02, cuda graph: False, gen throughput (token/s): 51.38, #queue-req: 0


    [2026-06-01 04:06:40] Decode batch, #running-req: 1, #token: 426, token usage: 0.02, cuda graph: False, gen throughput (token/s): 55.32, #queue-req: 0


    [2026-06-01 04:06:41] Decode batch, #running-req: 1, #token: 466, token usage: 0.02, cuda graph: False, gen throughput (token/s): 52.62, #queue-req: 0


    [2026-06-01 04:06:42] Decode batch, #running-req: 1, #token: 506, token usage: 0.02, cuda graph: False, gen throughput (token/s): 49.78, #queue-req: 0


    [2026-06-01 04:06:43] Decode batch, #running-req: 1, #token: 546, token usage: 0.03, cuda graph: False, gen throughput (token/s): 50.11, #queue-req: 0


    [2026-06-01 04:06:43] Decode batch, #running-req: 1, #token: 586, token usage: 0.03, cuda graph: False, gen throughput (token/s): 48.29, #queue-req: 0


    [2026-06-01 04:06:44] Decode batch, #running-req: 1, #token: 626, token usage: 0.03, cuda graph: False, gen throughput (token/s): 46.76, #queue-req: 0


    [2026-06-01 04:06:45] Decode batch, #running-req: 1, #token: 666, token usage: 0.03, cuda graph: False, gen throughput (token/s): 49.13, #queue-req: 0


    [2026-06-01 04:06:46] Decode batch, #running-req: 1, #token: 706, token usage: 0.03, cuda graph: False, gen throughput (token/s): 50.88, #queue-req: 0


    [2026-06-01 04:06:47] Decode batch, #running-req: 1, #token: 746, token usage: 0.04, cuda graph: False, gen throughput (token/s): 53.82, #queue-req: 0


    [2026-06-01 04:06:47] Decode batch, #running-req: 1, #token: 786, token usage: 0.04, cuda graph: False, gen throughput (token/s): 48.76, #queue-req: 0


    [2026-06-01 04:06:48] Decode batch, #running-req: 1, #token: 826, token usage: 0.04, cuda graph: False, gen throughput (token/s): 45.39, #queue-req: 0


    [2026-06-01 04:06:49] Decode batch, #running-req: 1, #token: 866, token usage: 0.04, cuda graph: False, gen throughput (token/s): 47.91, #queue-req: 0


    [2026-06-01 04:06:50] Decode batch, #running-req: 1, #token: 906, token usage: 0.04, cuda graph: False, gen throughput (token/s): 54.32, #queue-req: 0


    [2026-06-01 04:06:51] Decode batch, #running-req: 1, #token: 946, token usage: 0.05, cuda graph: False, gen throughput (token/s): 52.28, #queue-req: 0


    [2026-06-01 04:06:51] Decode batch, #running-req: 1, #token: 986, token usage: 0.05, cuda graph: False, gen throughput (token/s): 52.15, #queue-req: 0


    [2026-06-01 04:06:52] Decode batch, #running-req: 1, #token: 1026, token usage: 0.05, cuda graph: False, gen throughput (token/s): 53.88, #queue-req: 0
    [2026-06-01 04:06:52] INFO:     127.0.0.1:55326 - "POST /generate HTTP/1.1" 200 OK
    Output from lora0: 
