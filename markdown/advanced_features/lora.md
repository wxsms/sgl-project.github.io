...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 148.34it/s]


    [2026-05-07 02:29:40] Tokenizer loaded as generic TokenizersBackend for meta-llama/Meta-Llama-3.1-8B-Instruct, retrying with use_fast=False


    [2026-05-07 02:29:43] Tokenizer for meta-llama/Meta-Llama-3.1-8B-Instruct loaded as generic TokenizersBackend. Set --trust-remote-code to load the model-specific tokenizer.
    ...
    2026-05-07 02:29:49,816 - CUTE_DSL - WARNING - [handle_import_error] - Unexpected error during package walk: cutlass.cute.experimental
    [2026-05-07 02:29:49] Unexpected error during package walk: cutlass.cute.experimental
...
```
    ...
    [2026-05-07 02:30:04] Tokenizer loaded as generic TokenizersBackend for meta-llama/Meta-Llama-3.1-8B-Instruct, retrying with use_fast=False


    [2026-05-07 02:30:06] Tokenizer for meta-llama/Meta-Llama-3.1-8B-Instruct loaded as generic TokenizersBackend. Set --trust-remote-code to load the model-specific tokenizer.


    [2026-05-07 02:30:10] Tokenizer loaded as generic TokenizersBackend for meta-llama/Meta-Llama-3.1-8B-Instruct, retrying with use_fast=False


    [2026-05-07 02:30:10] Tokenizer loaded as generic TokenizersBackend for meta-llama/Meta-Llama-3.1-8B-Instruct, retrying with use_fast=False


    [2026-05-07 02:30:12] Tokenizer for meta-llama/Meta-Llama-3.1-8B-Instruct loaded as generic TokenizersBackend. Set --trust-remote-code to load the model-specific tokenizer.
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 168.65it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 18872.01it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 22339.83it/s]
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 320.71it/s]


    [2026-05-07 02:30:21] Tokenizer loaded as generic TokenizersBackend for meta-llama/Meta-Llama-3.1-8B-Instruct, retrying with use_fast=False


    [2026-05-07 02:30:23] Tokenizer for meta-llama/Meta-Llama-3.1-8B-Instruct loaded as generic TokenizersBackend. Set --trust-remote-code to load the model-specific tokenizer.
...
```
    ...
    2026-05-07 02:30:32,382 - CUTE_DSL - WARNING - [handle_import_error] - Unexpected error during package walk: cutlass.cute.experimental
    [2026-05-07 02:30:32] Unexpected error during package walk: cutlass.cute.experimental
...
```
    ...
    [2026-05-07 02:30:42] Tokenizer loaded as generic TokenizersBackend for meta-llama/Meta-Llama-3.1-8B-Instruct, retrying with use_fast=False


    [2026-05-07 02:30:44] Tokenizer for meta-llama/Meta-Llama-3.1-8B-Instruct loaded as generic TokenizersBackend. Set --trust-remote-code to load the model-specific tokenizer.


    [2026-05-07 02:30:48] Tokenizer loaded as generic TokenizersBackend for meta-llama/Meta-Llama-3.1-8B-Instruct, retrying with use_fast=False


    [2026-05-07 02:30:48] Tokenizer loaded as generic TokenizersBackend for meta-llama/Meta-Llama-3.1-8B-Instruct, retrying with use_fast=False


    [2026-05-07 02:30:50] Tokenizer for meta-llama/Meta-Llama-3.1-8B-Instruct loaded as generic TokenizersBackend. Set --trust-remote-code to load the model-specific tokenizer.


    [2026-05-07 02:30:51] Tokenizer for meta-llama/Meta-Llama-3.1-8B-Instruct loaded as generic TokenizersBackend. Set --trust-remote-code to load the model-specific tokenizer.
    ...
    [2026-05-07 02:30:59] Tokenizer loaded as generic TokenizersBackend for meta-llama/Meta-Llama-3.1-8B-Instruct, retrying with use_fast=False


    [2026-05-07 02:31:02] Tokenizer for meta-llama/Meta-Llama-3.1-8B-Instruct loaded as generic TokenizersBackend. Set --trust-remote-code to load the model-specific tokenizer.
    ...
    2026-05-07 02:31:05,211 - CUTE_DSL - WARNING - [handle_import_error] - Unexpected error during package walk: cutlass.cute.experimental
    [2026-05-07 02:31:05] Unexpected error during package walk: cutlass.cute.experimental
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 158.34it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 109.26it/s]
...
```
    ...
    [2026-05-07 02:31:21] Tokenizer loaded as generic TokenizersBackend for meta-llama/Meta-Llama-3.1-8B-Instruct, retrying with use_fast=False


    [2026-05-07 02:31:24] Tokenizer for meta-llama/Meta-Llama-3.1-8B-Instruct loaded as generic TokenizersBackend. Set --trust-remote-code to load the model-specific tokenizer.


    [2026-05-07 02:31:28] Tokenizer loaded as generic TokenizersBackend for meta-llama/Meta-Llama-3.1-8B-Instruct, retrying with use_fast=False


    [2026-05-07 02:31:28] Tokenizer loaded as generic TokenizersBackend for meta-llama/Meta-Llama-3.1-8B-Instruct, retrying with use_fast=False


    [2026-05-07 02:31:30] Tokenizer for meta-llama/Meta-Llama-3.1-8B-Instruct loaded as generic TokenizersBackend. Set --trust-remote-code to load the model-specific tokenizer.
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 161.48it/s]
    ...
    [2026-05-07 02:31:39] Tokenizer loaded as generic TokenizersBackend for meta-llama/Meta-Llama-3.1-8B-Instruct, retrying with use_fast=False


    [2026-05-07 02:31:41] Tokenizer for meta-llama/Meta-Llama-3.1-8B-Instruct loaded as generic TokenizersBackend. Set --trust-remote-code to load the model-specific tokenizer.
    ...
    2026-05-07 02:31:44,163 - CUTE_DSL - WARNING - [handle_import_error] - Unexpected error during package walk: cutlass.cute.experimental
    [2026-05-07 02:31:44] Unexpected error during package walk: cutlass.cute.experimental
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 160.47it/s]
...
```
    ...
    [2026-05-07 02:32:13] Load weight end. elapsed=3.55 s, type=LlamaForCausalLM, avail mem=27.43 GB, mem usage=15.02 GB.
    [2026-05-07 02:32:13] Using csgmv as backend of LoRA kernels.


    [2026-05-07 02:32:13] Found local HF snapshot for Nutanix/Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json at /root/.cache/huggingface/hub/models--Nutanix--Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json/snapshots/2c398740f3eba8dc63ee78999316b833a2833b6c; skipping download.
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 343.35it/s]
    [2026-05-07 02:32:14] Found local HF snapshot for algoprog/fact-generation-llama-3.1-8b-instruct-lora at /root/.cache/huggingface/hub/models--algoprog--fact-generation-llama-3.1-8b-instruct-lora/snapshots/dc8cdfb21993a6cb46199d6b1d79f68a42b06439; skipping download.
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 163.20it/s]


    [2026-05-07 02:32:15] Found local HF snapshot for philschmid/code-llama-3-1-8b-text-to-sql-lora at /root/.cache/huggingface/hub/models--philschmid--code-llama-3-1-8b-text-to-sql-lora/snapshots/141fc3a09386a8baf0d7495c247ae2d1a565f69f; skipping download.
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 78.86it/s]


    [2026-05-07 02:32:17] Using KV cache dtype: torch.bfloat16
    [2026-05-07 02:32:17] KV Cache is allocated. #tokens: 20480, K size: 1.25 GB, V size: 1.25 GB
    [2026-05-07 02:32:17] Memory pool end. avail mem=39.90 GB
    [2026-05-07 02:32:17] Disable piecewise CUDA graph because --disable-piecewise-cuda-graph is set


    [2026-05-07 02:32:19] Tokenizer loaded as generic TokenizersBackend for meta-llama/Meta-Llama-3.1-8B-Instruct, retrying with use_fast=False


    [2026-05-07 02:32:20] Loading tokenizer for meta-llama/Meta-Llama-3.1-8B-Instruct directly as PreTrainedTokenizerFast (bypassing AutoTokenizer)


    [2026-05-07 02:32:21] Tokenizer for meta-llama/Meta-Llama-3.1-8B-Instruct loaded as generic TokenizersBackend. Set --trust-remote-code to load the model-specific tokenizer.


    [2026-05-07 02:32:21] max_total_num_tokens=20480, chunked_prefill_size=8192, max_prefill_tokens=16384, max_running_requests=128, context_len=131072, available_gpu_mem=39.81 GB


    [2026-05-07 02:32:22] INFO:     Started server process [970771]
    [2026-05-07 02:32:22] INFO:     Waiting for application startup.
    [2026-05-07 02:32:22] Using default chat sampling params from model generation config: {'temperature': 0.6, 'top_p': 0.9}
    [2026-05-07 02:32:22] INFO:     Application startup complete.
    [2026-05-07 02:32:22] INFO:     Uvicorn running on http://127.0.0.1:35296 (Press CTRL+C to quit)
    /usr/local/lib/python3.10/dist-packages/fastapi/routing.py:120: FastAPIDeprecationWarning: ORJSONResponse is deprecated, FastAPI now serializes data directly to JSON bytes via Pydantic when a return type or response model is set, which is faster and doesn't need a custom response class. Read more in the FastAPI docs: https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model and https://fastapi.tiangolo.com/tutorial/response-model/
      response = await f(request)
    [2026-05-07 02:32:22] INFO:     127.0.0.1:38912 - "GET /v1/models HTTP/1.1" 200 OK


    [2026-05-07 02:32:23] INFO:     127.0.0.1:38916 - "GET /model_info HTTP/1.1" 200 OK


    2026-05-07 02:32:26,436 - CUTE_DSL - WARNING - [handle_import_error] - Unexpected error during package walk: cutlass.cute.experimental
    [2026-05-07 02:32:26] Unexpected error during package walk: cutlass.cute.experimental


    [2026-05-07 02:32:26] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-05-07 02:32:26] LoRA expand (K=6144, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-05-07 02:32:26] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-05-07 02:32:26] LoRA expand (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}


    [2026-05-07 02:32:27] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-05-07 02:32:27] LoRA expand (K=28672, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-05-07 02:32:27] LoRA shrink (K=14336, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
...
```
    ...
    [2026-05-07 02:32:27] LoRA adapter 'f64eb3728a5048f09b8daa650c1e556b': loaded weights for target modules ['qkv_proj'].
    [2026-05-07 02:32:27] Prefill batch, #new-seq: 1, #new-token: 7, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 3, #pending-token: 0, cuda graph: False, input throughput (token/s): 0.30
    [2026-05-07 02:32:27] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 2, #pending-token: 18, cuda graph: False, input throughput (token/s): 148.48


    [2026-05-07 02:32:27] INFO:     127.0.0.1:38918 - "POST /generate HTTP/1.1" 200 OK
    [2026-05-07 02:32:27] The server is fired up and ready to roll!
    [2026-05-07 02:32:27] LoRA adapter '0926fc758a34405f941b92893687ccac': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-05-07 02:32:27] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 1, #pending-token: 9, cuda graph: False, input throughput (token/s): 23.58


    [2026-05-07 02:32:28] Decode batch, #running-req: 2, #token: 89, token usage: 0.00, cuda graph: False, gen throughput (token/s): 3.16, #queue-req: 1


    [2026-05-07 02:32:29] LoRA adapter '13100d7d417e418684b33fb12953c49d': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-05-07 02:32:29] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 4.76
    [2026-05-07 02:32:29] Decode batch, #running-req: 2, #token: 103, token usage: 0.01, cuda graph: False, gen throughput (token/s): 58.94, #queue-req: 0


    [2026-05-07 02:32:30] Decode batch, #running-req: 2, #token: 183, token usage: 0.01, cuda graph: False, gen throughput (token/s): 77.04, #queue-req: 0


    [2026-05-07 02:32:31] Decode batch, #running-req: 1, #token: 169, token usage: 0.01, cuda graph: False, gen throughput (token/s): 63.21, #queue-req: 0


    [2026-05-07 02:32:32] Decode batch, #running-req: 1, #token: 209, token usage: 0.01, cuda graph: False, gen throughput (token/s): 47.03, #queue-req: 0


    [2026-05-07 02:32:33] Decode batch, #running-req: 1, #token: 249, token usage: 0.01, cuda graph: False, gen throughput (token/s): 39.34, #queue-req: 0


    [2026-05-07 02:32:34] Decode batch, #running-req: 1, #token: 289, token usage: 0.01, cuda graph: False, gen throughput (token/s): 43.55, #queue-req: 0


    [2026-05-07 02:32:35] Decode batch, #running-req: 1, #token: 329, token usage: 0.02, cuda graph: False, gen throughput (token/s): 48.75, #queue-req: 0


    [2026-05-07 02:32:36] Decode batch, #running-req: 1, #token: 369, token usage: 0.02, cuda graph: False, gen throughput (token/s): 34.61, #queue-req: 0


    [2026-05-07 02:32:37] Decode batch, #running-req: 1, #token: 409, token usage: 0.02, cuda graph: False, gen throughput (token/s): 31.22, #queue-req: 0


    [2026-05-07 02:32:38] Decode batch, #running-req: 1, #token: 449, token usage: 0.02, cuda graph: False, gen throughput (token/s): 31.36, #queue-req: 0


    [2026-05-07 02:32:40] Decode batch, #running-req: 1, #token: 489, token usage: 0.02, cuda graph: False, gen throughput (token/s): 31.21, #queue-req: 0


    [2026-05-07 02:32:41] Decode batch, #running-req: 1, #token: 529, token usage: 0.03, cuda graph: False, gen throughput (token/s): 31.89, #queue-req: 0


    [2026-05-07 02:32:42] Decode batch, #running-req: 1, #token: 569, token usage: 0.03, cuda graph: False, gen throughput (token/s): 33.76, #queue-req: 0


    [2026-05-07 02:32:43] Decode batch, #running-req: 1, #token: 609, token usage: 0.03, cuda graph: False, gen throughput (token/s): 37.85, #queue-req: 0


    [2026-05-07 02:32:44] Decode batch, #running-req: 1, #token: 649, token usage: 0.03, cuda graph: False, gen throughput (token/s): 41.06, #queue-req: 0


    [2026-05-07 02:32:45] Decode batch, #running-req: 1, #token: 689, token usage: 0.03, cuda graph: False, gen throughput (token/s): 35.67, #queue-req: 0


    [2026-05-07 02:32:47] Decode batch, #running-req: 1, #token: 729, token usage: 0.04, cuda graph: False, gen throughput (token/s): 32.16, #queue-req: 0


    [2026-05-07 02:32:48] Decode batch, #running-req: 1, #token: 769, token usage: 0.04, cuda graph: False, gen throughput (token/s): 31.77, #queue-req: 0


    [2026-05-07 02:32:49] Decode batch, #running-req: 1, #token: 809, token usage: 0.04, cuda graph: False, gen throughput (token/s): 32.33, #queue-req: 0


    [2026-05-07 02:32:50] Decode batch, #running-req: 1, #token: 849, token usage: 0.04, cuda graph: False, gen throughput (token/s): 33.63, #queue-req: 0


    [2026-05-07 02:32:51] Decode batch, #running-req: 1, #token: 889, token usage: 0.04, cuda graph: False, gen throughput (token/s): 33.52, #queue-req: 0


    [2026-05-07 02:32:53] Decode batch, #running-req: 1, #token: 929, token usage: 0.05, cuda graph: False, gen throughput (token/s): 35.32, #queue-req: 0


    [2026-05-07 02:32:54] Decode batch, #running-req: 1, #token: 969, token usage: 0.05, cuda graph: False, gen throughput (token/s): 36.84, #queue-req: 0


    [2026-05-07 02:32:54] Decode batch, #running-req: 1, #token: 1009, token usage: 0.05, cuda graph: False, gen throughput (token/s): 46.56, #queue-req: 0


    [2026-05-07 02:32:55] INFO:     127.0.0.1:38926 - "POST /generate HTTP/1.1" 200 OK
    Output from lora0: 
