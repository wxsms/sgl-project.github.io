...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 324.18it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 376.85it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 126.19it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 113.47it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 182.28it/s]
...
```
    ...
    [2026-06-09 21:11:27] Load weight end. elapsed=2.57 s, type=LlamaForCausalLM, avail mem=62.81 GB, mem usage=15.02 GB.
    [2026-06-09 21:11:27] Using csgmv as backend of LoRA kernels.
    ...
    [2026-06-09 21:11:27] Found local HF snapshot for algoprog/fact-generation-llama-3.1-8b-instruct-lora at /root/.cache/huggingface/hub/models--algoprog--fact-generation-llama-3.1-8b-instruct-lora/snapshots/dc8cdfb21993a6cb46199d6b1d79f68a42b06439; skipping download.


    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 179.54it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 81049.35it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 20738.22it/s]
    [2026-06-09 21:11:28] Found local HF snapshot for philschmid/code-llama-3-1-8b-text-to-sql-lora at /root/.cache/huggingface/hub/models--philschmid--code-llama-3-1-8b-text-to-sql-lora/snapshots/141fc3a09386a8baf0d7495c247ae2d1a565f69f; skipping download.
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 115.05it/s]


    [2026-06-09 21:11:29] Max concurrent requests (per dp worker) from the finalized token capacity: max_num_reqs=128.
    [2026-06-09 21:11:29] KV Cache is allocated. dtype: torch.bfloat16, #tokens: 20480, K size: 1.25 GB, V size: 1.25 GB
    [2026-06-09 21:11:29] Memory pool end. avail mem=56.18 GB
    [2026-06-09 21:11:29] Disable piecewise CUDA graph because --disable-piecewise-cuda-graph is set


    [2026-06-09 21:11:33] max_total_num_tokens=20480, chunked_prefill_size=8192, max_prefill_tokens=16384, max_running_requests=128, context_len=131072, available_gpu_mem=55.81 GB
    [2026-06-09 21:11:33] Tree cache initialized: source=default impl=RadixCache hybrid_swa=False hybrid_ssm=False hierarchical=False streaming_wrapped=False


    [2026-06-09 21:11:33] INFO:     Started server process [644573]
    [2026-06-09 21:11:33] INFO:     Waiting for application startup.
    [2026-06-09 21:11:33] Using default chat sampling params from model generation config: {'temperature': 0.6, 'top_p': 0.9}
    [2026-06-09 21:11:33] INFO:     Application startup complete.
    [2026-06-09 21:11:33] INFO:     Uvicorn running on http://127.0.0.1:32476 (Press CTRL+C to quit)


    /usr/local/lib/python3.10/dist-packages/fastapi/routing.py:120: FastAPIDeprecationWarning: ORJSONResponse is deprecated, FastAPI now serializes data directly to JSON bytes via Pydantic when a return type or response model is set, which is faster and doesn't need a custom response class. Read more in the FastAPI docs: https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model and https://fastapi.tiangolo.com/tutorial/response-model/
      response = await f(request)
    [2026-06-09 21:11:34] INFO:     127.0.0.1:54936 - "GET /v1/models HTTP/1.1" 200 OK


    [2026-06-09 21:11:34] INFO:     127.0.0.1:49298 - "GET /model_info HTTP/1.1" 200 OK


    [2026-06-09 21:11:35] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-09 21:11:35] LoRA expand (K=6144, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-09 21:11:35] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-09 21:11:35] LoRA expand (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}


    [2026-06-09 21:11:35] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-09 21:11:35] LoRA expand (K=28672, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-09 21:11:35] LoRA shrink (K=14336, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}


    [2026-06-09 21:11:36] Prefill batch, #new-seq: 1, #new-token: 7, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 2.30
    [2026-06-09 21:11:36] INFO:     127.0.0.1:49300 - "POST /generate HTTP/1.1" 200 OK
    [2026-06-09 21:11:36] The server is fired up and ready to roll!
...
```
    ...
    [2026-06-09 21:11:39] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-09 21:11:39] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-09 21:11:39] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-09 21:11:39] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-09 21:11:39] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-09 21:11:41] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-09 21:11:41] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-09 21:11:41] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-09 21:11:41] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-09 21:11:41] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-09 21:11:41] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-09 21:11:41] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-09 21:11:41] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 2, #pending-token: 18, cuda graph: False, input throughput (token/s): 1.60
    [2026-06-09 21:11:41] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-09 21:11:41] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-09 21:11:41] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-09 21:11:41] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-09 21:11:42] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-09 21:11:42] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-09 21:11:42] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-09 21:11:42] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-09 21:11:42] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-09 21:11:42] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-09 21:11:42] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-09 21:11:42] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-09 21:11:43] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-09 21:11:43] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-09 21:11:43] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-09 21:11:43] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-09 21:11:43] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-09 21:11:43] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-09 21:11:43] Decode batch, #running-req: 1, #token: 42, token usage: 0.00, cuda graph: False, gen throughput (token/s): 3.82, #queue-req: 2
    [2026-06-09 21:11:43] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-09 21:11:43] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-09 21:11:43] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-09 21:11:43] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-09 21:11:43] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-09 21:11:43] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-09 21:11:44] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 1, #pending-token: 9, cuda graph: False, input throughput (token/s): 4.19


    [2026-06-09 21:11:44] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-09 21:11:44] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 15.50


    [2026-06-09 21:11:44] Decode batch, #running-req: 2, #token: 61, token usage: 0.00, cuda graph: False, gen throughput (token/s): 68.96, #queue-req: 0


    [2026-06-09 21:11:45] Decode batch, #running-req: 2, #token: 141, token usage: 0.01, cuda graph: False, gen throughput (token/s): 104.22, #queue-req: 0


    [2026-06-09 21:11:46] Decode batch, #running-req: 1, #token: 124, token usage: 0.01, cuda graph: False, gen throughput (token/s): 74.53, #queue-req: 0


    [2026-06-09 21:11:46] Decode batch, #running-req: 1, #token: 164, token usage: 0.01, cuda graph: False, gen throughput (token/s): 54.75, #queue-req: 0


    [2026-06-09 21:11:47] Decode batch, #running-req: 1, #token: 204, token usage: 0.01, cuda graph: False, gen throughput (token/s): 54.30, #queue-req: 0


    [2026-06-09 21:11:48] Decode batch, #running-req: 1, #token: 244, token usage: 0.01, cuda graph: False, gen throughput (token/s): 53.14, #queue-req: 0


    [2026-06-09 21:11:49] Decode batch, #running-req: 1, #token: 284, token usage: 0.01, cuda graph: False, gen throughput (token/s): 54.12, #queue-req: 0


    [2026-06-09 21:11:49] Decode batch, #running-req: 1, #token: 324, token usage: 0.02, cuda graph: False, gen throughput (token/s): 51.96, #queue-req: 0


    [2026-06-09 21:11:50] Decode batch, #running-req: 1, #token: 364, token usage: 0.02, cuda graph: False, gen throughput (token/s): 50.74, #queue-req: 0


    [2026-06-09 21:11:51] Decode batch, #running-req: 1, #token: 404, token usage: 0.02, cuda graph: False, gen throughput (token/s): 54.06, #queue-req: 0


    [2026-06-09 21:11:52] Decode batch, #running-req: 1, #token: 444, token usage: 0.02, cuda graph: False, gen throughput (token/s): 52.19, #queue-req: 0


    [2026-06-09 21:11:53] Decode batch, #running-req: 1, #token: 484, token usage: 0.02, cuda graph: False, gen throughput (token/s): 47.91, #queue-req: 0


    [2026-06-09 21:11:53] Decode batch, #running-req: 1, #token: 524, token usage: 0.03, cuda graph: False, gen throughput (token/s): 47.26, #queue-req: 0


    [2026-06-09 21:11:54] Decode batch, #running-req: 1, #token: 564, token usage: 0.03, cuda graph: False, gen throughput (token/s): 47.43, #queue-req: 0


    [2026-06-09 21:11:55] Decode batch, #running-req: 1, #token: 604, token usage: 0.03, cuda graph: False, gen throughput (token/s): 47.91, #queue-req: 0


    [2026-06-09 21:11:56] Decode batch, #running-req: 1, #token: 644, token usage: 0.03, cuda graph: False, gen throughput (token/s): 49.10, #queue-req: 0


    [2026-06-09 21:11:57] Decode batch, #running-req: 1, #token: 684, token usage: 0.03, cuda graph: False, gen throughput (token/s): 51.71, #queue-req: 0


    [2026-06-09 21:11:57] Decode batch, #running-req: 1, #token: 724, token usage: 0.04, cuda graph: False, gen throughput (token/s): 56.28, #queue-req: 0


    [2026-06-09 21:11:58] Decode batch, #running-req: 1, #token: 764, token usage: 0.04, cuda graph: False, gen throughput (token/s): 55.93, #queue-req: 0


    [2026-06-09 21:11:59] Decode batch, #running-req: 1, #token: 804, token usage: 0.04, cuda graph: False, gen throughput (token/s): 51.12, #queue-req: 0


    [2026-06-09 21:12:00] Decode batch, #running-req: 1, #token: 844, token usage: 0.04, cuda graph: False, gen throughput (token/s): 51.11, #queue-req: 0


    [2026-06-09 21:12:01] Decode batch, #running-req: 1, #token: 884, token usage: 0.04, cuda graph: False, gen throughput (token/s): 48.68, #queue-req: 0


    [2026-06-09 21:12:01] Decode batch, #running-req: 1, #token: 924, token usage: 0.05, cuda graph: False, gen throughput (token/s): 50.08, #queue-req: 0


    [2026-06-09 21:12:02] Decode batch, #running-req: 1, #token: 964, token usage: 0.05, cuda graph: False, gen throughput (token/s): 50.55, #queue-req: 0


    [2026-06-09 21:12:03] Decode batch, #running-req: 1, #token: 1004, token usage: 0.05, cuda graph: False, gen throughput (token/s): 51.56, #queue-req: 0


    [2026-06-09 21:12:03] INFO:     127.0.0.1:49314 - "POST /generate HTTP/1.1" 200 OK
    Output from lora0: 
