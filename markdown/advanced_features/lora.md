...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 348.54it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 22764.20it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 11699.59it/s]
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 161.42it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 19173.96it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 91180.52it/s]
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 123.87it/s]
...
```
    ...
    [2026-06-07 06:07:50] Found local HF snapshot for algoprog/fact-generation-llama-3.1-8b-instruct-lora at /root/.cache/huggingface/hub/models--algoprog--fact-generation-llama-3.1-8b-instruct-lora/snapshots/dc8cdfb21993a6cb46199d6b1d79f68a42b06439; skipping download.


    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 143.04it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 58661.59it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 37200.04it/s]
    [2026-06-07 06:07:50] Found local HF snapshot for philschmid/code-llama-3-1-8b-text-to-sql-lora at /root/.cache/huggingface/hub/models--philschmid--code-llama-3-1-8b-text-to-sql-lora/snapshots/141fc3a09386a8baf0d7495c247ae2d1a565f69f; skipping download.
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 119.27it/s]


    [2026-06-07 06:07:51] Max concurrent requests (per dp worker) from the finalized token capacity: max_num_reqs=128.
    [2026-06-07 06:07:51] KV Cache is allocated. dtype: torch.bfloat16, #tokens: 20480, K size: 1.25 GB, V size: 1.25 GB
    [2026-06-07 06:07:51] Memory pool end. avail mem=58.26 GB
    [2026-06-07 06:07:51] Disable piecewise CUDA graph because --disable-piecewise-cuda-graph is set


    [2026-06-07 06:07:55] max_total_num_tokens=20480, chunked_prefill_size=8192, max_prefill_tokens=16384, max_running_requests=128, context_len=131072, available_gpu_mem=58.17 GB
    [2026-06-07 06:07:55] Tree cache initialized: source=default impl=RadixCache hybrid_swa=False hybrid_ssm=False hierarchical=False streaming_wrapped=False


    [2026-06-07 06:07:56] INFO:     Started server process [3238004]
    [2026-06-07 06:07:56] INFO:     Waiting for application startup.
    [2026-06-07 06:07:56] Using default chat sampling params from model generation config: {'temperature': 0.6, 'top_p': 0.9}
    [2026-06-07 06:07:56] INFO:     Application startup complete.
    [2026-06-07 06:07:56] INFO:     Uvicorn running on http://127.0.0.1:31460 (Press CTRL+C to quit)


    /usr/local/lib/python3.10/dist-packages/fastapi/routing.py:120: FastAPIDeprecationWarning: ORJSONResponse is deprecated, FastAPI now serializes data directly to JSON bytes via Pydantic when a return type or response model is set, which is faster and doesn't need a custom response class. Read more in the FastAPI docs: https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model and https://fastapi.tiangolo.com/tutorial/response-model/
      response = await f(request)
    [2026-06-07 06:07:57] INFO:     127.0.0.1:48068 - "GET /v1/models HTTP/1.1" 200 OK


    [2026-06-07 06:07:57] INFO:     127.0.0.1:48084 - "GET /model_info HTTP/1.1" 200 OK


    [2026-06-07 06:07:58] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-07 06:07:58] LoRA expand (K=6144, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-07 06:07:58] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-07 06:07:58] LoRA expand (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}


    [2026-06-07 06:07:58] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-07 06:07:58] LoRA expand (K=28672, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-07 06:07:58] LoRA shrink (K=14336, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}


    [2026-06-07 06:07:59] Prefill batch, #new-seq: 1, #new-token: 7, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 2.29
    [2026-06-07 06:07:59] INFO:     127.0.0.1:48096 - "POST /generate HTTP/1.1" 200 OK
    [2026-06-07 06:07:59] The server is fired up and ready to roll!
...
```
    ...
    [2026-06-07 06:08:02] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-07 06:08:02] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-07 06:08:02] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-07 06:08:05] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-07 06:08:05] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-07 06:08:05] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-07 06:08:05] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-07 06:08:05] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-07 06:08:05] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-07 06:08:05] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-07 06:08:05] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 2, #pending-token: 18, cuda graph: False, input throughput (token/s): 1.38
    [2026-06-07 06:08:05] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-07 06:08:05] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-07 06:08:05] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-07 06:08:05] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-07 06:08:05] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-07 06:08:05] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-07 06:08:06] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-07 06:08:06] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-07 06:08:06] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-07 06:08:06] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-07 06:08:06] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-07 06:08:06] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 1, #pending-token: 9, cuda graph: False, input throughput (token/s): 7.42


    [2026-06-07 06:08:07] Decode batch, #running-req: 2, #token: 63, token usage: 0.00, cuda graph: False, gen throughput (token/s): 4.61, #queue-req: 1


    [2026-06-07 06:08:07] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-07 06:08:07] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 8.32


    [2026-06-07 06:08:07] Decode batch, #running-req: 2, #token: 77, token usage: 0.00, cuda graph: False, gen throughput (token/s): 83.01, #queue-req: 0


    [2026-06-07 06:08:08] Decode batch, #running-req: 2, #token: 157, token usage: 0.01, cuda graph: False, gen throughput (token/s): 96.15, #queue-req: 0


    [2026-06-07 06:08:09] Decode batch, #running-req: 1, #token: 141, token usage: 0.01, cuda graph: False, gen throughput (token/s): 73.16, #queue-req: 0


    [2026-06-07 06:08:10] Decode batch, #running-req: 1, #token: 181, token usage: 0.01, cuda graph: False, gen throughput (token/s): 48.68, #queue-req: 0


    [2026-06-07 06:08:11] Decode batch, #running-req: 1, #token: 221, token usage: 0.01, cuda graph: False, gen throughput (token/s): 46.78, #queue-req: 0


    [2026-06-07 06:08:12] Decode batch, #running-req: 1, #token: 261, token usage: 0.01, cuda graph: False, gen throughput (token/s): 44.60, #queue-req: 0


    [2026-06-07 06:08:13] Decode batch, #running-req: 1, #token: 301, token usage: 0.01, cuda graph: False, gen throughput (token/s): 46.85, #queue-req: 0


    [2026-06-07 06:08:13] Decode batch, #running-req: 1, #token: 341, token usage: 0.02, cuda graph: False, gen throughput (token/s): 48.43, #queue-req: 0


    [2026-06-07 06:08:14] Decode batch, #running-req: 1, #token: 381, token usage: 0.02, cuda graph: False, gen throughput (token/s): 49.47, #queue-req: 0


    [2026-06-07 06:08:15] Decode batch, #running-req: 1, #token: 421, token usage: 0.02, cuda graph: False, gen throughput (token/s): 53.10, #queue-req: 0


    [2026-06-07 06:08:16] Decode batch, #running-req: 1, #token: 461, token usage: 0.02, cuda graph: False, gen throughput (token/s): 54.60, #queue-req: 0


    [2026-06-07 06:08:17] Decode batch, #running-req: 1, #token: 501, token usage: 0.02, cuda graph: False, gen throughput (token/s): 46.56, #queue-req: 0


    [2026-06-07 06:08:17] Decode batch, #running-req: 1, #token: 541, token usage: 0.03, cuda graph: False, gen throughput (token/s): 51.28, #queue-req: 0


    [2026-06-07 06:08:18] Decode batch, #running-req: 1, #token: 581, token usage: 0.03, cuda graph: False, gen throughput (token/s): 48.07, #queue-req: 0


    [2026-06-07 06:08:19] Decode batch, #running-req: 1, #token: 621, token usage: 0.03, cuda graph: False, gen throughput (token/s): 43.74, #queue-req: 0


    [2026-06-07 06:08:20] Decode batch, #running-req: 1, #token: 661, token usage: 0.03, cuda graph: False, gen throughput (token/s): 35.32, #queue-req: 0


    [2026-06-07 06:08:21] Decode batch, #running-req: 1, #token: 701, token usage: 0.03, cuda graph: False, gen throughput (token/s): 41.90, #queue-req: 0


    [2026-06-07 06:08:22] Decode batch, #running-req: 1, #token: 741, token usage: 0.04, cuda graph: False, gen throughput (token/s): 49.10, #queue-req: 0


    [2026-06-07 06:08:23] Decode batch, #running-req: 1, #token: 781, token usage: 0.04, cuda graph: False, gen throughput (token/s): 48.31, #queue-req: 0


    [2026-06-07 06:08:24] Decode batch, #running-req: 1, #token: 821, token usage: 0.04, cuda graph: False, gen throughput (token/s): 43.91, #queue-req: 0


    [2026-06-07 06:08:24] Decode batch, #running-req: 1, #token: 861, token usage: 0.04, cuda graph: False, gen throughput (token/s): 50.13, #queue-req: 0


    [2026-06-07 06:08:25] Decode batch, #running-req: 1, #token: 901, token usage: 0.04, cuda graph: False, gen throughput (token/s): 52.09, #queue-req: 0


    [2026-06-07 06:08:26] Decode batch, #running-req: 1, #token: 941, token usage: 0.05, cuda graph: False, gen throughput (token/s): 56.91, #queue-req: 0


    [2026-06-07 06:08:27] Decode batch, #running-req: 1, #token: 981, token usage: 0.05, cuda graph: False, gen throughput (token/s): 56.08, #queue-req: 0


    [2026-06-07 06:08:27] Decode batch, #running-req: 1, #token: 1021, token usage: 0.05, cuda graph: False, gen throughput (token/s): 53.68, #queue-req: 0


    [2026-06-07 06:08:28] INFO:     127.0.0.1:48110 - "POST /generate HTTP/1.1" 200 OK
    Output from lora0: 
