...
```
    ...
    Multi-thread loading shards:  50% Completed | 2/4 [00:04<00:04,  2.29s/it]

    Multi-thread loading shards:  75% Completed | 3/4 [00:06<00:02,  2.30s/it]
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 10.00it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 311.13it/s]
...
```
    ...
    [2026-06-04 19:10:36] Load weight end. elapsed=4.42 s, type=LlamaForCausalLM, avail mem=63.48 GB, mem usage=-4.62 GB.
    [2026-06-04 19:10:36] Using csgmv as backend of LoRA kernels.
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 16513.01it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 13684.52it/s]
    [2026-06-04 19:10:37] Found local HF snapshot for Nutanix/Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json at /root/.cache/huggingface/hub/models--Nutanix--Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json/snapshots/2c398740f3eba8dc63ee78999316b833a2833b6c; skipping download.
    ...
    [2026-06-04 19:10:37] Found local HF snapshot for algoprog/fact-generation-llama-3.1-8b-instruct-lora at /root/.cache/huggingface/hub/models--algoprog--fact-generation-llama-3.1-8b-instruct-lora/snapshots/dc8cdfb21993a6cb46199d6b1d79f68a42b06439; skipping download.
    ...
    [2026-06-04 19:10:38] Found local HF snapshot for philschmid/code-llama-3-1-8b-text-to-sql-lora at /root/.cache/huggingface/hub/models--philschmid--code-llama-3-1-8b-text-to-sql-lora/snapshots/141fc3a09386a8baf0d7495c247ae2d1a565f69f; skipping download.


    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 115.45it/s]


    [2026-06-04 19:10:39] Max concurrent requests (per dp worker) from the finalized token capacity: max_num_reqs=128.
    [2026-06-04 19:10:39] KV Cache is allocated. dtype: torch.bfloat16, #tokens: 20480, K size: 1.25 GB, V size: 1.25 GB
    [2026-06-04 19:10:39] Memory pool end. avail mem=58.26 GB
    [2026-06-04 19:10:39] Disable piecewise CUDA graph because --disable-piecewise-cuda-graph is set


    [2026-06-04 19:10:45] max_total_num_tokens=20480, chunked_prefill_size=8192, max_prefill_tokens=16384, max_running_requests=128, context_len=131072, available_gpu_mem=57.49 GB
    [2026-06-04 19:10:45] Tree cache initialized: source=default impl=RadixCache hybrid_swa=False hybrid_ssm=False hierarchical=False streaming_wrapped=False


    [2026-06-04 19:10:45] INFO:     Started server process [1550697]
    [2026-06-04 19:10:45] INFO:     Waiting for application startup.
    [2026-06-04 19:10:45] Using default chat sampling params from model generation config: {'temperature': 0.6, 'top_p': 0.9}
    [2026-06-04 19:10:45] INFO:     Application startup complete.
    [2026-06-04 19:10:45] INFO:     Uvicorn running on http://127.0.0.1:34421 (Press CTRL+C to quit)
    /usr/local/lib/python3.10/dist-packages/fastapi/routing.py:120: FastAPIDeprecationWarning: ORJSONResponse is deprecated, FastAPI now serializes data directly to JSON bytes via Pydantic when a return type or response model is set, which is faster and doesn't need a custom response class. Read more in the FastAPI docs: https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model and https://fastapi.tiangolo.com/tutorial/response-model/
      response = await f(request)
    [2026-06-04 19:10:45] INFO:     127.0.0.1:33172 - "GET /v1/models HTTP/1.1" 200 OK


    [2026-06-04 19:10:46] INFO:     127.0.0.1:33188 - "GET /model_info HTTP/1.1" 200 OK


    [2026-06-04 19:10:47] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-04 19:10:47] LoRA expand (K=6144, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-04 19:10:47] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-04 19:10:47] LoRA expand (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}


    [2026-06-04 19:10:48] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-04 19:10:48] LoRA expand (K=28672, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-04 19:10:48] LoRA shrink (K=14336, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}


    [2026-06-04 19:10:48] Prefill batch, #new-seq: 1, #new-token: 7, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 2.17
    [2026-06-04 19:10:48] INFO:     127.0.0.1:33202 - "POST /generate HTTP/1.1" 200 OK
    [2026-06-04 19:10:48] The server is fired up and ready to roll!
...
```
    ...
    [2026-06-04 19:10:50] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-04 19:10:50] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-04 19:10:51] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-04 19:10:53] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-04 19:10:53] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-04 19:10:53] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-04 19:10:53] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-04 19:10:53] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-04 19:10:54] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-04 19:10:54] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-04 19:10:54] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 2, #pending-token: 18, cuda graph: False, input throughput (token/s): 1.59
    [2026-06-04 19:10:54] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-04 19:10:54] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-04 19:10:54] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-04 19:10:54] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-04 19:10:54] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-04 19:10:54] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-04 19:10:55] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-04 19:10:55] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-04 19:10:55] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-04 19:10:55] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-04 19:10:55] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 1, #pending-token: 9, cuda graph: False, input throughput (token/s): 6.58
    [2026-06-04 19:10:55] Decode batch, #running-req: 2, #token: 61, token usage: 0.00, cuda graph: False, gen throughput (token/s): 4.70, #queue-req: 1


    [2026-06-04 19:10:56] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-04 19:10:56] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 9.57


    [2026-06-04 19:10:56] Decode batch, #running-req: 2, #token: 75, token usage: 0.00, cuda graph: False, gen throughput (token/s): 89.58, #queue-req: 0


    [2026-06-04 19:10:57] Decode batch, #running-req: 2, #token: 155, token usage: 0.01, cuda graph: False, gen throughput (token/s): 98.72, #queue-req: 0


    [2026-06-04 19:10:58] Decode batch, #running-req: 1, #token: 139, token usage: 0.01, cuda graph: False, gen throughput (token/s): 74.66, #queue-req: 0


    [2026-06-04 19:10:58] Decode batch, #running-req: 1, #token: 179, token usage: 0.01, cuda graph: False, gen throughput (token/s): 51.95, #queue-req: 0


    [2026-06-04 19:10:59] Decode batch, #running-req: 1, #token: 219, token usage: 0.01, cuda graph: False, gen throughput (token/s): 52.14, #queue-req: 0


    [2026-06-04 19:11:00] Decode batch, #running-req: 1, #token: 259, token usage: 0.01, cuda graph: False, gen throughput (token/s): 54.11, #queue-req: 0


    [2026-06-04 19:11:01] Decode batch, #running-req: 1, #token: 299, token usage: 0.01, cuda graph: False, gen throughput (token/s): 49.76, #queue-req: 0


    [2026-06-04 19:11:01] Decode batch, #running-req: 1, #token: 339, token usage: 0.02, cuda graph: False, gen throughput (token/s): 48.58, #queue-req: 0


    [2026-06-04 19:11:02] Decode batch, #running-req: 1, #token: 379, token usage: 0.02, cuda graph: False, gen throughput (token/s): 44.82, #queue-req: 0


    [2026-06-04 19:11:03] Decode batch, #running-req: 1, #token: 419, token usage: 0.02, cuda graph: False, gen throughput (token/s): 39.49, #queue-req: 0


    [2026-06-04 19:11:04] Decode batch, #running-req: 1, #token: 459, token usage: 0.02, cuda graph: False, gen throughput (token/s): 42.78, #queue-req: 0


    [2026-06-04 19:11:05] Decode batch, #running-req: 1, #token: 499, token usage: 0.02, cuda graph: False, gen throughput (token/s): 45.34, #queue-req: 0


    [2026-06-04 19:11:06] Decode batch, #running-req: 1, #token: 539, token usage: 0.03, cuda graph: False, gen throughput (token/s): 44.70, #queue-req: 0


    [2026-06-04 19:11:07] Decode batch, #running-req: 1, #token: 579, token usage: 0.03, cuda graph: False, gen throughput (token/s): 38.23, #queue-req: 0


    [2026-06-04 19:11:08] Decode batch, #running-req: 1, #token: 619, token usage: 0.03, cuda graph: False, gen throughput (token/s): 41.53, #queue-req: 0


    [2026-06-04 19:11:09] Decode batch, #running-req: 1, #token: 659, token usage: 0.03, cuda graph: False, gen throughput (token/s): 46.61, #queue-req: 0


    [2026-06-04 19:11:10] Decode batch, #running-req: 1, #token: 699, token usage: 0.03, cuda graph: False, gen throughput (token/s): 48.72, #queue-req: 0


    [2026-06-04 19:11:11] Decode batch, #running-req: 1, #token: 739, token usage: 0.04, cuda graph: False, gen throughput (token/s): 36.87, #queue-req: 0


    [2026-06-04 19:11:12] Decode batch, #running-req: 1, #token: 779, token usage: 0.04, cuda graph: False, gen throughput (token/s): 32.12, #queue-req: 0


    [2026-06-04 19:11:13] Decode batch, #running-req: 1, #token: 819, token usage: 0.04, cuda graph: False, gen throughput (token/s): 54.43, #queue-req: 0


    [2026-06-04 19:11:14] Decode batch, #running-req: 1, #token: 859, token usage: 0.04, cuda graph: False, gen throughput (token/s): 54.70, #queue-req: 0


    [2026-06-04 19:11:14] Decode batch, #running-req: 1, #token: 899, token usage: 0.04, cuda graph: False, gen throughput (token/s): 54.09, #queue-req: 0


    [2026-06-04 19:11:15] Decode batch, #running-req: 1, #token: 939, token usage: 0.05, cuda graph: False, gen throughput (token/s): 52.62, #queue-req: 0


    [2026-06-04 19:11:16] Decode batch, #running-req: 1, #token: 979, token usage: 0.05, cuda graph: False, gen throughput (token/s): 49.29, #queue-req: 0


    [2026-06-04 19:11:17] Decode batch, #running-req: 1, #token: 1019, token usage: 0.05, cuda graph: False, gen throughput (token/s): 47.55, #queue-req: 0


    [2026-06-04 19:11:17] INFO:     127.0.0.1:33218 - "POST /generate HTTP/1.1" 200 OK
    Output from lora0: 
