...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 117.79it/s]
...
```
    ...
    [2026-06-03 04:19:47] Load weight end. elapsed=3.33 s, type=LlamaForCausalLM, avail mem=45.75 GB, mem usage=15.02 GB.
    [2026-06-03 04:19:47] Using csgmv as backend of LoRA kernels.
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 64527.75it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 95869.81it/s]
    [2026-06-03 04:19:48] Found local HF snapshot for Nutanix/Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json at /root/.cache/huggingface/hub/models--Nutanix--Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json/snapshots/2c398740f3eba8dc63ee78999316b833a2833b6c; skipping download.
    ...
    [2026-06-03 04:19:48] Found local HF snapshot for algoprog/fact-generation-llama-3.1-8b-instruct-lora at /root/.cache/huggingface/hub/models--algoprog--fact-generation-llama-3.1-8b-instruct-lora/snapshots/dc8cdfb21993a6cb46199d6b1d79f68a42b06439; skipping download.
    ...
    [2026-06-03 04:19:48] Found local HF snapshot for philschmid/code-llama-3-1-8b-text-to-sql-lora at /root/.cache/huggingface/hub/models--philschmid--code-llama-3-1-8b-text-to-sql-lora/snapshots/141fc3a09386a8baf0d7495c247ae2d1a565f69f; skipping download.
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 115.98it/s]


    [2026-06-03 04:19:49] Max concurrent requests (per dp worker) from the finalized token capacity: max_num_reqs=128.
    [2026-06-03 04:19:49] KV Cache is allocated. dtype: torch.bfloat16, #tokens: 20480, K size: 1.25 GB, V size: 1.25 GB
    [2026-06-03 04:19:49] Memory pool end. avail mem=40.52 GB
    [2026-06-03 04:19:49] Disable piecewise CUDA graph because --disable-piecewise-cuda-graph is set


    [2026-06-03 04:19:53] max_total_num_tokens=20480, chunked_prefill_size=8192, max_prefill_tokens=16384, max_running_requests=128, context_len=131072, available_gpu_mem=39.76 GB
    [2026-06-03 04:19:53] Tree cache initialized: source=default impl=RadixCache hybrid_swa=False hybrid_ssm=False hierarchical=False streaming_wrapped=False


    [2026-06-03 04:19:54] INFO:     Started server process [103004]
    [2026-06-03 04:19:54] INFO:     Waiting for application startup.
    [2026-06-03 04:19:54] Using default chat sampling params from model generation config: {'temperature': 0.6, 'top_p': 0.9}
    [2026-06-03 04:19:54] INFO:     Application startup complete.
    [2026-06-03 04:19:54] INFO:     Uvicorn running on http://127.0.0.1:33659 (Press CTRL+C to quit)


    /usr/local/lib/python3.10/dist-packages/fastapi/routing.py:120: FastAPIDeprecationWarning: ORJSONResponse is deprecated, FastAPI now serializes data directly to JSON bytes via Pydantic when a return type or response model is set, which is faster and doesn't need a custom response class. Read more in the FastAPI docs: https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model and https://fastapi.tiangolo.com/tutorial/response-model/
      response = await f(request)
    [2026-06-03 04:19:55] INFO:     127.0.0.1:44178 - "GET /v1/models HTTP/1.1" 200 OK
    [2026-06-03 04:19:55] INFO:     127.0.0.1:44180 - "GET /model_info HTTP/1.1" 200 OK


    [2026-06-03 04:19:56] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-03 04:19:56] LoRA expand (K=6144, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-03 04:19:56] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-03 04:19:56] LoRA expand (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}


    [2026-06-03 04:19:56] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-03 04:19:56] LoRA expand (K=28672, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-03 04:19:56] LoRA shrink (K=14336, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}


    [2026-06-03 04:19:56] Prefill batch, #new-seq: 1, #new-token: 7, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 2.31
    [2026-06-03 04:19:56] INFO:     127.0.0.1:44196 - "POST /generate HTTP/1.1" 200 OK
    [2026-06-03 04:19:56] The server is fired up and ready to roll!
...
```
    ...
    [2026-06-03 04:20:00] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-03 04:20:00] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-03 04:20:00] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-03 04:20:00] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-03 04:20:00] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-03 04:20:02] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-03 04:20:02] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-03 04:20:02] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-03 04:20:02] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-03 04:20:02] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-03 04:20:03] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-03 04:20:03] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-03 04:20:03] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 2, #pending-token: 18, cuda graph: False, input throughput (token/s): 1.43
    [2026-06-03 04:20:03] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-03 04:20:03] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-03 04:20:03] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-03 04:20:03] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-03 04:20:03] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 1, #pending-token: 9, cuda graph: False, input throughput (token/s): 11.25


    [2026-06-03 04:20:04] Decode batch, #running-req: 2, #token: 70, token usage: 0.00, cuda graph: False, gen throughput (token/s): 5.48, #queue-req: 1


    [2026-06-03 04:20:05] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-03 04:20:05] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 6.58


    [2026-06-03 04:20:05] Decode batch, #running-req: 2, #token: 84, token usage: 0.00, cuda graph: False, gen throughput (token/s): 74.33, #queue-req: 0


    [2026-06-03 04:20:06] Decode batch, #running-req: 2, #token: 164, token usage: 0.01, cuda graph: False, gen throughput (token/s): 93.80, #queue-req: 0


    [2026-06-03 04:20:07] Decode batch, #running-req: 1, #token: 148, token usage: 0.01, cuda graph: False, gen throughput (token/s): 69.17, #queue-req: 0


    [2026-06-03 04:20:07] Decode batch, #running-req: 1, #token: 188, token usage: 0.01, cuda graph: False, gen throughput (token/s): 50.67, #queue-req: 0


    [2026-06-03 04:20:08] Decode batch, #running-req: 1, #token: 228, token usage: 0.01, cuda graph: False, gen throughput (token/s): 56.46, #queue-req: 0


    [2026-06-03 04:20:09] Decode batch, #running-req: 1, #token: 268, token usage: 0.01, cuda graph: False, gen throughput (token/s): 55.87, #queue-req: 0


    [2026-06-03 04:20:10] Decode batch, #running-req: 1, #token: 308, token usage: 0.02, cuda graph: False, gen throughput (token/s): 51.55, #queue-req: 0


    [2026-06-03 04:20:10] Decode batch, #running-req: 1, #token: 348, token usage: 0.02, cuda graph: False, gen throughput (token/s): 50.84, #queue-req: 0


    [2026-06-03 04:20:11] Decode batch, #running-req: 1, #token: 388, token usage: 0.02, cuda graph: False, gen throughput (token/s): 48.53, #queue-req: 0


    [2026-06-03 04:20:12] Decode batch, #running-req: 1, #token: 428, token usage: 0.02, cuda graph: False, gen throughput (token/s): 50.78, #queue-req: 0


    [2026-06-03 04:20:13] Decode batch, #running-req: 1, #token: 468, token usage: 0.02, cuda graph: False, gen throughput (token/s): 52.18, #queue-req: 0


    [2026-06-03 04:20:13] Decode batch, #running-req: 1, #token: 508, token usage: 0.02, cuda graph: False, gen throughput (token/s): 53.86, #queue-req: 0


    [2026-06-03 04:20:14] Decode batch, #running-req: 1, #token: 548, token usage: 0.03, cuda graph: False, gen throughput (token/s): 53.57, #queue-req: 0


    [2026-06-03 04:20:15] Decode batch, #running-req: 1, #token: 588, token usage: 0.03, cuda graph: False, gen throughput (token/s): 57.63, #queue-req: 0


    [2026-06-03 04:20:16] Decode batch, #running-req: 1, #token: 628, token usage: 0.03, cuda graph: False, gen throughput (token/s): 59.30, #queue-req: 0


    [2026-06-03 04:20:16] Decode batch, #running-req: 1, #token: 668, token usage: 0.03, cuda graph: False, gen throughput (token/s): 59.04, #queue-req: 0


    [2026-06-03 04:20:17] Decode batch, #running-req: 1, #token: 708, token usage: 0.03, cuda graph: False, gen throughput (token/s): 59.76, #queue-req: 0


    [2026-06-03 04:20:18] Decode batch, #running-req: 1, #token: 748, token usage: 0.04, cuda graph: False, gen throughput (token/s): 59.51, #queue-req: 0


    [2026-06-03 04:20:18] Decode batch, #running-req: 1, #token: 788, token usage: 0.04, cuda graph: False, gen throughput (token/s): 58.82, #queue-req: 0


    [2026-06-03 04:20:19] Decode batch, #running-req: 1, #token: 828, token usage: 0.04, cuda graph: False, gen throughput (token/s): 59.05, #queue-req: 0


    [2026-06-03 04:20:20] Decode batch, #running-req: 1, #token: 868, token usage: 0.04, cuda graph: False, gen throughput (token/s): 58.25, #queue-req: 0


    [2026-06-03 04:20:20] Decode batch, #running-req: 1, #token: 908, token usage: 0.04, cuda graph: False, gen throughput (token/s): 58.29, #queue-req: 0


    [2026-06-03 04:20:21] Decode batch, #running-req: 1, #token: 948, token usage: 0.05, cuda graph: False, gen throughput (token/s): 53.40, #queue-req: 0


    [2026-06-03 04:20:22] Decode batch, #running-req: 1, #token: 988, token usage: 0.05, cuda graph: False, gen throughput (token/s): 57.70, #queue-req: 0


    [2026-06-03 04:20:22] Decode batch, #running-req: 1, #token: 1028, token usage: 0.05, cuda graph: False, gen throughput (token/s): 58.94, #queue-req: 0
    [2026-06-03 04:20:23] INFO:     127.0.0.1:44204 - "POST /generate HTTP/1.1" 200 OK
    Output from lora0: 
