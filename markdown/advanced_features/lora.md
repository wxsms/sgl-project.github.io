...
```
    ...
    [2026-06-10 01:19:37] Load weight end. elapsed=3.38 s, type=LlamaForCausalLM, avail mem=44.07 GB, mem usage=15.96 GB.
    [2026-06-10 01:19:37] Using csgmv as backend of LoRA kernels.
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 80659.69it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 77314.36it/s]
    [2026-06-10 01:19:37] Found local HF snapshot for Nutanix/Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json at /root/.cache/huggingface/hub/models--Nutanix--Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json/snapshots/2c398740f3eba8dc63ee78999316b833a2833b6c; skipping download.
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 232.20it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 55553.70it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 21675.99it/s]
    [2026-06-10 01:19:37] Found local HF snapshot for algoprog/fact-generation-llama-3.1-8b-instruct-lora at /root/.cache/huggingface/hub/models--algoprog--fact-generation-llama-3.1-8b-instruct-lora/snapshots/dc8cdfb21993a6cb46199d6b1d79f68a42b06439; skipping download.
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]

    Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 174.64it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 21236.98it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 21732.15it/s]
    [2026-06-10 01:19:38] Found local HF snapshot for philschmid/code-llama-3-1-8b-text-to-sql-lora at /root/.cache/huggingface/hub/models--philschmid--code-llama-3-1-8b-text-to-sql-lora/snapshots/141fc3a09386a8baf0d7495c247ae2d1a565f69f; skipping download.
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 118.44it/s]


    [2026-06-10 01:19:39] Max concurrent requests (per dp worker) from the finalized token capacity: max_num_reqs=128.
    [2026-06-10 01:19:39] KV Cache is allocated. dtype: torch.bfloat16, #tokens: 20480, K size: 1.25 GB, V size: 1.25 GB
    [2026-06-10 01:19:39] Memory pool end. avail mem=38.84 GB
    [2026-06-10 01:19:39] Disable piecewise CUDA graph because --disable-piecewise-cuda-graph is set


    [2026-06-10 01:19:43] max_total_num_tokens=20480, chunked_prefill_size=8192, max_prefill_tokens=16384, max_running_requests=128, context_len=131072, available_gpu_mem=38.16 GB
    [2026-06-10 01:19:43] Tree cache initialized: source=default impl=RadixCache hybrid_swa=False hybrid_ssm=False hierarchical=False streaming_wrapped=False


    [2026-06-10 01:19:43] INFO:     Started server process [1828849]
    [2026-06-10 01:19:43] INFO:     Waiting for application startup.
    [2026-06-10 01:19:43] Using default chat sampling params from model generation config: {'temperature': 0.6, 'top_p': 0.9}
    [2026-06-10 01:19:43] INFO:     Application startup complete.
    [2026-06-10 01:19:43] INFO:     Uvicorn running on http://127.0.0.1:34957 (Press CTRL+C to quit)


    /usr/local/lib/python3.10/dist-packages/fastapi/routing.py:120: FastAPIDeprecationWarning: ORJSONResponse is deprecated, FastAPI now serializes data directly to JSON bytes via Pydantic when a return type or response model is set, which is faster and doesn't need a custom response class. Read more in the FastAPI docs: https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model and https://fastapi.tiangolo.com/tutorial/response-model/
      response = await f(request)
    [2026-06-10 01:19:44] INFO:     127.0.0.1:59930 - "GET /v1/models HTTP/1.1" 200 OK
    [2026-06-10 01:19:44] INFO:     127.0.0.1:59934 - "GET /model_info HTTP/1.1" 200 OK


    [2026-06-10 01:19:45] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-10 01:19:45] LoRA expand (K=6144, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-10 01:19:45] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-10 01:19:45] LoRA expand (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}


    [2026-06-10 01:19:46] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-10 01:19:46] LoRA expand (K=28672, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-10 01:19:46] LoRA shrink (K=14336, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}


    [2026-06-10 01:19:46] Prefill batch, #new-seq: 1, #new-token: 7, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 2.34
    [2026-06-10 01:19:46] INFO:     127.0.0.1:59938 - "POST /generate HTTP/1.1" 200 OK
    [2026-06-10 01:19:46] The server is fired up and ready to roll!
...
```
    ...
    [2026-06-10 01:19:49] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-10 01:19:49] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-10 01:19:50] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-10 01:19:52] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-10 01:19:52] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-10 01:19:52] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-10 01:19:52] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-10 01:19:52] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-10 01:19:52] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-10 01:19:52] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-10 01:19:52] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 2, #pending-token: 18, cuda graph: False, input throughput (token/s): 1.41
    [2026-06-10 01:19:52] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-10 01:19:52] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-10 01:19:52] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-10 01:19:52] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-10 01:19:52] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-10 01:19:52] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-10 01:19:53] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-10 01:19:53] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-10 01:19:53] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-10 01:19:53] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-10 01:19:53] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-10 01:19:53] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-10 01:19:54] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-10 01:19:54] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-10 01:19:54] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-10 01:19:54] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-10 01:19:54] Decode batch, #running-req: 1, #token: 42, token usage: 0.00, cuda graph: False, gen throughput (token/s): 3.58, #queue-req: 2
    [2026-06-10 01:19:54] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-10 01:19:54] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-10 01:19:54] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-10 01:19:54] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-10 01:19:54] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-10 01:19:54] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-10 01:19:55] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-10 01:19:55] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-10 01:19:55] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].


    [2026-06-10 01:19:55] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 1, #pending-token: 9, cuda graph: False, input throughput (token/s): 3.69


    [2026-06-10 01:19:55] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-10 01:19:55] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 18.88


    [2026-06-10 01:19:55] Decode batch, #running-req: 2, #token: 56, token usage: 0.00, cuda graph: False, gen throughput (token/s): 55.33, #queue-req: 0


    [2026-06-10 01:19:56] Decode batch, #running-req: 2, #token: 136, token usage: 0.01, cuda graph: False, gen throughput (token/s): 107.11, #queue-req: 0


    [2026-06-10 01:19:57] Decode batch, #running-req: 1, #token: 119, token usage: 0.01, cuda graph: False, gen throughput (token/s): 77.34, #queue-req: 0


    [2026-06-10 01:19:58] Decode batch, #running-req: 1, #token: 159, token usage: 0.01, cuda graph: False, gen throughput (token/s): 51.21, #queue-req: 0


    [2026-06-10 01:19:58] Decode batch, #running-req: 1, #token: 199, token usage: 0.01, cuda graph: False, gen throughput (token/s): 52.65, #queue-req: 0


    [2026-06-10 01:19:59] Decode batch, #running-req: 1, #token: 239, token usage: 0.01, cuda graph: False, gen throughput (token/s): 55.21, #queue-req: 0


    [2026-06-10 01:20:00] Decode batch, #running-req: 1, #token: 279, token usage: 0.01, cuda graph: False, gen throughput (token/s): 56.59, #queue-req: 0


    [2026-06-10 01:20:01] Decode batch, #running-req: 1, #token: 319, token usage: 0.02, cuda graph: False, gen throughput (token/s): 55.64, #queue-req: 0


    [2026-06-10 01:20:01] Decode batch, #running-req: 1, #token: 359, token usage: 0.02, cuda graph: False, gen throughput (token/s): 49.71, #queue-req: 0


    [2026-06-10 01:20:02] Decode batch, #running-req: 1, #token: 399, token usage: 0.02, cuda graph: False, gen throughput (token/s): 56.44, #queue-req: 0


    [2026-06-10 01:20:03] Decode batch, #running-req: 1, #token: 439, token usage: 0.02, cuda graph: False, gen throughput (token/s): 57.37, #queue-req: 0


    [2026-06-10 01:20:03] Decode batch, #running-req: 1, #token: 479, token usage: 0.02, cuda graph: False, gen throughput (token/s): 54.97, #queue-req: 0


    [2026-06-10 01:20:04] Decode batch, #running-req: 1, #token: 519, token usage: 0.03, cuda graph: False, gen throughput (token/s): 47.56, #queue-req: 0


    [2026-06-10 01:20:05] Decode batch, #running-req: 1, #token: 559, token usage: 0.03, cuda graph: False, gen throughput (token/s): 47.26, #queue-req: 0


    [2026-06-10 01:20:06] Decode batch, #running-req: 1, #token: 599, token usage: 0.03, cuda graph: False, gen throughput (token/s): 48.53, #queue-req: 0


    [2026-06-10 01:20:07] Decode batch, #running-req: 1, #token: 639, token usage: 0.03, cuda graph: False, gen throughput (token/s): 48.32, #queue-req: 0


    [2026-06-10 01:20:08] Decode batch, #running-req: 1, #token: 679, token usage: 0.03, cuda graph: False, gen throughput (token/s): 53.03, #queue-req: 0


    [2026-06-10 01:20:08] Decode batch, #running-req: 1, #token: 719, token usage: 0.04, cuda graph: False, gen throughput (token/s): 54.92, #queue-req: 0


    [2026-06-10 01:20:09] Decode batch, #running-req: 1, #token: 759, token usage: 0.04, cuda graph: False, gen throughput (token/s): 58.08, #queue-req: 0


    [2026-06-10 01:20:10] Decode batch, #running-req: 1, #token: 799, token usage: 0.04, cuda graph: False, gen throughput (token/s): 52.17, #queue-req: 0


    [2026-06-10 01:20:11] Decode batch, #running-req: 1, #token: 839, token usage: 0.04, cuda graph: False, gen throughput (token/s): 48.60, #queue-req: 0


    [2026-06-10 01:20:11] Decode batch, #running-req: 1, #token: 879, token usage: 0.04, cuda graph: False, gen throughput (token/s): 49.71, #queue-req: 0


    [2026-06-10 01:20:12] Decode batch, #running-req: 1, #token: 919, token usage: 0.04, cuda graph: False, gen throughput (token/s): 51.41, #queue-req: 0


    [2026-06-10 01:20:13] Decode batch, #running-req: 1, #token: 959, token usage: 0.05, cuda graph: False, gen throughput (token/s): 51.43, #queue-req: 0


    [2026-06-10 01:20:14] Decode batch, #running-req: 1, #token: 999, token usage: 0.05, cuda graph: False, gen throughput (token/s): 51.87, #queue-req: 0


    [2026-06-10 01:20:14] INFO:     127.0.0.1:59954 - "POST /generate HTTP/1.1" 200 OK
    Output from lora0: 
