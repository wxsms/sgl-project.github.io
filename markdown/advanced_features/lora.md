...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 351.75it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 20636.18it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 18893.26it/s]


    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 177.52it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 89240.51it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 10311.75it/s]
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 121.84it/s]
...
```
    ...
    [2026-06-10 05:02:25] Load weight end. elapsed=3.40 s, type=LlamaForCausalLM, avail mem=63.48 GB, mem usage=15.02 GB.
    [2026-06-10 05:02:25] Using csgmv as backend of LoRA kernels.
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 72005.22it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 81049.35it/s]
    [2026-06-10 05:02:25] Found local HF snapshot for Nutanix/Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json at /root/.cache/huggingface/hub/models--Nutanix--Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json/snapshots/2c398740f3eba8dc63ee78999316b833a2833b6c; skipping download.
    ...
    [2026-06-10 05:02:25] Found local HF snapshot for algoprog/fact-generation-llama-3.1-8b-instruct-lora at /root/.cache/huggingface/hub/models--algoprog--fact-generation-llama-3.1-8b-instruct-lora/snapshots/dc8cdfb21993a6cb46199d6b1d79f68a42b06439; skipping download.
    ...
    [2026-06-10 05:02:25] Found local HF snapshot for philschmid/code-llama-3-1-8b-text-to-sql-lora at /root/.cache/huggingface/hub/models--philschmid--code-llama-3-1-8b-text-to-sql-lora/snapshots/141fc3a09386a8baf0d7495c247ae2d1a565f69f; skipping download.
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 119.61it/s]


    [2026-06-10 05:02:26] Max concurrent requests (per dp worker) from the finalized token capacity: max_num_reqs=128.
    [2026-06-10 05:02:26] KV Cache is allocated. dtype: torch.bfloat16, #tokens: 20480, K size: 1.25 GB, V size: 1.25 GB
    [2026-06-10 05:02:26] Memory pool end. avail mem=58.26 GB
    [2026-06-10 05:02:26] Disable prefill CUDA graph because cuda_graph_config resolved prefill.backend='disabled' (e.g. via --cuda-graph-backend-prefill=disabled or auto-disable rules).


    [2026-06-10 05:02:30] max_total_num_tokens=20480, chunked_prefill_size=8192, max_prefill_tokens=16384, max_running_requests=128, context_len=131072, available_gpu_mem=58.17 GB
    [2026-06-10 05:02:30] Tree cache initialized: source=default impl=RadixCache hybrid_swa=False hybrid_ssm=False hierarchical=False streaming_wrapped=False


    [2026-06-10 05:02:31] INFO:     Started server process [1753000]
    [2026-06-10 05:02:31] INFO:     Waiting for application startup.
    [2026-06-10 05:02:31] Using default chat sampling params from model generation config: {'temperature': 0.6, 'top_p': 0.9}
    [2026-06-10 05:02:31] INFO:     Application startup complete.
    [2026-06-10 05:02:31] INFO:     Uvicorn running on http://127.0.0.1:31347 (Press CTRL+C to quit)


    /usr/local/lib/python3.10/dist-packages/fastapi/routing.py:120: FastAPIDeprecationWarning: ORJSONResponse is deprecated, FastAPI now serializes data directly to JSON bytes via Pydantic when a return type or response model is set, which is faster and doesn't need a custom response class. Read more in the FastAPI docs: https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model and https://fastapi.tiangolo.com/tutorial/response-model/
      response = await f(request)
    [2026-06-10 05:02:32] INFO:     127.0.0.1:46884 - "GET /v1/models HTTP/1.1" 200 OK
    [2026-06-10 05:02:32] INFO:     127.0.0.1:46892 - "GET /model_info HTTP/1.1" 200 OK


    [2026-06-10 05:02:33] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-10 05:02:33] LoRA expand (K=6144, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-10 05:02:33] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-10 05:02:33] LoRA expand (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}


    [2026-06-10 05:02:33] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-10 05:02:33] LoRA expand (K=28672, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-10 05:02:33] LoRA shrink (K=14336, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}


    [2026-06-10 05:02:33] Prefill batch, #new-seq: 1, #new-token: 7, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 2.33
    [2026-06-10 05:02:34] INFO:     127.0.0.1:46896 - "POST /generate HTTP/1.1" 200 OK
    [2026-06-10 05:02:34] The server is fired up and ready to roll!
...
```
    ...
    [2026-06-10 05:02:37] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-10 05:02:37] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-10 05:02:37] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-10 05:02:39] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-10 05:02:39] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-10 05:02:39] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-10 05:02:39] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-10 05:02:39] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-10 05:02:40] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 2, #pending-token: 18, cuda graph: False, input throughput (token/s): 1.46
    [2026-06-10 05:02:40] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].


    [2026-06-10 05:02:40] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 1, #pending-token: 9, cuda graph: False, input throughput (token/s): 53.93


    [2026-06-10 05:02:40] Decode batch, #running-req: 2, #token: 82, token usage: 0.00, cuda graph: False, gen throughput (token/s): 7.00, #queue-req: 1


    [2026-06-10 05:02:41] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-10 05:02:41] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 6.32


    [2026-06-10 05:02:41] Decode batch, #running-req: 2, #token: 97, token usage: 0.00, cuda graph: False, gen throughput (token/s): 87.68, #queue-req: 0


    [2026-06-10 05:02:42] Decode batch, #running-req: 2, #token: 177, token usage: 0.01, cuda graph: False, gen throughput (token/s): 94.17, #queue-req: 0


    [2026-06-10 05:02:43] Decode batch, #running-req: 1, #token: 160, token usage: 0.01, cuda graph: False, gen throughput (token/s): 73.55, #queue-req: 0


    [2026-06-10 05:02:44] Decode batch, #running-req: 1, #token: 200, token usage: 0.01, cuda graph: False, gen throughput (token/s): 52.46, #queue-req: 0


    [2026-06-10 05:02:44] Decode batch, #running-req: 1, #token: 240, token usage: 0.01, cuda graph: False, gen throughput (token/s): 49.98, #queue-req: 0


    [2026-06-10 05:02:45] Decode batch, #running-req: 1, #token: 280, token usage: 0.01, cuda graph: False, gen throughput (token/s): 47.53, #queue-req: 0


    [2026-06-10 05:02:46] Decode batch, #running-req: 1, #token: 320, token usage: 0.02, cuda graph: False, gen throughput (token/s): 47.94, #queue-req: 0


    [2026-06-10 05:02:47] Decode batch, #running-req: 1, #token: 360, token usage: 0.02, cuda graph: False, gen throughput (token/s): 49.49, #queue-req: 0


    [2026-06-10 05:02:48] Decode batch, #running-req: 1, #token: 400, token usage: 0.02, cuda graph: False, gen throughput (token/s): 50.53, #queue-req: 0


    [2026-06-10 05:02:48] Decode batch, #running-req: 1, #token: 440, token usage: 0.02, cuda graph: False, gen throughput (token/s): 53.62, #queue-req: 0


    [2026-06-10 05:02:49] Decode batch, #running-req: 1, #token: 480, token usage: 0.02, cuda graph: False, gen throughput (token/s): 50.91, #queue-req: 0


    [2026-06-10 05:02:50] Decode batch, #running-req: 1, #token: 520, token usage: 0.03, cuda graph: False, gen throughput (token/s): 52.32, #queue-req: 0


    [2026-06-10 05:02:51] Decode batch, #running-req: 1, #token: 560, token usage: 0.03, cuda graph: False, gen throughput (token/s): 51.30, #queue-req: 0


    [2026-06-10 05:02:52] Decode batch, #running-req: 1, #token: 600, token usage: 0.03, cuda graph: False, gen throughput (token/s): 52.85, #queue-req: 0


    [2026-06-10 05:02:52] Decode batch, #running-req: 1, #token: 640, token usage: 0.03, cuda graph: False, gen throughput (token/s): 52.45, #queue-req: 0


    [2026-06-10 05:02:53] Decode batch, #running-req: 1, #token: 680, token usage: 0.03, cuda graph: False, gen throughput (token/s): 50.37, #queue-req: 0


    [2026-06-10 05:02:54] Decode batch, #running-req: 1, #token: 720, token usage: 0.04, cuda graph: False, gen throughput (token/s): 44.68, #queue-req: 0


    [2026-06-10 05:02:55] Decode batch, #running-req: 1, #token: 760, token usage: 0.04, cuda graph: False, gen throughput (token/s): 45.95, #queue-req: 0


    [2026-06-10 05:02:56] Decode batch, #running-req: 1, #token: 800, token usage: 0.04, cuda graph: False, gen throughput (token/s): 42.36, #queue-req: 0


    [2026-06-10 05:02:57] Decode batch, #running-req: 1, #token: 840, token usage: 0.04, cuda graph: False, gen throughput (token/s): 45.85, #queue-req: 0


    [2026-06-10 05:02:58] Decode batch, #running-req: 1, #token: 880, token usage: 0.04, cuda graph: False, gen throughput (token/s): 50.36, #queue-req: 0


    [2026-06-10 05:02:58] Decode batch, #running-req: 1, #token: 920, token usage: 0.04, cuda graph: False, gen throughput (token/s): 49.32, #queue-req: 0


    [2026-06-10 05:02:59] Decode batch, #running-req: 1, #token: 960, token usage: 0.05, cuda graph: False, gen throughput (token/s): 47.46, #queue-req: 0


    [2026-06-10 05:03:00] Decode batch, #running-req: 1, #token: 1000, token usage: 0.05, cuda graph: False, gen throughput (token/s): 49.14, #queue-req: 0


    [2026-06-10 05:03:01] INFO:     127.0.0.1:33364 - "POST /generate HTTP/1.1" 200 OK
    Output from lora0: 
