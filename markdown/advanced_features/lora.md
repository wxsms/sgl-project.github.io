...
```
    ...
    Multi-thread loading shards:  75% Completed | 3/4 [00:06<00:01,  1.91s/it]
...
```
    ...
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 800.10it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 13262.62it/s]


    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 188.58it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 305.51it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 195.60it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 119.40it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 188.95it/s]
...
```
    ...
    [2026-06-05 04:55:52] Load weight end. elapsed=2.87 s, type=LlamaForCausalLM, avail mem=63.48 GB, mem usage=-4.62 GB.
    [2026-06-05 04:55:52] Using csgmv as backend of LoRA kernels.
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 76959.71it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 76608.29it/s]
    [2026-06-05 04:55:52] Found local HF snapshot for Nutanix/Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json at /root/.cache/huggingface/hub/models--Nutanix--Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json/snapshots/2c398740f3eba8dc63ee78999316b833a2833b6c; skipping download.
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 338.69it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 88301.14it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 21760.33it/s]
    [2026-06-05 04:55:52] Found local HF snapshot for algoprog/fact-generation-llama-3.1-8b-instruct-lora at /root/.cache/huggingface/hub/models--algoprog--fact-generation-llama-3.1-8b-instruct-lora/snapshots/dc8cdfb21993a6cb46199d6b1d79f68a42b06439; skipping download.
    ...
    [2026-06-05 04:55:53] Found local HF snapshot for philschmid/code-llama-3-1-8b-text-to-sql-lora at /root/.cache/huggingface/hub/models--philschmid--code-llama-3-1-8b-text-to-sql-lora/snapshots/141fc3a09386a8baf0d7495c247ae2d1a565f69f; skipping download.


    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 118.80it/s]


    [2026-06-05 04:55:54] Max concurrent requests (per dp worker) from the finalized token capacity: max_num_reqs=128.
    [2026-06-05 04:55:54] KV Cache is allocated. dtype: torch.bfloat16, #tokens: 20480, K size: 1.25 GB, V size: 1.25 GB
    [2026-06-05 04:55:54] Memory pool end. avail mem=58.26 GB
    [2026-06-05 04:55:54] Disable piecewise CUDA graph because --disable-piecewise-cuda-graph is set


    [2026-06-05 04:55:59] max_total_num_tokens=20480, chunked_prefill_size=8192, max_prefill_tokens=16384, max_running_requests=128, context_len=131072, available_gpu_mem=58.16 GB
    [2026-06-05 04:55:59] Tree cache initialized: source=default impl=RadixCache hybrid_swa=False hybrid_ssm=False hierarchical=False streaming_wrapped=False


    [2026-06-05 04:56:00] INFO:     Started server process [1831780]
    [2026-06-05 04:56:00] INFO:     Waiting for application startup.
    [2026-06-05 04:56:00] Using default chat sampling params from model generation config: {'temperature': 0.6, 'top_p': 0.9}
    [2026-06-05 04:56:00] INFO:     Application startup complete.
    [2026-06-05 04:56:00] INFO:     Uvicorn running on http://127.0.0.1:31890 (Press CTRL+C to quit)


    /usr/local/lib/python3.10/dist-packages/fastapi/routing.py:120: FastAPIDeprecationWarning: ORJSONResponse is deprecated, FastAPI now serializes data directly to JSON bytes via Pydantic when a return type or response model is set, which is faster and doesn't need a custom response class. Read more in the FastAPI docs: https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model and https://fastapi.tiangolo.com/tutorial/response-model/
      response = await f(request)
    [2026-06-05 04:56:01] INFO:     127.0.0.1:51398 - "GET /v1/models HTTP/1.1" 200 OK
    [2026-06-05 04:56:01] INFO:     127.0.0.1:51406 - "GET /model_info HTTP/1.1" 200 OK


    [2026-06-05 04:56:02] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-05 04:56:02] LoRA expand (K=6144, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-05 04:56:02] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-05 04:56:02] LoRA expand (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}


    [2026-06-05 04:56:02] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-05 04:56:02] LoRA expand (K=28672, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-05 04:56:02] LoRA shrink (K=14336, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}


    [2026-06-05 04:56:03] Prefill batch, #new-seq: 1, #new-token: 7, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 2.15
    [2026-06-05 04:56:03] INFO:     127.0.0.1:51412 - "POST /generate HTTP/1.1" 200 OK
    [2026-06-05 04:56:03] The server is fired up and ready to roll!
...
```
    ...
    [2026-06-05 04:56:06] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-05 04:56:06] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-05 04:56:07] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-05 04:56:09] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-05 04:56:09] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-05 04:56:09] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-05 04:56:09] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-05 04:56:09] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-05 04:56:09] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 2, #pending-token: 18, cuda graph: False, input throughput (token/s): 1.37
    [2026-06-05 04:56:09] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-05 04:56:09] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-05 04:56:09] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-05 04:56:09] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-05 04:56:09] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-05 04:56:09] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-05 04:56:10] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-05 04:56:10] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-05 04:56:10] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-05 04:56:10] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-05 04:56:10] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-05 04:56:10] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 1, #pending-token: 9, cuda graph: False, input throughput (token/s): 12.59


    [2026-06-05 04:56:10] Decode batch, #running-req: 2, #token: 72, token usage: 0.00, cuda graph: False, gen throughput (token/s): 5.49, #queue-req: 1


    [2026-06-05 04:56:11] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-05 04:56:11] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 6.35


    [2026-06-05 04:56:12] Decode batch, #running-req: 2, #token: 86, token usage: 0.00, cuda graph: False, gen throughput (token/s): 68.34, #queue-req: 0


    [2026-06-05 04:56:13] Decode batch, #running-req: 2, #token: 166, token usage: 0.01, cuda graph: False, gen throughput (token/s): 84.17, #queue-req: 0


    [2026-06-05 04:56:13] Decode batch, #running-req: 1, #token: 150, token usage: 0.01, cuda graph: False, gen throughput (token/s): 66.46, #queue-req: 0


    [2026-06-05 04:56:14] Decode batch, #running-req: 1, #token: 190, token usage: 0.01, cuda graph: False, gen throughput (token/s): 40.16, #queue-req: 0


    [2026-06-05 04:56:15] Decode batch, #running-req: 1, #token: 230, token usage: 0.01, cuda graph: False, gen throughput (token/s): 44.16, #queue-req: 0


    [2026-06-05 04:56:16] Decode batch, #running-req: 1, #token: 270, token usage: 0.01, cuda graph: False, gen throughput (token/s): 44.02, #queue-req: 0


    [2026-06-05 04:56:17] Decode batch, #running-req: 1, #token: 310, token usage: 0.02, cuda graph: False, gen throughput (token/s): 46.52, #queue-req: 0


    [2026-06-05 04:56:18] Decode batch, #running-req: 1, #token: 350, token usage: 0.02, cuda graph: False, gen throughput (token/s): 50.61, #queue-req: 0


    [2026-06-05 04:56:19] Decode batch, #running-req: 1, #token: 390, token usage: 0.02, cuda graph: False, gen throughput (token/s): 49.42, #queue-req: 0


    [2026-06-05 04:56:19] Decode batch, #running-req: 1, #token: 430, token usage: 0.02, cuda graph: False, gen throughput (token/s): 50.38, #queue-req: 0


    [2026-06-05 04:56:20] Decode batch, #running-req: 1, #token: 470, token usage: 0.02, cuda graph: False, gen throughput (token/s): 51.02, #queue-req: 0


    [2026-06-05 04:56:21] Decode batch, #running-req: 1, #token: 510, token usage: 0.02, cuda graph: False, gen throughput (token/s): 52.81, #queue-req: 0


    [2026-06-05 04:56:23] Decode batch, #running-req: 1, #token: 550, token usage: 0.03, cuda graph: False, gen throughput (token/s): 25.26, #queue-req: 0


    [2026-06-05 04:56:24] Decode batch, #running-req: 1, #token: 590, token usage: 0.03, cuda graph: False, gen throughput (token/s): 41.11, #queue-req: 0


    [2026-06-05 04:56:24] Decode batch, #running-req: 1, #token: 630, token usage: 0.03, cuda graph: False, gen throughput (token/s): 48.31, #queue-req: 0


    [2026-06-05 04:56:25] Decode batch, #running-req: 1, #token: 670, token usage: 0.03, cuda graph: False, gen throughput (token/s): 48.07, #queue-req: 0


    [2026-06-05 04:56:26] Decode batch, #running-req: 1, #token: 710, token usage: 0.03, cuda graph: False, gen throughput (token/s): 39.18, #queue-req: 0


    [2026-06-05 04:56:27] Decode batch, #running-req: 1, #token: 750, token usage: 0.04, cuda graph: False, gen throughput (token/s): 32.53, #queue-req: 0


    [2026-06-05 04:56:28] Decode batch, #running-req: 1, #token: 790, token usage: 0.04, cuda graph: False, gen throughput (token/s): 50.29, #queue-req: 0


    [2026-06-05 04:56:29] Decode batch, #running-req: 1, #token: 830, token usage: 0.04, cuda graph: False, gen throughput (token/s): 51.28, #queue-req: 0


    [2026-06-05 04:56:30] Decode batch, #running-req: 1, #token: 870, token usage: 0.04, cuda graph: False, gen throughput (token/s): 52.61, #queue-req: 0


    [2026-06-05 04:56:31] Decode batch, #running-req: 1, #token: 910, token usage: 0.04, cuda graph: False, gen throughput (token/s): 47.53, #queue-req: 0


    [2026-06-05 04:56:31] Decode batch, #running-req: 1, #token: 950, token usage: 0.05, cuda graph: False, gen throughput (token/s): 48.64, #queue-req: 0


    [2026-06-05 04:56:32] Decode batch, #running-req: 1, #token: 990, token usage: 0.05, cuda graph: False, gen throughput (token/s): 44.79, #queue-req: 0


    [2026-06-05 04:56:33] Decode batch, #running-req: 1, #token: 1030, token usage: 0.05, cuda graph: False, gen throughput (token/s): 42.23, #queue-req: 0
    [2026-06-05 04:56:33] INFO:     127.0.0.1:51400 - "POST /generate HTTP/1.1" 200 OK
    Output from lora0: 
