...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 179.60it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 365.04it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 160.21it/s]
...
```
    ...
    [2026-06-05 14:02:51] Load weight end. elapsed=3.31 s, type=LlamaForCausalLM, avail mem=26.08 GB, mem usage=15.02 GB.
    [2026-06-05 14:02:51] Using csgmv as backend of LoRA kernels.


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 80273.76it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 92182.51it/s]
    [2026-06-05 14:02:52] Found local HF snapshot for Nutanix/Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json at /root/.cache/huggingface/hub/models--Nutanix--Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json/snapshots/2c398740f3eba8dc63ee78999316b833a2833b6c; skipping download.
    ...
    [2026-06-05 14:02:52] Found local HF snapshot for algoprog/fact-generation-llama-3.1-8b-instruct-lora at /root/.cache/huggingface/hub/models--algoprog--fact-generation-llama-3.1-8b-instruct-lora/snapshots/dc8cdfb21993a6cb46199d6b1d79f68a42b06439; skipping download.
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 143.23it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 86928.58it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 52428.80it/s]
    [2026-06-05 14:02:52] Found local HF snapshot for philschmid/code-llama-3-1-8b-text-to-sql-lora at /root/.cache/huggingface/hub/models--philschmid--code-llama-3-1-8b-text-to-sql-lora/snapshots/141fc3a09386a8baf0d7495c247ae2d1a565f69f; skipping download.
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 109.60it/s]


    [2026-06-05 14:02:53] Max concurrent requests (per dp worker) from the finalized token capacity: max_num_reqs=128.
    [2026-06-05 14:02:53] KV Cache is allocated. dtype: torch.bfloat16, #tokens: 20480, K size: 1.25 GB, V size: 1.25 GB
    [2026-06-05 14:02:53] Memory pool end. avail mem=37.96 GB
    [2026-06-05 14:02:53] Disable piecewise CUDA graph because --disable-piecewise-cuda-graph is set


    [2026-06-05 14:02:59] max_total_num_tokens=20480, chunked_prefill_size=8192, max_prefill_tokens=16384, max_running_requests=128, context_len=131072, available_gpu_mem=58.17 GB
    [2026-06-05 14:02:59] Tree cache initialized: source=default impl=RadixCache hybrid_swa=False hybrid_ssm=False hierarchical=False streaming_wrapped=False


    [2026-06-05 14:02:59] INFO:     Started server process [1804367]
    [2026-06-05 14:02:59] INFO:     Waiting for application startup.
    [2026-06-05 14:02:59] Using default chat sampling params from model generation config: {'temperature': 0.6, 'top_p': 0.9}
    [2026-06-05 14:02:59] INFO:     Application startup complete.
    [2026-06-05 14:02:59] INFO:     Uvicorn running on http://127.0.0.1:37149 (Press CTRL+C to quit)


    /usr/local/lib/python3.10/dist-packages/fastapi/routing.py:120: FastAPIDeprecationWarning: ORJSONResponse is deprecated, FastAPI now serializes data directly to JSON bytes via Pydantic when a return type or response model is set, which is faster and doesn't need a custom response class. Read more in the FastAPI docs: https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model and https://fastapi.tiangolo.com/tutorial/response-model/
      response = await f(request)
    [2026-06-05 14:03:00] INFO:     127.0.0.1:42028 - "GET /v1/models HTTP/1.1" 200 OK
    [2026-06-05 14:03:00] INFO:     127.0.0.1:42044 - "GET /model_info HTTP/1.1" 200 OK


    [2026-06-05 14:03:01] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-05 14:03:01] LoRA expand (K=6144, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-05 14:03:01] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-05 14:03:01] LoRA expand (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}


    [2026-06-05 14:03:02] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-05 14:03:02] LoRA expand (K=28672, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-05 14:03:02] LoRA shrink (K=14336, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}


    [2026-06-05 14:03:02] Prefill batch, #new-seq: 1, #new-token: 7, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 2.23
    [2026-06-05 14:03:02] INFO:     127.0.0.1:42046 - "POST /generate HTTP/1.1" 200 OK
    [2026-06-05 14:03:02] The server is fired up and ready to roll!
...
```
    ...
    [2026-06-05 14:03:05] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-05 14:03:05] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-05 14:03:06] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-05 14:03:08] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-05 14:03:08] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-05 14:03:08] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-05 14:03:08] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-05 14:03:08] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-05 14:03:08] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-05 14:03:08] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-05 14:03:08] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 2, #pending-token: 18, cuda graph: False, input throughput (token/s): 1.43
    [2026-06-05 14:03:08] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-05 14:03:08] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-05 14:03:08] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-05 14:03:08] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-05 14:03:09] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-05 14:03:09] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-05 14:03:09] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-05 14:03:09] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-05 14:03:09] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-05 14:03:09] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-05 14:03:09] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-05 14:03:09] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-05 14:03:10] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-05 14:03:10] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-05 14:03:10] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-05 14:03:10] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-05 14:03:10] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-05 14:03:10] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-05 14:03:10] Decode batch, #running-req: 1, #token: 42, token usage: 0.00, cuda graph: False, gen throughput (token/s): 3.57, #queue-req: 2
    [2026-06-05 14:03:10] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-05 14:03:10] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-05 14:03:10] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-05 14:03:10] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-05 14:03:11] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-05 14:03:11] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-05 14:03:11] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-05 14:03:11] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-05 14:03:11] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-05 14:03:11] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-05 14:03:11] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-05 14:03:11] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-05 14:03:12] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-05 14:03:12] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-05 14:03:12] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-05 14:03:12] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-05 14:03:12] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].


    [2026-06-05 14:03:12] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 1, #pending-token: 9, cuda graph: False, input throughput (token/s): 2.47
    [2026-06-05 14:03:12] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-05 14:03:12] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 63.50


    [2026-06-05 14:03:12] Decode batch, #running-req: 2, #token: 36, token usage: 0.00, cuda graph: False, gen throughput (token/s): 22.60, #queue-req: 0


    [2026-06-05 14:03:13] Decode batch, #running-req: 2, #token: 116, token usage: 0.01, cuda graph: False, gen throughput (token/s): 105.22, #queue-req: 0


    [2026-06-05 14:03:14] Decode batch, #running-req: 1, #token: 100, token usage: 0.00, cuda graph: False, gen throughput (token/s): 77.75, #queue-req: 0


    [2026-06-05 14:03:14] Decode batch, #running-req: 1, #token: 140, token usage: 0.01, cuda graph: False, gen throughput (token/s): 45.52, #queue-req: 0


    [2026-06-05 14:03:15] Decode batch, #running-req: 1, #token: 180, token usage: 0.01, cuda graph: False, gen throughput (token/s): 45.33, #queue-req: 0


    [2026-06-05 14:03:16] Decode batch, #running-req: 1, #token: 220, token usage: 0.01, cuda graph: False, gen throughput (token/s): 47.96, #queue-req: 0


    [2026-06-05 14:03:17] Decode batch, #running-req: 1, #token: 260, token usage: 0.01, cuda graph: False, gen throughput (token/s): 44.88, #queue-req: 0


    [2026-06-05 14:03:18] Decode batch, #running-req: 1, #token: 300, token usage: 0.01, cuda graph: False, gen throughput (token/s): 44.23, #queue-req: 0


    [2026-06-05 14:03:19] Decode batch, #running-req: 1, #token: 340, token usage: 0.02, cuda graph: False, gen throughput (token/s): 47.88, #queue-req: 0


    [2026-06-05 14:03:20] Decode batch, #running-req: 1, #token: 380, token usage: 0.02, cuda graph: False, gen throughput (token/s): 48.14, #queue-req: 0


    [2026-06-05 14:03:20] Decode batch, #running-req: 1, #token: 420, token usage: 0.02, cuda graph: False, gen throughput (token/s): 50.66, #queue-req: 0


    [2026-06-05 14:03:21] Decode batch, #running-req: 1, #token: 460, token usage: 0.02, cuda graph: False, gen throughput (token/s): 48.58, #queue-req: 0


    [2026-06-05 14:03:22] Decode batch, #running-req: 1, #token: 500, token usage: 0.02, cuda graph: False, gen throughput (token/s): 48.71, #queue-req: 0


    [2026-06-05 14:03:23] Decode batch, #running-req: 1, #token: 540, token usage: 0.03, cuda graph: False, gen throughput (token/s): 52.80, #queue-req: 0


    [2026-06-05 14:03:24] Decode batch, #running-req: 1, #token: 580, token usage: 0.03, cuda graph: False, gen throughput (token/s): 55.08, #queue-req: 0


    [2026-06-05 14:03:24] Decode batch, #running-req: 1, #token: 620, token usage: 0.03, cuda graph: False, gen throughput (token/s): 49.27, #queue-req: 0


    [2026-06-05 14:03:25] Decode batch, #running-req: 1, #token: 660, token usage: 0.03, cuda graph: False, gen throughput (token/s): 47.45, #queue-req: 0


    [2026-06-05 14:03:26] Decode batch, #running-req: 1, #token: 700, token usage: 0.03, cuda graph: False, gen throughput (token/s): 47.10, #queue-req: 0


    [2026-06-05 14:03:27] Decode batch, #running-req: 1, #token: 740, token usage: 0.04, cuda graph: False, gen throughput (token/s): 47.76, #queue-req: 0


    [2026-06-05 14:03:28] Decode batch, #running-req: 1, #token: 780, token usage: 0.04, cuda graph: False, gen throughput (token/s): 39.61, #queue-req: 0


    [2026-06-05 14:03:29] Decode batch, #running-req: 1, #token: 820, token usage: 0.04, cuda graph: False, gen throughput (token/s): 45.75, #queue-req: 0


    [2026-06-05 14:03:29] Decode batch, #running-req: 1, #token: 860, token usage: 0.04, cuda graph: False, gen throughput (token/s): 53.81, #queue-req: 0


    [2026-06-05 14:03:30] Decode batch, #running-req: 1, #token: 900, token usage: 0.04, cuda graph: False, gen throughput (token/s): 50.32, #queue-req: 0


    [2026-06-05 14:03:31] Decode batch, #running-req: 1, #token: 940, token usage: 0.05, cuda graph: False, gen throughput (token/s): 33.35, #queue-req: 0


    [2026-06-05 14:03:33] Decode batch, #running-req: 1, #token: 980, token usage: 0.05, cuda graph: False, gen throughput (token/s): 31.58, #queue-req: 0


    [2026-06-05 14:03:34] Decode batch, #running-req: 1, #token: 1020, token usage: 0.05, cuda graph: False, gen throughput (token/s): 32.36, #queue-req: 0


    [2026-06-05 14:03:34] INFO:     127.0.0.1:42060 - "POST /generate HTTP/1.1" 200 OK
    Output from lora0: 
