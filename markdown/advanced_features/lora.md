...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 344.02it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 180.12it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 181.13it/s]
...
```
    ...
    Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 168.87it/s]
...
```
    ...
    [2026-06-09 02:59:13] Load weight end. elapsed=3.19 s, type=LlamaForCausalLM, avail mem=58.92 GB, mem usage=15.02 GB.
    [2026-06-09 02:59:13] Using csgmv as backend of LoRA kernels.
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 13562.83it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 19284.16it/s]
    [2026-06-09 02:59:13] Found local HF snapshot for Nutanix/Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json at /root/.cache/huggingface/hub/models--Nutanix--Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json/snapshots/2c398740f3eba8dc63ee78999316b833a2833b6c; skipping download.
    ...
    [2026-06-09 02:59:13] Found local HF snapshot for algoprog/fact-generation-llama-3.1-8b-instruct-lora at /root/.cache/huggingface/hub/models--algoprog--fact-generation-llama-3.1-8b-instruct-lora/snapshots/dc8cdfb21993a6cb46199d6b1d79f68a42b06439; skipping download.
    ...
    [2026-06-09 02:59:14] Found local HF snapshot for philschmid/code-llama-3-1-8b-text-to-sql-lora at /root/.cache/huggingface/hub/models--philschmid--code-llama-3-1-8b-text-to-sql-lora/snapshots/141fc3a09386a8baf0d7495c247ae2d1a565f69f; skipping download.
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 115.83it/s]


    [2026-06-09 02:59:15] Max concurrent requests (per dp worker) from the finalized token capacity: max_num_reqs=128.
    [2026-06-09 02:59:15] KV Cache is allocated. dtype: torch.bfloat16, #tokens: 20480, K size: 1.25 GB, V size: 1.25 GB
    [2026-06-09 02:59:15] Memory pool end. avail mem=58.26 GB
    [2026-06-09 02:59:15] Disable piecewise CUDA graph because --disable-piecewise-cuda-graph is set


    [2026-06-09 02:59:19] max_total_num_tokens=20480, chunked_prefill_size=8192, max_prefill_tokens=16384, max_running_requests=128, context_len=131072, available_gpu_mem=58.17 GB
    [2026-06-09 02:59:19] Tree cache initialized: source=default impl=RadixCache hybrid_swa=False hybrid_ssm=False hierarchical=False streaming_wrapped=False


    [2026-06-09 02:59:19] INFO:     Started server process [359256]
    [2026-06-09 02:59:19] INFO:     Waiting for application startup.
    [2026-06-09 02:59:19] Using default chat sampling params from model generation config: {'temperature': 0.6, 'top_p': 0.9}
    [2026-06-09 02:59:19] INFO:     Application startup complete.
    [2026-06-09 02:59:19] INFO:     Uvicorn running on http://127.0.0.1:37408 (Press CTRL+C to quit)


    /usr/local/lib/python3.10/dist-packages/fastapi/routing.py:120: FastAPIDeprecationWarning: ORJSONResponse is deprecated, FastAPI now serializes data directly to JSON bytes via Pydantic when a return type or response model is set, which is faster and doesn't need a custom response class. Read more in the FastAPI docs: https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model and https://fastapi.tiangolo.com/tutorial/response-model/
      response = await f(request)
    [2026-06-09 02:59:20] INFO:     127.0.0.1:50004 - "GET /v1/models HTTP/1.1" 200 OK


    [2026-06-09 02:59:20] INFO:     127.0.0.1:50016 - "GET /model_info HTTP/1.1" 200 OK


    [2026-06-09 02:59:21] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-09 02:59:21] LoRA expand (K=6144, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-09 02:59:21] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-09 02:59:21] LoRA expand (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}


    [2026-06-09 02:59:22] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-09 02:59:22] LoRA expand (K=28672, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-09 02:59:22] LoRA shrink (K=14336, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}


    [2026-06-09 02:59:22] Prefill batch, #new-seq: 1, #new-token: 7, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 2.17
    [2026-06-09 02:59:22] INFO:     127.0.0.1:50026 - "POST /generate HTTP/1.1" 200 OK
    [2026-06-09 02:59:22] The server is fired up and ready to roll!
...
```
    ...
    [2026-06-09 02:59:25] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-09 02:59:25] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-09 02:59:26] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-09 02:59:26] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-09 02:59:26] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-09 02:59:28] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-09 02:59:28] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-09 02:59:29] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-09 02:59:29] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-09 02:59:29] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 2, #pending-token: 18, cuda graph: False, input throughput (token/s): 1.33
    [2026-06-09 02:59:29] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-09 02:59:29] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-09 02:59:29] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-09 02:59:29] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-09 02:59:30] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-09 02:59:30] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-09 02:59:31] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-09 02:59:31] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-09 02:59:31] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-09 02:59:31] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-09 02:59:31] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-09 02:59:31] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-09 02:59:32] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-09 02:59:32] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-09 02:59:32] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-09 02:59:32] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 1, #pending-token: 9, cuda graph: False, input throughput (token/s): 2.94


    [2026-06-09 02:59:32] Decode batch, #running-req: 2, #token: 63, token usage: 0.00, cuda graph: False, gen throughput (token/s): 3.85, #queue-req: 1


    [2026-06-09 02:59:33] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-09 02:59:33] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 8.76


    [2026-06-09 02:59:33] Decode batch, #running-req: 2, #token: 77, token usage: 0.00, cuda graph: False, gen throughput (token/s): 84.92, #queue-req: 0


    [2026-06-09 02:59:34] Decode batch, #running-req: 2, #token: 157, token usage: 0.01, cuda graph: False, gen throughput (token/s): 98.79, #queue-req: 0


    [2026-06-09 02:59:35] Decode batch, #running-req: 1, #token: 141, token usage: 0.01, cuda graph: False, gen throughput (token/s): 69.28, #queue-req: 0


    [2026-06-09 02:59:36] Decode batch, #running-req: 1, #token: 181, token usage: 0.01, cuda graph: False, gen throughput (token/s): 47.54, #queue-req: 0


    [2026-06-09 02:59:36] Decode batch, #running-req: 1, #token: 221, token usage: 0.01, cuda graph: False, gen throughput (token/s): 47.24, #queue-req: 0


    [2026-06-09 02:59:37] Decode batch, #running-req: 1, #token: 261, token usage: 0.01, cuda graph: False, gen throughput (token/s): 47.85, #queue-req: 0


    [2026-06-09 02:59:38] Decode batch, #running-req: 1, #token: 301, token usage: 0.01, cuda graph: False, gen throughput (token/s): 47.34, #queue-req: 0


    [2026-06-09 02:59:39] Decode batch, #running-req: 1, #token: 341, token usage: 0.02, cuda graph: False, gen throughput (token/s): 49.22, #queue-req: 0


    [2026-06-09 02:59:40] Decode batch, #running-req: 1, #token: 381, token usage: 0.02, cuda graph: False, gen throughput (token/s): 53.36, #queue-req: 0


    [2026-06-09 02:59:40] Decode batch, #running-req: 1, #token: 421, token usage: 0.02, cuda graph: False, gen throughput (token/s): 51.07, #queue-req: 0


    [2026-06-09 02:59:41] Decode batch, #running-req: 1, #token: 461, token usage: 0.02, cuda graph: False, gen throughput (token/s): 52.07, #queue-req: 0


    [2026-06-09 02:59:42] Decode batch, #running-req: 1, #token: 501, token usage: 0.02, cuda graph: False, gen throughput (token/s): 43.28, #queue-req: 0


    [2026-06-09 02:59:43] Decode batch, #running-req: 1, #token: 541, token usage: 0.03, cuda graph: False, gen throughput (token/s): 41.76, #queue-req: 0


    [2026-06-09 02:59:44] Decode batch, #running-req: 1, #token: 581, token usage: 0.03, cuda graph: False, gen throughput (token/s): 39.54, #queue-req: 0


    [2026-06-09 02:59:45] Decode batch, #running-req: 1, #token: 621, token usage: 0.03, cuda graph: False, gen throughput (token/s): 47.36, #queue-req: 0


    [2026-06-09 02:59:46] Decode batch, #running-req: 1, #token: 661, token usage: 0.03, cuda graph: False, gen throughput (token/s): 42.42, #queue-req: 0


    [2026-06-09 02:59:47] Decode batch, #running-req: 1, #token: 701, token usage: 0.03, cuda graph: False, gen throughput (token/s): 49.11, #queue-req: 0


    [2026-06-09 02:59:47] Decode batch, #running-req: 1, #token: 741, token usage: 0.04, cuda graph: False, gen throughput (token/s): 49.53, #queue-req: 0


    [2026-06-09 02:59:48] Decode batch, #running-req: 1, #token: 781, token usage: 0.04, cuda graph: False, gen throughput (token/s): 49.99, #queue-req: 0


    [2026-06-09 02:59:49] Decode batch, #running-req: 1, #token: 821, token usage: 0.04, cuda graph: False, gen throughput (token/s): 52.70, #queue-req: 0


    [2026-06-09 02:59:50] Decode batch, #running-req: 1, #token: 861, token usage: 0.04, cuda graph: False, gen throughput (token/s): 53.07, #queue-req: 0


    [2026-06-09 02:59:51] Decode batch, #running-req: 1, #token: 901, token usage: 0.04, cuda graph: False, gen throughput (token/s): 53.34, #queue-req: 0


    [2026-06-09 02:59:51] Decode batch, #running-req: 1, #token: 941, token usage: 0.05, cuda graph: False, gen throughput (token/s): 46.28, #queue-req: 0


    [2026-06-09 02:59:52] Decode batch, #running-req: 1, #token: 981, token usage: 0.05, cuda graph: False, gen throughput (token/s): 50.10, #queue-req: 0


    [2026-06-09 02:59:53] Decode batch, #running-req: 1, #token: 1021, token usage: 0.05, cuda graph: False, gen throughput (token/s): 49.37, #queue-req: 0


    [2026-06-09 02:59:53] INFO:     127.0.0.1:48936 - "POST /generate HTTP/1.1" 200 OK
    Output from lora0: 
