...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 169.65it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 115.04it/s]
...
```
    ...
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 6700.17it/s]
...
```
    ...
    [2026-06-03 08:50:28] Load weight end. elapsed=3.37 s, type=LlamaForCausalLM, avail mem=48.46 GB, mem usage=29.37 GB.
    [2026-06-03 08:50:28] Using csgmv as backend of LoRA kernels.
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 19463.13it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 81049.35it/s]
    [2026-06-03 08:50:28] Found local HF snapshot for Nutanix/Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json at /root/.cache/huggingface/hub/models--Nutanix--Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json/snapshots/2c398740f3eba8dc63ee78999316b833a2833b6c; skipping download.
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 292.27it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 65281.00it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 65027.97it/s]
    [2026-06-03 08:50:28] Found local HF snapshot for algoprog/fact-generation-llama-3.1-8b-instruct-lora at /root/.cache/huggingface/hub/models--algoprog--fact-generation-llama-3.1-8b-instruct-lora/snapshots/dc8cdfb21993a6cb46199d6b1d79f68a42b06439; skipping download.


    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 92.16it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 13573.80it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 75234.15it/s]
    [2026-06-03 08:50:29] Found local HF snapshot for philschmid/code-llama-3-1-8b-text-to-sql-lora at /root/.cache/huggingface/hub/models--philschmid--code-llama-3-1-8b-text-to-sql-lora/snapshots/141fc3a09386a8baf0d7495c247ae2d1a565f69f; skipping download.
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 100.01it/s]


    [2026-06-03 08:50:30] Max concurrent requests (per dp worker) from the finalized token capacity: max_num_reqs=128.
    [2026-06-03 08:50:30] KV Cache is allocated. dtype: torch.bfloat16, #tokens: 20480, K size: 1.25 GB, V size: 1.25 GB
    [2026-06-03 08:50:30] Memory pool end. avail mem=41.87 GB
    [2026-06-03 08:50:30] Disable piecewise CUDA graph because --disable-piecewise-cuda-graph is set


    [2026-06-03 08:50:35] max_total_num_tokens=20480, chunked_prefill_size=8192, max_prefill_tokens=16384, max_running_requests=128, context_len=131072, available_gpu_mem=40.67 GB
    [2026-06-03 08:50:35] Tree cache initialized: source=default impl=RadixCache hybrid_swa=False hybrid_ssm=False hierarchical=False streaming_wrapped=False


    [2026-06-03 08:50:36] INFO:     Started server process [3923965]
    [2026-06-03 08:50:36] INFO:     Waiting for application startup.
    [2026-06-03 08:50:36] Using default chat sampling params from model generation config: {'temperature': 0.6, 'top_p': 0.9}
    [2026-06-03 08:50:36] INFO:     Application startup complete.
    [2026-06-03 08:50:36] INFO:     Uvicorn running on http://127.0.0.1:32275 (Press CTRL+C to quit)


    /usr/local/lib/python3.10/dist-packages/fastapi/routing.py:120: FastAPIDeprecationWarning: ORJSONResponse is deprecated, FastAPI now serializes data directly to JSON bytes via Pydantic when a return type or response model is set, which is faster and doesn't need a custom response class. Read more in the FastAPI docs: https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model and https://fastapi.tiangolo.com/tutorial/response-model/
      response = await f(request)
    [2026-06-03 08:50:36] INFO:     127.0.0.1:57522 - "GET /v1/models HTTP/1.1" 200 OK


    [2026-06-03 08:50:37] INFO:     127.0.0.1:57526 - "GET /model_info HTTP/1.1" 200 OK


    [2026-06-03 08:50:38] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-03 08:50:38] LoRA expand (K=6144, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-03 08:50:38] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-03 08:50:38] LoRA expand (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}


    [2026-06-03 08:50:38] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-03 08:50:38] LoRA expand (K=28672, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-03 08:50:38] LoRA shrink (K=14336, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}


    [2026-06-03 08:50:38] Prefill batch, #new-seq: 1, #new-token: 7, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 2.12
    [2026-06-03 08:50:39] INFO:     127.0.0.1:57530 - "POST /generate HTTP/1.1" 200 OK
    [2026-06-03 08:50:39] The server is fired up and ready to roll!
...
```
    ...
    [2026-06-03 08:50:41] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-03 08:50:41] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-03 08:50:42] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-03 08:50:44] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-03 08:50:44] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-03 08:50:45] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-03 08:50:45] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-03 08:50:45] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 2, #pending-token: 18, cuda graph: False, input throughput (token/s): 1.41
    [2026-06-03 08:50:45] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-03 08:50:45] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-03 08:50:45] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-03 08:50:45] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-03 08:50:45] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-03 08:50:45] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 1, #pending-token: 9, cuda graph: False, input throughput (token/s): 12.74


    [2026-06-03 08:50:46] Decode batch, #running-req: 2, #token: 78, token usage: 0.00, cuda graph: False, gen throughput (token/s): 6.02, #queue-req: 1


    [2026-06-03 08:50:47] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-03 08:50:47] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 5.21
    [2026-06-03 08:50:47] Decode batch, #running-req: 2, #token: 89, token usage: 0.00, cuda graph: False, gen throughput (token/s): 59.32, #queue-req: 0


    [2026-06-03 08:50:48] Decode batch, #running-req: 2, #token: 169, token usage: 0.01, cuda graph: False, gen throughput (token/s): 77.67, #queue-req: 0


    [2026-06-03 08:50:49] Decode batch, #running-req: 1, #token: 156, token usage: 0.01, cuda graph: False, gen throughput (token/s): 60.11, #queue-req: 0


    [2026-06-03 08:50:50] Decode batch, #running-req: 1, #token: 196, token usage: 0.01, cuda graph: False, gen throughput (token/s): 42.04, #queue-req: 0


    [2026-06-03 08:50:51] Decode batch, #running-req: 1, #token: 236, token usage: 0.01, cuda graph: False, gen throughput (token/s): 42.51, #queue-req: 0


    [2026-06-03 08:50:52] Decode batch, #running-req: 1, #token: 276, token usage: 0.01, cuda graph: False, gen throughput (token/s): 48.24, #queue-req: 0


    [2026-06-03 08:50:53] Decode batch, #running-req: 1, #token: 316, token usage: 0.02, cuda graph: False, gen throughput (token/s): 47.74, #queue-req: 0


    [2026-06-03 08:50:54] Decode batch, #running-req: 1, #token: 356, token usage: 0.02, cuda graph: False, gen throughput (token/s): 48.14, #queue-req: 0


    [2026-06-03 08:50:55] Decode batch, #running-req: 1, #token: 396, token usage: 0.02, cuda graph: False, gen throughput (token/s): 48.36, #queue-req: 0


    [2026-06-03 08:50:55] Decode batch, #running-req: 1, #token: 436, token usage: 0.02, cuda graph: False, gen throughput (token/s): 47.96, #queue-req: 0


    [2026-06-03 08:50:56] Decode batch, #running-req: 1, #token: 476, token usage: 0.02, cuda graph: False, gen throughput (token/s): 48.32, #queue-req: 0


    [2026-06-03 08:50:57] Decode batch, #running-req: 1, #token: 516, token usage: 0.03, cuda graph: False, gen throughput (token/s): 37.55, #queue-req: 0


    [2026-06-03 08:50:58] Decode batch, #running-req: 1, #token: 556, token usage: 0.03, cuda graph: False, gen throughput (token/s): 40.03, #queue-req: 0


    [2026-06-03 08:50:59] Decode batch, #running-req: 1, #token: 596, token usage: 0.03, cuda graph: False, gen throughput (token/s): 38.31, #queue-req: 0


    [2026-06-03 08:51:00] Decode batch, #running-req: 1, #token: 636, token usage: 0.03, cuda graph: False, gen throughput (token/s): 36.95, #queue-req: 0


    [2026-06-03 08:51:01] Decode batch, #running-req: 1, #token: 676, token usage: 0.03, cuda graph: False, gen throughput (token/s): 37.25, #queue-req: 0


    [2026-06-03 08:51:03] Decode batch, #running-req: 1, #token: 716, token usage: 0.03, cuda graph: False, gen throughput (token/s): 39.05, #queue-req: 0


    [2026-06-03 08:51:04] Decode batch, #running-req: 1, #token: 756, token usage: 0.04, cuda graph: False, gen throughput (token/s): 38.55, #queue-req: 0


    [2026-06-03 08:51:05] Decode batch, #running-req: 1, #token: 796, token usage: 0.04, cuda graph: False, gen throughput (token/s): 37.03, #queue-req: 0


    [2026-06-03 08:51:06] Decode batch, #running-req: 1, #token: 836, token usage: 0.04, cuda graph: False, gen throughput (token/s): 40.33, #queue-req: 0


    [2026-06-03 08:51:07] Decode batch, #running-req: 1, #token: 876, token usage: 0.04, cuda graph: False, gen throughput (token/s): 36.88, #queue-req: 0


    [2026-06-03 08:51:08] Decode batch, #running-req: 1, #token: 916, token usage: 0.04, cuda graph: False, gen throughput (token/s): 35.94, #queue-req: 0


    [2026-06-03 08:51:09] Decode batch, #running-req: 1, #token: 956, token usage: 0.05, cuda graph: False, gen throughput (token/s): 39.83, #queue-req: 0


    [2026-06-03 08:51:10] Decode batch, #running-req: 1, #token: 996, token usage: 0.05, cuda graph: False, gen throughput (token/s): 44.06, #queue-req: 0
    ...
    * Aria and Kael face their greatest
    ...
    [2026-06-03 08:51:11] INFO:     127.0.0.1:57536 - "POST /generate HTTP/1.1" 200 OK
