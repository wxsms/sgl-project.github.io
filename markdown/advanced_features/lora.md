...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 233.48it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 167.15it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 351.52it/s]
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 124.57it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 92.52it/s]
...
```
    ...
    [2026-06-03 01:55:10] Load weight end. elapsed=4.18 s, type=LlamaForCausalLM, avail mem=55.56 GB, mem usage=2.64 GB.
    [2026-06-03 01:55:10] Using csgmv as backend of LoRA kernels.
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 19108.45it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 18787.48it/s]
    [2026-06-03 01:55:10] Found local HF snapshot for Nutanix/Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json at /root/.cache/huggingface/hub/models--Nutanix--Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json/snapshots/2c398740f3eba8dc63ee78999316b833a2833b6c; skipping download.
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 201.49it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 78766.27it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 22162.77it/s]
    [2026-06-03 01:55:11] Found local HF snapshot for algoprog/fact-generation-llama-3.1-8b-instruct-lora at /root/.cache/huggingface/hub/models--algoprog--fact-generation-llama-3.1-8b-instruct-lora/snapshots/dc8cdfb21993a6cb46199d6b1d79f68a42b06439; skipping download.
    ...
    [2026-06-03 01:55:11] Found local HF snapshot for philschmid/code-llama-3-1-8b-text-to-sql-lora at /root/.cache/huggingface/hub/models--philschmid--code-llama-3-1-8b-text-to-sql-lora/snapshots/141fc3a09386a8baf0d7495c247ae2d1a565f69f; skipping download.


    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 116.95it/s]


    [2026-06-03 01:55:12] Max concurrent requests (per dp worker) from the finalized token capacity: max_num_reqs=128.
    [2026-06-03 01:55:12] KV Cache is allocated. dtype: torch.bfloat16, #tokens: 20480, K size: 1.25 GB, V size: 1.25 GB
    [2026-06-03 01:55:12] Memory pool end. avail mem=49.35 GB
    [2026-06-03 01:55:12] Disable piecewise CUDA graph because --disable-piecewise-cuda-graph is set


    [2026-06-03 01:55:18] max_total_num_tokens=20480, chunked_prefill_size=8192, max_prefill_tokens=16384, max_running_requests=128, context_len=131072, available_gpu_mem=48.63 GB
    [2026-06-03 01:55:18] Tree cache initialized: source=default impl=RadixCache hybrid_swa=False hybrid_ssm=False hierarchical=False streaming_wrapped=False


    [2026-06-03 01:55:18] INFO:     Started server process [3795067]
    [2026-06-03 01:55:18] INFO:     Waiting for application startup.
    [2026-06-03 01:55:18] Using default chat sampling params from model generation config: {'temperature': 0.6, 'top_p': 0.9}
    [2026-06-03 01:55:18] INFO:     Application startup complete.
    [2026-06-03 01:55:18] INFO:     Uvicorn running on http://127.0.0.1:36354 (Press CTRL+C to quit)
    /usr/local/lib/python3.10/dist-packages/fastapi/routing.py:120: FastAPIDeprecationWarning: ORJSONResponse is deprecated, FastAPI now serializes data directly to JSON bytes via Pydantic when a return type or response model is set, which is faster and doesn't need a custom response class. Read more in the FastAPI docs: https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model and https://fastapi.tiangolo.com/tutorial/response-model/
      response = await f(request)
    [2026-06-03 01:55:18] INFO:     127.0.0.1:47358 - "GET /v1/models HTTP/1.1" 200 OK


    [2026-06-03 01:55:19] INFO:     127.0.0.1:47366 - "GET /model_info HTTP/1.1" 200 OK


    [2026-06-03 01:55:20] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-03 01:55:20] LoRA expand (K=6144, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-03 01:55:20] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-03 01:55:20] LoRA expand (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}


    [2026-06-03 01:55:21] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-03 01:55:21] LoRA expand (K=28672, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-03 01:55:21] LoRA shrink (K=14336, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}


    [2026-06-03 01:55:21] Prefill batch, #new-seq: 1, #new-token: 7, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 2.16
    [2026-06-03 01:55:21] INFO:     127.0.0.1:47382 - "POST /generate HTTP/1.1" 200 OK
    [2026-06-03 01:55:21] The server is fired up and ready to roll!
...
```
    ...
    [2026-06-03 01:55:23] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-03 01:55:23] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-03 01:55:24] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-03 01:55:24] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-03 01:55:24] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-03 01:55:26] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-03 01:55:26] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-03 01:55:27] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-03 01:55:27] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-03 01:55:27] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-03 01:55:27] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-03 01:55:27] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    ...
    [2026-06-03 01:55:27] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-03 01:55:27] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-03 01:55:27] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 2, #pending-token: 18, cuda graph: False, input throughput (token/s): 1.44
    [2026-06-03 01:55:27] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-03 01:55:27] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-03 01:55:27] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-03 01:55:27] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-03 01:55:27] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-03 01:55:27] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-03 01:55:28] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-03 01:55:28] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-03 01:55:28] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-03 01:55:29] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-03 01:55:29] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-03 01:55:29] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-03 01:55:29] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-03 01:55:29] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-03 01:55:29] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-03 01:55:29] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-03 01:55:29] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-03 01:55:29] Decode batch, #running-req: 1, #token: 42, token usage: 0.00, cuda graph: False, gen throughput (token/s): 3.53, #queue-req: 2
    [2026-06-03 01:55:29] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-03 01:55:29] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-03 01:55:29] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-03 01:55:29] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-03 01:55:29] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-03 01:55:29] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-03 01:55:30] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-03 01:55:30] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-03 01:55:30] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-03 01:55:30] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-03 01:55:30] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-03 01:55:30] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 1, #pending-token: 9, cuda graph: False, input throughput (token/s): 2.98


    [2026-06-03 01:55:30] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-03 01:55:31] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 27.13


    [2026-06-03 01:55:31] Decode batch, #running-req: 2, #token: 46, token usage: 0.00, cuda graph: False, gen throughput (token/s): 36.07, #queue-req: 0


    [2026-06-03 01:55:31] Decode batch, #running-req: 2, #token: 126, token usage: 0.01, cuda graph: False, gen throughput (token/s): 104.56, #queue-req: 0


    [2026-06-03 01:55:32] Decode batch, #running-req: 1, #token: 110, token usage: 0.01, cuda graph: False, gen throughput (token/s): 71.91, #queue-req: 0


    [2026-06-03 01:55:33] Decode batch, #running-req: 1, #token: 150, token usage: 0.01, cuda graph: False, gen throughput (token/s): 50.68, #queue-req: 0


    [2026-06-03 01:55:34] Decode batch, #running-req: 1, #token: 190, token usage: 0.01, cuda graph: False, gen throughput (token/s): 48.69, #queue-req: 0


    [2026-06-03 01:55:35] Decode batch, #running-req: 1, #token: 230, token usage: 0.01, cuda graph: False, gen throughput (token/s): 40.46, #queue-req: 0


    [2026-06-03 01:55:36] Decode batch, #running-req: 1, #token: 270, token usage: 0.01, cuda graph: False, gen throughput (token/s): 34.08, #queue-req: 0


    [2026-06-03 01:55:37] Decode batch, #running-req: 1, #token: 310, token usage: 0.02, cuda graph: False, gen throughput (token/s): 32.22, #queue-req: 0


    [2026-06-03 01:55:38] Decode batch, #running-req: 1, #token: 350, token usage: 0.02, cuda graph: False, gen throughput (token/s): 35.83, #queue-req: 0


    [2026-06-03 01:55:39] Decode batch, #running-req: 1, #token: 390, token usage: 0.02, cuda graph: False, gen throughput (token/s): 47.98, #queue-req: 0


    [2026-06-03 01:55:40] Decode batch, #running-req: 1, #token: 430, token usage: 0.02, cuda graph: False, gen throughput (token/s): 49.68, #queue-req: 0


    [2026-06-03 01:55:41] Decode batch, #running-req: 1, #token: 470, token usage: 0.02, cuda graph: False, gen throughput (token/s): 48.54, #queue-req: 0


    [2026-06-03 01:55:42] Decode batch, #running-req: 1, #token: 510, token usage: 0.02, cuda graph: False, gen throughput (token/s): 48.82, #queue-req: 0


    [2026-06-03 01:55:42] Decode batch, #running-req: 1, #token: 550, token usage: 0.03, cuda graph: False, gen throughput (token/s): 49.12, #queue-req: 0


    [2026-06-03 01:55:43] Decode batch, #running-req: 1, #token: 590, token usage: 0.03, cuda graph: False, gen throughput (token/s): 49.68, #queue-req: 0


    [2026-06-03 01:55:44] Decode batch, #running-req: 1, #token: 630, token usage: 0.03, cuda graph: False, gen throughput (token/s): 50.96, #queue-req: 0


    [2026-06-03 01:55:45] Decode batch, #running-req: 1, #token: 670, token usage: 0.03, cuda graph: False, gen throughput (token/s): 48.88, #queue-req: 0


    [2026-06-03 01:55:46] Decode batch, #running-req: 1, #token: 710, token usage: 0.03, cuda graph: False, gen throughput (token/s): 47.45, #queue-req: 0


    [2026-06-03 01:55:47] Decode batch, #running-req: 1, #token: 750, token usage: 0.04, cuda graph: False, gen throughput (token/s): 47.04, #queue-req: 0


    [2026-06-03 01:55:47] Decode batch, #running-req: 1, #token: 790, token usage: 0.04, cuda graph: False, gen throughput (token/s): 48.24, #queue-req: 0


    [2026-06-03 01:55:48] Decode batch, #running-req: 1, #token: 830, token usage: 0.04, cuda graph: False, gen throughput (token/s): 50.49, #queue-req: 0


    [2026-06-03 01:55:49] Decode batch, #running-req: 1, #token: 870, token usage: 0.04, cuda graph: False, gen throughput (token/s): 51.36, #queue-req: 0


    [2026-06-03 01:55:50] Decode batch, #running-req: 1, #token: 910, token usage: 0.04, cuda graph: False, gen throughput (token/s): 39.48, #queue-req: 0


    [2026-06-03 01:55:51] Decode batch, #running-req: 1, #token: 950, token usage: 0.05, cuda graph: False, gen throughput (token/s): 46.16, #queue-req: 0


    [2026-06-03 01:55:52] Decode batch, #running-req: 1, #token: 990, token usage: 0.05, cuda graph: False, gen throughput (token/s): 50.93, #queue-req: 0


    [2026-06-03 01:55:52] Decode batch, #running-req: 1, #token: 1030, token usage: 0.05, cuda graph: False, gen throughput (token/s): 53.02, #queue-req: 0
    [2026-06-03 01:55:52] INFO:     127.0.0.1:34620 - "POST /generate HTTP/1.1" 200 OK
    Output from lora0: 
