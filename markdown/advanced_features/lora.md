...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 106.35it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 133.42it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 170.38it/s]
...
```
    ...
    [2026-06-04 22:35:39] Load weight end. elapsed=3.47 s, type=LlamaForCausalLM, avail mem=43.18 GB, mem usage=-2.09 GB.
    [2026-06-04 22:35:39] Using csgmv as backend of LoRA kernels.
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 88768.34it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 20213.51it/s]
    [2026-06-04 22:35:39] Found local HF snapshot for Nutanix/Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json at /root/.cache/huggingface/hub/models--Nutanix--Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json/snapshots/2c398740f3eba8dc63ee78999316b833a2833b6c; skipping download.
    ...
    [2026-06-04 22:35:40] Found local HF snapshot for algoprog/fact-generation-llama-3.1-8b-instruct-lora at /root/.cache/huggingface/hub/models--algoprog--fact-generation-llama-3.1-8b-instruct-lora/snapshots/dc8cdfb21993a6cb46199d6b1d79f68a42b06439; skipping download.
    ...
    [2026-06-04 22:35:40] Found local HF snapshot for philschmid/code-llama-3-1-8b-text-to-sql-lora at /root/.cache/huggingface/hub/models--philschmid--code-llama-3-1-8b-text-to-sql-lora/snapshots/141fc3a09386a8baf0d7495c247ae2d1a565f69f; skipping download.
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 116.64it/s]


    [2026-06-04 22:35:41] Max concurrent requests (per dp worker) from the finalized token capacity: max_num_reqs=128.
    [2026-06-04 22:35:41] KV Cache is allocated. dtype: torch.bfloat16, #tokens: 20480, K size: 1.25 GB, V size: 1.25 GB
    [2026-06-04 22:35:41] Memory pool end. avail mem=37.96 GB
    [2026-06-04 22:35:41] Disable piecewise CUDA graph because --disable-piecewise-cuda-graph is set


    [2026-06-04 22:35:45] max_total_num_tokens=20480, chunked_prefill_size=8192, max_prefill_tokens=16384, max_running_requests=128, context_len=131072, available_gpu_mem=58.16 GB
    [2026-06-04 22:35:45] Tree cache initialized: source=default impl=RadixCache hybrid_swa=False hybrid_ssm=False hierarchical=False streaming_wrapped=False


    [2026-06-04 22:35:45] INFO:     Started server process [1649923]
    [2026-06-04 22:35:45] INFO:     Waiting for application startup.
    [2026-06-04 22:35:45] Using default chat sampling params from model generation config: {'temperature': 0.6, 'top_p': 0.9}
    [2026-06-04 22:35:45] INFO:     Application startup complete.
    [2026-06-04 22:35:45] INFO:     Uvicorn running on http://127.0.0.1:39284 (Press CTRL+C to quit)


    /usr/local/lib/python3.10/dist-packages/fastapi/routing.py:120: FastAPIDeprecationWarning: ORJSONResponse is deprecated, FastAPI now serializes data directly to JSON bytes via Pydantic when a return type or response model is set, which is faster and doesn't need a custom response class. Read more in the FastAPI docs: https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model and https://fastapi.tiangolo.com/tutorial/response-model/
      response = await f(request)
    [2026-06-04 22:35:46] INFO:     127.0.0.1:36060 - "GET /v1/models HTTP/1.1" 200 OK


    [2026-06-04 22:35:46] INFO:     127.0.0.1:36064 - "GET /model_info HTTP/1.1" 200 OK


    [2026-06-04 22:35:47] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-04 22:35:47] LoRA expand (K=6144, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-04 22:35:47] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-04 22:35:47] LoRA expand (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}


    [2026-06-04 22:35:47] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-04 22:35:47] LoRA expand (K=28672, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-04 22:35:47] LoRA shrink (K=14336, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}


    [2026-06-04 22:35:48] Prefill batch, #new-seq: 1, #new-token: 7, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 2.37
    [2026-06-04 22:35:48] INFO:     127.0.0.1:36066 - "POST /generate HTTP/1.1" 200 OK
    [2026-06-04 22:35:48] The server is fired up and ready to roll!
...
```
    ...
    [2026-06-04 22:35:51] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-04 22:35:51] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-04 22:35:51] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-04 22:35:53] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-04 22:35:53] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-04 22:35:53] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-04 22:35:53] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 2, #pending-token: 18, cuda graph: False, input throughput (token/s): 1.60


    [2026-06-04 22:35:53] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 1, #pending-token: 9, cuda graph: False, input throughput (token/s): 98.03


    [2026-06-04 22:35:54] Decode batch, #running-req: 2, #token: 83, token usage: 0.00, cuda graph: False, gen throughput (token/s): 7.65, #queue-req: 1


    [2026-06-04 22:35:55] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-04 22:35:55] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 5.85


    [2026-06-04 22:35:55] Decode batch, #running-req: 2, #token: 97, token usage: 0.00, cuda graph: False, gen throughput (token/s): 72.11, #queue-req: 0


    [2026-06-04 22:35:56] Decode batch, #running-req: 2, #token: 177, token usage: 0.01, cuda graph: False, gen throughput (token/s): 94.48, #queue-req: 0


    [2026-06-04 22:35:57] Decode batch, #running-req: 1, #token: 161, token usage: 0.01, cuda graph: False, gen throughput (token/s): 70.17, #queue-req: 0


    [2026-06-04 22:35:58] Decode batch, #running-req: 1, #token: 201, token usage: 0.01, cuda graph: False, gen throughput (token/s): 49.40, #queue-req: 0


    [2026-06-04 22:35:58] Decode batch, #running-req: 1, #token: 241, token usage: 0.01, cuda graph: False, gen throughput (token/s): 51.54, #queue-req: 0


    [2026-06-04 22:35:59] Decode batch, #running-req: 1, #token: 281, token usage: 0.01, cuda graph: False, gen throughput (token/s): 56.54, #queue-req: 0


    [2026-06-04 22:36:00] Decode batch, #running-req: 1, #token: 321, token usage: 0.02, cuda graph: False, gen throughput (token/s): 55.29, #queue-req: 0


    [2026-06-04 22:36:01] Decode batch, #running-req: 1, #token: 361, token usage: 0.02, cuda graph: False, gen throughput (token/s): 50.43, #queue-req: 0


    [2026-06-04 22:36:01] Decode batch, #running-req: 1, #token: 401, token usage: 0.02, cuda graph: False, gen throughput (token/s): 47.11, #queue-req: 0


    [2026-06-04 22:36:02] Decode batch, #running-req: 1, #token: 441, token usage: 0.02, cuda graph: False, gen throughput (token/s): 47.63, #queue-req: 0


    [2026-06-04 22:36:03] Decode batch, #running-req: 1, #token: 481, token usage: 0.02, cuda graph: False, gen throughput (token/s): 47.59, #queue-req: 0


    [2026-06-04 22:36:04] Decode batch, #running-req: 1, #token: 521, token usage: 0.03, cuda graph: False, gen throughput (token/s): 48.51, #queue-req: 0


    [2026-06-04 22:36:05] Decode batch, #running-req: 1, #token: 561, token usage: 0.03, cuda graph: False, gen throughput (token/s): 52.23, #queue-req: 0


    [2026-06-04 22:36:05] Decode batch, #running-req: 1, #token: 601, token usage: 0.03, cuda graph: False, gen throughput (token/s): 55.81, #queue-req: 0


    [2026-06-04 22:36:06] Decode batch, #running-req: 1, #token: 641, token usage: 0.03, cuda graph: False, gen throughput (token/s): 42.24, #queue-req: 0


    [2026-06-04 22:36:07] Decode batch, #running-req: 1, #token: 681, token usage: 0.03, cuda graph: False, gen throughput (token/s): 45.62, #queue-req: 0


    [2026-06-04 22:36:08] Decode batch, #running-req: 1, #token: 721, token usage: 0.04, cuda graph: False, gen throughput (token/s): 48.68, #queue-req: 0


    [2026-06-04 22:36:09] Decode batch, #running-req: 1, #token: 761, token usage: 0.04, cuda graph: False, gen throughput (token/s): 44.18, #queue-req: 0


    [2026-06-04 22:36:10] Decode batch, #running-req: 1, #token: 801, token usage: 0.04, cuda graph: False, gen throughput (token/s): 33.04, #queue-req: 0


    [2026-06-04 22:36:11] Decode batch, #running-req: 1, #token: 841, token usage: 0.04, cuda graph: False, gen throughput (token/s): 34.74, #queue-req: 0


    [2026-06-04 22:36:12] Decode batch, #running-req: 1, #token: 881, token usage: 0.04, cuda graph: False, gen throughput (token/s): 34.70, #queue-req: 0


    [2026-06-04 22:36:14] Decode batch, #running-req: 1, #token: 921, token usage: 0.04, cuda graph: False, gen throughput (token/s): 37.70, #queue-req: 0


    [2026-06-04 22:36:14] Decode batch, #running-req: 1, #token: 961, token usage: 0.05, cuda graph: False, gen throughput (token/s): 43.37, #queue-req: 0


    [2026-06-04 22:36:15] Decode batch, #running-req: 1, #token: 1001, token usage: 0.05, cuda graph: False, gen throughput (token/s): 53.95, #queue-req: 0


    [2026-06-04 22:36:16] INFO:     127.0.0.1:36072 - "POST /generate HTTP/1.1" 200 OK
    Output from lora0: 
