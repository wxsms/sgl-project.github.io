...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 38.16it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 159.27it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 20893.17it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 97541.95it/s]
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 329.25it/s]
...
```
    ...
    [2026-06-03 21:59:58] Load weight end. elapsed=2.96 s, type=LlamaForCausalLM, avail mem=44.48 GB, mem usage=15.02 GB.
    [2026-06-03 21:59:58] Using csgmv as backend of LoRA kernels.
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 90200.09it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 61680.94it/s]
    [2026-06-03 21:59:58] Found local HF snapshot for Nutanix/Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json at /root/.cache/huggingface/hub/models--Nutanix--Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json/snapshots/2c398740f3eba8dc63ee78999316b833a2833b6c; skipping download.
    ...
    [2026-06-03 21:59:58] Found local HF snapshot for algoprog/fact-generation-llama-3.1-8b-instruct-lora at /root/.cache/huggingface/hub/models--algoprog--fact-generation-llama-3.1-8b-instruct-lora/snapshots/dc8cdfb21993a6cb46199d6b1d79f68a42b06439; skipping download.
    ...
    [2026-06-03 21:59:58] Found local HF snapshot for philschmid/code-llama-3-1-8b-text-to-sql-lora at /root/.cache/huggingface/hub/models--philschmid--code-llama-3-1-8b-text-to-sql-lora/snapshots/141fc3a09386a8baf0d7495c247ae2d1a565f69f; skipping download.
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 112.92it/s]


    [2026-06-03 21:59:59] Max concurrent requests (per dp worker) from the finalized token capacity: max_num_reqs=128.
    [2026-06-03 21:59:59] KV Cache is allocated. dtype: torch.bfloat16, #tokens: 20480, K size: 1.25 GB, V size: 1.25 GB
    [2026-06-03 21:59:59] Memory pool end. avail mem=37.84 GB
    [2026-06-03 21:59:59] Disable piecewise CUDA graph because --disable-piecewise-cuda-graph is set


    [2026-06-03 22:00:03] max_total_num_tokens=20480, chunked_prefill_size=8192, max_prefill_tokens=16384, max_running_requests=128, context_len=131072, available_gpu_mem=37.73 GB
    [2026-06-03 22:00:03] Tree cache initialized: source=default impl=RadixCache hybrid_swa=False hybrid_ssm=False hierarchical=False streaming_wrapped=False


    [2026-06-03 22:00:04] INFO:     Started server process [342117]
    [2026-06-03 22:00:04] INFO:     Waiting for application startup.
    [2026-06-03 22:00:04] Using default chat sampling params from model generation config: {'temperature': 0.6, 'top_p': 0.9}
    [2026-06-03 22:00:04] INFO:     Application startup complete.
    [2026-06-03 22:00:04] INFO:     Uvicorn running on http://127.0.0.1:32925 (Press CTRL+C to quit)


    /usr/local/lib/python3.10/dist-packages/fastapi/routing.py:120: FastAPIDeprecationWarning: ORJSONResponse is deprecated, FastAPI now serializes data directly to JSON bytes via Pydantic when a return type or response model is set, which is faster and doesn't need a custom response class. Read more in the FastAPI docs: https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model and https://fastapi.tiangolo.com/tutorial/response-model/
      response = await f(request)
    [2026-06-03 22:00:04] INFO:     127.0.0.1:43320 - "GET /v1/models HTTP/1.1" 200 OK


    [2026-06-03 22:00:05] INFO:     127.0.0.1:43332 - "GET /model_info HTTP/1.1" 200 OK


    [2026-06-03 22:00:06] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-03 22:00:06] LoRA expand (K=6144, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
...
```
    ...
    [2026-06-03 22:00:10] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-03 22:00:10] LoRA expand (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}


    [2026-06-03 22:00:11] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-03 22:00:11] LoRA expand (K=28672, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-03 22:00:11] LoRA shrink (K=14336, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-03 22:00:11] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].


    [2026-06-03 22:00:11] Prefill batch, #new-seq: 1, #new-token: 7, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 3, #pending-token: 0, cuda graph: False, input throughput (token/s): 0.92
    [2026-06-03 22:00:11] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 2, #pending-token: 18, cuda graph: False, input throughput (token/s): 67.11


    [2026-06-03 22:00:11] INFO:     127.0.0.1:43338 - "POST /generate HTTP/1.1" 200 OK
    [2026-06-03 22:00:11] The server is fired up and ready to roll!
    [2026-06-03 22:00:11] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-03 22:00:12] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 1, #pending-token: 9, cuda graph: False, input throughput (token/s): 10.11


    [2026-06-03 22:00:13] Decode batch, #running-req: 2, #token: 89, token usage: 0.00, cuda graph: False, gen throughput (token/s): 8.23, #queue-req: 1


    [2026-06-03 22:00:13] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-03 22:00:15] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 2.74
    [2026-06-03 22:00:15] Decode batch, #running-req: 2, #token: 103, token usage: 0.01, cuda graph: False, gen throughput (token/s): 28.93, #queue-req: 0


    [2026-06-03 22:00:16] Decode batch, #running-req: 2, #token: 183, token usage: 0.01, cuda graph: False, gen throughput (token/s): 78.69, #queue-req: 0


    [2026-06-03 22:00:17] Decode batch, #running-req: 1, #token: 169, token usage: 0.01, cuda graph: False, gen throughput (token/s): 64.22, #queue-req: 0


    [2026-06-03 22:00:18] Decode batch, #running-req: 1, #token: 209, token usage: 0.01, cuda graph: False, gen throughput (token/s): 46.36, #queue-req: 0


    [2026-06-03 22:00:19] Decode batch, #running-req: 1, #token: 249, token usage: 0.01, cuda graph: False, gen throughput (token/s): 46.60, #queue-req: 0


    [2026-06-03 22:00:20] Decode batch, #running-req: 1, #token: 289, token usage: 0.01, cuda graph: False, gen throughput (token/s): 46.86, #queue-req: 0


    [2026-06-03 22:00:21] Decode batch, #running-req: 1, #token: 329, token usage: 0.02, cuda graph: False, gen throughput (token/s): 46.95, #queue-req: 0


    [2026-06-03 22:00:21] Decode batch, #running-req: 1, #token: 369, token usage: 0.02, cuda graph: False, gen throughput (token/s): 46.90, #queue-req: 0


    [2026-06-03 22:00:22] Decode batch, #running-req: 1, #token: 409, token usage: 0.02, cuda graph: False, gen throughput (token/s): 39.44, #queue-req: 0


    [2026-06-03 22:00:23] Decode batch, #running-req: 1, #token: 449, token usage: 0.02, cuda graph: False, gen throughput (token/s): 45.20, #queue-req: 0


    [2026-06-03 22:00:24] Decode batch, #running-req: 1, #token: 489, token usage: 0.02, cuda graph: False, gen throughput (token/s): 45.25, #queue-req: 0


    [2026-06-03 22:00:25] Decode batch, #running-req: 1, #token: 529, token usage: 0.03, cuda graph: False, gen throughput (token/s): 46.58, #queue-req: 0


    [2026-06-03 22:00:26] Decode batch, #running-req: 1, #token: 569, token usage: 0.03, cuda graph: False, gen throughput (token/s): 45.74, #queue-req: 0


    [2026-06-03 22:00:27] Decode batch, #running-req: 1, #token: 609, token usage: 0.03, cuda graph: False, gen throughput (token/s): 47.11, #queue-req: 0


    [2026-06-03 22:00:28] Decode batch, #running-req: 1, #token: 649, token usage: 0.03, cuda graph: False, gen throughput (token/s): 47.16, #queue-req: 0


    [2026-06-03 22:00:29] Decode batch, #running-req: 1, #token: 689, token usage: 0.03, cuda graph: False, gen throughput (token/s): 47.06, #queue-req: 0


    [2026-06-03 22:00:29] Decode batch, #running-req: 1, #token: 729, token usage: 0.04, cuda graph: False, gen throughput (token/s): 47.07, #queue-req: 0


    [2026-06-03 22:00:30] Decode batch, #running-req: 1, #token: 769, token usage: 0.04, cuda graph: False, gen throughput (token/s): 46.81, #queue-req: 0


    [2026-06-03 22:00:31] Decode batch, #running-req: 1, #token: 809, token usage: 0.04, cuda graph: False, gen throughput (token/s): 47.43, #queue-req: 0


    [2026-06-03 22:00:32] Decode batch, #running-req: 1, #token: 849, token usage: 0.04, cuda graph: False, gen throughput (token/s): 47.29, #queue-req: 0


    [2026-06-03 22:00:33] Decode batch, #running-req: 1, #token: 889, token usage: 0.04, cuda graph: False, gen throughput (token/s): 47.07, #queue-req: 0


    [2026-06-03 22:00:34] Decode batch, #running-req: 1, #token: 929, token usage: 0.05, cuda graph: False, gen throughput (token/s): 47.38, #queue-req: 0


    [2026-06-03 22:00:34] Decode batch, #running-req: 1, #token: 969, token usage: 0.05, cuda graph: False, gen throughput (token/s): 47.48, #queue-req: 0


    [2026-06-03 22:00:35] Decode batch, #running-req: 1, #token: 1009, token usage: 0.05, cuda graph: False, gen throughput (token/s): 42.92, #queue-req: 0


    [2026-06-03 22:00:36] INFO:     127.0.0.1:56504 - "POST /generate HTTP/1.1" 200 OK
    Output from lora0: 
