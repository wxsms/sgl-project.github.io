...
```
    ...
    [2026-05-08 03:49:58] Tokenizer loaded as generic TokenizersBackend for meta-llama/Meta-Llama-3.1-8B-Instruct, retrying with use_fast=False


    [2026-05-08 03:50:01] Tokenizer for meta-llama/Meta-Llama-3.1-8B-Instruct loaded as generic TokenizersBackend. Set --trust-remote-code to load the model-specific tokenizer.


    [2026-05-08 03:50:04] Tokenizer loaded as generic TokenizersBackend for meta-llama/Meta-Llama-3.1-8B-Instruct, retrying with use_fast=False


    [2026-05-08 03:50:05] Tokenizer loaded as generic TokenizersBackend for meta-llama/Meta-Llama-3.1-8B-Instruct, retrying with use_fast=False


    [2026-05-08 03:50:08] Tokenizer for meta-llama/Meta-Llama-3.1-8B-Instruct loaded as generic TokenizersBackend. Set --trust-remote-code to load the model-specific tokenizer.


    [2026-05-08 03:50:08] Tokenizer for meta-llama/Meta-Llama-3.1-8B-Instruct loaded as generic TokenizersBackend. Set --trust-remote-code to load the model-specific tokenizer.


    [2026-05-08 03:50:09] Ignore import error when loading sglang.srt.models.afmoe: cannot import name 'fused_moe' from 'sglang.srt.layers.moe.fused_moe_triton' (/actions-runner/_work/sglang/sglang/python/sglang/srt/layers/moe/fused_moe_triton/__init__.py)
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 27.50it/s]


    [2026-05-08 03:50:20] Tokenizer loaded as generic TokenizersBackend for meta-llama/Meta-Llama-3.1-8B-Instruct, retrying with use_fast=False


    [2026-05-08 03:50:23] Tokenizer for meta-llama/Meta-Llama-3.1-8B-Instruct loaded as generic TokenizersBackend. Set --trust-remote-code to load the model-specific tokenizer.
    ...
    2026-05-08 03:50:26,342 - CUTE_DSL - WARNING - [handle_import_error] - Unexpected error during package walk: cutlass.cute.experimental
    [2026-05-08 03:50:26] Unexpected error during package walk: cutlass.cute.experimental
...
```
    ...
    [2026-05-08 03:50:43] Tokenizer loaded as generic TokenizersBackend for meta-llama/Meta-Llama-3.1-8B-Instruct, retrying with use_fast=False


    [2026-05-08 03:50:46] Tokenizer for meta-llama/Meta-Llama-3.1-8B-Instruct loaded as generic TokenizersBackend. Set --trust-remote-code to load the model-specific tokenizer.


    [2026-05-08 03:50:50] Tokenizer loaded as generic TokenizersBackend for meta-llama/Meta-Llama-3.1-8B-Instruct, retrying with use_fast=False


    [2026-05-08 03:50:50] Tokenizer loaded as generic TokenizersBackend for meta-llama/Meta-Llama-3.1-8B-Instruct, retrying with use_fast=False


    [2026-05-08 03:50:53] Tokenizer for meta-llama/Meta-Llama-3.1-8B-Instruct loaded as generic TokenizersBackend. Set --trust-remote-code to load the model-specific tokenizer.


    [2026-05-08 03:50:53] Tokenizer for meta-llama/Meta-Llama-3.1-8B-Instruct loaded as generic TokenizersBackend. Set --trust-remote-code to load the model-specific tokenizer.


    [2026-05-08 03:50:55] Ignore import error when loading sglang.srt.models.afmoe: cannot import name 'fused_moe' from 'sglang.srt.layers.moe.fused_moe_triton' (/actions-runner/_work/sglang/sglang/python/sglang/srt/layers/moe/fused_moe_triton/__init__.py)
    ...
    Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 172.37it/s]
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 268.02it/s]


    [2026-05-08 03:51:03] Tokenizer loaded as generic TokenizersBackend for meta-llama/Meta-Llama-3.1-8B-Instruct, retrying with use_fast=False


    [2026-05-08 03:51:07] Tokenizer for meta-llama/Meta-Llama-3.1-8B-Instruct loaded as generic TokenizersBackend. Set --trust-remote-code to load the model-specific tokenizer.
    ...
    2026-05-08 03:51:09,489 - CUTE_DSL - WARNING - [handle_import_error] - Unexpected error during package walk: cutlass.cute.experimental
    [2026-05-08 03:51:09] Unexpected error during package walk: cutlass.cute.experimental
...
```
    ...
    [2026-05-08 03:51:24] Tokenizer loaded as generic TokenizersBackend for meta-llama/Meta-Llama-3.1-8B-Instruct, retrying with use_fast=False
    ...
    [2026-05-08 03:51:31] Tokenizer loaded as generic TokenizersBackend for meta-llama/Meta-Llama-3.1-8B-Instruct, retrying with use_fast=False
    ...
    [2026-05-08 03:51:35] Tokenizer for meta-llama/Meta-Llama-3.1-8B-Instruct loaded as generic TokenizersBackend. Set --trust-remote-code to load the model-specific tokenizer.


    [2026-05-08 03:51:36] Ignore import error when loading sglang.srt.models.afmoe: cannot import name 'fused_moe' from 'sglang.srt.layers.moe.fused_moe_triton' (/actions-runner/_work/sglang/sglang/python/sglang/srt/layers/moe/fused_moe_triton/__init__.py)
    ...
    [2026-05-08 03:51:43] Tokenizer loaded as generic TokenizersBackend for meta-llama/Meta-Llama-3.1-8B-Instruct, retrying with use_fast=False


    [2026-05-08 03:51:47] Tokenizer for meta-llama/Meta-Llama-3.1-8B-Instruct loaded as generic TokenizersBackend. Set --trust-remote-code to load the model-specific tokenizer.
    ...
    2026-05-08 03:51:49,771 - CUTE_DSL - WARNING - [handle_import_error] - Unexpected error during package walk: cutlass.cute.experimental
    [2026-05-08 03:51:49] Unexpected error during package walk: cutlass.cute.experimental
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 326.25it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 174.88it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 113.14it/s]
...
```
    ...
    [2026-05-08 03:52:08] Tokenizer loaded as generic TokenizersBackend for meta-llama/Meta-Llama-3.1-8B-Instruct, retrying with use_fast=False


    [2026-05-08 03:52:12] Tokenizer for meta-llama/Meta-Llama-3.1-8B-Instruct loaded as generic TokenizersBackend. Set --trust-remote-code to load the model-specific tokenizer.


    [2026-05-08 03:52:15] Tokenizer loaded as generic TokenizersBackend for meta-llama/Meta-Llama-3.1-8B-Instruct, retrying with use_fast=False


    [2026-05-08 03:52:16] Tokenizer loaded as generic TokenizersBackend for meta-llama/Meta-Llama-3.1-8B-Instruct, retrying with use_fast=False


    [2026-05-08 03:52:19] Tokenizer for meta-llama/Meta-Llama-3.1-8B-Instruct loaded as generic TokenizersBackend. Set --trust-remote-code to load the model-specific tokenizer.
    [2026-05-08 03:52:19] Tokenizer for meta-llama/Meta-Llama-3.1-8B-Instruct loaded as generic TokenizersBackend. Set --trust-remote-code to load the model-specific tokenizer.


    [2026-05-08 03:52:20] Ignore import error when loading sglang.srt.models.afmoe: cannot import name 'fused_moe' from 'sglang.srt.layers.moe.fused_moe_triton' (/actions-runner/_work/sglang/sglang/python/sglang/srt/layers/moe/fused_moe_triton/__init__.py)
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 323.51it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 74235.47it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 15462.87it/s]
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 169.71it/s]
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 114.14it/s]


    [2026-05-08 03:52:30] Tokenizer loaded as generic TokenizersBackend for meta-llama/Meta-Llama-3.1-8B-Instruct, retrying with use_fast=False


    [2026-05-08 03:52:33] Tokenizer for meta-llama/Meta-Llama-3.1-8B-Instruct loaded as generic TokenizersBackend. Set --trust-remote-code to load the model-specific tokenizer.
    ...
    2026-05-08 03:52:35,998 - CUTE_DSL - WARNING - [handle_import_error] - Unexpected error during package walk: cutlass.cute.experimental
    [2026-05-08 03:52:35] Unexpected error during package walk: cutlass.cute.experimental
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 120.32it/s]
...
```
    ...
    [2026-05-08 03:53:07] Load weight end. elapsed=3.04 s, type=LlamaForCausalLM, avail mem=44.06 GB, mem usage=15.03 GB.
    [2026-05-08 03:53:07] Using csgmv as backend of LoRA kernels.
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 10987.04it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 81049.35it/s]
    [2026-05-08 03:53:08] Found local HF snapshot for Nutanix/Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json at /root/.cache/huggingface/hub/models--Nutanix--Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json/snapshots/2c398740f3eba8dc63ee78999316b833a2833b6c; skipping download.
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 311.27it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 83886.08it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 20044.46it/s]
    [2026-05-08 03:53:08] Found local HF snapshot for algoprog/fact-generation-llama-3.1-8b-instruct-lora at /root/.cache/huggingface/hub/models--algoprog--fact-generation-llama-3.1-8b-instruct-lora/snapshots/dc8cdfb21993a6cb46199d6b1d79f68a42b06439; skipping download.


    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 169.24it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 19901.80it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 67378.38it/s]
    [2026-05-08 03:53:09] Found local HF snapshot for philschmid/code-llama-3-1-8b-text-to-sql-lora at /root/.cache/huggingface/hub/models--philschmid--code-llama-3-1-8b-text-to-sql-lora/snapshots/141fc3a09386a8baf0d7495c247ae2d1a565f69f; skipping download.


    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 118.35it/s]


    [2026-05-08 03:53:12] Using KV cache dtype: torch.bfloat16
    [2026-05-08 03:53:12] KV Cache is allocated. #tokens: 20480, K size: 1.25 GB, V size: 1.25 GB
    [2026-05-08 03:53:12] Memory pool end. avail mem=38.64 GB
    [2026-05-08 03:53:12] Disable piecewise CUDA graph because --disable-piecewise-cuda-graph is set


    [2026-05-08 03:53:14] Tokenizer loaded as generic TokenizersBackend for meta-llama/Meta-Llama-3.1-8B-Instruct, retrying with use_fast=False


    [2026-05-08 03:53:15] Loading tokenizer for meta-llama/Meta-Llama-3.1-8B-Instruct directly as PreTrainedTokenizerFast (bypassing AutoTokenizer)


    [2026-05-08 03:53:17] Tokenizer for meta-llama/Meta-Llama-3.1-8B-Instruct loaded as generic TokenizersBackend. Set --trust-remote-code to load the model-specific tokenizer.


    [2026-05-08 03:53:17] max_total_num_tokens=20480, chunked_prefill_size=8192, max_prefill_tokens=16384, max_running_requests=128, context_len=131072, available_gpu_mem=29.60 GB


    [2026-05-08 03:53:18] INFO:     Started server process [1579743]
    [2026-05-08 03:53:18] INFO:     Waiting for application startup.
    [2026-05-08 03:53:18] Using default chat sampling params from model generation config: {'temperature': 0.6, 'top_p': 0.9}
    [2026-05-08 03:53:18] INFO:     Application startup complete.
    [2026-05-08 03:53:18] INFO:     Uvicorn running on http://127.0.0.1:31524 (Press CTRL+C to quit)


    /usr/local/lib/python3.10/dist-packages/fastapi/routing.py:120: FastAPIDeprecationWarning: ORJSONResponse is deprecated, FastAPI now serializes data directly to JSON bytes via Pydantic when a return type or response model is set, which is faster and doesn't need a custom response class. Read more in the FastAPI docs: https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model and https://fastapi.tiangolo.com/tutorial/response-model/
      response = await f(request)
    [2026-05-08 03:53:18] INFO:     127.0.0.1:43598 - "GET /v1/models HTTP/1.1" 200 OK


    [2026-05-08 03:53:19] INFO:     127.0.0.1:43610 - "GET /model_info HTTP/1.1" 200 OK


    2026-05-08 03:53:22,353 - CUTE_DSL - WARNING - [handle_import_error] - Unexpected error during package walk: cutlass.cute.experimental
    [2026-05-08 03:53:22] Unexpected error during package walk: cutlass.cute.experimental


    [2026-05-08 03:53:22] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-05-08 03:53:22] LoRA expand (K=6144, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-05-08 03:53:22] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-05-08 03:53:22] LoRA expand (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}


    [2026-05-08 03:53:22] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-05-08 03:53:22] LoRA expand (K=28672, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-05-08 03:53:22] LoRA shrink (K=14336, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
...
```
    ...
    [2026-05-08 03:53:26] Prefill batch, #new-seq: 1, #new-token: 7, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 0.23
    [2026-05-08 03:53:26] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-05-08 03:53:26] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 2, #pending-token: 18, cuda graph: False, input throughput (token/s): 99.23
    [2026-05-08 03:53:26] INFO:     127.0.0.1:43614 - "POST /generate HTTP/1.1" 200 OK
    [2026-05-08 03:53:26] The server is fired up and ready to roll!


    [2026-05-08 03:53:26] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-05-08 03:53:27] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 1, #pending-token: 9, cuda graph: False, input throughput (token/s): 25.48


    [2026-05-08 03:53:27] Decode batch, #running-req: 2, #token: 88, token usage: 0.00, cuda graph: False, gen throughput (token/s): 2.44, #queue-req: 1


    [2026-05-08 03:53:28] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-05-08 03:53:28] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 5.89
    [2026-05-08 03:53:28] Decode batch, #running-req: 2, #token: 102, token usage: 0.00, cuda graph: False, gen throughput (token/s): 77.29, #queue-req: 0


    [2026-05-08 03:53:29] Decode batch, #running-req: 2, #token: 182, token usage: 0.01, cuda graph: False, gen throughput (token/s): 107.69, #queue-req: 0


    [2026-05-08 03:53:30] Decode batch, #running-req: 1, #token: 168, token usage: 0.01, cuda graph: False, gen throughput (token/s): 81.61, #queue-req: 0


    [2026-05-08 03:53:31] Decode batch, #running-req: 1, #token: 208, token usage: 0.01, cuda graph: False, gen throughput (token/s): 53.42, #queue-req: 0


    [2026-05-08 03:53:31] Decode batch, #running-req: 1, #token: 248, token usage: 0.01, cuda graph: False, gen throughput (token/s): 49.15, #queue-req: 0


    [2026-05-08 03:53:32] Decode batch, #running-req: 1, #token: 288, token usage: 0.01, cuda graph: False, gen throughput (token/s): 50.81, #queue-req: 0


    [2026-05-08 03:53:33] Decode batch, #running-req: 1, #token: 328, token usage: 0.02, cuda graph: False, gen throughput (token/s): 54.72, #queue-req: 0


    [2026-05-08 03:53:34] Decode batch, #running-req: 1, #token: 368, token usage: 0.02, cuda graph: False, gen throughput (token/s): 56.14, #queue-req: 0


    [2026-05-08 03:53:34] Decode batch, #running-req: 1, #token: 408, token usage: 0.02, cuda graph: False, gen throughput (token/s): 55.61, #queue-req: 0


    [2026-05-08 03:53:35] Decode batch, #running-req: 1, #token: 448, token usage: 0.02, cuda graph: False, gen throughput (token/s): 56.39, #queue-req: 0


    [2026-05-08 03:53:36] Decode batch, #running-req: 1, #token: 488, token usage: 0.02, cuda graph: False, gen throughput (token/s): 55.68, #queue-req: 0


    [2026-05-08 03:53:36] Decode batch, #running-req: 1, #token: 528, token usage: 0.03, cuda graph: False, gen throughput (token/s): 58.01, #queue-req: 0


    [2026-05-08 03:53:37] Decode batch, #running-req: 1, #token: 568, token usage: 0.03, cuda graph: False, gen throughput (token/s): 57.28, #queue-req: 0


    [2026-05-08 03:53:38] Decode batch, #running-req: 1, #token: 608, token usage: 0.03, cuda graph: False, gen throughput (token/s): 55.08, #queue-req: 0


    [2026-05-08 03:53:39] Decode batch, #running-req: 1, #token: 648, token usage: 0.03, cuda graph: False, gen throughput (token/s): 53.86, #queue-req: 0


    [2026-05-08 03:53:39] Decode batch, #running-req: 1, #token: 688, token usage: 0.03, cuda graph: False, gen throughput (token/s): 56.17, #queue-req: 0


    [2026-05-08 03:53:40] Decode batch, #running-req: 1, #token: 728, token usage: 0.04, cuda graph: False, gen throughput (token/s): 56.55, #queue-req: 0


    [2026-05-08 03:53:41] Decode batch, #running-req: 1, #token: 768, token usage: 0.04, cuda graph: False, gen throughput (token/s): 57.36, #queue-req: 0


    [2026-05-08 03:53:41] Decode batch, #running-req: 1, #token: 808, token usage: 0.04, cuda graph: False, gen throughput (token/s): 56.94, #queue-req: 0


    [2026-05-08 03:53:42] Decode batch, #running-req: 1, #token: 848, token usage: 0.04, cuda graph: False, gen throughput (token/s): 56.76, #queue-req: 0


    [2026-05-08 03:53:43] Decode batch, #running-req: 1, #token: 888, token usage: 0.04, cuda graph: False, gen throughput (token/s): 57.18, #queue-req: 0


    [2026-05-08 03:53:43] Decode batch, #running-req: 1, #token: 928, token usage: 0.05, cuda graph: False, gen throughput (token/s): 56.27, #queue-req: 0


    [2026-05-08 03:53:44] Decode batch, #running-req: 1, #token: 968, token usage: 0.05, cuda graph: False, gen throughput (token/s): 51.54, #queue-req: 0


    [2026-05-08 03:53:45] Decode batch, #running-req: 1, #token: 1008, token usage: 0.05, cuda graph: False, gen throughput (token/s): 56.64, #queue-req: 0


    [2026-05-08 03:53:45] INFO:     127.0.0.1:55262 - "POST /generate HTTP/1.1" 200 OK
    Output from lora0: 
