...
```
    ...
    [2026-05-13 06:33:02] Tokenizer loaded as generic TokenizersBackend for meta-llama/Meta-Llama-3.1-8B-Instruct, retrying with use_fast=False
    ...
    [2026-05-13 06:33:18] Tokenizer loaded as generic TokenizersBackend for meta-llama/Meta-Llama-3.1-8B-Instruct, retrying with use_fast=False


    [2026-05-13 06:33:21] Tokenizer for meta-llama/Meta-Llama-3.1-8B-Instruct loaded as generic TokenizersBackend. Set --trust-remote-code to load the model-specific tokenizer.
...
```
    ...
    2026-05-13 06:33:27,550 - CUTE_DSL - WARNING - [handle_import_error] - Unexpected error during package walk: cutlass.cute.experimental
    [2026-05-13 06:33:27] Unexpected error during package walk: cutlass.cute.experimental
...
```
    ...
    [2026-05-13 06:33:42] Tokenizer loaded as generic TokenizersBackend for meta-llama/Meta-Llama-3.1-8B-Instruct, retrying with use_fast=False


    [2026-05-13 06:33:44] Tokenizer for meta-llama/Meta-Llama-3.1-8B-Instruct loaded as generic TokenizersBackend. Set --trust-remote-code to load the model-specific tokenizer.


    [2026-05-13 06:33:48] Tokenizer loaded as generic TokenizersBackend for meta-llama/Meta-Llama-3.1-8B-Instruct, retrying with use_fast=False


    [2026-05-13 06:33:48] Tokenizer loaded as generic TokenizersBackend for meta-llama/Meta-Llama-3.1-8B-Instruct, retrying with use_fast=False


    [2026-05-13 06:33:50] Tokenizer for meta-llama/Meta-Llama-3.1-8B-Instruct loaded as generic TokenizersBackend. Set --trust-remote-code to load the model-specific tokenizer.
    ...
    [2026-05-13 06:34:00] Tokenizer loaded as generic TokenizersBackend for meta-llama/Meta-Llama-3.1-8B-Instruct, retrying with use_fast=False


    [2026-05-13 06:34:02] Tokenizer for meta-llama/Meta-Llama-3.1-8B-Instruct loaded as generic TokenizersBackend. Set --trust-remote-code to load the model-specific tokenizer.
    ...
    2026-05-13 06:34:05,516 - CUTE_DSL - WARNING - [handle_import_error] - Unexpected error during package walk: cutlass.cute.experimental
    [2026-05-13 06:34:05] Unexpected error during package walk: cutlass.cute.experimental
...
```
    ...
    [2026-05-13 06:34:18] Tokenizer loaded as generic TokenizersBackend for meta-llama/Meta-Llama-3.1-8B-Instruct, retrying with use_fast=False


    [2026-05-13 06:34:21] Tokenizer for meta-llama/Meta-Llama-3.1-8B-Instruct loaded as generic TokenizersBackend. Set --trust-remote-code to load the model-specific tokenizer.


    [2026-05-13 06:34:24] Tokenizer loaded as generic TokenizersBackend for meta-llama/Meta-Llama-3.1-8B-Instruct, retrying with use_fast=False
    [2026-05-13 06:34:24] Tokenizer loaded as generic TokenizersBackend for meta-llama/Meta-Llama-3.1-8B-Instruct, retrying with use_fast=False


    [2026-05-13 06:34:27] Tokenizer for meta-llama/Meta-Llama-3.1-8B-Instruct loaded as generic TokenizersBackend. Set --trust-remote-code to load the model-specific tokenizer.
    [2026-05-13 06:34:27] Tokenizer for meta-llama/Meta-Llama-3.1-8B-Instruct loaded as generic TokenizersBackend. Set --trust-remote-code to load the model-specific tokenizer.
    ...
    [2026-05-13 06:34:35] Tokenizer loaded as generic TokenizersBackend for meta-llama/Meta-Llama-3.1-8B-Instruct, retrying with use_fast=False


    [2026-05-13 06:34:37] Tokenizer for meta-llama/Meta-Llama-3.1-8B-Instruct loaded as generic TokenizersBackend. Set --trust-remote-code to load the model-specific tokenizer.
    ...
    2026-05-13 06:34:40,395 - CUTE_DSL - WARNING - [handle_import_error] - Unexpected error during package walk: cutlass.cute.experimental
    [2026-05-13 06:34:40] Unexpected error during package walk: cutlass.cute.experimental
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 283.67it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 115.23it/s]
...
```
    ...
    [2026-05-13 06:34:56] Tokenizer loaded as generic TokenizersBackend for meta-llama/Meta-Llama-3.1-8B-Instruct, retrying with use_fast=False


    [2026-05-13 06:34:59] Tokenizer for meta-llama/Meta-Llama-3.1-8B-Instruct loaded as generic TokenizersBackend. Set --trust-remote-code to load the model-specific tokenizer.


    [2026-05-13 06:35:02] Tokenizer loaded as generic TokenizersBackend for meta-llama/Meta-Llama-3.1-8B-Instruct, retrying with use_fast=False
    [2026-05-13 06:35:02] Tokenizer loaded as generic TokenizersBackend for meta-llama/Meta-Llama-3.1-8B-Instruct, retrying with use_fast=False


    [2026-05-13 06:35:05] Tokenizer for meta-llama/Meta-Llama-3.1-8B-Instruct loaded as generic TokenizersBackend. Set --trust-remote-code to load the model-specific tokenizer.
    ...
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 3682.44it/s]
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 150.07it/s]
    ...
    [2026-05-13 06:35:15] Tokenizer loaded as generic TokenizersBackend for meta-llama/Meta-Llama-3.1-8B-Instruct, retrying with use_fast=False


    [2026-05-13 06:35:17] Tokenizer for meta-llama/Meta-Llama-3.1-8B-Instruct loaded as generic TokenizersBackend. Set --trust-remote-code to load the model-specific tokenizer.
    ...
    2026-05-13 06:35:20,218 - CUTE_DSL - WARNING - [handle_import_error] - Unexpected error during package walk: cutlass.cute.experimental
    [2026-05-13 06:35:20] Unexpected error during package walk: cutlass.cute.experimental
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 157.02it/s]
...
```
    ...
    [2026-05-13 06:35:50] Load weight end. elapsed=2.66 s, type=LlamaForCausalLM, avail mem=45.13 GB, mem usage=15.02 GB.
    [2026-05-13 06:35:50] Using csgmv as backend of LoRA kernels.
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 17439.93it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 96420.78it/s]
    [2026-05-13 06:35:50] Found local HF snapshot for Nutanix/Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json at /root/.cache/huggingface/hub/models--Nutanix--Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json/snapshots/2c398740f3eba8dc63ee78999316b833a2833b6c; skipping download.
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 368.73it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 11658.94it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 11765.23it/s]
    [2026-05-13 06:35:50] Found local HF snapshot for algoprog/fact-generation-llama-3.1-8b-instruct-lora at /root/.cache/huggingface/hub/models--algoprog--fact-generation-llama-3.1-8b-instruct-lora/snapshots/dc8cdfb21993a6cb46199d6b1d79f68a42b06439; skipping download.
    ...
    [2026-05-13 06:35:51] Found local HF snapshot for philschmid/code-llama-3-1-8b-text-to-sql-lora at /root/.cache/huggingface/hub/models--philschmid--code-llama-3-1-8b-text-to-sql-lora/snapshots/141fc3a09386a8baf0d7495c247ae2d1a565f69f; skipping download.
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 114.66it/s]


    [2026-05-13 06:35:54] Using KV cache dtype: torch.bfloat16
    [2026-05-13 06:35:54] KV Cache is allocated. #tokens: 20480, K size: 1.25 GB, V size: 1.25 GB
    [2026-05-13 06:35:54] Memory pool end. avail mem=39.22 GB
    [2026-05-13 06:35:54] Disable piecewise CUDA graph because --disable-piecewise-cuda-graph is set


    [2026-05-13 06:35:55] Tokenizer loaded as generic TokenizersBackend for meta-llama/Meta-Llama-3.1-8B-Instruct, retrying with use_fast=False


    [2026-05-13 06:35:56] Loading tokenizer for meta-llama/Meta-Llama-3.1-8B-Instruct directly as PreTrainedTokenizerFast (bypassing AutoTokenizer)


    [2026-05-13 06:35:58] Tokenizer for meta-llama/Meta-Llama-3.1-8B-Instruct loaded as generic TokenizersBackend. Set --trust-remote-code to load the model-specific tokenizer.


    [2026-05-13 06:35:58] max_total_num_tokens=20480, chunked_prefill_size=8192, max_prefill_tokens=16384, max_running_requests=128, context_len=131072, available_gpu_mem=23.51 GB


    [2026-05-13 06:35:58] INFO:     Started server process [1032799]
    [2026-05-13 06:35:58] INFO:     Waiting for application startup.
    [2026-05-13 06:35:58] Using default chat sampling params from model generation config: {'temperature': 0.6, 'top_p': 0.9}
    [2026-05-13 06:35:58] INFO:     Application startup complete.
    [2026-05-13 06:35:58] INFO:     Uvicorn running on http://127.0.0.1:33219 (Press CTRL+C to quit)


    /usr/local/lib/python3.10/dist-packages/fastapi/routing.py:120: FastAPIDeprecationWarning: ORJSONResponse is deprecated, FastAPI now serializes data directly to JSON bytes via Pydantic when a return type or response model is set, which is faster and doesn't need a custom response class. Read more in the FastAPI docs: https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model and https://fastapi.tiangolo.com/tutorial/response-model/
      response = await f(request)
    [2026-05-13 06:35:59] INFO:     127.0.0.1:52180 - "GET /v1/models HTTP/1.1" 200 OK


    [2026-05-13 06:35:59] INFO:     127.0.0.1:52194 - "GET /model_info HTTP/1.1" 200 OK


    2026-05-13 06:36:03,650 - CUTE_DSL - WARNING - [handle_import_error] - Unexpected error during package walk: cutlass.cute.experimental
    [2026-05-13 06:36:03] Unexpected error during package walk: cutlass.cute.experimental


    [2026-05-13 06:36:03] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-05-13 06:36:03] LoRA expand (K=6144, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-05-13 06:36:04] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-05-13 06:36:04] LoRA expand (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
...
```
    ...
    [2026-05-13 06:36:04] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-05-13 06:36:04] LoRA expand (K=28672, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-05-13 06:36:04] LoRA shrink (K=14336, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-05-13 06:36:04] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].


    [2026-05-13 06:36:07] Prefill batch, #new-seq: 1, #new-token: 7, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 3, #pending-token: 0, cuda graph: False, input throughput (token/s): 0.26
    [2026-05-13 06:36:07] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 2, #pending-token: 18, cuda graph: False, input throughput (token/s): 125.72


    [2026-05-13 06:36:07] INFO:     127.0.0.1:52198 - "POST /generate HTTP/1.1" 200 OK
    [2026-05-13 06:36:07] The server is fired up and ready to roll!
    [2026-05-13 06:36:07] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-05-13 06:36:08] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 1, #pending-token: 9, cuda graph: False, input throughput (token/s): 8.28


    [2026-05-13 06:36:09] Decode batch, #running-req: 2, #token: 89, token usage: 0.00, cuda graph: False, gen throughput (token/s): 2.65, #queue-req: 1


    [2026-05-13 06:36:10] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-05-13 06:36:11] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 3.81
    [2026-05-13 06:36:11] Decode batch, #running-req: 2, #token: 103, token usage: 0.01, cuda graph: False, gen throughput (token/s): 45.58, #queue-req: 0


    [2026-05-13 06:36:12] Decode batch, #running-req: 2, #token: 183, token usage: 0.01, cuda graph: False, gen throughput (token/s): 53.62, #queue-req: 0


    [2026-05-13 06:36:14] Decode batch, #running-req: 1, #token: 169, token usage: 0.01, cuda graph: False, gen throughput (token/s): 43.31, #queue-req: 0


    [2026-05-13 06:36:15] Decode batch, #running-req: 1, #token: 209, token usage: 0.01, cuda graph: False, gen throughput (token/s): 33.56, #queue-req: 0


    [2026-05-13 06:36:16] Decode batch, #running-req: 1, #token: 249, token usage: 0.01, cuda graph: False, gen throughput (token/s): 34.15, #queue-req: 0


    [2026-05-13 06:36:17] Decode batch, #running-req: 1, #token: 289, token usage: 0.01, cuda graph: False, gen throughput (token/s): 34.03, #queue-req: 0


    [2026-05-13 06:36:18] Decode batch, #running-req: 1, #token: 329, token usage: 0.02, cuda graph: False, gen throughput (token/s): 35.63, #queue-req: 0


    [2026-05-13 06:36:19] Decode batch, #running-req: 1, #token: 369, token usage: 0.02, cuda graph: False, gen throughput (token/s): 39.19, #queue-req: 0


    [2026-05-13 06:36:20] Decode batch, #running-req: 1, #token: 409, token usage: 0.02, cuda graph: False, gen throughput (token/s): 38.38, #queue-req: 0


    [2026-05-13 06:36:21] Decode batch, #running-req: 1, #token: 449, token usage: 0.02, cuda graph: False, gen throughput (token/s): 40.74, #queue-req: 0


    [2026-05-13 06:36:22] Decode batch, #running-req: 1, #token: 489, token usage: 0.02, cuda graph: False, gen throughput (token/s): 41.72, #queue-req: 0


    [2026-05-13 06:36:23] Decode batch, #running-req: 1, #token: 529, token usage: 0.03, cuda graph: False, gen throughput (token/s): 42.30, #queue-req: 0


    [2026-05-13 06:36:24] Decode batch, #running-req: 1, #token: 569, token usage: 0.03, cuda graph: False, gen throughput (token/s): 43.56, #queue-req: 0


    [2026-05-13 06:36:25] Decode batch, #running-req: 1, #token: 609, token usage: 0.03, cuda graph: False, gen throughput (token/s): 43.62, #queue-req: 0


    [2026-05-13 06:36:26] Decode batch, #running-req: 1, #token: 649, token usage: 0.03, cuda graph: False, gen throughput (token/s): 43.83, #queue-req: 0


    [2026-05-13 06:36:27] Decode batch, #running-req: 1, #token: 689, token usage: 0.03, cuda graph: False, gen throughput (token/s): 43.38, #queue-req: 0


    [2026-05-13 06:36:28] Decode batch, #running-req: 1, #token: 729, token usage: 0.04, cuda graph: False, gen throughput (token/s): 44.79, #queue-req: 0


    [2026-05-13 06:36:29] Decode batch, #running-req: 1, #token: 769, token usage: 0.04, cuda graph: False, gen throughput (token/s): 46.94, #queue-req: 0


    [2026-05-13 06:36:30] Decode batch, #running-req: 1, #token: 809, token usage: 0.04, cuda graph: False, gen throughput (token/s): 38.77, #queue-req: 0


    [2026-05-13 06:36:31] Decode batch, #running-req: 1, #token: 849, token usage: 0.04, cuda graph: False, gen throughput (token/s): 31.41, #queue-req: 0


    [2026-05-13 06:36:32] Decode batch, #running-req: 1, #token: 889, token usage: 0.04, cuda graph: False, gen throughput (token/s): 31.92, #queue-req: 0


    [2026-05-13 06:36:33] Decode batch, #running-req: 1, #token: 929, token usage: 0.05, cuda graph: False, gen throughput (token/s): 47.41, #queue-req: 0


    [2026-05-13 06:36:34] Decode batch, #running-req: 1, #token: 969, token usage: 0.05, cuda graph: False, gen throughput (token/s): 47.17, #queue-req: 0


    [2026-05-13 06:36:35] Decode batch, #running-req: 1, #token: 1009, token usage: 0.05, cuda graph: False, gen throughput (token/s): 47.02, #queue-req: 0


    [2026-05-13 06:36:35] INFO:     127.0.0.1:52212 - "POST /generate HTTP/1.1" 200 OK
    Output from lora0: 
