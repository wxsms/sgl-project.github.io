...
```
    ...
    Multi-thread loading shards:  75% Completed | 3/4 [00:06<00:01,  2.00s/it]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 362.99it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 201.99it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 277.51it/s]
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 123.80it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 190.61it/s]
...
```
    ...
    [2026-06-05 17:04:29] Load weight end. elapsed=2.94 s, type=LlamaForCausalLM, avail mem=43.84 GB, mem usage=15.02 GB.
    [2026-06-05 17:04:29] Using csgmv as backend of LoRA kernels.
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 21704.03it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 16561.91it/s]
    [2026-06-05 17:04:29] Found local HF snapshot for Nutanix/Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json at /root/.cache/huggingface/hub/models--Nutanix--Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json/snapshots/2c398740f3eba8dc63ee78999316b833a2833b6c; skipping download.
    ...
    [2026-06-05 17:04:30] Found local HF snapshot for algoprog/fact-generation-llama-3.1-8b-instruct-lora at /root/.cache/huggingface/hub/models--algoprog--fact-generation-llama-3.1-8b-instruct-lora/snapshots/dc8cdfb21993a6cb46199d6b1d79f68a42b06439; skipping download.


    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 177.41it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 21620.12it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 78398.21it/s]
    [2026-06-05 17:04:30] Found local HF snapshot for philschmid/code-llama-3-1-8b-text-to-sql-lora at /root/.cache/huggingface/hub/models--philschmid--code-llama-3-1-8b-text-to-sql-lora/snapshots/141fc3a09386a8baf0d7495c247ae2d1a565f69f; skipping download.


    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 129.55it/s]


    [2026-06-05 17:04:31] Max concurrent requests (per dp worker) from the finalized token capacity: max_num_reqs=128.
    [2026-06-05 17:04:31] KV Cache is allocated. dtype: torch.bfloat16, #tokens: 20480, K size: 1.25 GB, V size: 1.25 GB
    [2026-06-05 17:04:31] Memory pool end. avail mem=38.61 GB
    [2026-06-05 17:04:31] Disable piecewise CUDA graph because --disable-piecewise-cuda-graph is set


    [2026-06-05 17:04:36] max_total_num_tokens=20480, chunked_prefill_size=8192, max_prefill_tokens=16384, max_running_requests=128, context_len=131072, available_gpu_mem=57.49 GB
    [2026-06-05 17:04:36] Tree cache initialized: source=default impl=RadixCache hybrid_swa=False hybrid_ssm=False hierarchical=False streaming_wrapped=False


    [2026-06-05 17:04:37] INFO:     Started server process [1722103]
    [2026-06-05 17:04:37] INFO:     Waiting for application startup.
    [2026-06-05 17:04:37] Using default chat sampling params from model generation config: {'temperature': 0.6, 'top_p': 0.9}
    [2026-06-05 17:04:37] INFO:     Application startup complete.
    [2026-06-05 17:04:37] INFO:     Uvicorn running on http://127.0.0.1:30842 (Press CTRL+C to quit)
    /usr/local/lib/python3.10/dist-packages/fastapi/routing.py:120: FastAPIDeprecationWarning: ORJSONResponse is deprecated, FastAPI now serializes data directly to JSON bytes via Pydantic when a return type or response model is set, which is faster and doesn't need a custom response class. Read more in the FastAPI docs: https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model and https://fastapi.tiangolo.com/tutorial/response-model/
      response = await f(request)
    [2026-06-05 17:04:37] INFO:     127.0.0.1:37108 - "GET /v1/models HTTP/1.1" 200 OK


    [2026-06-05 17:04:38] INFO:     127.0.0.1:37114 - "GET /model_info HTTP/1.1" 200 OK


    [2026-06-05 17:04:39] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-05 17:04:39] LoRA expand (K=6144, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-05 17:04:39] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-05 17:04:39] LoRA expand (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}


    [2026-06-05 17:04:39] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-05 17:04:39] LoRA expand (K=28672, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-05 17:04:39] LoRA shrink (K=14336, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}


    [2026-06-05 17:04:39] Prefill batch, #new-seq: 1, #new-token: 7, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 2.21
    [2026-06-05 17:04:40] INFO:     127.0.0.1:37128 - "POST /generate HTTP/1.1" 200 OK
    [2026-06-05 17:04:40] The server is fired up and ready to roll!
...
```
    ...
    [2026-06-05 17:04:42] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-05 17:04:42] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-05 17:04:42] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-05 17:04:42] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-05 17:04:42] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-05 17:04:45] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-05 17:04:45] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-05 17:04:45] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-05 17:04:45] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-05 17:04:45] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-05 17:04:45] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 2, #pending-token: 18, cuda graph: False, input throughput (token/s): 1.63
    [2026-06-05 17:04:45] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-05 17:04:45] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-05 17:04:45] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-05 17:04:45] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-05 17:04:45] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-05 17:04:45] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 1, #pending-token: 9, cuda graph: False, input throughput (token/s): 38.12


    [2026-06-05 17:04:46] Decode batch, #running-req: 2, #token: 80, token usage: 0.00, cuda graph: False, gen throughput (token/s): 7.16, #queue-req: 1


    [2026-06-05 17:04:47] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-05 17:04:47] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 4.19


    [2026-06-05 17:04:48] Decode batch, #running-req: 2, #token: 94, token usage: 0.00, cuda graph: False, gen throughput (token/s): 45.10, #queue-req: 0


    [2026-06-05 17:04:48] Decode batch, #running-req: 2, #token: 174, token usage: 0.01, cuda graph: False, gen throughput (token/s): 98.13, #queue-req: 0


    [2026-06-05 17:04:49] Decode batch, #running-req: 1, #token: 158, token usage: 0.01, cuda graph: False, gen throughput (token/s): 75.44, #queue-req: 0


    [2026-06-05 17:04:50] Decode batch, #running-req: 1, #token: 198, token usage: 0.01, cuda graph: False, gen throughput (token/s): 53.29, #queue-req: 0


    [2026-06-05 17:04:51] Decode batch, #running-req: 1, #token: 238, token usage: 0.01, cuda graph: False, gen throughput (token/s): 55.14, #queue-req: 0


    [2026-06-05 17:04:51] Decode batch, #running-req: 1, #token: 278, token usage: 0.01, cuda graph: False, gen throughput (token/s): 56.30, #queue-req: 0


    [2026-06-05 17:04:52] Decode batch, #running-req: 1, #token: 318, token usage: 0.02, cuda graph: False, gen throughput (token/s): 54.75, #queue-req: 0


    [2026-06-05 17:04:53] Decode batch, #running-req: 1, #token: 358, token usage: 0.02, cuda graph: False, gen throughput (token/s): 53.05, #queue-req: 0


    [2026-06-05 17:04:53] Decode batch, #running-req: 1, #token: 398, token usage: 0.02, cuda graph: False, gen throughput (token/s): 56.22, #queue-req: 0


    [2026-06-05 17:04:54] Decode batch, #running-req: 1, #token: 438, token usage: 0.02, cuda graph: False, gen throughput (token/s): 54.75, #queue-req: 0


    [2026-06-05 17:04:55] Decode batch, #running-req: 1, #token: 478, token usage: 0.02, cuda graph: False, gen throughput (token/s): 53.69, #queue-req: 0


    [2026-06-05 17:04:56] Decode batch, #running-req: 1, #token: 518, token usage: 0.03, cuda graph: False, gen throughput (token/s): 54.39, #queue-req: 0


    [2026-06-05 17:04:56] Decode batch, #running-req: 1, #token: 558, token usage: 0.03, cuda graph: False, gen throughput (token/s): 56.07, #queue-req: 0


    [2026-06-05 17:04:57] Decode batch, #running-req: 1, #token: 598, token usage: 0.03, cuda graph: False, gen throughput (token/s): 47.58, #queue-req: 0


    [2026-06-05 17:04:58] Decode batch, #running-req: 1, #token: 638, token usage: 0.03, cuda graph: False, gen throughput (token/s): 46.05, #queue-req: 0


    [2026-06-05 17:04:59] Decode batch, #running-req: 1, #token: 678, token usage: 0.03, cuda graph: False, gen throughput (token/s): 44.28, #queue-req: 0


    [2026-06-05 17:05:00] Decode batch, #running-req: 1, #token: 718, token usage: 0.04, cuda graph: False, gen throughput (token/s): 52.45, #queue-req: 0


    [2026-06-05 17:05:01] Decode batch, #running-req: 1, #token: 758, token usage: 0.04, cuda graph: False, gen throughput (token/s): 52.71, #queue-req: 0


    [2026-06-05 17:05:01] Decode batch, #running-req: 1, #token: 798, token usage: 0.04, cuda graph: False, gen throughput (token/s): 56.10, #queue-req: 0


    [2026-06-05 17:05:02] Decode batch, #running-req: 1, #token: 838, token usage: 0.04, cuda graph: False, gen throughput (token/s): 50.57, #queue-req: 0


    [2026-06-05 17:05:03] Decode batch, #running-req: 1, #token: 878, token usage: 0.04, cuda graph: False, gen throughput (token/s): 53.78, #queue-req: 0


    [2026-06-05 17:05:04] Decode batch, #running-req: 1, #token: 918, token usage: 0.04, cuda graph: False, gen throughput (token/s): 53.77, #queue-req: 0


    [2026-06-05 17:05:04] Decode batch, #running-req: 1, #token: 958, token usage: 0.05, cuda graph: False, gen throughput (token/s): 55.78, #queue-req: 0


    [2026-06-05 17:05:05] Decode batch, #running-req: 1, #token: 998, token usage: 0.05, cuda graph: False, gen throughput (token/s): 49.64, #queue-req: 0


    [2026-06-05 17:05:06] INFO:     127.0.0.1:37144 - "POST /generate HTTP/1.1" 200 OK
    Output from lora0: 
