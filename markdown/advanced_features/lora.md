...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 158.03it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 330.29it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 167.16it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 94.29it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 133.11it/s]
...
```
    ...
    [2026-06-01 04:35:03] Load weight end. elapsed=3.93 s, type=LlamaForCausalLM, avail mem=43.84 GB, mem usage=15.02 GB.
    [2026-06-01 04:35:03] Using csgmv as backend of LoRA kernels.
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 14438.22it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 85163.53it/s]
    [2026-06-01 04:35:03] Found local HF snapshot for Nutanix/Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json at /root/.cache/huggingface/hub/models--Nutanix--Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json/snapshots/2c398740f3eba8dc63ee78999316b833a2833b6c; skipping download.
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 322.84it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 5849.80it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 12390.85it/s]
    [2026-06-01 04:35:04] Found local HF snapshot for algoprog/fact-generation-llama-3.1-8b-instruct-lora at /root/.cache/huggingface/hub/models--algoprog--fact-generation-llama-3.1-8b-instruct-lora/snapshots/dc8cdfb21993a6cb46199d6b1d79f68a42b06439; skipping download.
    ...
    [2026-06-01 04:35:04] Found local HF snapshot for philschmid/code-llama-3-1-8b-text-to-sql-lora at /root/.cache/huggingface/hub/models--philschmid--code-llama-3-1-8b-text-to-sql-lora/snapshots/141fc3a09386a8baf0d7495c247ae2d1a565f69f; skipping download.


    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 99.72it/s]


    [2026-06-01 04:35:05] Max concurrent requests (per dp worker) from the finalized token capacity: max_num_reqs=128.
    [2026-06-01 04:35:05] KV Cache is allocated. dtype: torch.bfloat16, #tokens: 20480, K size: 1.25 GB, V size: 1.25 GB
    [2026-06-01 04:35:05] Memory pool end. avail mem=37.96 GB
    [2026-06-01 04:35:05] Disable piecewise CUDA graph because --disable-piecewise-cuda-graph is set


    [2026-06-01 04:35:11] max_total_num_tokens=20480, chunked_prefill_size=8192, max_prefill_tokens=16384, max_running_requests=128, context_len=131072, available_gpu_mem=49.26 GB
    [2026-06-01 04:35:11] Tree cache initialized: source=default impl=RadixCache hybrid_swa=False hybrid_ssm=False hierarchical=False streaming_wrapped=False


    [2026-06-01 04:35:11] INFO:     Started server process [2065098]
    [2026-06-01 04:35:11] INFO:     Waiting for application startup.
    [2026-06-01 04:35:11] Using default chat sampling params from model generation config: {'temperature': 0.6, 'top_p': 0.9}
    [2026-06-01 04:35:11] INFO:     Application startup complete.
    [2026-06-01 04:35:11] INFO:     Uvicorn running on http://127.0.0.1:36074 (Press CTRL+C to quit)


    /usr/local/lib/python3.10/dist-packages/fastapi/routing.py:120: FastAPIDeprecationWarning: ORJSONResponse is deprecated, FastAPI now serializes data directly to JSON bytes via Pydantic when a return type or response model is set, which is faster and doesn't need a custom response class. Read more in the FastAPI docs: https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model and https://fastapi.tiangolo.com/tutorial/response-model/
      response = await f(request)
    [2026-06-01 04:35:12] INFO:     127.0.0.1:55132 - "GET /v1/models HTTP/1.1" 200 OK


    [2026-06-01 04:35:12] INFO:     127.0.0.1:55142 - "GET /model_info HTTP/1.1" 200 OK


    [2026-06-01 04:35:13] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-01 04:35:13] LoRA expand (K=6144, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-01 04:35:13] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-01 04:35:13] LoRA expand (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}


    [2026-06-01 04:35:14] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-01 04:35:14] LoRA expand (K=28672, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-01 04:35:14] LoRA shrink (K=14336, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}


    [2026-06-01 04:35:14] Prefill batch, #new-seq: 1, #new-token: 7, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 2.06
    [2026-06-01 04:35:14] INFO:     127.0.0.1:55156 - "POST /generate HTTP/1.1" 200 OK
    [2026-06-01 04:35:14] The server is fired up and ready to roll!
...
```
    ...
    [2026-06-01 04:35:17] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-01 04:35:17] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-01 04:35:17] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-01 04:35:20] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-01 04:35:20] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-01 04:35:20] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-01 04:35:20] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-01 04:35:20] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-01 04:35:20] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 2, #pending-token: 18, cuda graph: False, input throughput (token/s): 1.45
    [2026-06-01 04:35:20] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-01 04:35:20] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-01 04:35:20] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-01 04:35:20] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-01 04:35:20] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-01 04:35:20] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-01 04:35:21] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-01 04:35:21] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-01 04:35:21] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-01 04:35:21] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    ...
    [2026-06-01 04:35:21] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 1, #pending-token: 9, cuda graph: False, input throughput (token/s): 8.24


    [2026-06-01 04:35:22] Decode batch, #running-req: 2, #token: 66, token usage: 0.00, cuda graph: False, gen throughput (token/s): 4.89, #queue-req: 1


    [2026-06-01 04:35:22] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].
    [2026-06-01 04:35:23] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 8.12


    [2026-06-01 04:35:23] Decode batch, #running-req: 2, #token: 80, token usage: 0.00, cuda graph: False, gen throughput (token/s): 87.25, #queue-req: 0


    [2026-06-01 04:35:23] Decode batch, #running-req: 2, #token: 160, token usage: 0.01, cuda graph: False, gen throughput (token/s): 91.99, #queue-req: 0


    [2026-06-01 04:35:24] Decode batch, #running-req: 1, #token: 144, token usage: 0.01, cuda graph: False, gen throughput (token/s): 66.05, #queue-req: 0


    [2026-06-01 04:35:25] Decode batch, #running-req: 1, #token: 184, token usage: 0.01, cuda graph: False, gen throughput (token/s): 50.15, #queue-req: 0


    [2026-06-01 04:35:26] Decode batch, #running-req: 1, #token: 224, token usage: 0.01, cuda graph: False, gen throughput (token/s): 53.00, #queue-req: 0


    [2026-06-01 04:35:27] Decode batch, #running-req: 1, #token: 264, token usage: 0.01, cuda graph: False, gen throughput (token/s): 50.99, #queue-req: 0


    [2026-06-01 04:35:27] Decode batch, #running-req: 1, #token: 304, token usage: 0.01, cuda graph: False, gen throughput (token/s): 53.00, #queue-req: 0


    [2026-06-01 04:35:28] Decode batch, #running-req: 1, #token: 344, token usage: 0.02, cuda graph: False, gen throughput (token/s): 51.84, #queue-req: 0


    [2026-06-01 04:35:29] Decode batch, #running-req: 1, #token: 384, token usage: 0.02, cuda graph: False, gen throughput (token/s): 50.21, #queue-req: 0


    [2026-06-01 04:35:30] Decode batch, #running-req: 1, #token: 424, token usage: 0.02, cuda graph: False, gen throughput (token/s): 51.73, #queue-req: 0


    [2026-06-01 04:35:31] Decode batch, #running-req: 1, #token: 464, token usage: 0.02, cuda graph: False, gen throughput (token/s): 46.96, #queue-req: 0


    [2026-06-01 04:35:31] Decode batch, #running-req: 1, #token: 504, token usage: 0.02, cuda graph: False, gen throughput (token/s): 48.41, #queue-req: 0


    [2026-06-01 04:35:32] Decode batch, #running-req: 1, #token: 544, token usage: 0.03, cuda graph: False, gen throughput (token/s): 44.72, #queue-req: 0


    [2026-06-01 04:35:33] Decode batch, #running-req: 1, #token: 584, token usage: 0.03, cuda graph: False, gen throughput (token/s): 50.20, #queue-req: 0


    [2026-06-01 04:35:34] Decode batch, #running-req: 1, #token: 624, token usage: 0.03, cuda graph: False, gen throughput (token/s): 52.26, #queue-req: 0


    [2026-06-01 04:35:35] Decode batch, #running-req: 1, #token: 664, token usage: 0.03, cuda graph: False, gen throughput (token/s): 53.15, #queue-req: 0


    [2026-06-01 04:35:35] Decode batch, #running-req: 1, #token: 704, token usage: 0.03, cuda graph: False, gen throughput (token/s): 53.44, #queue-req: 0


    [2026-06-01 04:35:36] Decode batch, #running-req: 1, #token: 744, token usage: 0.04, cuda graph: False, gen throughput (token/s): 53.63, #queue-req: 0


    [2026-06-01 04:35:37] Decode batch, #running-req: 1, #token: 784, token usage: 0.04, cuda graph: False, gen throughput (token/s): 55.04, #queue-req: 0


    [2026-06-01 04:35:38] Decode batch, #running-req: 1, #token: 824, token usage: 0.04, cuda graph: False, gen throughput (token/s): 50.68, #queue-req: 0


    [2026-06-01 04:35:38] Decode batch, #running-req: 1, #token: 864, token usage: 0.04, cuda graph: False, gen throughput (token/s): 52.77, #queue-req: 0


    [2026-06-01 04:35:39] Decode batch, #running-req: 1, #token: 904, token usage: 0.04, cuda graph: False, gen throughput (token/s): 53.19, #queue-req: 0


    [2026-06-01 04:35:40] Decode batch, #running-req: 1, #token: 944, token usage: 0.05, cuda graph: False, gen throughput (token/s): 52.54, #queue-req: 0


    [2026-06-01 04:35:41] Decode batch, #running-req: 1, #token: 984, token usage: 0.05, cuda graph: False, gen throughput (token/s): 48.61, #queue-req: 0


    [2026-06-01 04:35:42] Decode batch, #running-req: 1, #token: 1024, token usage: 0.05, cuda graph: False, gen throughput (token/s): 54.05, #queue-req: 0
    [2026-06-01 04:35:42] INFO:     127.0.0.1:52382 - "POST /generate HTTP/1.1" 200 OK
    Output from lora0: 
