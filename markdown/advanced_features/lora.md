...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 140.91it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 121.38it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 168.51it/s]
...
```
    ...
    [2026-06-01 20:32:55] Load weight end. elapsed=3.40 s, type=LlamaForCausalLM, avail mem=45.15 GB, mem usage=12.39 GB.
    [2026-06-01 20:32:55] Using csgmv as backend of LoRA kernels.
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 14886.62it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 17641.66it/s]
    [2026-06-01 20:32:56] Found local HF snapshot for Nutanix/Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json at /root/.cache/huggingface/hub/models--Nutanix--Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json/snapshots/2c398740f3eba8dc63ee78999316b833a2833b6c; skipping download.
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 300.17it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 18957.31it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 52593.15it/s]
    [2026-06-01 20:32:56] Found local HF snapshot for algoprog/fact-generation-llama-3.1-8b-instruct-lora at /root/.cache/huggingface/hub/models--algoprog--fact-generation-llama-3.1-8b-instruct-lora/snapshots/dc8cdfb21993a6cb46199d6b1d79f68a42b06439; skipping download.


    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 153.44it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 64035.18it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 5463.11it/s]
    [2026-06-01 20:32:57] Found local HF snapshot for philschmid/code-llama-3-1-8b-text-to-sql-lora at /root/.cache/huggingface/hub/models--philschmid--code-llama-3-1-8b-text-to-sql-lora/snapshots/141fc3a09386a8baf0d7495c247ae2d1a565f69f; skipping download.
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 64.74it/s]


    [2026-06-01 20:32:58] Max concurrent requests (per dp worker) from the finalized token capacity: max_num_reqs=128.
    [2026-06-01 20:32:58] KV Cache is allocated. dtype: torch.bfloat16, #tokens: 20480, K size: 1.25 GB, V size: 1.25 GB
    [2026-06-01 20:32:58] Memory pool end. avail mem=39.90 GB
    [2026-06-01 20:32:58] Disable piecewise CUDA graph because --disable-piecewise-cuda-graph is set


    [2026-06-01 20:33:09] max_total_num_tokens=20480, chunked_prefill_size=8192, max_prefill_tokens=16384, max_running_requests=128, context_len=131072, available_gpu_mem=39.81 GB
    [2026-06-01 20:33:09] Tree cache initialized: source=default impl=RadixCache hybrid_swa=False hybrid_ssm=False hierarchical=False streaming_wrapped=False


    [2026-06-01 20:33:09] INFO:     Started server process [2610567]
    [2026-06-01 20:33:09] INFO:     Waiting for application startup.
    [2026-06-01 20:33:09] Using default chat sampling params from model generation config: {'temperature': 0.6, 'top_p': 0.9}
    [2026-06-01 20:33:09] INFO:     Application startup complete.
    [2026-06-01 20:33:09] INFO:     Uvicorn running on http://127.0.0.1:30920 (Press CTRL+C to quit)


    /usr/local/lib/python3.10/dist-packages/fastapi/routing.py:120: FastAPIDeprecationWarning: ORJSONResponse is deprecated, FastAPI now serializes data directly to JSON bytes via Pydantic when a return type or response model is set, which is faster and doesn't need a custom response class. Read more in the FastAPI docs: https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model and https://fastapi.tiangolo.com/tutorial/response-model/
      response = await f(request)
    [2026-06-01 20:33:10] INFO:     127.0.0.1:59644 - "GET /v1/models HTTP/1.1" 200 OK


    [2026-06-01 20:33:10] INFO:     127.0.0.1:59658 - "GET /model_info HTTP/1.1" 200 OK


    [2026-06-01 20:33:11] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-01 20:33:11] LoRA expand (K=6144, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-01 20:33:12] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-01 20:33:12] LoRA expand (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}


    [2026-06-01 20:33:12] LoRA shrink (K=4096, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
    [2026-06-01 20:33:12] LoRA expand (K=28672, R=256): no tuned config, using defaults {'BLOCK_N': 64, 'BLOCK_K': 16}
    [2026-06-01 20:33:12] LoRA shrink (K=14336, R=256): no tuned config, using defaults {'BLOCK_N': 16, 'BLOCK_K': 256}
...
```
    ...
    [2026-06-01 20:33:16] Prefill batch, #new-seq: 1, #new-token: 7, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 0.98
    [2026-06-01 20:33:16] LoRA adapter '85e4aea1bd4053009505fcba5ed672a1': loaded weights for target modules ['qkv_proj'].
    [2026-06-01 20:33:16] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 2, #pending-token: 18, cuda graph: False, input throughput (token/s): 49.52


    [2026-06-01 20:33:16] INFO:     127.0.0.1:59668 - "POST /generate HTTP/1.1" 200 OK
    [2026-06-01 20:33:16] The server is fired up and ready to roll!
    [2026-06-01 20:33:16] LoRA adapter 'f90a12a9114e53249d1c4156418a4a43': loaded weights for target modules ['gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-01 20:33:17] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 1, #pending-token: 9, cuda graph: False, input throughput (token/s): 8.85


    [2026-06-01 20:33:18] Decode batch, #running-req: 2, #token: 88, token usage: 0.00, cuda graph: False, gen throughput (token/s): 8.38, #queue-req: 1


    [2026-06-01 20:33:19] LoRA adapter '83085c14120557f79ef7b4ab7b570223': loaded weights for target modules ['down_proj', 'gate_up_proj', 'o_proj', 'qkv_proj'].


    [2026-06-01 20:33:21] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 0, #pending-token: 0, cuda graph: False, input throughput (token/s): 2.19
    [2026-06-01 20:33:21] Decode batch, #running-req: 2, #token: 102, token usage: 0.00, cuda graph: False, gen throughput (token/s): 22.28, #queue-req: 0


    [2026-06-01 20:33:22] Decode batch, #running-req: 2, #token: 182, token usage: 0.01, cuda graph: False, gen throughput (token/s): 77.87, #queue-req: 0


    [2026-06-01 20:33:23] Decode batch, #running-req: 1, #token: 168, token usage: 0.01, cuda graph: False, gen throughput (token/s): 64.26, #queue-req: 0


    [2026-06-01 20:33:24] Decode batch, #running-req: 1, #token: 208, token usage: 0.01, cuda graph: False, gen throughput (token/s): 46.78, #queue-req: 0


    [2026-06-01 20:33:25] Decode batch, #running-req: 1, #token: 248, token usage: 0.01, cuda graph: False, gen throughput (token/s): 47.23, #queue-req: 0


    [2026-06-01 20:33:26] Decode batch, #running-req: 1, #token: 288, token usage: 0.01, cuda graph: False, gen throughput (token/s): 46.93, #queue-req: 0


    [2026-06-01 20:33:27] Decode batch, #running-req: 1, #token: 328, token usage: 0.02, cuda graph: False, gen throughput (token/s): 38.23, #queue-req: 0


    [2026-06-01 20:33:28] Decode batch, #running-req: 1, #token: 368, token usage: 0.02, cuda graph: False, gen throughput (token/s): 38.73, #queue-req: 0


    [2026-06-01 20:33:29] Decode batch, #running-req: 1, #token: 408, token usage: 0.02, cuda graph: False, gen throughput (token/s): 46.30, #queue-req: 0


    [2026-06-01 20:33:30] Decode batch, #running-req: 1, #token: 448, token usage: 0.02, cuda graph: False, gen throughput (token/s): 46.84, #queue-req: 0


    [2026-06-01 20:33:30] Decode batch, #running-req: 1, #token: 488, token usage: 0.02, cuda graph: False, gen throughput (token/s): 47.06, #queue-req: 0


    [2026-06-01 20:33:31] Decode batch, #running-req: 1, #token: 528, token usage: 0.03, cuda graph: False, gen throughput (token/s): 47.01, #queue-req: 0


    [2026-06-01 20:33:32] Decode batch, #running-req: 1, #token: 568, token usage: 0.03, cuda graph: False, gen throughput (token/s): 47.11, #queue-req: 0


    [2026-06-01 20:33:33] Decode batch, #running-req: 1, #token: 608, token usage: 0.03, cuda graph: False, gen throughput (token/s): 46.38, #queue-req: 0


    [2026-06-01 20:33:34] Decode batch, #running-req: 1, #token: 648, token usage: 0.03, cuda graph: False, gen throughput (token/s): 46.64, #queue-req: 0


    [2026-06-01 20:33:35] Decode batch, #running-req: 1, #token: 688, token usage: 0.03, cuda graph: False, gen throughput (token/s): 47.53, #queue-req: 0


    [2026-06-01 20:33:36] Decode batch, #running-req: 1, #token: 728, token usage: 0.04, cuda graph: False, gen throughput (token/s): 47.36, #queue-req: 0


    [2026-06-01 20:33:37] Decode batch, #running-req: 1, #token: 768, token usage: 0.04, cuda graph: False, gen throughput (token/s): 37.40, #queue-req: 0


    [2026-06-01 20:33:38] Decode batch, #running-req: 1, #token: 808, token usage: 0.04, cuda graph: False, gen throughput (token/s): 42.04, #queue-req: 0


    [2026-06-01 20:33:39] Decode batch, #running-req: 1, #token: 848, token usage: 0.04, cuda graph: False, gen throughput (token/s): 44.25, #queue-req: 0


    [2026-06-01 20:33:39] Decode batch, #running-req: 1, #token: 888, token usage: 0.04, cuda graph: False, gen throughput (token/s): 41.38, #queue-req: 0


    [2026-06-01 20:33:40] Decode batch, #running-req: 1, #token: 928, token usage: 0.05, cuda graph: False, gen throughput (token/s): 39.97, #queue-req: 0


    [2026-06-01 20:33:41] Decode batch, #running-req: 1, #token: 968, token usage: 0.05, cuda graph: False, gen throughput (token/s): 42.39, #queue-req: 0


    [2026-06-01 20:33:42] Decode batch, #running-req: 1, #token: 1008, token usage: 0.05, cuda graph: False, gen throughput (token/s): 43.42, #queue-req: 0


    [2026-06-01 20:33:43] INFO:     127.0.0.1:42262 - "POST /generate HTTP/1.1" 200 OK
    Output from lora0: 
