...
```
    ...
    [2026-03-18 22:20:56] INFO utils.py:148: Note: detected 128 virtual cores but NumExpr set to maximum of 64, check "NUMEXPR_MAX_THREADS" environment variable.


    [2026-03-18 22:20:56] INFO utils.py:151: Note: NumExpr detected 128 cores but "NUMEXPR_MAX_THREADS" not set, so enforcing safe limit of 16.


    [2026-03-18 22:20:56] INFO utils.py:164: NumExpr defaulting to 16 threads.
...
```
    ...
    <frozen importlib._bootstrap_external>:1184: FutureWarning: The cuda.cudart module is deprecated and will be removed in a future release, please switch to use the cuda.bindings.runtime module instead.
    <frozen importlib._bootstrap_external>:1184: FutureWarning: The cuda.nvrtc module is deprecated and will be removed in a future release, please switch to use the cuda.bindings.nvrtc module instead.
    [2026-03-18 22:21:04] Transformers version 5.3.0 is used for model type qwen2_5_vl. If you experience issues related to RoPE parameters, they may be due to incompatibilities between Transformers >=5.0.0 and some models. You can try downgrading to transformers==4.57.1 as a workaround.


    [2026-03-18 22:21:07] Transformers version 5.3.0 is used for model type qwen2_5_vl. If you experience issues related to RoPE parameters, they may be due to incompatibilities between Transformers >=5.0.0 and some models. You can try downgrading to transformers==4.57.1 as a workaround.
...
```
    ...
    Model response:
    The image shows a street scene with two yellow taxis in New York City, which are iconic for their distinctive uniforms and services. The man in the image appears to be drying laundry on a clothesline along the back of one of the taxis, which likely belongs to a cab company. This is an unusual and humorous activity as taxis are typically not used to dry laundry. The setting suggests a busy urban environment, possibly during warm weather when using outdoor methods of drying clothes might be more common.
...
```
    ...
    The image shows a yellow taxi cab parked on a city street. A person wearing a yellow shirt is removing a stretched-out jacket from the back window of the taxi. The jacket appears to be hanging over a stand attached to the back of the cab. The background includes other vehicles and buildings, indicating an urban setting.
...
```
    ...
    The photo shows a yellow taxi cab in the background with a person operating a bean bag machine at the curb. The person appears to be in the middle of a performance or distraction setup using the bean bag machine.
